...
import androidx.viewpager2.C0819R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    public static abstract class OnPageChangeCallback {
        ...
        public void onPageScrolled(int i, float f, @C0049Px int i2) {
        }
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        C08352 r3 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
        ...
        C08363 r4 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0819R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0819R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0819R.styleable.ViewPager2_android_orientation, 0));
        } finally {
    ...
    public boolean fakeDragBy(@C0049Px @SuppressLint({"SupportAnnotationUsage"}) float f) {
