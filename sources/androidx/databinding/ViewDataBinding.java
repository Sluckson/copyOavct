...
import androidx.databinding.library.C0342R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    public void setRootTag(View view) {
        view.setTag(C0342R.C0343id.dataBinding, this);
    }

    /* access modifiers changed from: protected */
    public void setRootTag(View[] viewArr) {
        for (View tag : viewArr) {
            tag.setTag(C0342R.C0343id.dataBinding, this);
        }
    }
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0342R.C0343id.dataBinding);
        }
        return null;
    }
