...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0051R.C0054id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0051R.C0054id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0051R.C0054id.action_bar));
        }
    }
