...
class TooltipPopup {
    ...
    TooltipPopup(@NonNull Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0051R.C0056layout.abc_tooltip, (ViewGroup) null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0051R.C0054id.message);
        ...
        layoutParams.windowAnimations = C0051R.C0057style.Animation_AppCompat_Tooltip;
