...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(C0051R.styleable.ActionMode_closeItemLayout, C0051R.C0056layout.abc_action_mode_close_item_material);
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0051R.C0056layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0051R.C0054id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0051R.C0054id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0051R.C0054id.action_mode_close_button).setOnClickListener(new View.OnClickListener() {
