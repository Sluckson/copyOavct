...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(C0051R.styleable.SwitchCompat_android_thumb);
        Drawable drawable = this.mThumbDrawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(C0051R.styleable.SwitchCompat_track);
