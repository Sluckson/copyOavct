...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView {
    ...
    public void setFirstBaselineToTopHeight(@C0049Px @IntRange(from = 0) int i) {
    ...
    public void setLastBaselineToBottomHeight(@C0049Px @IntRange(from = 0) int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0049Px @IntRange(from = 0) int i) {
