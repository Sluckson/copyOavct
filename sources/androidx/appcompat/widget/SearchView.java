...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0051R.styleable.SearchView_layout, C0051R.C0056layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0051R.C0054id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0051R.C0054id.search_edit_frame);
        this.mSearchPlate = findViewById(C0051R.C0054id.search_plate);
        this.mSubmitArea = findViewById(C0051R.C0054id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0051R.C0054id.search_button);
        this.mGoButton = (ImageView) findViewById(C0051R.C0054id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0051R.C0054id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0051R.C0054id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0051R.C0054id.search_mag_icon);
        ...
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0051R.styleable.SearchView_suggestionRowLayout, C0051R.C0056layout.abc_search_dropdown_item_icons_2line);
        ...
        this.mVoiceWebSearchIntent.addFlags(C1119C.ENCODING_PCM_MU_LAW);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(C1119C.ENCODING_PCM_MU_LAW);
    ...
    public void onActionViewExpanded() {
        if (!this.mExpandedInActionView) {
            ...
            this.mSearchSrcTextView.setImeOptions(this.mCollapsedImeOptions | PdfFormField.FF_RADIOSINUNISON);
            this.mSearchSrcTextView.setText("");
            setIconified(false);
        }
    }
