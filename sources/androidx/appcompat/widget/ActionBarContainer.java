...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        if (getId() == C0051R.C0054id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0051R.C0054id.action_bar);
        this.mContextView = findViewById(C0051R.C0054id.action_context_bar);
    }
