...
class AlertController {
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0051R.C0054id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0051R.C0054id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0051R.C0054id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0051R.C0054id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0051R.C0054id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0051R.C0054id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0051R.C0054id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0051R.C0054id.buttonPanel);
        ...
        if (!(z3 || resolvePanel2 == null || (findViewById2 = resolvePanel2.findViewById(C0051R.C0054id.textSpacerNoButtons)) == null)) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0051R.C0054id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (!(resolvePanel2 == null || (findViewById = resolvePanel2.findViewById(C0051R.C0054id.textSpacerNoTitle)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0051R.C0054id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0051R.C0054id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0051R.C0054id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0051R.C0054id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0051R.C0054id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0051R.C0054id.scrollView);
