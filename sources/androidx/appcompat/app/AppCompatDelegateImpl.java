...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        try {
            ...
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0051R.C0057style.Theme_AppCompat_Empty);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(C0051R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0051R.C0056layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(C0051R.C0056layout.abc_screen_simple, (ViewGroup) null);
            } else if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0051R.C0056layout.abc_dialog_title_material, (ViewGroup) null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0051R.C0056layout.abc_screen_toolbar, (ViewGroup) null);
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0051R.C0054id.decor_content_parent);
            ...
            if (viewGroup != null) {
                ...
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0051R.C0054id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0051R.C0054id.action_bar_activity_content);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(@androidx.annotation.NonNull androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x00b7:
            ...
            int r4 = androidx.appcompat.C0051R.C0054id.action_mode_bar_stub
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            i = ContextCompat.getColor(this.mContext, C0051R.C0052color.abc_decor_view_status_guard_light);
        } else {
            i = ContextCompat.getColor(this.mContext, C0051R.C0052color.abc_decor_view_status_guard);
        }
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                newTheme.applyStyle(C0051R.C0057style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0051R.C0056layout.abc_list_menu_item_layout);
