...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0051R.styleable.DrawerArrowToggle, C0051R.attr.drawerArrowStyle, C0051R.C0057style.Base_Widget_AppCompat_DrawerArrowToggle);
