...
class FragmentStateManager {
    ...
    public int computeMaxState() {
        ...
        int i2 = C04101.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i2 == 1) {
            return i;
        }
        if (i2 == 2) {
    ...
    static /* synthetic */ class C04101 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C04101.<clinit>():void");
        }
    }
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0383R.C0386id.fragment_container_view_tag, this.mFragment);
    ...
    public void createView(@androidx.annotation.NonNull androidx.fragment.app.FragmentContainer r5) {
        ...
        L_0x00b4:
            ...
            androidx.fragment.app.Fragment r5 = r4.mFragment
            android.view.View r5 = r5.mView
            int r2 = androidx.fragment.C0383R.C0386id.fragment_container_view_tag
