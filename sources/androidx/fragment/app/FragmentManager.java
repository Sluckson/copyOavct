...
public abstract class FragmentManager {
    ...
    static Fragment getViewFragment(@NonNull View view) {
        Object tag = view.getTag(C0383R.C0386id.fragment_container_view_tag);
    ...
    private void setVisibleRemovingFragment(@NonNull Fragment fragment) {
        ...
        if (fragmentContainer != null) {
            if (fragmentContainer.getTag(C0383R.C0386id.visible_removing_fragment_view_tag) == null) {
                fragmentContainer.setTag(C0383R.C0386id.visible_removing_fragment_view_tag, fragment);
            }
            ((Fragment) fragmentContainer.getTag(C0383R.C0386id.visible_removing_fragment_view_tag)).setNextAnim(fragment.getNextAnim());
        }
    }
