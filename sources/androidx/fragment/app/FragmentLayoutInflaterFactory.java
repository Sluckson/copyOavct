...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        String attributeValue = attributeSet.getAttributeValue((String) null, Markup.HTML_ATTR_CSS_CLASS);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0383R.styleable.Fragment);
        if (attributeValue == null) {
            attributeValue = obtainStyledAttributes.getString(C0383R.styleable.Fragment_android_name);
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0383R.styleable.Fragment_android_id, -1);
        String string = obtainStyledAttributes.getString(C0383R.styleable.Fragment_android_tag);
