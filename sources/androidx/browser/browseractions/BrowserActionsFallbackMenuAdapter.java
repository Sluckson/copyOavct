...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(this.mContext).inflate(C0161R.C0165layout.browser_actions_context_menu_row, (ViewGroup) null);
            viewHolderItem = new ViewHolderItem();
            viewHolderItem.mIcon = (ImageView) view.findViewById(C0161R.C0164id.browser_actions_menu_item_icon);
            viewHolderItem.mText = (TextView) view.findViewById(C0161R.C0164id.browser_actions_menu_item_text);
