...
import androidx.recyclerview.C0646R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public void onScrolled(@C0049Px int i, @C0049Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0646R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0646R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0646R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        }
        String string = obtainStyledAttributes.getString(C0646R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0646R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0646R.styleable.RecyclerView_android_clipToPadding, true);
        this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0646R.styleable.RecyclerView_fastScrollEnabled, false);
        if (this.mEnableFastScroller) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0646R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0646R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0646R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0646R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
    ...
    public void smoothScrollBy(@C0049Px int i, @C0049Px int i2) {
        smoothScrollBy(i, i2, (Interpolator) null);
    }

    public void smoothScrollBy(@C0049Px int i, @C0049Px int i2, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i2, interpolator, Integer.MIN_VALUE);
    }

    public void smoothScrollBy(@C0049Px int i, @C0049Px int i2, @Nullable Interpolator interpolator, int i3) {
        smoothScrollBy(i, i2, interpolator, i3, false);
    }

    /* access modifiers changed from: package-private */
    public void smoothScrollBy(@C0049Px int i, @C0049Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutSuppressed) {
    ...
    public void offsetChildrenVertical(@C0049Px int i) {
        int childCount = this.mChildHelper.getChildCount();
    ...
    public void offsetChildrenHorizontal(@C0049Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0646R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0646R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0646R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0646R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0646R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0646R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0646R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0646R.dimen.fastscroll_margin));
    }
    ...
    public static abstract class SmoothScroller {
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0049Px int i, @C0049Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@C0049Px int i, @C0049Px int i2) {
                this(i, i2, Integer.MIN_VALUE, (Interpolator) null);
            }

            public Action(@C0049Px int i, @C0049Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0049Px int i, @C0049Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0049Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@C0049Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0049Px int i, @C0049Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
