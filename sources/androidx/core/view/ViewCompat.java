...
public class ViewCompat {
    ...
    public static void setPaddingRelative(@NonNull View view, @C0049Px int i, @C0049Px int i2, @C0049Px int i3, @C0049Px int i4) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo651to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            C02792 r1 = new View.OnUnhandledKeyEventListener() {
