...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontsContractCompat.C02695.compare(byte[], byte[]):int");
        }
    };
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0085, code lost:
        sBackgroundThread.postAndReply(r1, new androidx.core.provider.FontsContractCompat.C02583());
     */
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo669to = 1000) int i2, boolean z, int i3) {
