...
public final class TextViewCompat {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @C0049Px @IntRange(from = 0) int i) {
        int i2;
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @C0049Px @IntRange(from = 0) int i) {
        int i2;
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        if (Build.VERSION.SDK_INT < 16 || textView.getIncludeFontPadding()) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @C0049Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
