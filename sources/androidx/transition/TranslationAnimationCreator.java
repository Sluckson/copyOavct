...
class TranslationAnimationCreator {
    ...
    static Animator createAnimation(@NonNull View view, @NonNull TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, @Nullable TimeInterpolator timeInterpolator, @NonNull Transition transition) {
        ...
        int[] iArr = (int[]) transitionValues2.view.getTag(C0765R.C0768id.transition_position);
        if (iArr != null) {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        private int[] mTransitionPosition = ((int[]) this.mViewInHierarchy.getTag(C0765R.C0768id.transition_position));
        ...
        TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2) {
            ...
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0765R.C0768id.transition_position, (Object) null);
            }
        }
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            this.mViewInHierarchy.setTag(C0765R.C0768id.transition_position, this.mTransitionPosition);
        }
