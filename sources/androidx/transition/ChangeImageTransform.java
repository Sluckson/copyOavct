...
public class ChangeImageTransform extends Transition {
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        if (drawable.getIntrinsicWidth() > 0 && drawable.getIntrinsicHeight() > 0) {
            int i = C07523.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C07523 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C07523.<clinit>():void");
        }
    }
