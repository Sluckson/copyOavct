...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0765R.C0768id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0765R.C0768id.parent_matrix));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z) {
        ...
        final boolean z2 = z;
        C07553 r1 = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (!z2 || !ChangeTransform.this.mUseOverlay) {
                        view.setTag(C0765R.C0768id.transition_transform, (Object) null);
                        view.setTag(C0765R.C0768id.parent_matrix, (Object) null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix matrix) {
                ...
                view.setTag(C0765R.C0768id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0765R.C0768id.parent_matrix, matrix);
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0765R.C0768id.transition_transform, (Object) null);
            this.mView.setTag(C0765R.C0768id.parent_matrix, (Object) null);
        }
