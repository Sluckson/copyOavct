...
class ViewUtilsBase {
    ...
    public void setTransitionAlpha(@NonNull View view, float f) {
        Float f2 = (Float) view.getTag(C0765R.C0768id.save_non_transition_alpha);
        if (f2 != null) {
    ...
    public float getTransitionAlpha(@NonNull View view) {
        Float f = (Float) view.getTag(C0765R.C0768id.save_non_transition_alpha);
        if (f != null) {
    ...
    public void saveNonTransitionAlpha(@NonNull View view) {
        if (view.getTag(C0765R.C0768id.save_non_transition_alpha) == null) {
            view.setTag(C0765R.C0768id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }

    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0765R.C0768id.save_non_transition_alpha, (Object) null);
        }
    }
