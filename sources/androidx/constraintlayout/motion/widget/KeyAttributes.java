...
public class KeyAttributes extends Key {
    ...
    public void setInterpolation(HashMap<String, Integer> hashMap) {
        if (this.mCurveFit != -1) {
            ...
            if (!Float.isNaN(this.mRotation)) {
                hashMap.put(ElementTags.ROTATION, Integer.valueOf(this.mCurveFit));
            }
            if (!Float.isNaN(this.mRotationX)) {
    ...
    private static class Loader {
        ...
        static {
            ...
            mAttrMap.append(C0215R.styleable.KeyAttribute_android_transformPivotX, 19);
            mAttrMap.append(C0215R.styleable.KeyAttribute_android_transformPivotY, 20);
            ...
            mAttrMap.append(C0215R.styleable.KeyAttribute_android_scaleY, 14);
            mAttrMap.append(C0215R.styleable.KeyAttribute_android_translationX, 15);
            mAttrMap.append(C0215R.styleable.KeyAttribute_android_translationY, 16);
            mAttrMap.append(C0215R.styleable.KeyAttribute_android_translationZ, 17);
            mAttrMap.append(C0215R.styleable.KeyAttribute_motionProgress, 18);
        }
