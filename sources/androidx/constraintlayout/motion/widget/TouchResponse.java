...
class TouchResponse {
    ...
    private void fill(TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            } else if (index == C0215R.styleable.OnSwipe_dragThreshold) {
            ...
            } else if (index == C0215R.styleable.OnSwipe_nestedScrollFlags) {
                this.mFlags = typedArray.getInteger(index, 0);
            } else if (index == C0215R.styleable.OnSwipe_limitBoundsTo) {
