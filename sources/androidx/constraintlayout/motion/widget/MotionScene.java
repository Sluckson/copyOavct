...
public class MotionScene {
    ...
    public static class Transition {
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                } else if (index == C0215R.styleable.Transition_pathMotionArc) {
                    this.mPathMotionArc = typedArray.getInteger(index, -1);
                } else if (index == C0215R.styleable.Transition_layoutDuringTransition) {
                    this.mLayoutDuringTransition = typedArray.getInteger(index, 0);
                } else if (index == C0215R.styleable.Transition_transitionFlags) {
    ...
    private void load(android.content.Context r10, int r11) {
        /*
            ...
            r1 = 0
            int r2 = r0.getEventType()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x000d:
            r3 = 1
            ...
            goto L_0x0149
        L_0x0018:
            java.lang.String r2 = r0.getName()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            boolean r6 = r9.DEBUG_DESKTOP     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r6 == 0) goto L_0x0036
            java.io.PrintStream r6 = java.lang.System.out     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r7.<init>()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r8 = "parsing = "
            r7.append(r8)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r7.append(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r7 = r7.toString()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r6.println(r7)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x0036:
            int r6 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r7 = -1
        ...
        L_0x0041:
            ...
            boolean r3 = r2.equals(r3)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r3 == 0) goto L_0x0084
            r3 = 4
            goto L_0x0085
        L_0x004b:
            boolean r3 = r2.equals(r8)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r3 == 0) goto L_0x0084
            r3 = 0
            goto L_0x0085
        L_0x0053:
        ...
        L_0x0067:
            ...
            boolean r4 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        ...
        L_0x0085:
            ...
            }     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x0088:
            goto L_0x0131
        L_0x008a:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r2.<init>(r10, r0)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.util.ArrayList r3 = r1.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0149
        L_0x0098:
            r9.parseConstraintSet(r10, r0)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0149
        L_0x009d:
            androidx.constraintlayout.widget.StateSet r2 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r2.<init>(r10, r0)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r9.mStateSet = r2     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0149
        L_0x00a6:
            r1.addOnClick(r10, r0)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0149
        L_0x00ab:
            if (r1 != 0) goto L_0x00da
            android.content.res.Resources r2 = r10.getResources()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r2 = r2.getResourceEntryName(r11)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            int r3 = r0.getLineNumber()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r5 = " OnSwipe ("
            r4.append(r5)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r2 = ".xml:"
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r4.append(r3)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r2 = ")"
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r2 = r4.toString()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            android.util.Log.v(r8, r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x00da:
            androidx.constraintlayout.motion.widget.TouchResponse r2 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            androidx.constraintlayout.motion.widget.MotionLayout r3 = r9.mMotionLayout     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r2.<init>(r10, r3, r0)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r1.mTouchResponse = r2     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0149
        L_0x00e5:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r9.mTransitionList     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r2 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r2.<init>(r9, r10, r0)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r9.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r1 != 0) goto L_0x0112
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r1 != 0) goto L_0x0112
            r9.mCurrentTransition = r2     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r9.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r1 == 0) goto L_0x0112
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r9.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r1.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r1 == 0) goto L_0x0112
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r9.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r1.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            boolean r3 = r9.mRtl     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r1.setRTL(r3)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x0112:
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r1 == 0) goto L_0x012b
            int r1 = r2.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            if (r1 != r7) goto L_0x0121
            r9.mDefaultTransition = r2     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0126
        L_0x0121:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r9.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x0126:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r9.mTransitionList     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r1.remove(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x012b:
            r1 = r2
            goto L_0x0149
        L_0x012d:
            r9.parseMotionSceneTags(r10, r0)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0149
        L_0x0131:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r3.<init>()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r4 = "WARNING UNKNOWN ATTRIBUTE "
            r3.append(r4)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            r3.append(r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            java.lang.String r2 = r3.toString()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            android.util.Log.v(r8, r2)     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x0149
        L_0x0146:
            r0.getName()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
        L_0x0149:
            int r2 = r0.next()     // Catch:{ XmlPullParserException -> 0x0154, IOException -> 0x014f }
            goto L_0x000d
        L_0x014f:
            r10 = move-exception
            r10.printStackTrace()
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            } else if (index == C0215R.styleable.MotionScene_layoutDuringTransition) {
