...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    static String[] names = {Constants_MVVM.EXTRA_ITEM_POSITION, "x", "y", "width", "height", "pathRotate"};
    ...
    public void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.mMode = 1;
        MotionPaths motionPaths5 = motionPaths;
        this.f29x = (float) ((int) ((motionPaths5.f29x + f12) - f14));
        this.f30y = (float) ((int) ((motionPaths5.f30y + f15) - f17));
        this.f29x += f19;
        this.f30y += f20;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition3.mTransitionEasing);
        this.mPathMotionArc = keyPosition3.mPathMotionArc;
    ...
    public void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (!Float.isNaN(f10)) {
            ...
            view2.setRotation((float) (((double) f5) + ((double) f10) + Math.toDegrees(Math.atan2((double) (f13 + (f14 / 2.0f)), (double) (f11 + (f12 / 2.0f))))));
