...
public class HorizontalChainReference extends ChainReference {
    ...
    public void apply() {
        ...
        int i = C02011.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain[this.mStyle.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C02011 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.helpers.HorizontalChainReference.C02011.<clinit>():void");
        }
    }
