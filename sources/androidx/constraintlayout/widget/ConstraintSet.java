...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0215R.styleable.Constraint_motionProgress, 68);
    ...
    private void populateConstraint(Context context, Constraint constraint, TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (!(index == C0215R.styleable.Constraint_android_id || C0215R.styleable.Constraint_android_layout_marginStart == index || C0215R.styleable.Constraint_android_layout_marginEnd == index)) {
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0215R.C0218id.class.getField(trim).getInt((Object) null);
