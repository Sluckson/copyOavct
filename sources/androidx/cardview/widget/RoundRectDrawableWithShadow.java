...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0182R.C0183color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0182R.C0183color.cardview_shadow_end_color);
