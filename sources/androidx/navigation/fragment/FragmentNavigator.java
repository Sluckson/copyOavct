...
public class FragmentNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(@NonNull Context context, @NonNull AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0571R.styleable.FragmentNavigator);
            String string = obtainAttributes.getString(C0571R.styleable.FragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }
