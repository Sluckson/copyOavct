...
import androidx.navigation.C0552R;
...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    private int getContainerId() {
        int id = getId();
        if (id == 0 || id == -1) {
            return C0571R.C0574id.nav_host_fragment_container;
        }
        return id;
    }
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attributeSet, @Nullable Bundle bundle) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0552R.styleable.NavHost);
        int resourceId = obtainStyledAttributes.getResourceId(C0552R.styleable.NavHost_navGraph, 0);
        if (resourceId != 0) {
            this.mGraphId = resourceId;
        }
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0571R.styleable.NavHostFragment);
        if (obtainStyledAttributes2.getBoolean(C0571R.styleable.NavHostFragment_defaultNavHost, false)) {
            this.mDefaultNavHost = true;
        }
