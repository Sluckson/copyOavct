...
public class ActivityNavigator extends Navigator<Destination> {
    ...
    public NavDestination navigate(@NonNull Destination destination, @Nullable Bundle bundle, @Nullable NavOptions navOptions, @Nullable Navigator.Extras extras) {
        ...
        if (destination.getIntent() != null) {
            ...
            if (!(this.mContext instanceof Activity)) {
                intent2.addFlags(C1119C.ENCODING_PCM_MU_LAW);
            }
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(@NonNull Context context, @NonNull AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0552R.styleable.ActivityNavigator);
            String string = obtainAttributes.getString(C0552R.styleable.ActivityNavigator_targetPackage);
            if (string != null) {
                string = string.replace(NavInflater.APPLICATION_ID_PLACEHOLDER, context.getPackageName());
            }
            setTargetPackage(string);
            String string2 = obtainAttributes.getString(C0552R.styleable.ActivityNavigator_android_name);
            if (string2 != null) {
                if (string2.charAt(0) == '.') {
            ...
            setAction(obtainAttributes.getString(C0552R.styleable.ActivityNavigator_action));
            String string3 = obtainAttributes.getString(C0552R.styleable.ActivityNavigator_data);
            if (string3 != null) {
                setData(Uri.parse(string3));
            }
            setDataPattern(obtainAttributes.getString(C0552R.styleable.ActivityNavigator_dataPattern));
