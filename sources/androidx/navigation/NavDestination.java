...
public class NavDestination {
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0558R.styleable.Navigator);
        setId(obtainAttributes.getResourceId(C0558R.styleable.Navigator_android_id, 0));
        this.mIdName = getDisplayName(context, this.mId);
        setLabel(obtainAttributes.getText(C0558R.styleable.Navigator_android_label));
