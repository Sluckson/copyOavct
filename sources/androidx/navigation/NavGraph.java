...
public class NavGraph extends NavDestination implements Iterable<NavDestination> {
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0558R.styleable.NavGraphNavigator);
        setStartDestination(obtainAttributes.getResourceId(C0558R.styleable.NavGraphNavigator_startDestination, 0));
