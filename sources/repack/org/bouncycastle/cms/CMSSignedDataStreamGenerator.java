...
public class CMSSignedDataStreamGenerator extends CMSSignedGenerator {
    ...
    private class SignerIntInfoGeneratorImpl implements SignerIntInfoGenerator {
        private final String _encName = CMSSignedHelper.INSTANCE.getEncryptionAlgName(this._encOID);
        ...
        SignerIntInfoGeneratorImpl(PrivateKey privateKey, SignerIdentifier signerIdentifier, String str, String str2, CMSAttributeTableGenerator cMSAttributeTableGenerator, CMSAttributeTableGenerator cMSAttributeTableGenerator2, Provider provider, SecureRandom secureRandom) throws NoSuchAlgorithmException, InvalidKeyException {
            ...
            String str3 = String.valueOf(CMSSignedHelper.INSTANCE.getDigestAlgName(str)) + "with" + this._encName;
            if (this._sAttr != null) {
                this._sig = CMSSignedHelper.INSTANCE.getSignatureInstance(str3, provider);
    ...
    public void addSigner(PrivateKey privateKey, X509Certificate x509Certificate, String str, Provider provider) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
        addSigner(privateKey, x509Certificate, str, (CMSAttributeTableGenerator) new DefaultSignedAttributeTableGenerator(), (CMSAttributeTableGenerator) null, provider);
    }
    ...
    public void addSigner(PrivateKey privateKey, X509Certificate x509Certificate, String str, String str2, Provider provider) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
        addSigner(privateKey, x509Certificate, str, str2, (CMSAttributeTableGenerator) new DefaultSignedAttributeTableGenerator(), (CMSAttributeTableGenerator) null, provider);
    }
    ...
    public void addSigner(PrivateKey privateKey, X509Certificate x509Certificate, String str, AttributeTable attributeTable, AttributeTable attributeTable2, Provider provider) throws NoSuchAlgorithmException, InvalidKeyException {
        addSigner(privateKey, x509Certificate, str, (CMSAttributeTableGenerator) new DefaultSignedAttributeTableGenerator(attributeTable), (CMSAttributeTableGenerator) new SimpleAttributeTableGenerator(attributeTable2), provider);
    }
    ...
    public void addSigner(PrivateKey privateKey, X509Certificate x509Certificate, String str, String str2, AttributeTable attributeTable, AttributeTable attributeTable2, Provider provider) throws NoSuchAlgorithmException, InvalidKeyException {
        addSigner(privateKey, x509Certificate, str, str2, (CMSAttributeTableGenerator) new DefaultSignedAttributeTableGenerator(attributeTable), (CMSAttributeTableGenerator) new SimpleAttributeTableGenerator(attributeTable2), provider);
    }
    ...
    public void addSigner(PrivateKey privateKey, byte[] bArr, String str, Provider provider) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
        addSigner(privateKey, bArr, str, (CMSAttributeTableGenerator) new DefaultSignedAttributeTableGenerator(), (CMSAttributeTableGenerator) null, provider);
    }
    ...
    public void addSigner(PrivateKey privateKey, byte[] bArr, String str, String str2, Provider provider) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException {
        addSigner(privateKey, bArr, str, str2, (CMSAttributeTableGenerator) new DefaultSignedAttributeTableGenerator(), (CMSAttributeTableGenerator) null, provider);
    }
    ...
    public void addSigner(PrivateKey privateKey, byte[] bArr, String str, AttributeTable attributeTable, AttributeTable attributeTable2, Provider provider) throws NoSuchAlgorithmException, InvalidKeyException {
        addSigner(privateKey, bArr, str, (CMSAttributeTableGenerator) new DefaultSignedAttributeTableGenerator(attributeTable), (CMSAttributeTableGenerator) new SimpleAttributeTableGenerator(attributeTable2), provider);
    }
    ...
    private void doAddSigner(PrivateKey privateKey, SignerIdentifier signerIdentifier, String str, String str2, CMSAttributeTableGenerator cMSAttributeTableGenerator, CMSAttributeTableGenerator cMSAttributeTableGenerator2, Provider provider, Provider provider2) throws NoSuchAlgorithmException, InvalidKeyException {
        String str3 = str2;
        MessageDigest digestInstance = CMSSignedHelper.INSTANCE.getDigestInstance(CMSSignedHelper.INSTANCE.getDigestAlgName(str3), provider2);
        this._signerInfs.add(new DigestAndSignerInfoGeneratorHolder(new SignerIntInfoGeneratorImpl(privateKey, signerIdentifier, str2, str, cMSAttributeTableGenerator, cMSAttributeTableGenerator2, provider, this.rand), digestInstance, str3));
    ...
    public OutputStream open(ASN1ObjectIdentifier aSN1ObjectIdentifier, OutputStream outputStream, boolean z, OutputStream outputStream2) throws IOException {
        ...
        for (DigestAndSignerInfoGeneratorHolder digestAlgorithm : this._signerInfs) {
            aSN1EncodableVector.add(digestAlgorithm.getDigestAlgorithm());
        }
        for (SignerInfoGenerator digestAlgorithm2 : this.signerGens) {
            aSN1EncodableVector.add(digestAlgorithm2.getDigestAlgorithm());
        }
