...
public class KeyAgreeRecipientId extends RecipientId {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Arrays.areEqual(this.subjectKeyId, keyAgreeRecipientId.subjectKeyId) || !equalsObj(this.serialNumber, keyAgreeRecipientId.serialNumber) || !equalsObj(this.issuer, keyAgreeRecipientId.issuer)) {
            return false;
        }
        return true;
    }
