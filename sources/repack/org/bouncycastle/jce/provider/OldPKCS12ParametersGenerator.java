...
class OldPKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        byte[] bArr;
        byte[] bArr2;
        byte[] bArr3 = new byte[this.f6243v];
        ...
        byte[] bArr6 = new byte[this.f6243v];
        int i10 = this.f6242u;
        int i11 = ((i2 + i10) - 1) / i10;
        for (int i12 = 1; i12 <= i11; i12++) {
            byte[] bArr7 = new byte[this.f6242u];
            ...
            if (i12 == i11) {
                ...
                System.arraycopy(bArr7, 0, bArr4, (i12 - 1) * this.f6242u, bArr7.length);
            }
        }
        return bArr4;
    }
