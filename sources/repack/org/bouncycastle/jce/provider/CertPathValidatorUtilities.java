...
public class CertPathValidatorUtilities {
    ...
    protected static java.security.cert.TrustAnchor findTrustAnchor(java.security.cert.X509Certificate r8, java.util.Set r9, java.lang.String r10) throws repack.org.bouncycastle.jce.provider.AnnotatedException {
        /*
        ...
        L_0x0040:
            ...
            if (r6 == 0) goto L_0x0060
            javax.security.auth.x500.X500Principal r6 = new javax.security.auth.x500.X500Principal     // Catch:{ IllegalArgumentException -> 0x0060 }
            java.lang.String r7 = r3.getCAName()     // Catch:{ IllegalArgumentException -> 0x0060 }
            r6.<init>(r7)     // Catch:{ IllegalArgumentException -> 0x0060 }
            boolean r6 = r1.equals(r6)     // Catch:{ IllegalArgumentException -> 0x0060 }
            if (r6 == 0) goto L_0x0060
            java.security.PublicKey r5 = r3.getCAPublicKey()     // Catch:{ IllegalArgumentException -> 0x0060 }
            goto L_0x0061
        L_0x0060:
            r3 = r2
        L_0x0061:
        ...
        L_0x006a:
            ...
            goto L_0x0077
        L_0x006f:
            repack.org.bouncycastle.jce.provider.AnnotatedException r8 = new repack.org.bouncycastle.jce.provider.AnnotatedException
        ...
        L_0x0078:
            r8 = move-exception
            repack.org.bouncycastle.jce.provider.AnnotatedException r9 = new repack.org.bouncycastle.jce.provider.AnnotatedException
            java.lang.String r10 = "Cannot set subject search criteria for trust anchor."
            r9.<init>(r10, r8)
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: repack.org.bouncycastle.jce.provider.CertPathValidatorUtilities.findTrustAnchor(java.security.cert.X509Certificate, java.util.Set, java.lang.String):java.security.cert.TrustAnchor");
    }
    ...
    protected static void addAdditionalStoresFromAltNames(X509Certificate x509Certificate, ExtendedPKIXParameters extendedPKIXParameters) throws CertificateParsingException {
        if (x509Certificate.getIssuerAlternativeNames() != null) {
            for (List next : x509Certificate.getIssuerAlternativeNames()) {
                if (next.get(0).equals(new Integer(6))) {
