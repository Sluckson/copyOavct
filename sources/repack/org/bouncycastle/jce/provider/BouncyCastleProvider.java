...
import repack.org.bouncycastle.asn1.p064bc.BCObjectIdentifiers;
    ...
    private void loadAlgorithms(String str, String[] strArr) {
        for (int i = 0; i != strArr.length; i++) {
            ...
            try {
                ...
                if (classLoader != null) {
                    cls = classLoader.loadClass(String.valueOf(str) + strArr[i] + "$Mappings");
                } else {
                    cls = Class.forName(String.valueOf(str) + strArr[i] + "$Mappings");
                }
