...
public class PKIXNameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return Collections.singleton(ipWithSubnetMask(m4827or(minMaxIPs[0], minMaxIPs[2]), m4827or(bArr4, bArr6)));
    }
    ...
    private void checkPermittedDNS(java.util.Set r4, java.lang.String r5) throws repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidatorException {
        /*
            r3 = this;
        ...
        L_0x0007:
            ...
            return
        L_0x001a:
            repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidatorException r4 = new repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidatorException
        ...
        L_0x0034:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidator.checkPermittedDNS(java.util.Set, java.lang.String):void");
    }

    /* JADX WARNING: Removed duplicated region for block: B:7:0x0012  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void checkExcludedDNS(java.util.Set r3, java.lang.String r4) throws repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidatorException {
        /*
            r2 = this;
        ...
        L_0x0012:
            ...
            goto L_0x000b
        L_0x0025:
            repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidatorException r3 = new repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidatorException
            java.lang.String r4 = "DNS is from an excluded subtree."
            r3.<init>(r4)
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: repack.org.bouncycastle.jce.provider.PKIXNameConstraintValidator.checkExcludedDNS(java.util.Set, java.lang.String):void");
    }
    ...
    /* renamed from: or */
    private static byte[] m4827or(byte[] bArr, byte[] bArr2) {
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length / 2; i++) {
            str = String.valueOf(str) + Integer.toString(bArr[i] & 255) + ".";
        }
        String str2 = String.valueOf(str.substring(0, str.length() - 1)) + "/";
        for (int length = bArr.length / 2; length < bArr.length; length++) {
            str2 = String.valueOf(str2) + Integer.toString(bArr[length] & 255) + ".";
        }
    ...
    private String stringifyIPCollection(Set set) {
        ...
        Iterator it = set.iterator();
        while (it.hasNext()) {
            str = String.valueOf(str) + stringifyIP((byte[]) it.next()) + ",";
        }
        if (str.length() > 1) {
    ...
    public String toString() {
        ...
        if (this.permittedSubtreesDN != null) {
            str = String.valueOf(String.valueOf(str) + "DN:\n") + this.permittedSubtreesDN.toString() + "\n";
        }
        if (this.permittedSubtreesDNS != null) {
            str = String.valueOf(String.valueOf(str) + "DNS:\n") + this.permittedSubtreesDNS.toString() + "\n";
        }
        if (this.permittedSubtreesEmail != null) {
            str = String.valueOf(String.valueOf(str) + "Email:\n") + this.permittedSubtreesEmail.toString() + "\n";
        }
        if (this.permittedSubtreesURI != null) {
            str = String.valueOf(String.valueOf(str) + "URI:\n") + this.permittedSubtreesURI.toString() + "\n";
        }
        if (this.permittedSubtreesIP != null) {
            str = String.valueOf(String.valueOf(str) + "IP:\n") + stringifyIPCollection(this.permittedSubtreesIP) + "\n";
        }
        String str2 = String.valueOf(str) + "excluded:\n";
        if (!this.excludedSubtreesDN.isEmpty()) {
            str2 = String.valueOf(String.valueOf(str2) + "DN:\n") + this.excludedSubtreesDN.toString() + "\n";
        }
        if (!this.excludedSubtreesDNS.isEmpty()) {
            str2 = String.valueOf(String.valueOf(str2) + "DNS:\n") + this.excludedSubtreesDNS.toString() + "\n";
        }
        if (!this.excludedSubtreesEmail.isEmpty()) {
            str2 = String.valueOf(String.valueOf(str2) + "Email:\n") + this.excludedSubtreesEmail.toString() + "\n";
        }
