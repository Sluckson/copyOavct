...
import repack.org.bouncycastle.crypto.p067io.DigestInputStream;
import repack.org.bouncycastle.crypto.p067io.DigestOutputStream;
import repack.org.bouncycastle.crypto.p067io.MacInputStream;
import repack.org.bouncycastle.crypto.p067io.MacOutputStream;
...
public class JDKKeyStore extends KeyStoreSpi implements BCKeyStore {
    ...
    private class StoreEntry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
            r2 = repack.org.bouncycastle.jce.provider.JDKKeyStore.access$1(r10.this$0, new java.io.DataInputStream(new javax.crypto.CipherInputStream(r2, r10.this$0.makePBECipher("BrokenPBEWithSHAAnd3-KeyTripleDES-CBC", 2, r11, r1, r9))));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:?, code lost:
            ...
            r2.readFully(r1);
            r9 = r2.readInt();
            r2 = repack.org.bouncycastle.jce.provider.JDKKeyStore.access$1(r10.this$0, new java.io.DataInputStream(new javax.crypto.CipherInputStream(r2, r10.this$0.makePBECipher("OldPBEWithSHAAnd3-KeyTripleDES-CBC", 2, r11, r1, r9))));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x00bd, code lost:
            ...
            r9.write(r7);
            r9.writeInt(r8);
            r11 = new java.io.DataOutputStream(new javax.crypto.CipherOutputStream(r9, r10.this$0.makePBECipher(repack.org.bouncycastle.jce.provider.JDKKeyStore.KEY_CIPHER, 1, r11, r7, r8)));
            repack.org.bouncycastle.jce.provider.JDKKeyStore.access$0(r10.this$0, r2, r11);
            r11.close();
        ...
        public java.lang.Object getObject(char[] r11) throws java.security.NoSuchAlgorithmException, java.security.UnrecoverableKeyException {
            ...
            L_0x000e:
                ...
                repack.org.bouncycastle.jce.provider.JDKKeyStore r3 = repack.org.bouncycastle.jce.provider.JDKKeyStore.this     // Catch:{ Exception -> 0x00fa }
                ...
                repack.org.bouncycastle.jce.provider.JDKKeyStore r1 = repack.org.bouncycastle.jce.provider.JDKKeyStore.this     // Catch:{ Exception -> 0x0049 }
            ...
            L_0x0049:
                ...
                repack.org.bouncycastle.jce.provider.JDKKeyStore r2 = repack.org.bouncycastle.jce.provider.JDKKeyStore.this     // Catch:{ Exception -> 0x0083 }
            ...
            L_0x0083:
                ...
                javax.crypto.CipherInputStream r4 = new javax.crypto.CipherInputStream     // Catch:{ Exception -> 0x00fa }
                r4.<init>(r2, r3)     // Catch:{ Exception -> 0x00fa }
                repack.org.bouncycastle.jce.provider.JDKKeyStore r2 = repack.org.bouncycastle.jce.provider.JDKKeyStore.this     // Catch:{ Exception -> 0x00fa }
            ...
            L_0x0100:
                ...
                throw r11
            */
            throw new UnsupportedOperationException("Method not decompiled: repack.org.bouncycastle.jce.provider.JDKKeyStore.StoreEntry.getObject(char[]):java.lang.Object");
        }
            ...
            if (inputStream != null) {
                ...
                if (readInt == 1 || readInt == 0) {
                    ...
                    if (bArr.length == 20) {
                        ...
                        CipherInputStream cipherInputStream = new CipherInputStream(dataInputStream, makePBECipher(readInt == 0 ? "OldPBEWithSHAAndTwofish-CBC" : JDKKeyStore.STORE_CIPHER, 2, cArr, bArr, readInt2));
