    ...
    public CertPathValidatorResult engineValidate(CertPath certPath, CertPathParameters certPathParameters) throws CertPathValidatorException, InvalidAlgorithmParameterException {
        if (certPathParameters instanceof ExtendedPKIXParameters) {
            ...
            if (targetConstraints instanceof X509AttributeCertStoreSelector) {
                ...
                try {
                    RFC3281CertPathUtilities.checkCRLs(attributeCert, extendedPKIXParameters, x509Certificate, CertPathValidatorUtilities.getValidCertDateFromValidityModel(extendedPKIXParameters, (CertPath) null, -1), certPath.getCertificates());
