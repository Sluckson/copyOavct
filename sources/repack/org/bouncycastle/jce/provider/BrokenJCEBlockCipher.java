...
import repack.org.bouncycastle.jce.provider.BrokenPBE;
            ...
            if (algorithmParameterSpec == null) {
                ...
                if (algorithmParameterSpec instanceof IvParameterSpec) {
                    ...
                    if (!(rC2ParameterSpec.getIV() == null || this.ivLength == 0)) {
                        parametersWithIV = new ParametersWithIV(cipherParameters, rC2ParameterSpec.getIV());
                        this.ivParam = (ParametersWithIV) parametersWithIV;
                    }
                    ...
                    if (rC5ParameterSpec.getWordSize() != 32) {
                        ...
                        parametersWithIV = new ParametersWithIV(cipherParameters, rC5ParameterSpec.getIV());
                        this.ivParam = (ParametersWithIV) parametersWithIV;
                    }
                } else {
