...
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    static {
        ...
        Object obj = "SHA224WITHRSAANDMGF1";
        params.put(obj, creatPSSParams(new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha224, new DERNull()), 28));
        Object obj2 = "SHA256WITHRSAANDMGF1";
        params.put(obj2, creatPSSParams(new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256, new DERNull()), 32));
