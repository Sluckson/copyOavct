...
public class PKCS12Example {
    static char[] passwd = {Barcode128.START_B, Barcode128.CODE_BC_TO_A, 'l', 'l', 'o', ' ', 'w', 'o', 'r', 'l', Barcode128.CODE_AC_TO_B};
    ...
    public static Certificate createMasterCert(PublicKey publicKey, PrivateKey privateKey) throws Exception {
        ...
        v1CertGen.setIssuerDN((X509Name) new X509Principal("C=AU, O=The Legion of the Bouncy Castle, OU=Bouncy Primary Certificate"));
        ...
        v1CertGen.setSubjectDN((X509Name) new X509Principal("C=AU, O=The Legion of the Bouncy Castle, OU=Bouncy Primary Certificate"));
    ...
    public static Certificate createIntermediateCert(PublicKey publicKey, PrivateKey privateKey, X509Certificate x509Certificate) throws Exception {
        ...
        hashtable.put(X509Principal.f5878C, "AU");
        hashtable.put(X509Principal.f5883O, "The Legion of the Bouncy Castle");
        hashtable.put(X509Principal.f5884OU, "Bouncy Intermediate Certificate");
        hashtable.put(X509Principal.EmailAddress, "feedback-crypto@bouncycastle.org");
        vector.addElement(X509Principal.f5878C);
        vector.addElement(X509Principal.f5883O);
        vector.addElement(X509Principal.f5884OU);
        vector.addElement(X509Principal.EmailAddress);
        v3CertGen.reset();
        v3CertGen.setSerialNumber(BigInteger.valueOf(2));
        v3CertGen.setIssuerDN((X509Name) PrincipalUtil.getSubjectX509Principal(x509Certificate));
        ...
        v3CertGen.setSubjectDN((X509Name) new X509Principal(vector, hashtable));
    ...
    public static Certificate createCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        hashtable2.put(X509Principal.f5878C, "AU");
        hashtable2.put(X509Principal.f5883O, "The Legion of the Bouncy Castle");
        hashtable2.put(X509Principal.f5882L, "Melbourne");
        hashtable2.put(X509Principal.f5879CN, "Eric H. Echidna");
        hashtable2.put(X509Principal.EmailAddress, "feedback-crypto@bouncycastle.org");
        vector2.addElement(X509Principal.f5878C);
        vector2.addElement(X509Principal.f5883O);
        vector2.addElement(X509Principal.f5882L);
        vector2.addElement(X509Principal.f5879CN);
        vector2.addElement(X509Principal.EmailAddress);
        v3CertGen.reset();
        v3CertGen.setSerialNumber(BigInteger.valueOf(3));
        v3CertGen.setIssuerDN((X509Name) new X509Principal(vector, hashtable));
        v3CertGen.setNotBefore(new Date(System.currentTimeMillis() - 2592000000L));
        v3CertGen.setNotAfter(new Date(System.currentTimeMillis() + 2592000000L));
        v3CertGen.setSubjectDN((X509Name) new X509Principal(vector2, hashtable2));
        v3CertGen.setPublicKey(publicKey);
        v3CertGen.setSignatureAlgorithm("SHA1WithRSAEncryption");
        v3CertGen.addExtension((DERObjectIdentifier) X509Extensions.SubjectKeyIdentifier, false, (DEREncodable) new SubjectKeyIdentifierStructure(publicKey));
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        instance2.setKeyEntry("Eric's Key", generatePrivate3, (char[]) null, certificateArr);
