...
public interface NISTObjectIdentifiers {
    public static final ASN1ObjectIdentifier aes = nistAlgorithm.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    public static final ASN1ObjectIdentifier dsa_with_sha224 = id_dsa_with_sha2.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    public static final ASN1ObjectIdentifier dsa_with_sha256 = id_dsa_with_sha2.branch(ExifInterface.GPS_MEASUREMENT_2D);
    public static final ASN1ObjectIdentifier dsa_with_sha384 = id_dsa_with_sha2.branch(ExifInterface.GPS_MEASUREMENT_3D);
    ...
    public static final ASN1ObjectIdentifier id_aes128_ECB = aes.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier id_dsa_with_sha2 = nistAlgorithm.branch(ExifInterface.GPS_MEASUREMENT_3D);
