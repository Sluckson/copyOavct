...
public class PKIHeaderBuilder {
    ...
    public PKIHeaderBuilder setSenderKID(byte[] bArr) {
        return setSenderKID((ASN1OctetString) new DEROctetString(bArr));
    }
    ...
    public PKIHeaderBuilder setTransactionID(byte[] bArr) {
        return setTransactionID((ASN1OctetString) new DEROctetString(bArr));
    }
    ...
    public PKIHeaderBuilder setSenderNonce(byte[] bArr) {
        return setSenderNonce((ASN1OctetString) new DEROctetString(bArr));
    }
    ...
    public PKIHeaderBuilder setRecipNonce(byte[] bArr) {
        return setRecipNonce((ASN1OctetString) new DEROctetString(bArr));
    }
    ...
    private static ASN1Sequence makeGeneralInfoSeq(InfoTypeAndValue infoTypeAndValue) {
        return new DERSequence((DEREncodable) infoTypeAndValue);
    }
