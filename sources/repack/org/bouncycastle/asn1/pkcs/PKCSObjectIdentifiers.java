...
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier dhKeyAgreement = pkcs_3.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier id_aa_receiptRequest = id_aa.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier id_ct_authData = id_ct.branch(ExifInterface.GPS_MEASUREMENT_2D);
    ...
    public static final ASN1ObjectIdentifier id_cti_ets_proofOfOrigin = id_cti.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier keyBag = bagtypes.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    public static final ASN1ObjectIdentifier md2 = digestAlgorithm.branch(ExifInterface.GPS_MEASUREMENT_2D);
    ...
    public static final ASN1ObjectIdentifier pbeWithMD2AndDES_CBC = pkcs_5.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier pbeWithSHAAnd128BitRC4 = pkcs_12PbeIds.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier pkcs_12PbeIds = pkcs_12.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_contentType = pkcs_9.branch(ExifInterface.GPS_MEASUREMENT_3D);
    public static final ASN1ObjectIdentifier pkcs_9_at_counterSignature = pkcs_9.branch("6");
    public static final ASN1ObjectIdentifier pkcs_9_at_emailAddress = pkcs_9.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_unstructuredName = pkcs_9.branch(ExifInterface.GPS_MEASUREMENT_2D);
    public static final ASN1ObjectIdentifier preferSignedData = pkcs_9.branch("15.1");
    public static final ASN1ObjectIdentifier rsaEncryption = pkcs_1.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    public static final ASN1ObjectIdentifier sdsiCertificate = certTypes.branch(ExifInterface.GPS_MEASUREMENT_2D);
    ...
    public static final ASN1ObjectIdentifier x509Certificate = certTypes.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    public static final ASN1ObjectIdentifier x509Crl = crlTypes.branch(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
