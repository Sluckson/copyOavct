    ...
    public DEREncodable readObject() throws IOException {
        ...
        if (readLength >= 0) {
            ...
            if (z) {
                ...
                if (readTagNumber != 16) {
                    return readTagNumber != 17 ? new DERUnknownTag(true, readTagNumber, definiteLengthInputStream.toByteArray()) : new DERSetParser(new ASN1StreamParser((InputStream) definiteLengthInputStream));
                }
