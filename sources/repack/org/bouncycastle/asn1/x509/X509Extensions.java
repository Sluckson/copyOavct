...
public class X509Extensions extends ASN1Encodable {
    ...
    public X509Extensions(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (instance.size() == 3) {
                this.extensions.put(instance.getObjectAt(0), new X509Extension(DERBoolean.getInstance((Object) instance.getObjectAt(1)), ASN1OctetString.getInstance(instance.getObjectAt(2))));
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (enumeration.hasMoreElements()) {
            this.ordering.addElement(new ASN1ObjectIdentifier(((DERObjectIdentifier) enumeration.nextElement()).getId()));
        }
