...
public class AttributeCertificateHolder implements CertSelector, Selector {
    ...
    public AttributeCertificateHolder(X509Principal x509Principal, BigInteger bigInteger) {
        this.holder = new Holder(new IssuerSerial(new GeneralNames((ASN1Sequence) new DERSequence((DEREncodable) new GeneralName((X509Name) x509Principal))), new DERInteger(bigInteger)));
    }
    ...
    private GeneralNames generateGeneralNames(X509Principal x509Principal) {
        return new GeneralNames((ASN1Sequence) new DERSequence((DEREncodable) new GeneralName((X509Name) x509Principal)));
    }
    ...
    public boolean match(java.security.cert.Certificate r5) {
        ...
        L_0x0006:
            ...
            repack.org.bouncycastle.asn1.x509.Holder r2 = r4.holder     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.IssuerSerial r2 = r2.getBaseCertificateID()     // Catch:{  }
            r3 = 1
            if (r2 == 0) goto L_0x0040
            repack.org.bouncycastle.asn1.x509.Holder r5 = r4.holder     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.IssuerSerial r5 = r5.getBaseCertificateID()     // Catch:{  }
            repack.org.bouncycastle.asn1.DERInteger r5 = r5.getSerial()     // Catch:{  }
            ...
            repack.org.bouncycastle.jce.X509Principal r5 = repack.org.bouncycastle.jce.PrincipalUtil.getIssuerX509Principal((java.security.cert.X509Certificate) r0)     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.Holder r0 = r4.holder     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.IssuerSerial r0 = r0.getBaseCertificateID()     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.GeneralNames r0 = r0.getIssuer()     // Catch:{  }
        ...
        L_0x0040:
            repack.org.bouncycastle.asn1.x509.Holder r2 = r4.holder     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.GeneralNames r2 = r2.getEntityName()     // Catch:{  }
            if (r2 == 0) goto L_0x0059
            repack.org.bouncycastle.jce.X509Principal r0 = repack.org.bouncycastle.jce.PrincipalUtil.getSubjectX509Principal(r0)     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.Holder r2 = r4.holder     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.GeneralNames r2 = r2.getEntityName()     // Catch:{  }
        ...
        L_0x0059:
            repack.org.bouncycastle.asn1.x509.Holder r0 = r4.holder     // Catch:{  }
            repack.org.bouncycastle.asn1.x509.ObjectDigestInfo r0 = r0.getObjectDigestInfo()     // Catch:{  }
        ...
        L_0x0087:
            ...
            boolean r5 = repack.org.bouncycastle.util.Arrays.areEqual((byte[]) r5, (byte[]) r0)     // Catch:{  }
            if (r5 != 0) goto L_0x0095
        L_0x0095:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: repack.org.bouncycastle.x509.AttributeCertificateHolder.match(java.security.cert.Certificate):boolean");
    }
