...
class X509Util {
    ...
    static AlgorithmIdentifier getSigAlgID(DERObjectIdentifier dERObjectIdentifier, String str) {
        ...
        if (params.containsKey(upperCase)) {
            return new AlgorithmIdentifier(dERObjectIdentifier, (DEREncodable) params.get(upperCase));
        }
    ...
    static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        String property2 = provider.getProperty(String.valueOf(str) + "." + upperCase);
        if (property2 != null) {
            try {
