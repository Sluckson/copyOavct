...
public class AttrCertExample {
    ...
    public static X509Certificate createClientCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        hashtable.put(X509Principal.f5882L, "Melbourne");
        hashtable.put(X509Principal.f5879CN, "Eric H. Echidna");
        ...
        vector.addElement(X509Principal.f5882L);
        vector.addElement(X509Principal.f5879CN);
        vector.addElement(X509Principal.EmailAddress);
        v3CertGen.reset();
        v3CertGen.setSerialNumber(BigInteger.valueOf(20));
        v3CertGen.setIssuerDN((X509Name) new X509Principal("C=AU, O=The Legion of the Bouncy Castle, OU=Bouncy Primary Certificate"));
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        x509V2AttributeCertificateGenerator.setSerialNumber(new BigInteger(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE));
        ...
        x509V2AttributeCertificateGenerator.addAttribute(new X509Attribute("2.5.24.72", (ASN1Encodable) new DERSequence(aSN1EncodableVector)));
        ...
        if (holder.match((Certificate) createClientCert)) {
            if (holder.getEntityNames() != null) {
                System.out.println(String.valueOf(holder.getEntityNames().length) + " entity names found");
            }
            if (holder.getIssuer() != null) {
                System.out.println(String.valueOf(holder.getIssuer().length) + " issuer names found, serial number " + holder.getSerialNumber());
            }
        ...
        if (issuer.match((Certificate) createAcIssuerCert)) {
            if (issuer.getPrincipals() != null) {
                System.out.println(String.valueOf(issuer.getPrincipals().length) + " entity names found");
            }
