...
public class DefaultDigestAlgorithmIdentifierFinder implements DigestAlgorithmIdentifierFinder {
    ...
    public AlgorithmIdentifier find(AlgorithmIdentifier algorithmIdentifier) {
        if (algorithmIdentifier.getAlgorithm().equals(PKCSObjectIdentifiers.id_RSASSA_PSS)) {
            return ((RSASSAPSSparams) algorithmIdentifier.getParameters()).getHashAlgorithm();
        }
        return new AlgorithmIdentifier((DERObjectIdentifier) digestOids.get(algorithmIdentifier.getAlgorithm()), new DERNull());
    }
}
