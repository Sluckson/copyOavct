...
public class HC128Engine implements StreamCipher {
    ...
    /* renamed from: p */
    private int[] f6094p = new int[512];

    /* renamed from: q */
    private int[] f6095q = new int[512];
    ...
    private int step() {
        ...
        if (this.cnt < 512) {
            int[] iArr = this.f6094p;
            iArr[mod512] = iArr[mod512] + m4813g1(iArr[dim(mod512, 3)], this.f6094p[dim(mod512, 10)], this.f6094p[dim(mod512, FrameMetricsAggregator.EVERY_DURATION)]);
            i = m4815h1(this.f6094p[dim(mod512, 12)]);
            i2 = this.f6094p[mod512];
        } else {
            int[] iArr2 = this.f6095q;
            iArr2[mod512] = iArr2[mod512] + m4814g2(iArr2[dim(mod512, 3)], this.f6095q[dim(mod512, 10)], this.f6095q[dim(mod512, FrameMetricsAggregator.EVERY_DURATION)]);
            i = m4816h2(this.f6095q[dim(mod512, 12)]);
            i2 = this.f6095q[mod512];
        }
        int i3 = i2 ^ i;
    ...
    private void init() {
        if (this.key.length == 16) {
            ...
            for (int i5 = 16; i5 < 1280; i5++) {
                iArr[i5] = m4812f2(iArr[i5 - 2]) + iArr[i5 - 7] + m4811f1(iArr[i5 - 15]) + iArr[i5 - 16] + i5;
            }
            System.arraycopy(iArr, 256, this.f6094p, 0, 512);
            System.arraycopy(iArr, 768, this.f6095q, 0, 512);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f6093iv = parametersWithIV.getIV();
            cipherParameters2 = parametersWithIV.getParameters();
        } else {
            this.f6093iv = new byte[0];
