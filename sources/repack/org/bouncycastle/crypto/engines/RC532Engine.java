...
public class RC532Engine implements BlockCipher {
    ...
    private void setKey(byte[] bArr) {
        ...
        this.f6106_S = new int[((this._noRounds + 1) * 2)];
        this.f6106_S[0] = P32;
        int i4 = 1;
        while (true) {
            iArr = this.f6106_S;
        ...
        for (int i10 = 0; i10 < i5; i10++) {
            int[] iArr3 = this.f6106_S;
            i7 = rotateLeft(iArr3[i6] + i7 + i8, 3);
            iArr3[i6] = i7;
            i8 = rotateLeft(iArr2[i9] + i7 + i8, i8 + i7);
            iArr2[i9] = i8;
            i6 = (i6 + 1) % this.f6106_S.length;
            i9 = (i9 + 1) % iArr2.length;
        }
    }

    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int bytesToWord = bytesToWord(bArr, i) + this.f6106_S[0];
        int bytesToWord2 = bytesToWord(bArr, i + 4) + this.f6106_S[1];
        for (int i3 = 1; i3 <= this._noRounds; i3++) {
            int i4 = i3 * 2;
            bytesToWord = rotateLeft(bytesToWord ^ bytesToWord2, bytesToWord2) + this.f6106_S[i4];
            bytesToWord2 = rotateLeft(bytesToWord2 ^ bytesToWord, bytesToWord) + this.f6106_S[i4 + 1];
        }
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = this._noRounds; i3 >= 1; i3--) {
            int i4 = i3 * 2;
            bytesToWord2 = rotateRight(bytesToWord2 - this.f6106_S[i4 + 1], bytesToWord) ^ bytesToWord;
            bytesToWord = rotateRight(bytesToWord - this.f6106_S[i4], bytesToWord2) ^ bytesToWord2;
        }
        wordToBytes(bytesToWord - this.f6106_S[0], bArr2, i2);
        wordToBytes(bytesToWord2 - this.f6106_S[1], bArr2, i2 + 4);
        return 8;
    }
