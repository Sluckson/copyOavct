...
public class DESedeWrapEngine implements Wrapper {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters2 instanceof KeyParameter) {
            ...
            if (this.forWrapping) {
                this.f6091iv = new byte[8];
                secureRandom.nextBytes(this.f6091iv);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f6091iv);
            }
        } else if (cipherParameters2 instanceof ParametersWithIV) {
            this.paramPlusIV = (ParametersWithIV) cipherParameters2;
            this.f6091iv = this.paramPlusIV.getIV();
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (this.forWrapping) {
            ...
            if (bArr3.length % blockSize == 0) {
                ...
                byte[] bArr5 = this.f6091iv;
                byte[] bArr6 = new byte[(bArr5.length + bArr4.length)];
                System.arraycopy(bArr5, 0, bArr6, 0, bArr5.length);
                System.arraycopy(bArr4, 0, bArr6, this.f6091iv.length, bArr4.length);
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        if (this.forWrapping) {
            ...
            if (i2 % blockSize == 0) {
                ...
                System.arraycopy(reverse, 0, this.f6091iv, 0, 8);
