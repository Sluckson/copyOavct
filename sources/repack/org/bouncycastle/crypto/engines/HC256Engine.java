...
public class HC256Engine implements StreamCipher {
    ...
    /* renamed from: p */
    private int[] f6097p = new int[1024];

    /* renamed from: q */
    private int[] f6098q = new int[1024];
    ...
    private void init() {
        ...
        if (bArr.length != 32 && bArr.length != 16) {
        ...
        } else if (this.f6096iv.length >= 16) {
            byte[] bArr2 = this.key;
            if (bArr2.length != 32) {
            ...
            byte[] bArr5 = this.f6096iv;
            if (bArr5.length < 32) {
                byte[] bArr6 = new byte[32];
                System.arraycopy(bArr5, 0, bArr6, 0, bArr5.length);
                byte[] bArr7 = this.f6096iv;
            ...
            for (int i3 = 0; i3 < 32; i3++) {
                int i4 = (i3 >> 2) + 8;
                iArr[i4] = iArr[i4] | ((this.f6096iv[i3] & 255) << ((i3 & 3) * 8));
            }
            ...
            System.arraycopy(iArr, 512, this.f6097p, 0, 1024);
            System.arraycopy(iArr, WMSTransport.PUSHPUBLISHSESSIONWOWZ_HANDSHAKESIZE_CLIENT1, this.f6098q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f6096iv = parametersWithIV.getIV();
            cipherParameters2 = parametersWithIV.getParameters();
        } else {
            this.f6096iv = new byte[0];
