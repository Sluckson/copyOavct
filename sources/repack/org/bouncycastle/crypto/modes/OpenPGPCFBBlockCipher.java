...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    /* renamed from: FR */
    private byte[] f6163FR;
    private byte[] FRE;

    /* renamed from: IV */
    private byte[] f6164IV;
    ...
    public OpenPGPCFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f6164IV = new byte[i];
        this.f6163FR = new byte[i];
        this.FRE = new byte[i];
    }
    ...
    public String getAlgorithmName() {
        return String.valueOf(this.cipher.getAlgorithmName()) + "/OpenPGPCFB";
    }
    ...
    public void reset() {
        this.count = 0;
        byte[] bArr = this.f6164IV;
        byte[] bArr2 = this.f6163FR;
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        ...
        if (i + i5 > bArr.length) {
            ...
            if (i6 > i5) {
                ...
                byte[] bArr7 = this.f6163FR;
                System.arraycopy(bArr7, 2, bArr7, 0, this.blockSize - 2);
                System.arraycopy(bArr2, i2, this.f6163FR, this.blockSize - 2, 2);
                this.cipher.processBlock(this.f6163FR, 0, this.FRE, 0);
                while (true) {
                    i3 = this.blockSize;
                    if (i7 >= i3) {
