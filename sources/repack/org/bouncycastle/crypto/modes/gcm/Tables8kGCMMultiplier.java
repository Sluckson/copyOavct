...
public class Tables8kGCMMultiplier implements GCMMultiplier {
    ...
    /* renamed from: M */
    private final int[][][] f6171M = ((int[][][]) Array.newInstance(int[].class, new int[]{32, 16}));

    public void init(byte[] bArr) {
        int[][][] iArr = this.f6171M;
        iArr[0][0] = new int[4];
        iArr[1][0] = new int[4];
        iArr[1][8] = GCMUtil.asInts(bArr);
        for (int i = 4; i >= 1; i >>= 1) {
            int[] iArr2 = new int[4];
            System.arraycopy(this.f6171M[1][i + i], 0, iArr2, 0, 4);
            GCMUtil.multiplyP(iArr2);
            this.f6171M[1][i] = iArr2;
        }
        int[] iArr3 = new int[4];
        System.arraycopy(this.f6171M[1][1], 0, iArr3, 0, 4);
        GCMUtil.multiplyP(iArr3);
        this.f6171M[0][8] = iArr3;
        for (int i2 = 4; i2 >= 1; i2 >>= 1) {
            int[] iArr4 = new int[4];
            System.arraycopy(this.f6171M[0][i2 + i2], 0, iArr4, 0, 4);
            GCMUtil.multiplyP(iArr4);
            this.f6171M[0][i2] = iArr4;
        }
        int i3 = 0;
        while (true) {
            for (int i4 = 2; i4 < 16; i4 += i4) {
                for (int i5 = 1; i5 < i4; i5++) {
                    int[] iArr5 = new int[4];
                    System.arraycopy(this.f6171M[i3][i4], 0, iArr5, 0, 4);
                    GCMUtil.xor(iArr5, this.f6171M[i3][i5]);
                    this.f6171M[i3][i4 + i5] = iArr5;
                }
            }
            i3++;
            if (i3 != 32) {
                if (i3 > 1) {
                    this.f6171M[i3][0] = new int[4];
                    for (int i6 = 8; i6 > 0; i6 >>= 1) {
                        int[] iArr6 = new int[4];
                        System.arraycopy(this.f6171M[i3 - 2][i6], 0, iArr6, 0, 4);
                        GCMUtil.multiplyP8(iArr6);
                        this.f6171M[i3][i6] = iArr6;
                    }
                }
            } else {
                return;
