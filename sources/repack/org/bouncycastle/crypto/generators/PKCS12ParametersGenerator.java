...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest2) {
        ...
        if (digest2 instanceof ExtendedDigest) {
            this.f6136u = digest2.getDigestSize();
            this.f6137v = ((ExtendedDigest) digest2).getByteLength();
            return;
        }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        byte[] bArr;
        byte[] bArr2;
        byte[] bArr3 = new byte[this.f6137v];
        ...
        byte[] bArr6 = new byte[this.f6137v];
        int i10 = this.f6136u;
        int i11 = ((i2 + i10) - 1) / i10;
        for (int i12 = 1; i12 <= i11; i12++) {
            byte[] bArr7 = new byte[this.f6136u];
            ...
            if (i12 == i11) {
                ...
                System.arraycopy(bArr7, 0, bArr4, (i12 - 1) * this.f6136u, bArr7.length);
            }
        }
        return bArr4;
    }
