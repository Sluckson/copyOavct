...
public abstract class CubicCurve2D implements Shape, Cloneable {
    ...
    public static class Float extends CubicCurve2D {
        ...
        /* renamed from: x1 */
        public float f4925x1;

        /* renamed from: x2 */
        public float f4926x2;

        /* renamed from: y1 */
        public float f4927y1;

        /* renamed from: y2 */
        public float f4928y2;
        ...
        public double getX1() {
            return (double) this.f4925x1;
        }

        public double getY1() {
            return (double) this.f4927y1;
        }
        ...
        public double getX2() {
            return (double) this.f4926x2;
        }

        public double getY2() {
            return (double) this.f4928y2;
        }

        public Point2D getP1() {
            return new Point2D.Float(this.f4925x1, this.f4927y1);
        }
        ...
        public Rectangle2D getBounds2D() {
            float min = Math.min(Math.min(this.f4925x1, this.f4926x2), Math.min(this.ctrlx1, this.ctrlx2));
            float min2 = Math.min(Math.min(this.f4927y1, this.f4928y2), Math.min(this.ctrly1, this.ctrly2));
            return new Rectangle2D.Float(min, min2, Math.max(Math.max(this.f4925x1, this.f4926x2), Math.max(this.ctrlx1, this.ctrlx2)) - min, Math.max(Math.max(this.f4927y1, this.f4928y2), Math.max(this.ctrly1, this.ctrly2)) - min2);
        }
    }
    ...
    public static class Double extends CubicCurve2D {
        ...
        /* renamed from: x1 */
        public double f4921x1;

        /* renamed from: x2 */
        public double f4922x2;

        /* renamed from: y1 */
        public double f4923y1;

        /* renamed from: y2 */
        public double f4924y2;
        ...
        public Point2D getP1() {
            return new Point2D.Double(this.f4921x1, this.f4923y1);
        }
        ...
        public Point2D getP2() {
            return new Point2D.Double(this.f4922x2, this.f4924y2);
        }
        ...
        public Rectangle2D getBounds2D() {
            double min = Math.min(Math.min(this.f4921x1, this.f4922x2), Math.min(this.ctrlx1, this.ctrlx2));
            double min2 = Math.min(Math.min(this.f4923y1, this.f4924y2), Math.min(this.ctrly1, this.ctrly2));
            return new Rectangle2D.Double(min, min2, Math.max(Math.max(this.f4921x1, this.f4922x2), Math.max(this.ctrlx1, this.ctrlx2)) - min, Math.max(Math.max(this.f4923y1, this.f4924y2), Math.max(this.ctrly1, this.ctrly2)) - min2);
        }
    }
    ...
    class Iterator implements PathIterator {
        ...
        Iterator(CubicCurve2D cubicCurve2D, AffineTransform affineTransform) {
            this.f4929c = cubicCurve2D;
            this.f4930t = affineTransform;
        }
        ...
        public int currentSegment(double[] dArr) {
            ...
            if (!isDone()) {
                int i2 = 0;
                if (this.index == 0) {
                    dArr[0] = this.f4929c.getX1();
                    dArr[1] = this.f4929c.getY1();
                    i = 1;
                } else {
                    dArr[0] = this.f4929c.getCtrlX1();
                    dArr[1] = this.f4929c.getCtrlY1();
                    dArr[2] = this.f4929c.getCtrlX2();
                    dArr[3] = this.f4929c.getCtrlY2();
                    dArr[4] = this.f4929c.getX2();
                    dArr[5] = this.f4929c.getY2();
                    i2 = 3;
                    i = 3;
                }
                AffineTransform affineTransform = this.f4930t;
        ...
        public int currentSegment(float[] fArr) {
            ...
            if (!isDone()) {
                int i2 = 0;
                if (this.index == 0) {
                    fArr[0] = (float) this.f4929c.getX1();
                    fArr[1] = (float) this.f4929c.getY1();
                    i = 1;
                } else {
                    fArr[0] = (float) this.f4929c.getCtrlX1();
                    fArr[1] = (float) this.f4929c.getCtrlY1();
                    fArr[2] = (float) this.f4929c.getCtrlX2();
                    fArr[3] = (float) this.f4929c.getCtrlY2();
                    fArr[4] = (float) this.f4929c.getX2();
                    fArr[5] = (float) this.f4929c.getY2();
                    i2 = 3;
                    i = 3;
                }
                AffineTransform affineTransform = this.f4930t;
