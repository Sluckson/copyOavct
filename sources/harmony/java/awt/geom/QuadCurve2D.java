...
public abstract class QuadCurve2D implements Shape, Cloneable {
    ...
    public static class Float extends QuadCurve2D {
        ...
        /* renamed from: x1 */
        public float f4965x1;

        /* renamed from: x2 */
        public float f4966x2;

        /* renamed from: y1 */
        public float f4967y1;

        /* renamed from: y2 */
        public float f4968y2;
        ...
        public double getX1() {
            return (double) this.f4965x1;
        }

        public double getY1() {
            return (double) this.f4967y1;
        }
        ...
        public double getX2() {
            return (double) this.f4966x2;
        }

        public double getY2() {
            return (double) this.f4968y2;
        }

        public Point2D getP1() {
            return new Point2D.Float(this.f4965x1, this.f4967y1);
        }
        ...
        public Point2D getP2() {
            return new Point2D.Float(this.f4966x2, this.f4968y2);
        }

        public void setCurve(double d, double d2, double d3, double d4, double d5, double d6) {
            this.f4965x1 = (float) d;
            this.f4967y1 = (float) d2;
            this.ctrlx = (float) d3;
            this.ctrly = (float) d4;
            this.f4966x2 = (float) d5;
            this.f4968y2 = (float) d6;
        }
        ...
        public Rectangle2D getBounds2D() {
            float min = Math.min(Math.min(this.f4965x1, this.f4966x2), this.ctrlx);
            float min2 = Math.min(Math.min(this.f4967y1, this.f4968y2), this.ctrly);
            return new Rectangle2D.Float(min, min2, Math.max(Math.max(this.f4965x1, this.f4966x2), this.ctrlx) - min, Math.max(Math.max(this.f4967y1, this.f4968y2), this.ctrly) - min2);
        }
    }
    ...
    public static class Double extends QuadCurve2D {
        ...
        /* renamed from: x1 */
        public double f4961x1;

        /* renamed from: x2 */
        public double f4962x2;

        /* renamed from: y1 */
        public double f4963y1;

        /* renamed from: y2 */
        public double f4964y2;
        ...
        public Point2D getP1() {
            return new Point2D.Double(this.f4961x1, this.f4963y1);
        }
        ...
        public Point2D getP2() {
            return new Point2D.Double(this.f4962x2, this.f4964y2);
        }
        ...
        public Rectangle2D getBounds2D() {
            double min = Math.min(Math.min(this.f4961x1, this.f4962x2), this.ctrlx);
            double min2 = Math.min(Math.min(this.f4963y1, this.f4964y2), this.ctrly);
            return new Rectangle2D.Double(min, min2, Math.max(Math.max(this.f4961x1, this.f4962x2), this.ctrlx) - min, Math.max(Math.max(this.f4963y1, this.f4964y2), this.ctrly) - min2);
        }
    }
    ...
    class Iterator implements PathIterator {
        ...
        Iterator(QuadCurve2D quadCurve2D, AffineTransform affineTransform) {
            this.f4969c = quadCurve2D;
            this.f4970t = affineTransform;
        }
        ...
        public int currentSegment(double[] dArr) {
            ...
            if (!isDone()) {
                int i2 = 0;
                if (this.index == 0) {
                    dArr[0] = this.f4969c.getX1();
                    dArr[1] = this.f4969c.getY1();
                    i = 1;
                } else {
                    dArr[0] = this.f4969c.getCtrlX();
                    dArr[1] = this.f4969c.getCtrlY();
                    dArr[2] = this.f4969c.getX2();
                    dArr[3] = this.f4969c.getY2();
                    i2 = 2;
                    i = 2;
                }
                AffineTransform affineTransform = this.f4970t;
        ...
        public int currentSegment(float[] fArr) {
            ...
            if (!isDone()) {
                int i2 = 0;
                if (this.index == 0) {
                    fArr[0] = (float) this.f4969c.getX1();
                    fArr[1] = (float) this.f4969c.getY1();
                    i = 1;
                } else {
                    fArr[0] = (float) this.f4969c.getCtrlX();
                    fArr[1] = (float) this.f4969c.getCtrlY();
                    fArr[2] = (float) this.f4969c.getX2();
                    fArr[3] = (float) this.f4969c.getY2();
                    i2 = 2;
                    i = 2;
                }
                AffineTransform affineTransform = this.f4970t;
