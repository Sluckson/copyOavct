...
public final class GeneralPath implements Shape, Cloneable {
    ...
    class Iterator implements PathIterator {
        ...
        Iterator(GeneralPath generalPath, AffineTransform affineTransform) {
            this.f4942p = generalPath;
            this.f4943t = affineTransform;
        }

        public int getWindingRule() {
            return this.f4942p.getWindingRule();
        }

        public boolean isDone() {
            return this.typeIndex >= this.f4942p.typeSize;
        }
        ...
        public int currentSegment(double[] dArr) {
            if (!isDone()) {
                byte b = this.f4942p.types[this.typeIndex];
                int i = GeneralPath.pointShift[b];
                for (int i2 = 0; i2 < i; i2++) {
                    dArr[i2] = (double) this.f4942p.points[this.pointIndex + i2];
                }
                AffineTransform affineTransform = this.f4943t;
        ...
        public int currentSegment(float[] fArr) {
            if (!isDone()) {
                byte b = this.f4942p.types[this.typeIndex];
                int i = GeneralPath.pointShift[b];
                System.arraycopy(this.f4942p.points, this.pointIndex, fArr, 0, i);
                AffineTransform affineTransform = this.f4943t;
                if (affineTransform != null) {
