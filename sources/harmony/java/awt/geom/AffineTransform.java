...
public class AffineTransform implements Cloneable, Serializable {
    ...
    public int getType() {
        ...
        double d3 = this.m10;
        double d4 = this.m11;
        if ((d * d2) + (d3 * d4) != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            return 32;
        }
        int i2 = 0;
        ...
        if ((this.m00 * this.m11) - (this.m01 * this.m10) < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            i2 |= 64;
        }
        double d5 = this.m00;
        double d6 = this.m10;
        ...
        if ((this.m00 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && this.m11 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) || (this.m10 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && this.m01 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && (this.m00 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || this.m11 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE))) {
            return i2 | 8;
        }
        return (this.m01 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && this.m10 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) ? i2 : i2 | 16;
    }
