...
public class Context {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0026, code lost:
        if ((r0.get(r2).listener instanceof p011io.grpc.Context.ParentListener) != false) goto L_0x0031;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0044, code lost:
        if ((r0.get(r1).listener instanceof p011io.grpc.Context.ParentListener) == false) goto L_0x004f;
     */
    ...
    public void notifyAndClearListeners() {
        ...
        L_0x0016:
            ...
            io.grpc.Context$ExecutableListener r3 = (p011io.grpc.Context.ExecutableListener) r3
            io.grpc.Context$CancellationListener r3 = r3.listener
            boolean r3 = r3 instanceof p011io.grpc.Context.ParentListener
        ...
        L_0x0034:
            ...
            io.grpc.Context$ExecutableListener r2 = (p011io.grpc.Context.ExecutableListener) r2
            io.grpc.Context$CancellationListener r2 = r2.listener
            boolean r2 = r2 instanceof p011io.grpc.Context.ParentListener
        ...
        L_0x005c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.Context.notifyAndClearListeners():void");
    }
    ...
    public static final class CancellableContext extends Context implements Closeable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:8:0x000d, code lost:
            if (p011io.grpc.Context.super.isCancelled() == false) goto L_0x0017;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:9:0x000f, code lost:
            cancel(p011io.grpc.Context.super.cancellationCause());
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean isCancelled() {
            /*
            ...
            L_0x0008:
                monitor-exit(r2)     // Catch:{ all -> 0x0019 }
                boolean r0 = p011io.grpc.Context.super.isCancelled()
                if (r0 == 0) goto L_0x0017
                java.lang.Throwable r0 = p011io.grpc.Context.super.cancellationCause()
                r2.cancel(r0)
                return r1
            L_0x0017:
                r0 = 0
            ...
            L_0x0019:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.Context.CancellableContext.isCancelled():boolean");
        }
