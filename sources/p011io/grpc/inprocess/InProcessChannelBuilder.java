...
public final class InProcessChannelBuilder extends AbstractManagedChannelImplBuilder<InProcessChannelBuilder> {
    ...
    private InProcessChannelBuilder(String str) {
        super(new InProcessSocketAddress(str), C4334a.f4804at);
    ...
    static final class InProcessClientTransportFactory implements ClientTransportFactory {
        ...
        private InProcessClientTransportFactory(java.lang.String r1, @javax.annotation.Nullable java.util.concurrent.ScheduledExecutorService r2, int r3) {
            ...
            L_0x000a:
                ...
                io.grpc.internal.SharedResourceHolder$Resource<java.util.concurrent.ScheduledExecutorService> r1 = p011io.grpc.internal.GrpcUtil.TIMER_SERVICE
                java.lang.Object r1 = p011io.grpc.internal.SharedResourceHolder.get(r1)
                r2 = r1
            ...
            L_0x0019:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessChannelBuilder.InProcessClientTransportFactory.<init>(java.lang.String, java.util.concurrent.ScheduledExecutorService, int):void");
        }
