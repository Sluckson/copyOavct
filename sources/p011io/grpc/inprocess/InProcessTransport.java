...
import p011io.grpc.internal.ClientStream;
import p011io.grpc.internal.ClientStreamListener;
import p011io.grpc.internal.ClientTransport;
import p011io.grpc.internal.ConnectionClientTransport;
import p011io.grpc.internal.GrpcAttributes;
import p011io.grpc.internal.GrpcUtil;
import p011io.grpc.internal.InUseStateAggregator;
import p011io.grpc.internal.ManagedClientTransport;
import p011io.grpc.internal.NoopClientStream;
import p011io.grpc.internal.ObjectPool;
import p011io.grpc.internal.ServerStream;
import p011io.grpc.internal.ServerStreamListener;
import p011io.grpc.internal.ServerTransport;
import p011io.grpc.internal.ServerTransportListener;
import p011io.grpc.internal.StatsTraceContext;
...
final class InProcessTransport implements ServerTransport, ConnectionClientTransport {
    ...
    public synchronized void shutdown(p011io.grpc.Status r2) {
        /*
            r1 = this;
            monitor-enter(r1)
        ...
        L_0x0019:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.shutdown(io.grpc.Status):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0021, code lost:
        p011io.grpc.inprocess.InProcessTransport.InProcessStream.access$700((p011io.grpc.inprocess.InProcessTransport.InProcessStream) r0.next()).cancel(r3);
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void shutdownNow(p011io.grpc.Status r3) {
        /*
            r2 = this;
        ...
        L_0x001b:
            ...
            io.grpc.inprocess.InProcessTransport$InProcessStream r1 = (p011io.grpc.inprocess.InProcessTransport.InProcessStream) r1
        ...
        L_0x0030:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.shutdownNow(io.grpc.Status):void");
    }
    ...
    public synchronized void notifyTerminated() {
        ...
        L_0x002a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.notifyTerminated():void");
    }
        ...
        private class InProcessServerStream implements ServerStream {
            ...
            public synchronized boolean clientRequested(int r6) {
                ...
                L_0x0015:
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r3 = (p011io.grpc.internal.StreamListener.MessageProducer) r3     // Catch:{ all -> 0x0079 }
                ...
                L_0x003a:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r6 = p011io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0079 }
                ...
                L_0x0079:
                    ...
                    throw r6
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.clientRequested(int):boolean");
            }
            ...
            public synchronized void writeMessage(java.io.InputStream r9) {
                ...
                L_0x0007:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = p011io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x005a }
                ...
                L_0x005a:
                    ...
                    throw r9
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.writeMessage(java.io.InputStream):void");
            }
            ...
            public synchronized boolean isReady() {
                ...
                L_0x000f:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.isReady():boolean");
            }
            ...
            public void close(Status status, Metadata metadata) {
                InProcessStream.this.clientStream.serverClosed(Status.f4989OK, status);
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:12:0x0037, code lost:
                p011io.grpc.inprocess.InProcessTransport.InProcessStream.access$1900(r1.this$1);
             */
            /* JADX WARNING: Code restructure failed: missing block: B:13:0x003c, code lost:
                return;
             */
            /* Code decompiled incorrectly, please refer to instructions dump. */
            private void notifyClientClose(p011io.grpc.Status r2, p011io.grpc.Metadata r3) {
                /*
                    r1 = this;
                    io.grpc.Status r2 = p011io.grpc.inprocess.InProcessTransport.stripCause(r2)
                    monitor-enter(r1)
                ...
                L_0x000b:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = p011io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x003d }
                ...
                L_0x0036:
                    monitor-exit(r1)     // Catch:{ all -> 0x003d }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r2 = p011io.grpc.inprocess.InProcessTransport.InProcessStream.this
                    r2.streamClosed()
                    return
                L_0x003d:
                    r2 = move-exception
                    ...
                    throw r2
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.notifyClientClose(io.grpc.Status, io.grpc.Metadata):void");
            }
        ...
        private class InProcessClientStream implements ClientStream {
            ...
            public synchronized boolean serverRequested(int r5) {
                ...
                L_0x0015:
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r3 = (p011io.grpc.internal.StreamListener.MessageProducer) r3     // Catch:{ all -> 0x0055 }
                ...
                L_0x0055:
                    ...
                    throw r5
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.serverRequested(int):boolean");
            }
            ...
            public synchronized void writeMessage(java.io.InputStream r9) {
                ...
                L_0x005a:
                    ...
                    throw r9
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.writeMessage(java.io.InputStream):void");
            }
            ...
            public synchronized boolean isReady() {
                ...
                L_0x000f:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.isReady():boolean");
            }
            ...
            public synchronized void halfClose() {
                ...
                L_0x001a:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.halfClose():void");
            }
