...
import p011io.grpc.internal.AbstractClientStream;
import p011io.grpc.internal.ClientStreamListener;
import p011io.grpc.internal.Http2ClientStreamTransportState;
...
class OkHttpClientStream extends AbstractClientStream {
    ...
    class TransportState extends Http2ClientStreamTransportState {
        ...
        public void start(int i) {
            Preconditions.checkState(OkHttpClientStream.this.f4993id == -1, "the stream has been started with id %s", i);
            int unused = OkHttpClientStream.this.f4993id = i;
            OkHttpClientStream.this.state.onStreamAllocated();
            if (this.canStart) {
                this.frameWriter.synStream(OkHttpClientStream.this.useGet, false, OkHttpClientStream.this.f4993id, 0, this.requestHeaders);
                OkHttpClientStream.this.statsTraceCtx.clientOutboundHeaders();
                this.requestHeaders = null;
                if (this.pendingData.size() > 0) {
                    this.outboundFlow.data(this.pendingDataHasEndOfStream, OkHttpClientStream.this.f4993id, this.pendingData, this.flushPendingData);
                }
                this.canStart = false;
            }
        }
        ...
        public void bytesRead(int i) {
            ...
            if (((float) i2) <= ((float) i3) * 0.5f) {
                ...
                this.frameWriter.windowUpdate(OkHttpClientStream.this.mo63472id(), (long) i4);
            }
        }
        ...
        public void transportDataReceived(Buffer buffer, boolean z) {
            ...
            if (this.window < 0) {
                this.frameWriter.rstStream(OkHttpClientStream.this.mo63472id(), ErrorCode.FLOW_CONTROL_ERROR);
                this.transport.finishStream(OkHttpClientStream.this.mo63472id(), Status.INTERNAL.withDescription("Received data size exceeded our receiving window size"), ClientStreamListener.RpcProgress.PROCESSED, false, (ErrorCode) null, (Metadata) null);
                return;
            }
        ...
        private void onEndOfStream() {
            if (!isOutboundClosed()) {
                this.transport.finishStream(OkHttpClientStream.this.mo63472id(), (Status) null, ClientStreamListener.RpcProgress.PROCESSED, false, ErrorCode.CANCEL, (Metadata) null);
            } else {
                this.transport.finishStream(OkHttpClientStream.this.mo63472id(), (Status) null, ClientStreamListener.RpcProgress.PROCESSED, false, (ErrorCode) null, (Metadata) null);
            }
        }
        ...
        public void cancel(Status status, boolean z, Metadata metadata) {
            if (!this.cancelSent) {
                ...
                this.transport.finishStream(OkHttpClientStream.this.mo63472id(), status, ClientStreamListener.RpcProgress.PROCESSED, z, ErrorCode.CANCEL, metadata);
            }
        }
        ...
        public void sendBuffer(Buffer buffer, boolean z, boolean z2) {
            if (!this.cancelSent) {
                ...
                Preconditions.checkState(OkHttpClientStream.this.mo63472id() != -1, "streamId should be set");
                this.outboundFlow.data(z, OkHttpClientStream.this.mo63472id(), buffer, z2);
            }
        }
