...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f4994dn;
    private int end;
    private final int length = this.f4994dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f4994dn = x500Principal.getName("RFC2253");
    }
        ...
        if (i4 < this.length) {
            ...
            if (this.chars[i4] == ' ') {
                ...
                if (cArr3[i6] != '=' || i6 == this.length) {
                    throw new IllegalStateException("Unexpected end of DN: " + this.f4994dn);
                }
            }
            this.pos++;
            while (true) {
    ...
    private java.lang.String escapedAV() {
        ...
        L_0x009b:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.okhttp.internal.DistinguishedNameParser.escapedAV():java.lang.String");
    }
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f4994dn);
            } else {
                i2 = c - '7';
            }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f4994dn.toCharArray();
