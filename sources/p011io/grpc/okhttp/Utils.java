...
import p011io.grpc.internal.TransportFrameUtil;
...
class Utils {
    ...
    static ConnectionSpec convertSpec(com.squareup.okhttp.ConnectionSpec connectionSpec) {
        ...
        p011io.grpc.okhttp.internal.CipherSuite[] cipherSuiteArr = new p011io.grpc.okhttp.internal.CipherSuite[cipherSuites.size()];
        for (int i2 = 0; i2 < cipherSuiteArr.length; i2++) {
            cipherSuiteArr[i2] = p011io.grpc.okhttp.internal.CipherSuite.valueOf(cipherSuites.get(i2).name());
        }
