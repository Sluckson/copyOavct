...
import p011io.grpc.HttpConnectProxiedSocketAddress;
...
import p011io.grpc.StatusException;
...
import p011io.grpc.internal.Http2Ping;
import p011io.grpc.internal.InUseStateAggregator;
import p011io.grpc.internal.KeepAliveManager;
import p011io.grpc.internal.ManagedClientTransport;
import p011io.grpc.internal.SerializingExecutor;
import p011io.grpc.internal.SharedResourceHolder;
import p011io.grpc.internal.StatsTraceContext;
import p011io.grpc.internal.TransportTracer;
import p011io.grpc.okhttp.ExceptionHandlingFrameWriter;
import p011io.grpc.okhttp.OkHttpClientStream;
import p011io.grpc.okhttp.OkHttpFrameLogger;
import p011io.grpc.okhttp.internal.ConnectionSpec;
import p011io.grpc.okhttp.internal.framed.ErrorCode;
import p011io.grpc.okhttp.internal.framed.FrameReader;
import p011io.grpc.okhttp.internal.framed.FrameWriter;
import p011io.grpc.okhttp.internal.framed.Header;
import p011io.grpc.okhttp.internal.framed.HeadersMode;
import p011io.grpc.okhttp.internal.framed.Http2;
import p011io.grpc.okhttp.internal.framed.Settings;
...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler {
    ...
    public void ping(p011io.grpc.internal.ClientTransport.PingCallback r9, java.util.concurrent.Executor r10) {
        /*
            r8 = this;
        ...
        L_0x000c:
            ...
            p011io.grpc.internal.Http2Ping.notifyFailed(r9, r10, r1)     // Catch:{ all -> 0x0056 }
        ...
        L_0x0056:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.okhttp.OkHttpClientTransport.ping(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    private void startStream(OkHttpClientStream okHttpClientStream) {
        Preconditions.checkState(okHttpClientStream.mo63472id() == -1, "StreamId already assigned");
    ...
    class ClientFrameHandler implements FrameReader.Handler, Runnable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x006c, code lost:
            r9 = r7.this$0;
            r10 = p011io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR;
            p011io.grpc.okhttp.OkHttpClientTransport.access$2200(r9, r10, "Received window_update for unknown stream: " + r8);
         */
        ...
        public void windowUpdate(int r8, long r9) {
            /*
                ...
                io.grpc.okhttp.OkHttpFrameLogger$Direction r1 = p011io.grpc.okhttp.OkHttpFrameLogger.Direction.INBOUND
                ...
                io.grpc.okhttp.OkHttpClientTransport r8 = p011io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.okhttp.internal.framed.ErrorCode r10 = p011io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r8.onError(r10, r9)
                goto L_0x002b
            L_0x0019:
                io.grpc.okhttp.OkHttpClientTransport r0 = p011io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.Status r10 = p011io.grpc.Status.INTERNAL
                io.grpc.Status r2 = r10.withDescription(r9)
                io.grpc.internal.ClientStreamListener$RpcProgress r3 = p011io.grpc.internal.ClientStreamListener.RpcProgress.PROCESSED
                r4 = 0
                io.grpc.okhttp.internal.framed.ErrorCode r5 = p011io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r6 = 0
                r1 = r8
            ...
            L_0x002c:
                r0 = 0
                io.grpc.okhttp.OkHttpClientTransport r1 = p011io.grpc.okhttp.OkHttpClientTransport.this
                java.lang.Object r1 = r1.lock
                monitor-enter(r1)
                if (r8 != 0) goto L_0x0043
                io.grpc.okhttp.OkHttpClientTransport r8 = p011io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
                ...
                return
            L_0x0043:
                io.grpc.okhttp.OkHttpClientTransport r2 = p011io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
                ...
                io.grpc.okhttp.OkHttpClientStream r2 = (p011io.grpc.okhttp.OkHttpClientStream) r2     // Catch:{ all -> 0x0085 }
                if (r2 == 0) goto L_0x0060
                io.grpc.okhttp.OkHttpClientTransport r3 = p011io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
                io.grpc.okhttp.OutboundFlowController r3 = r3.outboundFlow     // Catch:{ all -> 0x0085 }
                int r10 = (int) r9     // Catch:{ all -> 0x0085 }
                r3.windowUpdate(r2, r10)     // Catch:{ all -> 0x0085 }
                goto L_0x0069
            L_0x0060:
                io.grpc.okhttp.OkHttpClientTransport r9 = p011io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
            ...
            L_0x0069:
                ...
                io.grpc.okhttp.OkHttpClientTransport r9 = p011io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.okhttp.internal.framed.ErrorCode r10 = p011io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
            ...
            L_0x0085:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.okhttp.OkHttpClientTransport.ClientFrameHandler.windowUpdate(int, long):void");
        }
    }
}
