...
public final class ServerInterceptors {
    ...
    private static <ReqT, RespT> void wrapAndAddMethod(p011io.grpc.ServerServiceDefinition.Builder r2, p011io.grpc.ServerMethodDefinition<ReqT, RespT> r3, java.util.List<? extends p011io.grpc.ServerInterceptor> r4) {
        /*
        ...
        L_0x0008:
            ...
            io.grpc.ServerInterceptor r1 = (p011io.grpc.ServerInterceptor) r1
            io.grpc.ServerInterceptors$InterceptCallHandler r0 = p011io.grpc.ServerInterceptors.InterceptCallHandler.create(r1, r0)
            goto L_0x0008
        L_0x0019:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.ServerInterceptors.wrapAndAddMethod(io.grpc.ServerServiceDefinition$Builder, io.grpc.ServerMethodDefinition, java.util.List):void");
    }
