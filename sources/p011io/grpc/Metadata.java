...
public final class Metadata {
    ...
    public static abstract class Key<T> {
        ...
        /* renamed from: of */
        public static <T> Key<T> m4595of(String str, BinaryMarshaller<T> binaryMarshaller) {
            return new BinaryKey(str, binaryMarshaller);
        }

        /* renamed from: of */
        public static <T> Key<T> m4594of(String str, AsciiMarshaller<T> asciiMarshaller) {
            return m4596of(str, false, asciiMarshaller);
        }

        /* renamed from: of */
        static <T> Key<T> m4596of(String str, boolean z, AsciiMarshaller<T> asciiMarshaller) {
            return new AsciiKey(str, z, asciiMarshaller);
        }

        /* renamed from: of */
        static <T> Key<T> m4597of(String str, boolean z, TrustedAsciiMarshaller<T> trustedAsciiMarshaller) {
