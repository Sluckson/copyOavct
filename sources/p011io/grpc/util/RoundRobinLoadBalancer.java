...
import p011io.grpc.internal.ServiceConfigUtil;

/* renamed from: io.grpc.util.RoundRobinLoadBalancer */
final class RoundRobinLoadBalancer extends LoadBalancer {
    private static final Status EMPTY_OK = Status.f4989OK.withDescription("no subchannels ready");
    @VisibleForTesting
    ...
    static final class StickinessState {
        ...
        StickinessState(@Nonnull String str) {
            this.key = Metadata.Key.m4594of(str, Metadata.ASCII_STRING_MARSHALLER);
        }
