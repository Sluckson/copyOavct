...
import p011io.grpc.internal.AbstractStream;
import p011io.grpc.internal.ClientStreamListener;
import p011io.grpc.internal.MessageFramer;
...
public abstract class AbstractClientStream extends AbstractStream implements ClientStream, MessageFramer.Sink {
    ...
    protected static abstract class TransportState extends AbstractStream.TransportState {
        ...
        public void inboundHeadersReceived(p011io.grpc.Metadata r6) {
            /*
                r5 = this;
                ...
                io.grpc.Metadata$Key<java.lang.String> r0 = p011io.grpc.internal.GrpcUtil.CONTENT_ENCODING_KEY
            ...
            L_0x002f:
                ...
                boolean r2 = r0.equalsIgnoreCase(r2)
                if (r2 != 0) goto L_0x004f
                io.grpc.Status r6 = p011io.grpc.Status.INTERNAL
            ...
            L_0x004f:
                r0 = 0
            L_0x0050:
                io.grpc.Metadata$Key<java.lang.String> r2 = p011io.grpc.internal.GrpcUtil.MESSAGE_ENCODING_KEY
                ...
                return
            L_0x007a:
                io.grpc.Codec r1 = p011io.grpc.Codec.Identity.NONE
            ...
            L_0x0099:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.AbstractClientStream.TransportState.inboundHeadersReceived(io.grpc.Metadata):void");
        }
