...
public class MessageDeframer implements Closeable, Deframer {
    ...
    private void deliver() {
        if (!this.inDelivery) {
            ...
            while (!this.stopDelivery && this.pendingDeliveries > 0 && readRequiredBytes()) {
                try {
                    int i = C45031.$SwitchMap$io$grpc$internal$MessageDeframer$State[this.state.ordinal()];
                    if (i == 1) {
                        processHeader();
                    } else if (i == 2) {
                        processBody();
    ...
    static /* synthetic */ class C45031 {
        ...
        static {
            /*
                io.grpc.internal.MessageDeframer$State[] r0 = p011io.grpc.internal.MessageDeframer.State.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.grpc.internal.MessageDeframer$State r1 = p011io.grpc.internal.MessageDeframer.State.HEADER     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$grpc$internal$MessageDeframer$State     // Catch:{ NoSuchFieldError -> 0x001f }
                io.grpc.internal.MessageDeframer$State r1 = p011io.grpc.internal.MessageDeframer.State.BODY     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.MessageDeframer.C45031.<clinit>():void");
        }
    }
    ...
    private void processBody() {
        ...
        this.nextFrame = null;
        this.listener.messagesAvailable(new SingleMessageProducer(compressedBody, (C45031) null));
    ...
    private static class SingleMessageProducer implements StreamListener.MessageProducer {
        ...
        /* synthetic */ SingleMessageProducer(InputStream inputStream, C45031 r2) {
            this(inputStream);
        }
