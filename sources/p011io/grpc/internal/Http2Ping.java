...
public class Http2Ping {
    ...
    public void addCallback(p011io.grpc.internal.ClientTransport.PingCallback r3, java.util.concurrent.Executor r4) {
        /*
            r2 = this;
            monitor-enter(r2)
        ...
        L_0x000c:
            ...
            java.lang.Throwable r0 = r2.failureCause     // Catch:{ all -> 0x0022 }
            java.lang.Runnable r3 = asRunnable((p011io.grpc.internal.ClientTransport.PingCallback) r3, (java.lang.Throwable) r0)     // Catch:{ all -> 0x0022 }
            goto L_0x001d
        L_0x0017:
            long r0 = r2.roundTripTimeNanos     // Catch:{ all -> 0x0022 }
            java.lang.Runnable r3 = asRunnable((p011io.grpc.internal.ClientTransport.PingCallback) r3, (long) r0)     // Catch:{ all -> 0x0022 }
        L_0x001d:
            monitor-exit(r2)     // Catch:{ all -> 0x0022 }
            doExecute(r4, r3)
            return
        L_0x0022:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.Http2Ping.addCallback(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0029, code lost:
        r4 = r3.next();
        doExecute((java.util.concurrent.Executor) r4.getValue(), asRunnable((p011io.grpc.internal.ClientTransport.PingCallback) r4.getKey(), r1));
     */
    ...
    public boolean complete() {
        ...
        L_0x0023:
            ...
            io.grpc.internal.ClientTransport$PingCallback r4 = (p011io.grpc.internal.ClientTransport.PingCallback) r4
            java.lang.Runnable r4 = asRunnable((p011io.grpc.internal.ClientTransport.PingCallback) r4, (long) r1)
            doExecute(r5, r4)
            goto L_0x0023
        L_0x0043:
            return r0
        L_0x0044:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.Http2Ping.complete():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0020, code lost:
        r1 = r0.next();
        notifyFailed((p011io.grpc.internal.ClientTransport.PingCallback) r1.getKey(), (java.util.concurrent.Executor) r1.getValue(), r4);
     */
    ...
    public void failed(java.lang.Throwable r4) {
        ...
        L_0x001a:
            ...
            io.grpc.internal.ClientTransport$PingCallback r2 = (p011io.grpc.internal.ClientTransport.PingCallback) r2
        ...
        L_0x0037:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.Http2Ping.failed(java.lang.Throwable):void");
    }
