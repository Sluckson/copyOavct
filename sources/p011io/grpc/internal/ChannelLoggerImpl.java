...
final class ChannelLoggerImpl extends ChannelLogger {
    ...
    static /* synthetic */ class C44461 {
        ...
        static {
            /*
                io.grpc.ChannelLogger$ChannelLogLevel[] r0 = p011io.grpc.ChannelLogger.ChannelLogLevel.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.grpc.ChannelLogger$ChannelLogLevel r1 = p011io.grpc.ChannelLogger.ChannelLogLevel.ERROR     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$grpc$ChannelLogger$ChannelLogLevel     // Catch:{ NoSuchFieldError -> 0x001f }
                io.grpc.ChannelLogger$ChannelLogLevel r1 = p011io.grpc.ChannelLogger.ChannelLogLevel.WARNING     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.ChannelLoggerImpl.C44461.<clinit>():void");
        }
    }
    ...
    private static InternalChannelz.ChannelTrace.Event.Severity toTracerSeverity(ChannelLogger.ChannelLogLevel channelLogLevel) {
        int i = C44461.$SwitchMap$io$grpc$ChannelLogger$ChannelLogLevel[channelLogLevel.ordinal()];
        if (i == 1) {
