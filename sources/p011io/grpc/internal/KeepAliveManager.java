...
public class KeepAliveManager {
    ...
    public synchronized void onDataReceived() {
        /*
            ...
            io.grpc.internal.KeepAliveManager$State r1 = p011io.grpc.internal.KeepAliveManager.State.PING_SCHEDULED     // Catch:{ all -> 0x0055 }
            if (r0 != r1) goto L_0x0015
            io.grpc.internal.KeepAliveManager$State r0 = p011io.grpc.internal.KeepAliveManager.State.PING_DELAYED     // Catch:{ all -> 0x0055 }
            r5.state = r0     // Catch:{ all -> 0x0055 }
            goto L_0x0053
        L_0x0015:
            io.grpc.internal.KeepAliveManager$State r0 = r5.state     // Catch:{ all -> 0x0055 }
            io.grpc.internal.KeepAliveManager$State r1 = p011io.grpc.internal.KeepAliveManager.State.PING_SENT     // Catch:{ all -> 0x0055 }
            if (r0 == r1) goto L_0x0021
            io.grpc.internal.KeepAliveManager$State r0 = r5.state     // Catch:{ all -> 0x0055 }
            io.grpc.internal.KeepAliveManager$State r1 = p011io.grpc.internal.KeepAliveManager.State.IDLE_AND_PING_SENT     // Catch:{ all -> 0x0055 }
        ...
        L_0x002b:
            io.grpc.internal.KeepAliveManager$State r0 = r5.state     // Catch:{ all -> 0x0055 }
            io.grpc.internal.KeepAliveManager$State r2 = p011io.grpc.internal.KeepAliveManager.State.IDLE_AND_PING_SENT     // Catch:{ all -> 0x0055 }
            if (r0 != r2) goto L_0x0037
            io.grpc.internal.KeepAliveManager$State r0 = p011io.grpc.internal.KeepAliveManager.State.IDLE     // Catch:{ all -> 0x0055 }
            r5.state = r0     // Catch:{ all -> 0x0055 }
            monitor-exit(r5)
            return
        L_0x0037:
            io.grpc.internal.KeepAliveManager$State r0 = p011io.grpc.internal.KeepAliveManager.State.PING_SCHEDULED     // Catch:{ all -> 0x0055 }
            r5.state = r0     // Catch:{ all -> 0x0055 }
        ...
        L_0x0055:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.KeepAliveManager.onDataReceived():void");
    }
    ...
    public synchronized void onTransportIdle() {
        ...
        L_0x0007:
            ...
            io.grpc.internal.KeepAliveManager$State r1 = p011io.grpc.internal.KeepAliveManager.State.PING_SCHEDULED     // Catch:{ all -> 0x0023 }
            if (r0 == r1) goto L_0x0013
            io.grpc.internal.KeepAliveManager$State r0 = r2.state     // Catch:{ all -> 0x0023 }
            io.grpc.internal.KeepAliveManager$State r1 = p011io.grpc.internal.KeepAliveManager.State.PING_DELAYED     // Catch:{ all -> 0x0023 }
            if (r0 != r1) goto L_0x0017
        L_0x0013:
            io.grpc.internal.KeepAliveManager$State r0 = p011io.grpc.internal.KeepAliveManager.State.IDLE     // Catch:{ all -> 0x0023 }
            r2.state = r0     // Catch:{ all -> 0x0023 }
        L_0x0017:
            io.grpc.internal.KeepAliveManager$State r0 = r2.state     // Catch:{ all -> 0x0023 }
            io.grpc.internal.KeepAliveManager$State r1 = p011io.grpc.internal.KeepAliveManager.State.PING_SENT     // Catch:{ all -> 0x0023 }
            if (r0 != r1) goto L_0x0021
            io.grpc.internal.KeepAliveManager$State r0 = p011io.grpc.internal.KeepAliveManager.State.IDLE_AND_PING_SENT     // Catch:{ all -> 0x0023 }
            r2.state = r0     // Catch:{ all -> 0x0023 }
        L_0x0021:
            monitor-exit(r2)
            return
        L_0x0023:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.KeepAliveManager.onTransportIdle():void");
    }
