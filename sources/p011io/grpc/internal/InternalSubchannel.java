...
import p011io.grpc.ConnectivityStateInfo;
...
import p011io.grpc.internal.BackoffPolicy;
import p011io.grpc.internal.ClientStreamListener;
import p011io.grpc.internal.ClientTransportFactory;
...
final class InternalSubchannel implements InternalInstrumented<InternalChannelz.ChannelStats> {
    ...
    public p011io.grpc.internal.ClientTransport obtainActiveTransport() {
        /*
            r4 = this;
        ...
        L_0x0013:
            ...
            io.grpc.ConnectivityState r2 = p011io.grpc.ConnectivityState.IDLE     // Catch:{ all -> 0x0036 }
            if (r1 != r2) goto L_0x002e
            io.grpc.internal.ChannelLoggerImpl r1 = r4.channelLogger     // Catch:{ all -> 0x0036 }
            io.grpc.ChannelLogger$ChannelLogLevel r2 = p011io.grpc.ChannelLogger.ChannelLogLevel.INFO     // Catch:{ all -> 0x0036 }
            java.lang.String r3 = "CONNECTING as requested"
            r1.log(r2, r3)     // Catch:{ all -> 0x0036 }
            io.grpc.ConnectivityState r1 = p011io.grpc.ConnectivityState.CONNECTING     // Catch:{ all -> 0x0036 }
        ...
        L_0x0039:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.InternalSubchannel.obtainActiveTransport():io.grpc.internal.ClientTransport");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void shutdown(p011io.grpc.Status r5) {
        /*
            r4 = this;
            ...
            io.grpc.ConnectivityState r2 = p011io.grpc.ConnectivityState.SHUTDOWN     // Catch:{ all -> 0x0048 }
        ...
        L_0x0014:
            ...
            io.grpc.ConnectivityState r1 = p011io.grpc.ConnectivityState.SHUTDOWN     // Catch:{ all -> 0x0048 }
        ...
        L_0x004b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.InternalSubchannel.shutdown(io.grpc.Status):void");
    }
    ...
    private class TransportListener implements ManagedClientTransport.Listener {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:24:0x00ba, code lost:
            p011io.grpc.internal.InternalSubchannel.access$900(r6.this$0).drain();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:25:0x00c3, code lost:
            return;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void transportShutdown(p011io.grpc.Status r7) {
            /*
                r6 = this;
                io.grpc.internal.InternalSubchannel r0 = p011io.grpc.internal.InternalSubchannel.this
                io.grpc.internal.ChannelLoggerImpl r0 = r0.channelLogger
                io.grpc.ChannelLogger$ChannelLogLevel r1 = p011io.grpc.ChannelLogger.ChannelLogLevel.INFO
                r2 = 2
                ...
                r4 = 0
                r2[r4] = r3
                io.grpc.internal.InternalSubchannel r3 = p011io.grpc.internal.InternalSubchannel.this
                java.lang.String r3 = r3.printShortStatus(r7)
                r5 = 1
                r2[r5] = r3
                java.lang.String r3 = "{0} SHUTDOWN with {1}"
                r0.log(r1, r3, r2)
                io.grpc.internal.InternalSubchannel r0 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c7 }
                java.lang.Object r0 = r0.lock     // Catch:{ all -> 0x00c7 }
                monitor-enter(r0)     // Catch:{ all -> 0x00c7 }
                io.grpc.internal.InternalSubchannel r1 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c4 }
                io.grpc.ConnectivityStateInfo r1 = r1.state     // Catch:{ all -> 0x00c4 }
                io.grpc.ConnectivityState r1 = r1.getState()     // Catch:{ all -> 0x00c4 }
                io.grpc.ConnectivityState r2 = p011io.grpc.ConnectivityState.SHUTDOWN     // Catch:{ all -> 0x00c4 }
                if (r1 != r2) goto L_0x0042
                monitor-exit(r0)     // Catch:{ all -> 0x00c4 }
                io.grpc.internal.InternalSubchannel r7 = p011io.grpc.internal.InternalSubchannel.this
            ...
            L_0x0042:
                ...
                io.grpc.internal.InternalSubchannel r7 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c4 }
                io.grpc.ConnectivityState r1 = p011io.grpc.ConnectivityState.IDLE     // Catch:{ all -> 0x00c4 }
                r7.gotoNonErrorState(r1)     // Catch:{ all -> 0x00c4 }
                io.grpc.internal.InternalSubchannel r7 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c4 }
                p011io.grpc.internal.ManagedClientTransport unused = r7.activeTransport = r3     // Catch:{ all -> 0x00c4 }
                io.grpc.internal.InternalSubchannel r7 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c4 }
            ...
            L_0x0063:
                ...
                io.grpc.ConnectivityStateInfo r1 = r1.state     // Catch:{ all -> 0x00c4 }
                io.grpc.ConnectivityState r1 = r1.getState()     // Catch:{ all -> 0x00c4 }
                io.grpc.ConnectivityState r2 = p011io.grpc.ConnectivityState.CONNECTING     // Catch:{ all -> 0x00c4 }
                if (r1 != r2) goto L_0x007c
                r4 = 1
            L_0x007c:
                java.lang.String r1 = "Expected state is CONNECTING, actual state is %s"
                io.grpc.internal.InternalSubchannel r2 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c4 }
                ...
                io.grpc.internal.InternalSubchannel r1 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c4 }
                p011io.grpc.internal.ConnectionClientTransport unused = r1.pendingTransport = r3     // Catch:{ all -> 0x00c4 }
                io.grpc.internal.InternalSubchannel r1 = p011io.grpc.internal.InternalSubchannel.this     // Catch:{ all -> 0x00c4 }
                io.grpc.internal.InternalSubchannel$Index r1 = r1.addressIndex     // Catch:{ all -> 0x00c4 }
            ...
            L_0x00c7:
                ...
                throw r7
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.InternalSubchannel.TransportListener.transportShutdown(io.grpc.Status):void");
        }
