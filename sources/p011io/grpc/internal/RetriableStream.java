...
import p011io.grpc.internal.HedgingPolicy;
import p011io.grpc.internal.RetryPolicy;
...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    @VisibleForTesting
    static final Metadata.Key<String> GRPC_PREVIOUS_RPC_ATTEMPTS = Metadata.Key.m4594of("grpc-previous-rpc-attempts", Metadata.ASCII_STRING_MARSHALLER);
    @VisibleForTesting
    static final Metadata.Key<String> GRPC_RETRY_PUSHBACK_MS = Metadata.Key.m4594of("grpc-retry-pushback-ms", Metadata.ASCII_STRING_MARSHALLER);
    /* access modifiers changed from: private */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0061, code lost:
        r3 = (p011io.grpc.internal.RetriableStream.BufferEntry) r1.next();
        r4 = r7.state;
     */
    ...
    public void drain(p011io.grpc.internal.RetriableStream.Substream r8) {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x005b:
            ...
            io.grpc.internal.RetriableStream$BufferEntry r3 = (p011io.grpc.internal.RetriableStream.BufferEntry) r3
        ...
        L_0x0088:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.RetriableStream.drain(io.grpc.internal.RetriableStream$Substream):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x002c, code lost:
        r2.setFuture(r5.scheduledExecutorService.schedule(new p011io.grpc.internal.RetriableStream.HedgingRunnable(r5, r2), (long) r6.intValue(), java.util.concurrent.TimeUnit.MILLISECONDS));
     */
    ...
    public void pushbackHedging(@javax.annotation.Nullable java.lang.Integer r6) {
        ...
        L_0x0042:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.RetriableStream.pushbackHedging(java.lang.Integer):void");
    }
    ...
    private final class Sublistener implements ClientStreamListener {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void closed(p011io.grpc.Status r5, p011io.grpc.internal.ClientStreamListener.RpcProgress r6, p011io.grpc.Metadata r7) {
            /*
                r4 = this;
                io.grpc.internal.RetriableStream r0 = p011io.grpc.internal.RetriableStream.this
                java.lang.Object r0 = r0.lock
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r1 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01be }
                io.grpc.internal.RetriableStream r2 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01be }
                ...
                p011io.grpc.internal.RetriableStream.State unused = r1.state = r2     // Catch:{ all -> 0x01be }
                ...
                io.grpc.internal.RetriableStream r6 = p011io.grpc.internal.RetriableStream.this
                io.grpc.internal.RetriableStream$Substream r0 = r4.substream
                r6.commitAndRun(r0)
                io.grpc.internal.RetriableStream r6 = p011io.grpc.internal.RetriableStream.this
            ...
            L_0x003c:
                ...
                io.grpc.internal.ClientStreamListener$RpcProgress r0 = p011io.grpc.internal.ClientStreamListener.RpcProgress.REFUSED
                r1 = 0
                r2 = 1
                ...
                io.grpc.internal.RetriableStream r5 = p011io.grpc.internal.RetriableStream.this
                ...
                monitor-enter(r6)
                io.grpc.internal.RetriableStream r7 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00a8 }
                io.grpc.internal.RetriableStream r0 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00a8 }
                ...
                p011io.grpc.internal.RetriableStream.State unused = r7.state = r0     // Catch:{ all -> 0x00a8 }
                io.grpc.internal.RetriableStream r7 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00a8 }
                io.grpc.internal.RetriableStream r0 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00a8 }
                io.grpc.internal.RetriableStream$State r0 = r0.state     // Catch:{ all -> 0x00a8 }
            ...
            L_0x00ab:
                ...
                p011io.grpc.internal.RetryPolicy unused = r6.retryPolicy = r7
            L_0x00c0:
                io.grpc.internal.RetriableStream r6 = p011io.grpc.internal.RetriableStream.this
                io.grpc.internal.RetryPolicy r6 = r6.retryPolicy
            ...
            L_0x00cf:
                ...
                return
            L_0x00de:
                io.grpc.internal.ClientStreamListener$RpcProgress r0 = p011io.grpc.internal.ClientStreamListener.RpcProgress.DROPPED
            ...
            L_0x00f0:
                ...
                p011io.grpc.internal.RetryPolicy unused = r6.retryPolicy = r0
                io.grpc.internal.RetriableStream r6 = p011io.grpc.internal.RetriableStream.this
            ...
            L_0x0119:
                ...
                java.lang.Object r0 = r5.lock
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r5 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0150 }
                ...
                io.grpc.internal.RetriableStream r1 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0150 }
                java.lang.Object r1 = r1.lock     // Catch:{ all -> 0x0150 }
                r7.<init>(r1)     // Catch:{ all -> 0x0150 }
                p011io.grpc.internal.RetriableStream.FutureCanceller unused = r5.scheduledRetry = r7     // Catch:{ all -> 0x0150 }
            ...
            L_0x015c:
                ...
                java.lang.Object r6 = r6.lock
                monitor-enter(r6)
                io.grpc.internal.RetriableStream r0 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
                io.grpc.internal.RetriableStream r2 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
                ...
                p011io.grpc.internal.RetriableStream.State unused = r0.state = r2     // Catch:{ all -> 0x019e }
                if (r1 != 0) goto L_0x019c
                io.grpc.internal.RetriableStream r0 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
                io.grpc.internal.RetriableStream r1 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x019e }
            ...
            L_0x01be:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.RetriableStream.Sublistener.closed(io.grpc.Status, io.grpc.internal.ClientStreamListener$RpcProgress, io.grpc.Metadata):void");
        }

        /* JADX WARNING: Removed duplicated region for block: B:34:0x00e7  */
        /* JADX WARNING: Removed duplicated region for block: B:35:0x00e9  */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private p011io.grpc.internal.RetriableStream.RetryPlan makeRetryDecision(p011io.grpc.Status r13, p011io.grpc.Metadata r14) {
            /*
                r12 = this;
                io.grpc.internal.RetriableStream r0 = p011io.grpc.internal.RetriableStream.this
                ...
                io.grpc.internal.RetriableStream r1 = p011io.grpc.internal.RetriableStream.this
                ...
                return r13
            L_0x0036:
                io.grpc.Metadata$Key<java.lang.String> r1 = p011io.grpc.internal.RetriableStream.GRPC_RETRY_PUSHBACK_MS
            ...
            L_0x004c:
                r14 = r1
            L_0x004d:
                io.grpc.internal.RetriableStream r2 = p011io.grpc.internal.RetriableStream.this
            ...
            L_0x0063:
                io.grpc.internal.RetriableStream r13 = p011io.grpc.internal.RetriableStream.this
            ...
            L_0x0070:
                ...
                double r2 = (double) r2
                java.util.Random r13 = p011io.grpc.internal.RetriableStream.random
            ...
            L_0x00ea:
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.RetriableStream.Sublistener.makeRetryDecision(io.grpc.Status, io.grpc.Metadata):io.grpc.internal.RetriableStream$RetryPlan");
        }
    ...
    class BufferSizeTracer extends ClientStreamTracer {
        ...
        public void outboundWireSize(long r8) {
            ...
            L_0x000b:
                ...
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
            ...
            L_0x0037:
                ...
                goto L_0x0071
            L_0x0049:
                io.grpc.internal.RetriableStream r8 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream$ChannelBufferMeter r8 = r8.channelBufferUsed     // Catch:{ all -> 0x0088 }
                long r2 = r7.bufferNeeded     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r9 = p011io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
            ...
            L_0x0088:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.RetriableStream.BufferSizeTracer.outboundWireSize(long):void");
        }
    }
    ...
    static final class Throttle {
        ...
        void onSuccess() {
            ...
            L_0x001a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.RetriableStream.Throttle.onSuccess():void");
        }
