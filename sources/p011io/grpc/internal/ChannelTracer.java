...
final class ChannelTracer {
    ...
    static /* synthetic */ class C44482 {
        ...
        static {
            /*
                io.grpc.InternalChannelz$ChannelTrace$Event$Severity[] r0 = p011io.grpc.InternalChannelz.ChannelTrace.Event.Severity.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.grpc.InternalChannelz$ChannelTrace$Event$Severity r1 = p011io.grpc.InternalChannelz.ChannelTrace.Event.Severity.CT_ERROR     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$grpc$InternalChannelz$ChannelTrace$Event$Severity     // Catch:{ NoSuchFieldError -> 0x001f }
                io.grpc.InternalChannelz$ChannelTrace$Event$Severity r1 = p011io.grpc.InternalChannelz.ChannelTrace.Event.Severity.CT_WARNING     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.ChannelTracer.C44482.<clinit>():void");
        }
    }
    ...
    public void reportEvent(InternalChannelz.ChannelTrace.Event event) {
        Level level;
        int i = C44482.$SwitchMap$io$grpc$InternalChannelz$ChannelTrace$Event$Severity[event.severity.ordinal()];
        if (i == 1) {
            level = Level.FINE;
        } else if (i != 2) {
            level = Level.FINEST;
