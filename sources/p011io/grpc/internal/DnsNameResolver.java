...
final class DnsNameResolver extends NameResolver {
    ...
    private static final String JNDI_LOCALHOST_PROPERTY = System.getProperty("io.grpc.internal.DnsNameResolverProvider.enable_jndi_localhost", PdfBoolean.FALSE);
    private static final String JNDI_PROPERTY = System.getProperty("io.grpc.internal.DnsNameResolverProvider.enable_jndi", "true");
    private static final String JNDI_SRV_PROPERTY = System.getProperty("io.grpc.internal.DnsNameResolverProvider.enable_grpclb", PdfBoolean.FALSE);
    private static final String JNDI_TXT_PROPERTY = System.getProperty("io.grpc.internal.DnsNameResolverProvider.enable_service_config", PdfBoolean.FALSE);
    @VisibleForTesting
    ...
    public p011io.grpc.internal.DnsNameResolver.ResourceResolver getResourceResolver() {
        /*
            r2 = this;
            ...
            io.grpc.internal.DnsNameResolver$ResourceResolver r0 = (p011io.grpc.internal.DnsNameResolver.ResourceResolver) r0
        ...
        L_0x0012:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.grpc.internal.DnsNameResolver.getResourceResolver():io.grpc.internal.DnsNameResolver$ResourceResolver");
    }
    ...
    static boolean shouldUseJndi(boolean z, boolean z2, String str) {
        ...
        if (C4334a.f4804at.equalsIgnoreCase(str)) {
            return z2;
        }
        if (str.contains(":")) {
            return false;
