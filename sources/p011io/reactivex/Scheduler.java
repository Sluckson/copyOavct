...
import p011io.reactivex.internal.schedulers.NewThreadWorker;
import p011io.reactivex.internal.schedulers.SchedulerWhen;
        ...
        final class PeriodicTask implements Runnable, SchedulerRunnableIntrospection {
            ...
            public void run() {
                ...
                if (!this.f4999sd.isDisposed()) {
                    ...
                    this.f4999sd.replace(Worker.this.schedule(this, j - now, TimeUnit.NANOSECONDS));
                }
            }
