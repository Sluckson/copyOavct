...
import p011io.reactivex.schedulers.SchedulerRunnableIntrospection;
...
public final class ExecutorScheduler extends Scheduler {
    ...
    public static final class ExecutorWorker extends Scheduler.Worker implements Runnable {
        ...
        public void run() {
            ...
            L_0x0025:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.schedulers.ExecutorScheduler.ExecutorWorker.run():void");
        }
    ...
    final class DelayedDispose implements Runnable {
        ...
        /* renamed from: dr */
        private final DelayedRunnable f5350dr;

        DelayedDispose(DelayedRunnable delayedRunnable) {
            this.f5350dr = delayedRunnable;
        }

        public void run() {
            this.f5350dr.direct.replace(ExecutorScheduler.this.scheduleDirect(this.f5350dr));
        }
    }
}
