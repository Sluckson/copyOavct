...
public final class ObservableDetach<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class DetachObserver<T> implements Observer<T>, Disposable {
        ...
        public void dispose() {
            Disposable disposable = this.f5225s;
            this.f5225s = EmptyComponent.INSTANCE;
            this.actual = EmptyComponent.asObserver();
            disposable.dispose();
        }

        public boolean isDisposed() {
            return this.f5225s.isDisposed();
        }

        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f5225s, disposable)) {
                this.f5225s = disposable;
