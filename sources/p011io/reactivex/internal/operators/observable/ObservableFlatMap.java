...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f5233s, disposable)) {
                this.f5233s = disposable;
        ...
        public void drainLoop() {
            ...
            L_0x0023:
                ...
                io.reactivex.internal.operators.observable.ObservableFlatMap$InnerObserver[] r5 = (p011io.reactivex.internal.operators.observable.ObservableFlatMap.InnerObserver[]) r5
                int r6 = r5.length
            ...
            L_0x004f:
                ...
                java.lang.Throwable r2 = p011io.reactivex.internal.util.ExceptionHelper.TERMINATED
            ...
            L_0x0107:
                ...
                io.reactivex.ObservableSource r3 = (p011io.reactivex.ObservableSource) r3     // Catch:{ all -> 0x0126 }
            ...
            L_0x0129:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.observable.ObservableFlatMap.MergeObserver.drainLoop():void");
        }
