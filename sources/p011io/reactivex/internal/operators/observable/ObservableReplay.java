...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, Disposable {
    ...
    public void connect(p011io.reactivex.functions.Consumer<? super p011io.reactivex.disposables.Disposable> r5) {
        ...
        L_0x0000:
            ...
            io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver r0 = (p011io.reactivex.internal.operators.observable.ObservableReplay.ReplayObserver) r0
        ...
        L_0x004d:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.observable.ObservableReplay.connect(io.reactivex.functions.Consumer):void");
    }
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        public void truncateFinal() {
            /*
                ...
                io.reactivex.internal.operators.observable.ObservableReplay$Node r2 = (p011io.reactivex.internal.operators.observable.ObservableReplay.Node) r2
                java.lang.Object r3 = r2.get()
                io.reactivex.internal.operators.observable.ObservableReplay$Node r3 = (p011io.reactivex.internal.operators.observable.ObservableReplay.Node) r3
                r4 = 0
            L_0x0018:
                r9 = r3
                r3 = r2
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.observable.ObservableReplay.SizeAndTimeBoundReplayBuffer.truncateFinal():void");
        }
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:0:0x0000 A[LOOP_START, MTH_ENTER_BLOCK] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void subscribe(p011io.reactivex.Observer<? super T> r4) {
            /*
                r3 = this;
            L_0x0000:
            ...
            L_0x0035:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.observable.ObservableReplay.ReplaySource.subscribe(io.reactivex.Observer):void");
        }
    }
    ...
    static final class Replay<T> extends ConnectableObservable<T> {
        ...
        /* renamed from: co */
        private final ConnectableObservable<T> f5260co;
        private final Observable<T> observable;

        Replay(ConnectableObservable<T> connectableObservable, Observable<T> observable2) {
            this.f5260co = connectableObservable;
            this.observable = observable2;
        }

        public void connect(Consumer<? super Disposable> consumer) {
            this.f5260co.connect(consumer);
        }
