...
public final class ObservableFromIterable<T> extends Observable<T> {
    ...
    static final class FromIterableDisposable<T> extends BasicQueueDisposable<T> {
        ...
        /* renamed from: it */
        final Iterator<? extends T> f5239it;
        ...
        public void run() {
            while (!isDisposed()) {
                try {
                    this.actual.onNext(ObjectHelper.requireNonNull(this.f5239it.next(), "The iterator returned a null value"));
                    if (!isDisposed()) {
                        try {
                            if (!this.f5239it.hasNext()) {
                                if (!isDisposed()) {
        ...
        public T poll() {
            ...
            if (!this.checkNext) {
                this.checkNext = true;
            } else if (!this.f5239it.hasNext()) {
                this.done = true;
                return null;
            }
            return ObjectHelper.requireNonNull(this.f5239it.next(), "The iterator returned a null value");
        }
