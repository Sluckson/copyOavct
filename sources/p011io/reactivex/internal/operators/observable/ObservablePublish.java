...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    public void connect(p011io.reactivex.functions.Consumer<? super p011io.reactivex.disposables.Disposable> r5) {
        ...
        L_0x0000:
            ...
            io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver r0 = (p011io.reactivex.internal.operators.observable.ObservablePublish.PublishObserver) r0
        ...
        L_0x0040:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.observable.ObservablePublish.connect(io.reactivex.functions.Consumer):void");
    }
    ...
    static final class PublishObserver<T> implements Observer<T>, Disposable {
        ...
        /* renamed from: s */
        final AtomicReference<Disposable> f5252s = new AtomicReference<>();
        ...
        public void dispose() {
            if (((InnerDisposable[]) this.observers.getAndSet(TERMINATED)) != TERMINATED) {
                ...
                DisposableHelper.dispose(this.f5252s);
            }
        }
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f5252s, disposable);
        }
