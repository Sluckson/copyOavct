...
import p011io.reactivex.internal.observers.InnerQueuedObserver;
import p011io.reactivex.internal.observers.InnerQueuedObserverSupport;
...
public final class ObservableConcatMapEager<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class ConcatMapEagerMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable, InnerQueuedObserverSupport<R> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f5216d, disposable)) {
                this.f5216d = disposable;
