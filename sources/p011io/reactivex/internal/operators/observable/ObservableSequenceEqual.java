                ...
                while (!this.cancelled) {
                    ...
                    if (!z || (th2 = equalObserver.error) == null) {
                        ...
                        if (!z2 || (th = equalObserver2.error) == null) {
                            if (this.f5268v1 == null) {
                                this.f5268v1 = spscLinkedArrayQueue.poll();
                            }
                            boolean z3 = this.f5268v1 == null;
                            if (this.f5269v2 == null) {
                                this.f5269v2 = spscLinkedArrayQueue2.poll();
                            }
                            boolean z4 = this.f5269v2 == null;
                            if (z && z2 && z3 && z4) {
                                ...
                                if (!z3 && !z4) {
                                    try {
                                        if (!this.comparer.test(this.f5268v1, this.f5269v2)) {
