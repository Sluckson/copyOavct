...
public final class ObservableBlockingSubscribe {
    ...
    public static <T> void subscribe(p011io.reactivex.ObservableSource<? extends T> r4, p011io.reactivex.Observer<? super T> r5) {
        /*
        ...
        L_0x002a:
            ...
            java.lang.Object r3 = p011io.reactivex.internal.observers.BlockingObserver.TERMINATED
            if (r4 == r3) goto L_0x003a
            boolean r2 = p011io.reactivex.internal.util.NotificationLite.acceptFull((java.lang.Object) r2, r5)
            if (r2 == 0) goto L_0x0010
        L_0x003a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.observable.ObservableBlockingSubscribe.subscribe(io.reactivex.ObservableSource, io.reactivex.Observer):void");
    }
