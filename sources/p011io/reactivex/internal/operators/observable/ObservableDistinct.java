...
public final class ObservableDistinct<T, K> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class DistinctObserver<T, K> extends BasicFuseableObserver<T, T> {
        ...
        /*  JADX ERROR: StackOverflow in pass: RegionMakerVisitor
            ...
            */
        @p011io.reactivex.annotations.Nullable
        public T poll() throws java.lang.Exception {
            /*
                r4 = this;
            L_0x0000:
                io.reactivex.internal.fuseable.QueueDisposable r0 = r4.f5001qs
                ...
                java.lang.Object r2 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r2, (java.lang.String) r3)
                boolean r1 = r1.add(r2)
                if (r1 == 0) goto L_0x0000
            L_0x001c:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.observable.ObservableDistinct.DistinctObserver.poll():java.lang.Object");
        }
