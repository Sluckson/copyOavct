...
public final class FlowableWithLatestFrom<T, U, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class WithLatestFromSubscriber<T, U, R> extends AtomicReference<U> implements ConditionalSubscriber<T>, Subscription {
        ...
        /* renamed from: s */
        final AtomicReference<Subscription> f5160s = new AtomicReference<>();
        ...
        public void onSubscribe(Subscription subscription) {
            SubscriptionHelper.deferredSetOnce(this.f5160s, this.requested, subscription);
        }

        public void onNext(T t) {
            if (!tryOnNext(t)) {
                this.f5160s.get().request(1);
            }
        }
        ...
        public void request(long j) {
            SubscriptionHelper.deferredRequest(this.f5160s, this.requested, j);
        }

        public void cancel() {
            SubscriptionHelper.cancel(this.f5160s);
            SubscriptionHelper.cancel(this.other);
        }
