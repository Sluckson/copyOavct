...
import p011io.reactivex.internal.subscriptions.BasicQueueSubscription;
...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        @Nullable
        public final T poll() {
            Iterator<? extends T> it = this.f5087it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return ObjectHelper.requireNonNull(this.f5087it.next(), "Iterator.next() returned a null value");
        }
