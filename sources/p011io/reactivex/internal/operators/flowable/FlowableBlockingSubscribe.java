...
import p011io.reactivex.internal.subscribers.BoundedSubscriber;
import p011io.reactivex.internal.subscribers.LambdaSubscriber;
import p011io.reactivex.internal.util.BlockingHelper;
import p011io.reactivex.internal.util.BlockingIgnoringReceiver;
...
public final class FlowableBlockingSubscribe {
    ...
    public static <T> void subscribe(org.reactivestreams.Publisher<? extends T> r3, org.reactivestreams.Subscriber<? super T> r4) {
        ...
        L_0x0014:
            ...
            goto L_0x0041
        L_0x0021:
            p011io.reactivex.internal.util.BlockingHelper.verifyNonBlocking()     // Catch:{ InterruptedException -> 0x003a }
        ...
        L_0x0028:
            ...
            goto L_0x0041
        L_0x002f:
            java.lang.Object r2 = p011io.reactivex.internal.subscribers.BlockingSubscriber.TERMINATED     // Catch:{ InterruptedException -> 0x003a }
            if (r3 == r2) goto L_0x0041
            boolean r3 = p011io.reactivex.internal.util.NotificationLite.acceptFull((java.lang.Object) r3, r4)     // Catch:{ InterruptedException -> 0x003a }
        ...
        L_0x0041:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.flowable.FlowableBlockingSubscribe.subscribe(org.reactivestreams.Publisher, org.reactivestreams.Subscriber):void");
    }
