...
public final class FlowableRetryPredicate<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class RetrySubscriber<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        /* renamed from: sa */
        final SubscriptionArbiter f5115sa;
        ...
        RetrySubscriber(Subscriber<? super T> subscriber, long j, Predicate<? super Throwable> predicate2, SubscriptionArbiter subscriptionArbiter, Publisher<? extends T> publisher) {
            ...
            this.f5115sa = subscriptionArbiter;
        ...
        public void onSubscribe(Subscription subscription) {
            this.f5115sa.setSubscription(subscription);
        }
        ...
        public void subscribeNext() {
            if (getAndIncrement() == 0) {
                int i = 1;
                while (!this.f5115sa.isCancelled()) {
                    long j = this.produced;
                    if (j != 0) {
                        this.produced = 0;
                        this.f5115sa.produced(j);
                    }
