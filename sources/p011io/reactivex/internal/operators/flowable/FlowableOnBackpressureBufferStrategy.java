...
import p011io.reactivex.BackpressureOverflowStrategy;
...
public final class FlowableOnBackpressureBufferStrategy<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class OnBackpressureBufferStrategySubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5100s, subscription)) {
                this.f5100s = subscription;
            ...
            if (!this.done) {
                ...
                synchronized (deque2) {
                    ...
                    if (((long) deque2.size()) == this.bufferSize) {
                        int i = C46221.$SwitchMap$io$reactivex$BackpressureOverflowStrategy[this.strategy.ordinal()];
                        if (i == 1) {
                            deque2.pollLast();
                            deque2.offer(t);
                        } else if (i == 2) {
    ...
    static /* synthetic */ class C46221 {
        ...
        static {
            /*
                io.reactivex.BackpressureOverflowStrategy[] r0 = p011io.reactivex.BackpressureOverflowStrategy.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.reactivex.BackpressureOverflowStrategy r1 = p011io.reactivex.BackpressureOverflowStrategy.DROP_LATEST     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$reactivex$BackpressureOverflowStrategy     // Catch:{ NoSuchFieldError -> 0x001f }
                io.reactivex.BackpressureOverflowStrategy r1 = p011io.reactivex.BackpressureOverflowStrategy.DROP_OLDEST     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.flowable.FlowableOnBackpressureBufferStrategy.C46221.<clinit>():void");
        }
    }
}
