...
public final class FlowableFlattenIterable<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class FlattenIterableSubscriber<T, R> extends BasicIntQueueSubscription<R> implements FlowableSubscriber<T> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5086s, subscription)) {
                this.f5086s = subscription;
        ...
        public void drain() {
            ...
            L_0x004a:
                ...
                org.reactivestreams.Subscription r3 = r1.f5086s
                r3.cancel()
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r3 = r1.error
                p011io.reactivex.internal.util.ExceptionHelper.addThrowable(r3, r0)
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                java.lang.Throwable r0 = p011io.reactivex.internal.util.ExceptionHelper.terminate(r0)
                r2.onError(r0)
                return
            L_0x0062:
                r0 = move-exception
                ...
                org.reactivestreams.Subscription r0 = r1.f5086s
                r0.cancel()
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                p011io.reactivex.internal.util.ExceptionHelper.addThrowable(r0, r4)
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                java.lang.Throwable r0 = p011io.reactivex.internal.util.ExceptionHelper.terminate(r0)
                r1.current = r7
                r3.clear()
            ...
            L_0x0098:
                ...
                java.lang.Object r5 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r15, (java.lang.String) r5)     // Catch:{ Throwable -> 0x00dc }
                r2.onNext(r5)
                boolean r5 = r1.done
            ...
            L_0x00c1:
                r0 = move-exception
                r3 = r0
                p011io.reactivex.exceptions.Exceptions.throwIfFatal(r3)
                r1.current = r7
                org.reactivestreams.Subscription r0 = r1.f5086s
                r0.cancel()
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                p011io.reactivex.internal.util.ExceptionHelper.addThrowable(r0, r3)
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                java.lang.Throwable r0 = p011io.reactivex.internal.util.ExceptionHelper.terminate(r0)
                r2.onError(r0)
                return
            ...
            L_0x012c:
                ...
                goto L_0x001a
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.flowable.FlowableFlattenIterable.FlattenIterableSubscriber.drain():void");
        }
