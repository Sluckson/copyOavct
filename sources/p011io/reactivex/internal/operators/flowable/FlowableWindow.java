...
public final class FlowableWindow<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5149s, subscription)) {
                this.f5149s = subscription;
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                this.f5149s.request(BackpressureHelper.multiplyCap(this.size, j));
            }
        }
    ...
    static final class WindowSkipSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5151s, subscription)) {
                this.f5151s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public void request(long j) {
            ...
            if (this.firstRequest.get() || !this.firstRequest.compareAndSet(false, true)) {
                this.f5151s.request(BackpressureHelper.multiplyCap(this.skip, j));
                return;
            }
            this.f5151s.request(BackpressureHelper.addCap(BackpressureHelper.multiplyCap(this.size, j), BackpressureHelper.multiplyCap(this.skip - this.size, j - 1)));
        }
    ...
    static final class WindowOverlapSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5150s, subscription)) {
                this.f5150s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                ...
                if (this.firstRequest.get() || !this.firstRequest.compareAndSet(false, true)) {
                    this.f5150s.request(BackpressureHelper.multiplyCap(this.skip, j));
                } else {
                    this.f5150s.request(BackpressureHelper.addCap(this.size, BackpressureHelper.multiplyCap(this.skip, j - 1)));
                }
                drain();
            }
        }
