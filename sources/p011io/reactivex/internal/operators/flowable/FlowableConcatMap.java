...
public final class FlowableConcatMap<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static /* synthetic */ class C46201 {
        ...
        static {
            /*
                io.reactivex.internal.util.ErrorMode[] r0 = p011io.reactivex.internal.util.ErrorMode.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.reactivex.internal.util.ErrorMode r1 = p011io.reactivex.internal.util.ErrorMode.BOUNDARY     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$reactivex$internal$util$ErrorMode     // Catch:{ NoSuchFieldError -> 0x001f }
                io.reactivex.internal.util.ErrorMode r1 = p011io.reactivex.internal.util.ErrorMode.END     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.flowable.FlowableConcatMap.C46201.<clinit>():void");
        }
    }
    ...
    public static <T, R> Subscriber<T> subscribe(Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode2) {
        int i2 = C46201.$SwitchMap$io$reactivex$internal$util$ErrorMode[errorMode2.ordinal()];
        if (i2 == 1) {
    ...
    static abstract class BaseConcatMapSubscriber<T, R> extends AtomicInteger implements FlowableSubscriber<T>, ConcatMapSupport<R>, Subscription {
        ...
        public final void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5060s, subscription)) {
                this.f5060s = subscription;
