...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f5338it;
        final Function<? super T, ? extends Iterable<? extends R>> mapper;
        boolean outputFused;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f5337d, disposable)) {
                this.f5337d = disposable;
        ...
        public void onError(Throwable th) {
            this.f5337d = DisposableHelper.DISPOSED;
            this.actual.onError(th);
        }
        ...
        public void drain() {
            if (getAndIncrement() == 0) {
                ...
                Iterator<? extends R> it = this.f5338it;
