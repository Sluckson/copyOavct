package p011io.reactivex.internal.operators.parallel;
...
import p011io.reactivex.parallel.ParallelFailureHandling;
...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5319s, subscription)) {
                this.f5319s = subscription;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r10 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r4, (java.lang.String) r5)     // Catch:{ Throwable -> 0x001b }
                org.reactivestreams.Subscriber<? super R> r1 = r9.actual
                r1.onNext(r10)
                return r0
            L_0x001b:
                r4 = move-exception
                p011io.reactivex.exceptions.Exceptions.throwIfFatal(r4)
                r5 = 2
                ...
                java.lang.Object r6 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ Throwable -> 0x0052 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p011io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x0052 }
                int[] r7 = p011io.reactivex.internal.operators.parallel.ParallelMapTry.C46251.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x0052:
                r10 = move-exception
                p011io.reactivex.exceptions.Exceptions.throwIfFatal(r10)
                r9.cancel()
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTrySubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static /* synthetic */ class C46251 {
        ...
        static {
            /*
                io.reactivex.parallel.ParallelFailureHandling[] r0 = p011io.reactivex.parallel.ParallelFailureHandling.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.reactivex.parallel.ParallelFailureHandling r1 = p011io.reactivex.parallel.ParallelFailureHandling.RETRY     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$reactivex$parallel$ParallelFailureHandling     // Catch:{ NoSuchFieldError -> 0x001f }
                io.reactivex.parallel.ParallelFailureHandling r1 = p011io.reactivex.parallel.ParallelFailureHandling.SKIP     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = $SwitchMap$io$reactivex$parallel$ParallelFailureHandling     // Catch:{ NoSuchFieldError -> 0x002a }
                io.reactivex.parallel.ParallelFailureHandling r1 = p011io.reactivex.parallel.ParallelFailureHandling.STOP     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.parallel.ParallelMapTry.C46251.<clinit>():void");
        }
    }
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5318s, subscription)) {
                this.f5318s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r10 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r0, (java.lang.String) r4)     // Catch:{ Throwable -> 0x001b }
            ...
            L_0x001b:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ Throwable -> 0x0053 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p011io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x0053 }
                int[] r7 = p011io.reactivex.internal.operators.parallel.ParallelMapTry.C46251.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x0053:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTryConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
