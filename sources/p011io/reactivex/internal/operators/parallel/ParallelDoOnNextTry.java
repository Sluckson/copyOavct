...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5310s, subscription)) {
                this.f5310s = subscription;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.Object r6 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ Throwable -> 0x004b }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p011io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x004b }
                int[] r7 = p011io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C46231.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004b:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static /* synthetic */ class C46231 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C46231.<clinit>():void");
        }
    }
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f5309s, subscription)) {
                this.f5309s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p011io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ Throwable -> 0x004c }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p011io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x004c }
                int[] r7 = p011io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C46231.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004c:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
