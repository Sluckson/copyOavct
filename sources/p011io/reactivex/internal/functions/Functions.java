package p011io.reactivex.internal.functions;
...
public final class Functions {
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final BiFunction<? super T1, ? super T2, ? extends R> f173f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f173f = biFunction;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 2) {
                return this.f173f.apply(objArr[0], objArr[1]);
            }
    ...
    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function3<T1, T2, T3, R> f174f;

        Array3Func(Function3<T1, T2, T3, R> function3) {
            this.f174f = function3;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 3) {
                return this.f174f.apply(objArr[0], objArr[1], objArr[2]);
            }
    ...
    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function4<T1, T2, T3, T4, R> f175f;

        Array4Func(Function4<T1, T2, T3, T4, R> function4) {
            this.f175f = function4;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
                return this.f175f.apply(objArr[0], objArr[1], objArr[2], objArr[3]);
            }
    ...
    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        private final Function5<T1, T2, T3, T4, T5, R> f176f;

        Array5Func(Function5<T1, T2, T3, T4, T5, R> function5) {
            this.f176f = function5;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
                return this.f176f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4]);
            }
    ...
    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function6<T1, T2, T3, T4, T5, T6, R> f177f;

        Array6Func(Function6<T1, T2, T3, T4, T5, T6, R> function6) {
            this.f177f = function6;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
                return this.f177f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5]);
            }
    ...
    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f178f;

        Array7Func(Function7<T1, T2, T3, T4, T5, T6, T7, R> function7) {
            this.f178f = function7;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
                return this.f178f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6]);
            }
    ...
    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f179f;

        Array8Func(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8) {
            this.f179f = function8;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
                return this.f179f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7]);
            }
    ...
    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f180f;

        Array9Func(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9) {
            this.f180f = function9;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
                return this.f180f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[8]);
            }
