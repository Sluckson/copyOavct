...
import p011io.reactivex.internal.schedulers.ComputationScheduler;
import p011io.reactivex.internal.schedulers.ExecutorScheduler;
import p011io.reactivex.internal.schedulers.IoScheduler;
import p011io.reactivex.internal.schedulers.NewThreadScheduler;
import p011io.reactivex.internal.schedulers.SchedulerPoolFactory;
import p011io.reactivex.internal.schedulers.SingleScheduler;
import p011io.reactivex.internal.schedulers.TrampolineScheduler;
...
public final class Schedulers {
    ...
    /* renamed from: IO */
    static final Scheduler f5393IO = RxJavaPlugins.initIoScheduler(new IOTask());
    @NonNull
    ...
    @NonNull
    /* renamed from: io */
    public static Scheduler m4611io() {
        return RxJavaPlugins.onIoScheduler(f5393IO);
    }
