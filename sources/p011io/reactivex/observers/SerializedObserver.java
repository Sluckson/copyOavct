...
import p011io.reactivex.internal.util.AppendOnlyLinkedArrayList;
...
public final class SerializedObserver<T> implements Observer<T>, Disposable {
    ...
    public void onSubscribe(@NonNull Disposable disposable) {
        if (DisposableHelper.validate(this.f5391s, disposable)) {
            this.f5391s = disposable;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x003a, code lost:
        p011io.reactivex.plugins.RxJavaPlugins.onError(r3);
     */
    ...
    public void onError(@p011io.reactivex.annotations.NonNull java.lang.Throwable r3) {
        /*
            r2 = this;
            boolean r0 = r2.done
        ...
        L_0x0021:
            java.lang.Object r3 = p011io.reactivex.internal.util.NotificationLite.error(r3)     // Catch:{ all -> 0x0044 }
        ...
        L_0x0044:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.reactivex.observers.SerializedObserver.onError(java.lang.Throwable):void");
    }
