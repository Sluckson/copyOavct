...
public abstract class ResourceMaybeObserver<T> implements MaybeObserver<T>, Disposable {
    ...
    /* renamed from: s */
    private final AtomicReference<Disposable> f5387s = new AtomicReference<>();
    ...
    public final void onSubscribe(@NonNull Disposable disposable) {
        if (EndConsumerHelper.setOnce(this.f5387s, disposable, getClass())) {
            onStart();
        }
    }

    public final void dispose() {
        if (DisposableHelper.dispose(this.f5387s)) {
            this.resources.dispose();
        }
    }

    public final boolean isDisposed() {
        return DisposableHelper.isDisposed(this.f5387s.get());
    }
}
