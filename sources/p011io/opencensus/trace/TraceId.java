...
public final class TraceId implements Comparable<TraceId> {
    ...
    public static p011io.opencensus.trace.TraceId generateRandomId(java.util.Random r7) {
        /*
        L_0x0000:
            long r0 = r7.nextLong()
            long r2 = r7.nextLong()
        ...
        L_0x0012:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p011io.opencensus.trace.TraceId.generateRandomId(java.util.Random):io.opencensus.trace.TraceId");
    }
