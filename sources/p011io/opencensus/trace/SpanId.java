...
public final class SpanId implements Comparable<SpanId> {
    ...
    public byte[] getBytes() {
        ...
        BigendianEncoding.longToByteArray(this.f4995id, bArr, 0);
        return bArr;
    }

    public void copyBytesTo(byte[] bArr, int i) {
        BigendianEncoding.longToByteArray(this.f4995id, bArr, i);
    }

    public void copyLowerBase16To(char[] cArr, int i) {
        BigendianEncoding.longToBase16String(this.f4995id, cArr, i);
    }

    public boolean isValid() {
        return this.f4995id != 0;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if ((obj instanceof SpanId) && this.f4995id == ((SpanId) obj).f4995id) {
            return true;
        }
        return false;
    }
