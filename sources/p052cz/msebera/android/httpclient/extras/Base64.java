package p052cz.msebera.android.httpclient.extras;
...
public class Base64 {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        ...
        } else if (decoder.f4879op == decoder.output.length) {
            return decoder.output;
        } else {
            byte[] bArr2 = new byte[decoder.f4879op];
            System.arraycopy(decoder.output, 0, bArr2, 0, decoder.f4879op);
            return bArr2;
        }
    }
    ...
    static class Decoder extends Coder {
        ...
        public boolean process(byte[] r17, int r18, int r19, boolean r20) {
            ...
            L_0x0123:
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: p052cz.msebera.android.httpclient.extras.Base64.Decoder.process(byte[], int, int, boolean):boolean");
        }
    }
    ...
    static class Encoder extends Coder {
        static final /* synthetic */ boolean $assertionsDisabled = false;
        private static final byte[] ENCODE = {65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, ByteBuffer.ZERO, 49, 50, 51, 52, 53, 54, 55, 56, 57, 43, DocWriter.FORWARD};
        private static final byte[] ENCODE_WEBSAFE = {65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, ByteBuffer.ZERO, 49, 50, 51, 52, 53, 54, 55, 56, 57, 45, 95};
        ...
        public boolean process(byte[] r18, int r19, int r20, boolean r21) {
            ...
            L_0x01e7:
                ...
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: p052cz.msebera.android.httpclient.extras.Base64.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
