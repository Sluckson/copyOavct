...
public class BasicFuture<T> implements Future<T>, Cancellable {
    ...
    /* renamed from: ex */
    private volatile Exception f4875ex;
    ...
    private T getResult() throws ExecutionException {
        if (this.f4875ex == null) {
            return this.result;
        }
        throw new ExecutionException(this.f4875ex);
    }
    ...
    public boolean completed(T r3) {
        ...
        L_0x0019:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p052cz.msebera.android.httpclient.concurrent.BasicFuture.completed(java.lang.Object):boolean");
    }
    ...
    public boolean failed(java.lang.Exception r3) {
        ...
        L_0x0008:
            r0 = 1
            r2.completed = r0     // Catch:{ all -> 0x0019 }
            r2.f4875ex = r3     // Catch:{ all -> 0x0019 }
            r2.notifyAll()     // Catch:{ all -> 0x0019 }
            monitor-exit(r2)     // Catch:{ all -> 0x0019 }
            cz.msebera.android.httpclient.concurrent.FutureCallback<T> r1 = r2.callback
            if (r1 == 0) goto L_0x0018
        ...
        L_0x0019:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p052cz.msebera.android.httpclient.concurrent.BasicFuture.failed(java.lang.Exception):boolean");
    }
    ...
    public boolean cancel(boolean r2) {
        ...
        L_0x0019:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p052cz.msebera.android.httpclient.concurrent.BasicFuture.cancel(boolean):boolean");
    }
