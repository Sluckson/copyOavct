    ...
    public static final <T> void startCoroutineUnintercepted(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        ...
        try {
            ...
            if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                ...
                probeCoroutineCreated.resumeWith(Result.m4853constructorimpl(invoke));
            }
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            probeCoroutineCreated.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(th)));
        }
    }
