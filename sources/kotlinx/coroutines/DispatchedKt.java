...
public final class DispatchedKt {
        ...
        if (continuation instanceof DispatchedContinuation) {
            ...
            try {
                ...
                if (job == null || job.isActive()) {
                    ...
                    dispatchedContinuation.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(job.getCancellationException())));
                    z = true;
                }
                if (!z) {
    ...
    public static final <T> void resumeCancellableWithException(@NotNull Continuation<? super T> continuation, @NotNull Throwable th) {
        ...
        Result.Companion companion3 = Result.Companion;
        continuation.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(th, continuation))));
    }
