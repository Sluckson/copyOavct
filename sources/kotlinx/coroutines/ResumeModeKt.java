...
public final class ResumeModeKt {
    ...
    public static final <T> void resumeMode(@NotNull Continuation<? super T> continuation, T t, int i) {
        ...
        if (i == 0) {
            ...
            continuation.resumeWith(Result.m4853constructorimpl(t));
        } else if (i == 1) {
            ...
            try {
                ...
                continuation2.resumeWith(Result.m4853constructorimpl(t));
    ...
    public static final <T> void resumeWithExceptionMode(@NotNull Continuation<? super T> continuation, @NotNull Throwable th, int i) {
        ...
        if (i == 0) {
            Result.Companion companion = Result.Companion;
            continuation.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(th)));
        } else if (i == 1) {
            ...
            try {
                Continuation<T> continuation2 = dispatchedContinuation.continuation;
                Result.Companion companion2 = Result.Companion;
                continuation2.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(th, continuation2))));
                Unit unit = Unit.INSTANCE;
            } finally {
                ThreadContextKt.restoreThreadContext(context, updateThreadContext);
            }
    ...
    public static final <T> void resumeUninterceptedMode(@NotNull Continuation<? super T> continuation, T t, int i) {
        ...
        if (i == 0) {
            ...
            Result.Companion companion = Result.Companion;
            intercepted.resumeWith(Result.m4853constructorimpl(t));
        } else if (i == 1) {
    ...
    public static final <T> void resumeUninterceptedWithExceptionMode(@NotNull Continuation<? super T> continuation, @NotNull Throwable th, int i) {
        ...
        if (i == 0) {
            Continuation<? super T> intercepted = IntrinsicsKt.intercepted(continuation);
            Result.Companion companion = Result.Companion;
            intercepted.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(th)));
        } else if (i == 1) {
