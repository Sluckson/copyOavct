...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final Object receiveOrClosed(@NotNull Continuation<? super ValueOrClosed<? extends E>> continuation) {
        ...
        if (pollInternal instanceof Closed) {
            ...
            obj = ValueOrClosed.m5862constructorimpl(new ValueOrClosed.Closed(((Closed) pollInternal).closeCause));
        } else {
            ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
            obj = ValueOrClosed.m5862constructorimpl(pollInternal);
        }
        return ValueOrClosed.m5861boximpl(obj);
    }
            ...
            if (!isEmpty()) {
                ...
                if (pollSelectInternal != SelectKt.getALREADY_SELECTED()) {
                    if (pollSelectInternal == AbstractChannelKt.POLL_FAILED) {
                        ...
                        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                        UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m5861boximpl(ValueOrClosed.m5862constructorimpl(new ValueOrClosed.Closed(((Closed) pollSelectInternal).closeCause))), selectInstance.getCompletion());
                    } else {
                        ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                        UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m5861boximpl(ValueOrClosed.m5862constructorimpl(pollSelectInternal)), selectInstance.getCompletion());
                        return;
                    }
                } else {
                    return;
                ...
                if (!getChannel().enqueueReceive(receive)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            cancellableContinuation.resumeWith(Result.m4853constructorimpl(boxBoolean));
                            break;
                        }
                    } else {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            cancellableContinuation.resumeWith(Result.m4853constructorimpl(boxBoolean2));
                        } else {
                            Throwable receiveException = closed.getReceiveException();
                            Result.Companion companion3 = Result.Companion;
                            cancellableContinuation.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(receiveException)));
                        }
                    }
                } else {
    ...
    private static final class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.Companion;
            return ValueOrClosed.m5861boximpl(ValueOrClosed.m5862constructorimpl(e));
        }
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            ...
            if (this.receiveMode == 1 && closed.closeCause == null) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m4853constructorimpl((Object) null));
            } else if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                ValueOrClosed r3 = ValueOrClosed.m5861boximpl(ValueOrClosed.m5862constructorimpl(new ValueOrClosed.Closed(closed.closeCause)));
                Result.Companion companion3 = Result.Companion;
                this.cont.resumeWith(Result.m4853constructorimpl(r3));
            } else {
                Throwable receiveException = closed.getReceiveException();
                Result.Companion companion4 = Result.Companion;
                this.cont.resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(receiveException)));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(@NotNull Object obj) {
            ...
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                obj = ValueOrClosed.m5861boximpl(ValueOrClosed.m5862constructorimpl(obj));
            }
            ...
            if (this.select.trySelect((Object) null)) {
                ...
                if (i == 0) {
                    ...
                    if (i == 2) {
                        Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                        ContinuationKt.startCoroutine(function2, ValueOrClosed.m5861boximpl(ValueOrClosed.m5862constructorimpl(new ValueOrClosed.Closed(closed.closeCause))), this.select.getCompletion());
                    }
    ...
    @Metadata(mo66931bv = {1, 0, 3}, mo66932d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0005\b\u0002\u0018\u0000*\u0006\b\u0001\u0010\u0001 \u00012\u00020\u0002B\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00028\u0001¢\u0006\u0002\u0010\u0005R\u0010\u0010\u0003\u001a\u00020\u00028\u0006X\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00028\u00018\u0006X\u0004¢\u0006\u0004\n\u0002\u0010\u0006\u0002\u0004\n\u0002\b\u0019¨\u0006\u0007"}, mo66933d2 = {"Lkotlinx/coroutines/channels/AbstractChannel$IdempotentTokenValue;", "E", "", "token", "value", "(Ljava/lang/Object;Ljava/lang/Object;)V", "Ljava/lang/Object;", "kotlinx-coroutines-core"}, mo66934k = 1, mo66935mv = {1, 1, 15})
    /* compiled from: AbstractChannel.kt */
    ...
    /* access modifiers changed from: package-private */
    @Nullable
    public final /* synthetic */ <R> Object receiveSuspend(int i, @NotNull Continuation<? super R> continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 0);
        CancellableContinuation cancellableContinuation = cancellableContinuationImpl;
            ...
            if (!enqueueReceive(receive)) {
                ...
                if (!(pollInternal instanceof Closed)) {
                    if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                        ...
                        Result.Companion companion = Result.Companion;
                        cancellableContinuation.resumeWith(Result.m4853constructorimpl(resumeValue));
                        break;
                    }
                } else {
