    ...
    public final void resumeCancellable(T t) {
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                resumeWith(Result.m4853constructorimpl(ResultKt.createFailure(job.getCancellationException())));
                z = true;
            }
            if (!z) {
                context = getContext();
