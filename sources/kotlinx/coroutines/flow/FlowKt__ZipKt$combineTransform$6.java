...
@DebugMetadata(mo67566c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo67567f = "Zip.kt", mo67568i = {0}, mo67569l = {294}, mo67570m = "invokeSuspend", mo67571n = {"$this$flow"}, mo67572s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$6.f5480p$ = (FlowCollector) obj;
    ...
    @DebugMetadata(mo67566c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo67567f = "Zip.kt", mo67568i = {0, 0}, mo67569l = {294}, mo67570m = "invokeSuspend", mo67571n = {"$receiver", "it"}, mo67572s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C48002 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;

        /* renamed from: p$ */
        private FlowCollector f5481p$;
        private Object[] p$0;
        ...
        public final Continuation<Unit> create(@NotNull FlowCollector<? super R> flowCollector, @NotNull T[] tArr, @NotNull Continuation<? super Unit> continuation) {
            ...
            C48002 r0 = new C48002(this.this$0, continuation);
            r0.f5481p$ = flowCollector;
            r0.p$0 = tArr;
            return r0;
        }

        public final Object invoke(Object obj, Object obj2, Object obj3) {
            return ((C48002) create((FlowCollector) obj, (Object[]) obj2, (Continuation) obj3)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = this.f5481p$;
        ...
        public final Object invokeSuspend$$forInline(@NotNull Object obj) {
            this.this$0.$transform.invoke(this.f5481p$, this.p$0, this);
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f5480p$;
            ...
            }, new C48002(this, (Continuation) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            FlowCollector flowCollector2 = (FlowCollector) this.L$0;
    ...
    public final Object invokeSuspend$$forInline(@NotNull Object obj) {
        ...
        }, new C48002(this, (Continuation) null), this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
