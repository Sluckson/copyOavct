...
@DebugMetadata(mo67566c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$2$values$1", mo67567f = "Delay.kt", mo67568i = {0, 0}, mo67569l = {137}, mo67570m = "invokeSuspend", mo67571n = {"$this$produce", "$this$collect$iv"}, mo67572s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$debounce$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        flowKt__DelayKt$debounce$2$values$1.f5438p$ = (ProducerScope) obj;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            ProducerScope producerScope = this.f5438p$;
            Flow flow = this.this$0.$this_debounce;
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(new C4656xbf31cc91(producerScope), this) == coroutine_suspended) {
