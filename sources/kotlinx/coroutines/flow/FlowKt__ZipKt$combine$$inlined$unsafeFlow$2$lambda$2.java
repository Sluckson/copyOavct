...
@DebugMetadata(mo67566c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2", mo67567f = "Zip.kt", mo67568i = {0, 0}, mo67569l = {246}, mo67570m = "invokeSuspend", mo67571n = {"$receiver", "it"}, mo67572s = {"L$0", "L$1"})
...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@NotNull FlowCollector<? super R> flowCollector, @NotNull T[] tArr, @NotNull Continuation<? super Unit> continuation) {
        ...
        flowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2.f5465p$ = flowCollector;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = this.f5465p$;
