...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        return this.$this_unsafeTransform$inlined.collect(new C4679xb062d257(flowCollector, this), continuation);
    }
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C4679xb062d257(flowCollector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
