...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        return this.$this_unsafeTransform$inlined.collect(new C4767xaa78f19a(flowCollector, this), continuation);
    }
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C4767xaa78f19a(flowCollector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
