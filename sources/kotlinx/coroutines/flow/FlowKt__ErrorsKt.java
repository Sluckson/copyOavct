...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> onErrorCollect(@NotNull Flow<? extends T> flow, @NotNull Flow<? extends T> flow2, @NotNull Function1<? super Throwable, Boolean> function1) {
        ...
        return FlowKt.m5872catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, (Continuation) null));
    }
    ...
    public static final <T> java.lang.Object catchImpl(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.Flow<? extends T> r5, @org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super T> r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super java.lang.Throwable> r7) {
        ...
        L_0x0019:
            ...
            kotlin.ResultKt.throwOnFailure(r7)     // Catch:{ Throwable -> 0x003b }
            goto L_0x006b
        L_0x003b:
            r6 = move-exception
            r7 = r5
        ...
        L_0x0046:
            ...
            r7.element = r2
            kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$$inlined$collect$1 r2 = new kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$$inlined$collect$1     // Catch:{ Throwable -> 0x006c }
            r2.<init>(r6, r7)     // Catch:{ Throwable -> 0x006c }
            kotlinx.coroutines.flow.FlowCollector r2 = (kotlinx.coroutines.flow.FlowCollector) r2     // Catch:{ Throwable -> 0x006c }
            r0.L$0 = r5     // Catch:{ Throwable -> 0x006c }
            r0.L$1 = r6     // Catch:{ Throwable -> 0x006c }
            r0.L$2 = r7     // Catch:{ Throwable -> 0x006c }
            r0.L$3 = r5     // Catch:{ Throwable -> 0x006c }
            r0.label = r4     // Catch:{ Throwable -> 0x006c }
            java.lang.Object r5 = r5.collect(r2, r0)     // Catch:{ Throwable -> 0x006c }
    ...
    public static final <T> Flow<T> m5873catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
