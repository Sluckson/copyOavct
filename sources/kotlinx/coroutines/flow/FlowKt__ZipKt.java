...
final /* synthetic */ class FlowKt__ZipKt {
    ...
    @NotNull
    @ExperimentalCoroutinesApi
    public static final /* synthetic */ <T, R> Flow<R> combineTransform(@NotNull Flow<? extends T>[] flowArr, @NotNull @BuilderInference Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    @NotNull
    @ExperimentalCoroutinesApi
    public static final /* synthetic */ <T, R> Flow<R> combineTransform(@NotNull Iterable<? extends Flow<? extends T>> iterable, @NotNull @BuilderInference Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3) {
        Intrinsics.checkParameterIsNotNull(iterable, "flows");
        Intrinsics.checkParameterIsNotNull(function3, "transform");
        Object[] array = CollectionsKt.toList(iterable).toArray(new Flow[0]);
        if (array != null) {
    ...
    @NotNull
    @ExperimentalCoroutinesApi
    public static final /* synthetic */ <T, R> Flow<R> combine(@NotNull Flow<? extends T>[] flowArr, @NotNull Function2<? super T[], ? super Continuation<? super R>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull(flowArr, "flows");
        Intrinsics.checkParameterIsNotNull(function2, "transform");
        Intrinsics.needClassReification();
