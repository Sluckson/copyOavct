...
@DebugMetadata(mo67566c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$onErrorCollect$2", mo67567f = "Errors.kt", mo67568i = {0, 0, 0, 0}, mo67569l = {230}, mo67570m = "invokeSuspend", mo67571n = {"$this$catch", "e", "$this$emitAll$iv", "flow$iv"}, mo67572s = {"L$0", "L$1", "L$2", "L$3"})
...
final class FlowKt__ErrorsKt$onErrorCollect$2 extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@NotNull FlowCollector<? super T> flowCollector, @NotNull Throwable th, @NotNull Continuation<? super Unit> continuation) {
        ...
        flowKt__ErrorsKt$onErrorCollect$2.f5444p$ = flowCollector;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = this.f5444p$;
