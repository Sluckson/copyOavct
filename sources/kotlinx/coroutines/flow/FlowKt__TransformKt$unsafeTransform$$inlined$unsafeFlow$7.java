...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7 implements Flow<R> {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        return this.$this_unsafeTransform$inlined.collect(new C4773x930bd3d8(flowCollector, this), continuation);
    }
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C4773x930bd3d8(flowCollector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
