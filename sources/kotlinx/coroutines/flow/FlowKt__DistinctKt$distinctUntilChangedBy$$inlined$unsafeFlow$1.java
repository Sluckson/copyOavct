...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        return this.$this_distinctUntilChangedBy$inlined.collect(new C4667x59d1cced(flowCollector, objectRef, this), continuation);
    }
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        objectRef.element = NullSurrogateKt.NULL;
        InlineMarker.mark(0);
        this.$this_distinctUntilChangedBy$inlined.collect(new C4667x59d1cced(flowCollector, objectRef, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
