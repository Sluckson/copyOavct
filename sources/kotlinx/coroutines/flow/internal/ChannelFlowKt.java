...
public final class ChannelFlowKt {
    ...
    @Nullable
    static final /* synthetic */ <T, V> Object withContextUndispatched(@NotNull CoroutineContext coroutineContext, @NotNull Object obj, @NotNull Function2<? super V, ? super Continuation<? super T>, ? extends Object> function2, V v, @NotNull Continuation<? super T> continuation) {
        Object updateThreadContext = ThreadContextKt.updateThreadContext(coroutineContext, obj);
        try {
            Continuation channelFlowKt$withContextUndispatched$$inlined$suspendCoroutineUninterceptedOrReturn$lambda$1 = new C4801x9e72d8c3(coroutineContext, continuation, coroutineContext, obj, function2, v);
            if (function2 != null) {
