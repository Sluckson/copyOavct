...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public ChannelFlowMerge(@NotNull Flow<? extends Flow<? extends T>> flow2, int i, @NotNull CoroutineContext coroutineContext, int i2) {
