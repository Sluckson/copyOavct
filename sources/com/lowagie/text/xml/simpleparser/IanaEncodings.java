...
public class IanaEncodings {
    ...
    static {
        ...
        map.put("US-ASCII", HTTP.ASCII);
        map.put("ISO-IR-6", HTTP.ASCII);
        map.put("ANSI_X3.4-1986", HTTP.ASCII);
        map.put("ISO_646.IRV:1991", HTTP.ASCII);
        map.put(HTTP.ASCII, HTTP.ASCII);
        map.put("CSASCII", HTTP.ASCII);
        map.put("ISO646-US", HTTP.ASCII);
        map.put("US", HTTP.ASCII);
        map.put("IBM367", HTTP.ASCII);
        map.put("CP367", HTTP.ASCII);
        map.put("UTF-8", "UTF8");
