...
public final class FontFactory {
    ...
    public static Font getFont(String str, String str2, boolean z, float f, int i, Color color, boolean z2) {
        return fontImp.getFont(str, str2, z, f, i, color, z2);
    }

    public static Font getFont(Properties properties) {
        FontFactoryImp fontFactoryImp = fontImp;
        fontFactoryImp.defaultEmbedding = defaultEmbedding;
        fontFactoryImp.defaultEncoding = defaultEncoding;
        return fontFactoryImp.getFont(properties);
    }
    ...
    public static Font getFont(String str, String str2, float f, int i) {
        return getFont(str, str2, defaultEmbedding, f, i, (Color) null);
    }

    public static Font getFont(String str, String str2, float f) {
        return getFont(str, str2, defaultEmbedding, f, -1, (Color) null);
    }

    public static Font getFont(String str, String str2) {
        return getFont(str, str2, defaultEmbedding, -1.0f, -1, (Color) null);
    }
    ...
    public static Font getFont(String str, float f, Color color) {
        return getFont(str, defaultEncoding, defaultEmbedding, f, -1, color);
    }

    public static Font getFont(String str, float f, int i) {
        return getFont(str, defaultEncoding, defaultEmbedding, f, i, (Color) null);
    }

    public static Font getFont(String str, float f) {
        return getFont(str, defaultEncoding, defaultEmbedding, f, -1, (Color) null);
    }

    public static Font getFont(String str) {
        return getFont(str, defaultEncoding, defaultEmbedding, -1.0f, -1, (Color) null);
    }
