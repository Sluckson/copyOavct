...
public class Annotation implements Element {
    ...
    protected HashMap<String, Serializable> annotationAttributes;
    ...
    public Annotation(float f, float f2, float f3, float f4, String str, String str2, boolean z) {
        ...
        HashMap<String, Serializable> hashMap = this.annotationAttributes;
        boolean[] zArr = new boolean[2];
        zArr[1] = z;
        hashMap.put("parameters", zArr);
    }
    ...
    public HashMap<String, Serializable> attributes() {
