...
public class PageSize {
    ...
    /* renamed from: A0 */
    public static final Rectangle f582A0 = new RectangleReadOnly(2384.0f, 3370.0f);

    /* renamed from: A1 */
    public static final Rectangle f583A1 = new RectangleReadOnly(1684.0f, 2384.0f);
    public static final Rectangle A10 = new RectangleReadOnly(73.0f, 105.0f);

    /* renamed from: A2 */
    public static final Rectangle f584A2 = new RectangleReadOnly(1191.0f, 1684.0f);

    /* renamed from: A3 */
    public static final Rectangle f585A3 = new RectangleReadOnly(842.0f, 1191.0f);

    /* renamed from: A4 */
    public static final Rectangle f586A4 = new RectangleReadOnly(595.0f, 842.0f);

    /* renamed from: A5 */
    public static final Rectangle f587A5 = new RectangleReadOnly(420.0f, 595.0f);

    /* renamed from: A6 */
    public static final Rectangle f588A6 = new RectangleReadOnly(297.0f, 420.0f);

    /* renamed from: A7 */
    public static final Rectangle f589A7 = new RectangleReadOnly(210.0f, 297.0f);

    /* renamed from: A8 */
    public static final Rectangle f590A8 = new RectangleReadOnly(148.0f, 210.0f);

    /* renamed from: A9 */
    public static final Rectangle f591A9 = new RectangleReadOnly(105.0f, 148.0f);
    ...
    /* renamed from: B0 */
    public static final Rectangle f592B0 = new RectangleReadOnly(2834.0f, 4008.0f);

    /* renamed from: B1 */
    public static final Rectangle f593B1 = new RectangleReadOnly(2004.0f, 2834.0f);
    public static final Rectangle B10 = new RectangleReadOnly(87.0f, 124.0f);

    /* renamed from: B2 */
    public static final Rectangle f594B2 = new RectangleReadOnly(1417.0f, 2004.0f);

    /* renamed from: B3 */
    public static final Rectangle f595B3 = new RectangleReadOnly(1000.0f, 1417.0f);

    /* renamed from: B4 */
    public static final Rectangle f596B4 = new RectangleReadOnly(708.0f, 1000.0f);

    /* renamed from: B5 */
    public static final Rectangle f597B5 = new RectangleReadOnly(498.0f, 708.0f);

    /* renamed from: B6 */
    public static final Rectangle f598B6 = new RectangleReadOnly(354.0f, 498.0f);

    /* renamed from: B7 */
    public static final Rectangle f599B7 = new RectangleReadOnly(249.0f, 354.0f);

    /* renamed from: B8 */
    public static final Rectangle f600B8 = new RectangleReadOnly(175.0f, 249.0f);

    /* renamed from: B9 */
    public static final Rectangle f601B9 = new RectangleReadOnly(124.0f, 175.0f);
    ...
    public static Rectangle getRectangle(String str) {
        ...
        if (indexOf == -1) {
            ...
            try {
                ...
                throw new RuntimeException(String.valueOf(upperCase) + " is not a valid page size format; " + e.getMessage());
            }
        }
    }
}
