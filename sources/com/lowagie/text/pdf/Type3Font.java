...
public class Type3Font extends BaseFont {
    ...
    public PdfContentByte defineGlyph(char c, float f, float f2, float f3, float f4, float f5) {
        ...
        Type3Glyph type3Glyph = (Type3Glyph) this.char2glyph.get(num);
        if (type3Glyph != null) {
            return type3Glyph;
        }
        ...
        this.char2glyph.put(num, type3Glyph2);
        return type3Glyph2;
    }
            ...
            if (i != zArr22.length) {
                ...
                for (int i7 = 0; i7 < i4; i7++) {
                    ...
                    if (unicodeToName == null) {
                        unicodeToName = HtmlTags.ANCHOR + i9;
                    }
                    PdfName pdfName = new PdfName(unicodeToName);
                    pdfArray.add((PdfObject) pdfName);
                    PdfStream pdfStream = new PdfStream(((Type3Glyph) this.char2glyph.get(new Integer(i9))).toPdf((PdfWriter) null));
    ...
    public int getWidth(int i) {
        ...
        throw new IllegalArgumentException("The char " + i + " is not defined in a Type3 font");
    }
