...
public class PdfAction extends PdfDictionary {
    ...
    PdfAction(PdfIndirectReference pdfIndirectReference) {
        put(PdfName.f719S, PdfName.GOTO);
        put(PdfName.f661D, pdfIndirectReference);
    }

    public PdfAction(String str, String str2) {
        put(PdfName.f719S, PdfName.GOTOR);
        put(PdfName.f673F, new PdfString(str));
        put(PdfName.f661D, new PdfString(str2));
    }

    public PdfAction(String str, int i) {
        put(PdfName.f719S, PdfName.GOTOR);
        put(PdfName.f673F, new PdfString(str));
        PdfName pdfName = PdfName.f661D;
    ...
    public PdfAction(int i) {
        put(PdfName.f719S, PdfName.NAMED);
        if (i == 1) {
            put(PdfName.f696N, PdfName.FIRSTPAGE);
        } else if (i == 2) {
            put(PdfName.f696N, PdfName.PREVPAGE);
        } else if (i == 3) {
            put(PdfName.f696N, PdfName.NEXTPAGE);
        } else if (i == 4) {
            put(PdfName.f696N, PdfName.LASTPAGE);
        } else if (i == 5) {
            put(PdfName.f719S, PdfName.JAVASCRIPT);
            put(PdfName.f690JS, new PdfString("this.print(true);\r"));
        } else {
    ...
    public PdfAction(String str, String str2, String str3, String str4) {
        put(PdfName.f719S, PdfName.LAUNCH);
        if (str2 == null && str3 == null && str4 == null) {
            put(PdfName.f673F, new PdfString(str));
            return;
        }
        PdfDictionary pdfDictionary = new PdfDictionary();
        pdfDictionary.put(PdfName.f673F, new PdfString(str));
        if (str2 != null) {
            pdfDictionary.put(PdfName.f707P, new PdfString(str2));
        }
        if (str3 != null) {
            pdfDictionary.put(PdfName.f703O, new PdfString(str3));
        }
        if (str4 != null) {
            pdfDictionary.put(PdfName.f661D, new PdfString(str4));
        }
    ...
    public static PdfAction rendition(String str, PdfFileSpecification pdfFileSpecification, String str2, PdfIndirectReference pdfIndirectReference) throws IOException {
        ...
        pdfAction.put(PdfName.f719S, PdfName.RENDITION);
        pdfAction.put(PdfName.f715R, new PdfRendition(str, pdfFileSpecification, str2));
    ...
    public static PdfAction javaScript(String str, PdfWriter pdfWriter, boolean z) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.JAVASCRIPT);
        String str2 = PdfObject.TEXT_UNICODE;
        if (z && str.length() < 50) {
            pdfAction.put(PdfName.f690JS, new PdfString(str, str2));
            ...
            try {
                ...
                pdfAction.put(PdfName.f690JS, pdfWriter.addToBody(pdfStream).getIndirectReference());
            } catch (Exception unused) {
                pdfAction.put(PdfName.f690JS, new PdfString(str));
            }
        } else {
            pdfAction.put(PdfName.f690JS, new PdfString(str));
        }
    ...
    static PdfAction createHide(PdfObject pdfObject, boolean z) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.HIDE);
        pdfAction.put(PdfName.f723T, pdfObject);
        if (!z) {
            pdfAction.put(PdfName.f679H, PdfBoolean.PDFFALSE);
        }
        return pdfAction;
    }
    ...
    public static PdfAction createSubmitForm(String str, Object[] objArr, int i) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.SUBMITFORM);
        PdfDictionary pdfDictionary = new PdfDictionary();
        pdfDictionary.put(PdfName.f673F, new PdfString(str));
        pdfDictionary.put(PdfName.f677FS, PdfName.URL);
        pdfAction.put(PdfName.f673F, pdfDictionary);
        if (objArr != null) {
    ...
    public static PdfAction createResetForm(Object[] objArr, int i) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.RESETFORM);
        if (objArr != null) {
            pdfAction.put(PdfName.FIELDS, buildArray(objArr));
        }
        pdfAction.put(PdfName.FLAGS, new PdfNumber(i));
    ...
    public static PdfAction createImportData(String str) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.IMPORTDATA);
        pdfAction.put(PdfName.f673F, new PdfString(str));
        return pdfAction;
    }
    ...
    public static PdfAction gotoLocalPage(int i, PdfDestination pdfDestination, PdfWriter pdfWriter) {
        ...
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.GOTO);
        pdfAction.put(PdfName.f661D, pdfDestination);
        return pdfAction;
    }
    ...
    public static PdfAction gotoLocalPage(String str, boolean z) {
        ...
        pdfAction.put(PdfName.f719S, PdfName.GOTO);
        if (z) {
            pdfAction.put(PdfName.f661D, new PdfName(str));
        } else {
            pdfAction.put(PdfName.f661D, new PdfString(str, (String) null));
        }
        return pdfAction;
    }
    ...
    public static PdfAction gotoRemotePage(String str, String str2, boolean z, boolean z2) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f673F, new PdfString(str));
        pdfAction.put(PdfName.f719S, PdfName.GOTOR);
        if (z) {
            pdfAction.put(PdfName.f661D, new PdfName(str2));
        } else {
            pdfAction.put(PdfName.f661D, new PdfString(str2, (String) null));
        }
        if (z2) {
    ...
    public static PdfAction gotoEmbedded(String str, PdfTargetDictionary pdfTargetDictionary, String str2, boolean z, boolean z2) {
        ...
        return gotoEmbedded(str, pdfTargetDictionary, new PdfString(str2, (String) null), z2);
    }

    public static PdfAction gotoEmbedded(String str, PdfTargetDictionary pdfTargetDictionary, PdfObject pdfObject, boolean z) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.GOTOE);
        pdfAction.put(PdfName.f723T, pdfTargetDictionary);
        pdfAction.put(PdfName.f661D, pdfObject);
    ...
    public static PdfAction setOCGstate(ArrayList arrayList, boolean z) {
        PdfName pdfName;
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f719S, PdfName.SETOCGSTATE);
        PdfArray pdfArray = new PdfArray();
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (obj != null) {
                if (obj instanceof PdfIndirectReference) {
                    ...
                    throw new IllegalArgumentException("Invalid type was passed in state: " + obj.getClass().getName());
                }
            }
        }
