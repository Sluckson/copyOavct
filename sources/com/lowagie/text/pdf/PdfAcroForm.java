...
public class PdfAcroForm extends PdfDictionary {
    ...
    public boolean isValid() {
        ...
        if (this.calculationOrder.size() > 0) {
            put(PdfName.f659CO, this.calculationOrder);
        }
        ...
        for (PdfTemplate resources : this.fieldTemplates.keySet()) {
            PdfFormField.mergeResources(pdfDictionary, (PdfDictionary) resources.getResources());
        }
        put(PdfName.f667DR, pdfDictionary);
        put(PdfName.f662DA, new PdfString("/Helv 0 Tf 0 g "));
    ...
    public PdfFormField addRadioButton(PdfFormField pdfFormField, String str, float f, float f2, float f3, float f4) {
        ...
        if (((PdfName) pdfFormField.get(PdfName.f736V)).toString().substring(1).equals(str)) {
