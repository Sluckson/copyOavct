...
public abstract class DocWriter implements DocListener {
    ...
    /* renamed from: GT */
    public static final byte f569GT = 62;

    /* renamed from: LT */
    public static final byte f570LT = 60;
    ...
    /* renamed from: os */
    protected OutputStreamCounter f571os;
    ...
    protected DocWriter(Document document2, OutputStream outputStream) {
        ...
        this.f571os = new OutputStreamCounter(new BufferedOutputStream(outputStream));
    }
    ...
    public void write(String str) throws IOException {
        this.f571os.write(getISOBytes(str));
    }
    ...
    public void write(String str, String str2) throws IOException {
        this.f571os.write(32);
        write(str);
        this.f571os.write(61);
        this.f571os.write(34);
        write(str2);
        this.f571os.write(34);
    }
