...
public class AppSwitchHelper {
    ...
    private static Result processResponseIntent(Bundle bundle) {
        ...
        if (HtmlTags.CODE.equals(bundle.getString("response_type").toLowerCase(Locale.US))) {
        ...
        try {
            ...
            return new Result(string2, responseType, new JSONObject().put(HtmlTags.CODE, string3), bundle.getString("email"));
