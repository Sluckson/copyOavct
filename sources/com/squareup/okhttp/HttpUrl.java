...
public final class HttpUrl {
    ...
    /* synthetic */ HttpUrl(Builder builder, C41481 r2) {
        this(builder);
    }
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C41481.$SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
    ...
    static /* synthetic */ class C41481 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.HttpUrl.C41481.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public HttpUrl build() {
            if (this.scheme == null) {
                ...
                return new HttpUrl(this, (C41481) null);
            } else {
