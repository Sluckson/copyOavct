...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f3452dn;
    private int end;
    private final int length = this.f3452dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f3452dn = x500Principal.getName("RFC2253");
    }
        ...
        if (i4 < this.length) {
            ...
            if (this.chars[i4] == ' ') {
                ...
                if (cArr3[i6] != '=' || i6 == this.length) {
                    throw new IllegalStateException("Unexpected end of DN: " + this.f3452dn);
                }
            }
            this.pos++;
            while (true) {
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f3452dn);
            } else {
                i2 = c - '7';
            }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f3452dn.toCharArray();
