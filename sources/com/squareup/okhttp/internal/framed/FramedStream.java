...
public final class FramedStream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f3450id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void reply(List<Header> list, boolean z) throws IOException {
        ...
        this.connection.writeSynReply(this.f3450id, z2, list);
        if (z2) {
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f3450id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f3450id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f3450id);
            return true;
        }
    }
    ...
    private final class FramedDataSource implements Source {
        ...
        public long read(okio.Buffer r9, long r10) throws java.io.IOException {
            ...
            L_0x001d:
                ...
                int r3 = r3.f3450id     // Catch:{ all -> 0x00b1 }
    ...
    final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean z) throws IOException {
            ...
            FramedStream.this.writeTimeout.enter();
            try {
                FramedStream.this.connection.writeData(FramedStream.this.f3450id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                FramedStream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
