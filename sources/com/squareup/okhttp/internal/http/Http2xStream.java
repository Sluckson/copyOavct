...
public final class Http2xStream implements HttpStream {
    ...
    private static final ByteString ENCODING = ByteString.encodeUtf8(ElementTags.ENCODING);
    private static final ByteString HOST = ByteString.encodeUtf8("host");
    private static final List<ByteString> HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList((T[]) new ByteString[]{CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, f3451TE, TRANSFER_ENCODING, ENCODING, UPGRADE, Header.TARGET_METHOD, Header.TARGET_PATH, Header.TARGET_SCHEME, Header.TARGET_AUTHORITY, Header.TARGET_HOST, Header.VERSION});
    private static final List<ByteString> HTTP_2_SKIPPED_RESPONSE_HEADERS = Util.immutableList((T[]) new ByteString[]{CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, f3451TE, TRANSFER_ENCODING, ENCODING, UPGRADE});
    ...
    /* renamed from: TE */
    private static final ByteString f3451TE = ByteString.encodeUtf8("te");
    ...
    public static Response.Builder readSpdy3HeadersList(List<Header> list) throws IOException {
        ...
        if (str2 != null) {
            StatusLine parse = StatusLine.parse(str + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + str2);
