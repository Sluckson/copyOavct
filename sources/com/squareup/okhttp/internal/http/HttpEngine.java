            ...
            if (this.httpStream == null) {
                ...
                if (this.networkRequest != null) {
                    ...
                    if (response2 != null) {
                        ...
                        this.userResponse = new Response.Builder().request(this.userRequest).priorResponse(stripBody(this.priorResponse)).protocol(Protocol.HTTP_1_1).code(HttpStatus.SC_GATEWAY_TIMEOUT).message("Unsatisfiable Request (only-if-cached)").body(EMPTY_BODY).build();
                    }
