...
public class CacheDispatcher extends Thread {
    ...
    public void run() {
        if (DEBUG) {
            VolleyLog.m26v("start new dispatcher", new Object[0]);
        }
    ...
    private static class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
        ...
        public void onResponseReceived(Request<?> request, Response<?> response) {
            ...
            if (remove != null) {
                if (VolleyLog.DEBUG) {
                    VolleyLog.m26v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(remove.size()), cacheKey);
                }
        ...
        public synchronized void onNoUsableResponseReceived(Request<?> request) {
            ...
            if (remove != null && !remove.isEmpty()) {
                if (VolleyLog.DEBUG) {
                    VolleyLog.m26v("%d waiting requests for cacheKey=%s; resend to network", Integer.valueOf(remove.size()), cacheKey);
                }
                ...
                try {
                    ...
                    VolleyLog.m24e("Couldn't add request to queue. %s", e.toString());
                    Thread.currentThread().interrupt();
        ...
        public synchronized boolean maybeAddToWaitingRequests(com.android.volley.Request<?> r6) {
            ...
            L_0x001e:
                ...
                com.android.volley.VolleyLog.m23d(r6, r1)     // Catch:{ all -> 0x0052 }
            L_0x0038:
                monitor-exit(r5)
                return r2
            L_0x003a:
