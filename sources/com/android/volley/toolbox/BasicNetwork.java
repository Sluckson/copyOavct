...
public class BasicNetwork implements Network {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00c1, code lost:
        ...
        com.android.volley.VolleyLog.m24e("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r29.getUrl());
     */
    ...
    public com.android.volley.NetworkResponse performRequest(com.android.volley.Request<?> r29) throws com.android.volley.VolleyError {
        ...
        L_0x0008:
            ...
            r15 = r0
            r21 = r13
            r15.<init>((int) r16, (byte[]) r17, (boolean) r18, (long) r19, (java.util.List<com.android.volley.Header>) r21)     // Catch:{ SocketTimeoutException -> 0x0163, MalformedURLException -> 0x0147, IOException -> 0x005d }
            return r0
        L_0x0043:
            ...
            r21 = r1
            r23 = r0
            r21.<init>((int) r22, (byte[]) r23, (boolean) r24, (long) r25, (java.util.List<com.android.volley.Header>) r27)     // Catch:{ SocketTimeoutException -> 0x0163, MalformedURLException -> 0x0147, IOException -> 0x005d }
            return r1
        L_0x005d:
            r0 = move-exception
            r15 = r2
        ...
        L_0x0074:
            ...
            r15 = r20
            r19 = r1
            r13.<init>((int) r14, (byte[]) r15, (boolean) r16, (long) r17, (java.util.List<com.android.volley.Header>) r19)     // Catch:{ SocketTimeoutException -> 0x0163, MalformedURLException -> 0x0147, IOException -> 0x00a9 }
            return r0
        L_0x00a2:
            r1 = r13
        ...
        L_0x00bf:
            ...
            com.android.volley.VolleyLog.m24e(r2, r1)
    ...
    private void logSlowRequests(long j, Request<?> request, byte[] bArr, int i) {
        if (DEBUG || j > 3000) {
            ...
            VolleyLog.m23d("HTTP response for request=<%s> [lifetime=%d], [size=%s], [rc=%d], [retryCount=%s]", objArr);
        }
    }
    ...
    public void logError(String str, String str2, long j) {
        VolleyLog.m26v("HTTP ERROR(%s) %d ms to fetch %s", str, Long.valueOf(SystemClock.elapsedRealtime() - j), str2);
    }
            ...
            try {
                ...
                if (inputStream != null) {
                    try {
                        ...
                        VolleyLog.m26v("Error occurred when closing InputStream", new Object[0]);
                    }
                }
