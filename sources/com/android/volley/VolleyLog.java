...
public class VolleyLog {
    ...
    public static void setTag(String str) {
        m23d("Changing log tag to %s", str);
        TAG = str;
    ...
    /* renamed from: e */
    public static void m24e(String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m25e(Throwable th, String str, Object... objArr) {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String str) {
            ...
            if (totalDuration > 0) {
                ...
                VolleyLog.m23d("(%-4d ms) %s", Long.valueOf(totalDuration), str);
                for (Marker next : this.mMarkers) {
                    long j2 = next.time;
                    VolleyLog.m23d("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(next.thread), next.name);
                    j = j2;
                }
            }
        }
        ...
        public void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m24e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
