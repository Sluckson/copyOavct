...
public class LocalPayment {
        ...
        if (localPaymentRequest == null) {
            ...
            braintreeFragment.waitForConfiguration(new ConfigurationListener() {
                public void onConfigurationFetched(Configuration configuration) {
                    ...
                    braintreeFragment.getHttpClient().post("/v1/paypal_hermes/create_payment_resource", localPaymentRequest.build(braintreeFragment.getReturnUrlScheme() + "://" + LocalPayment.LOCAL_PAYMENT_SUCCESSS, braintreeFragment.getReturnUrlScheme() + "://" + LocalPayment.LOCAL_PAYMENT_CANCEL), new HttpResponseCallback() {
    ...
    static void onActivityResult(final BraintreeFragment braintreeFragment, int i, Intent intent) {
        ...
        try {
            ...
            jSONObject.put(MetadataBuilder.META_KEY, new JSONObject().put(FirebaseAnalytics.Param.SOURCE, "client").put("integration", braintreeFragment.getIntegrationType()).put("sessionId", braintreeFragment.getSessionId()));
