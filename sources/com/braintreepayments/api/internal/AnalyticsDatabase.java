...
public class AnalyticsDatabase extends SQLiteOpenHelper {
        ...
        queueTask(new DatabaseTask(new Runnable() {
            ...
            public void run() {
                ...
                L_0x0025:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.braintreepayments.api.internal.AnalyticsDatabase.C09701.run():void");
            }
        }));
    }

    public void removeEvents(List<AnalyticsEvent> list) {
        final StringBuilder sb = new StringBuilder(f91ID);
        sb.append(" in (");
        final String[] strArr = new String[list.size()];
        for (int i = 0; i < list.size(); i++) {
            strArr[i] = Integer.toString(list.get(i).f92id);
            sb.append("?");
            if (i < list.size() - 1) {
                sb.append(",");
            } else {
    ...
    public java.util.List<java.util.List<com.braintreepayments.api.internal.AnalyticsEvent>> getPendingRequests() {
        ...
        L_0x004e:
            ...
            r10.f92id = r11     // Catch:{ JSONException -> 0x0084 }
