...
public class PostalAddressParser {
    ...
    public static PostalAddress fromJson(JSONObject jSONObject) {
        ...
        String optString3 = Json.optString(jSONObject, COUNTRY_CODE_ALPHA_2_KEY, (String) null);
        if (optString == null) {
        ...
        if (optString != null || Json.optString(jSONObject, "name", (String) null) == null) {
            return new PostalAddress().recipientName(Json.optString(jSONObject, RECIPIENT_NAME_KEY, (String) null)).streetAddress(optString).extendedAddress(optString2).locality(Json.optString(jSONObject, LOCALITY_KEY, (String) null)).region(Json.optString(jSONObject, "state", (String) null)).postalCode(Json.optString(jSONObject, "postalCode", (String) null)).countryCodeAlpha2(optString3);
        }
