...
public class DataCollector {
    ...
    public static void startDeviceCollector(final BraintreeFragment braintreeFragment, final String str, final String str2, @Nullable final BraintreeResponseListener<String> braintreeResponseListener) throws ClassNotFoundException, NumberFormatException {
    ...
    static void collectRiskData(final BraintreeFragment braintreeFragment, @NonNull final PaymentMethodNonce paymentMethodNonce) {
        braintreeFragment.waitForConfiguration(new ConfigurationListener() {
            public void onConfigurationFetched(Configuration configuration) {
                String customerId;
