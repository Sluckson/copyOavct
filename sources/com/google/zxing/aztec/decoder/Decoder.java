...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "0", IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, ExifInterface.GPS_MEASUREMENT_2D, ExifInterface.GPS_MEASUREMENT_3D, "4", "5", "6", "7", "8", "9", ",", ".", "CTRL_UL", "CTRL_US"};
    private static final String[] LOWER_TABLE = {"CTRL_PS", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, HtmlTags.ANCHOR, HtmlTags.f603B, "c", "d", "e", "f", "g", "h", HtmlTags.f606I, "j", "k", "l", "m", "n", "o", "p", "q", "r", HtmlTags.f607S, "t", HtmlTags.f608U, "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    ...
    static /* synthetic */ class C26881 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C26881.<clinit>():void");
        }
    }

    private static String getCharacter(Table table, int i) {
        int i2 = C26881.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
