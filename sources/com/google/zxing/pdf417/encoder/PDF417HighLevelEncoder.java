...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_MIXED_RAW = {ByteBuffer.ZERO, 49, 50, 51, 52, 53, 54, 55, 56, 57, 38, 13, 9, 44, 58, 35, 45, 46, 36, DocWriter.FORWARD, 43, 37, 42, DocWriter.EQUALS, 94, 0, 32, 0, 0, 0};
    private static final byte[] TEXT_PUNCTUATION_RAW = {59, DocWriter.f570LT, DocWriter.f569GT, SignedBytes.MAX_POWER_OF_TWO, 91, 92, 93, 95, 96, 126, AMFData.DATA_TYPE_BYTEARRAY, 13, 9, 44, 58, 10, 45, 46, 36, DocWriter.FORWARD, 34, 124, 42, 40, 41, 63, 123, 125, 39, 0};
