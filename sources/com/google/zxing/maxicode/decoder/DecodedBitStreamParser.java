...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f454FS = '\u001c';

    /* renamed from: GS */
    private static final char f455GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f456NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f457RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f455GS + format + f455GS + format2 + f455GS);
            } else {
                sb.insert(0, str + f455GS + format + f455GS + format2 + f455GS);
            }
        } else if (i == 4) {
    ...
    private static int getServiceClass(byte[] bArr) {
        return getInt(bArr, new byte[]{55, 56, 57, 58, 59, DocWriter.f570LT, 49, 50, 51, 52});
    }

    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f275US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{AMFData.DATA_TYPE_BYTEARRAY, 34, 35, 36, Ascii.f264EM, Ascii.SUB, Ascii.ESC, Ascii.f266FS, Ascii.f267GS, Ascii.f271RS, 19, 20, Ascii.NAK, 22, Ascii.ETB, Ascii.CAN, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f275US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{AMFData.DATA_TYPE_BYTEARRAY, 34, 35, 36, Ascii.f264EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f266FS, Ascii.f267GS, Ascii.f271RS, 19, 20})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, 22, Ascii.ETB, Ascii.CAN, 13, 14})), SETS[0].charAt(getInt(bArr, new byte[]{15, 16, 17, 18, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
