...
public class SymbolInfo {
    ...
    static {
        SymbolInfo[] symbolInfoArr = {new SymbolInfo(false, 3, 5, 8, 8, 1), new SymbolInfo(false, 5, 7, 10, 10, 1), new SymbolInfo(true, 5, 7, 16, 6, 1), new SymbolInfo(false, 8, 10, 12, 12, 1), new SymbolInfo(true, 10, 11, 14, 6, 2), new SymbolInfo(false, 12, 12, 14, 14, 1), new SymbolInfo(true, 16, 14, 24, 10, 1), new SymbolInfo(false, 18, 14, 16, 16, 1), new SymbolInfo(false, 22, 18, 18, 18, 1), new SymbolInfo(true, 22, 18, 16, 10, 2), new SymbolInfo(false, 30, 20, 20, 20, 1), new SymbolInfo(true, 32, 24, 16, 14, 2), new SymbolInfo(false, 36, 24, 22, 22, 1), new SymbolInfo(false, 44, 28, 24, 24, 1), new SymbolInfo(true, 49, 28, 22, 14, 2), new SymbolInfo(false, 62, 36, 14, 14, 4), new SymbolInfo(false, 86, 42, 16, 16, 4), new SymbolInfo(false, 114, 48, 18, 18, 4), new SymbolInfo(false, CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA, 56, 20, 20, 4), new SymbolInfo(false, 174, 68, 22, 22, 4), new SymbolInfo(false, HttpStatus.SC_NO_CONTENT, 84, 24, 24, 4, 102, 42), new SymbolInfo(false, TIFFConstants.TIFFTAG_MINSAMPLEVALUE, 112, 14, 14, 16, CipherSuite.TLS_PSK_WITH_AES_128_CBC_SHA, 56), new SymbolInfo(false, 368, CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA, 16, 16, 16, 92, 36), new SymbolInfo(false, 456, PsExtractor.AUDIO_STREAM, 18, 18, 16, 114, 48), new SymbolInfo(false, 576, 224, 20, 20, 16, CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA, 56), new SymbolInfo(false, 696, TIFFConstants.TIFFTAG_MODEL, 22, 22, 16, 174, 68), new SymbolInfo(false, 816, TIFFConstants.TIFFTAG_DOTRANGE, 24, 24, 16, 136, 56), new SymbolInfo(false, 1050, HttpStatus.SC_REQUEST_TIMEOUT, 18, 18, 36, 175, 68), new SymbolInfo(false, 1304, MetaDo.META_DELETEOBJECT, 20, 20, 36, 163, 62), new DataMatrixSymbolInfo144()};
