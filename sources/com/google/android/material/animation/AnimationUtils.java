...
public class AnimationUtils {
    ...
    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f3, @FloatRange(from = 0.0d, mo651to = 1.0d) float f4, @FloatRange(from = 0.0d, mo651to = 1.0d) float f5) {
        if (f5 < f3) {
            return f;
        }
