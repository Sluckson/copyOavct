...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    @StyleRes
    private static final int DEFAULT_STYLE = C1308R.C1314style.Widget_MaterialComponents_Badge;
    @AttrRes
    private static final int DEFAULT_THEME_ATTR = C1308R.attr.badgeStyle;
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(@NonNull Context context) {
            this.badgeTextColor = new TextAppearance(context, C1308R.C1314style.TextAppearance_MaterialComponents_Badge).textColor.getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C1308R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C1308R.plurals.mtrl_badge_content_description;
            this.contentDescriptionExceedsMaxBadgeNumberRes = C1308R.string.mtrl_exceed_max_badge_number_content_description;
            this.isVisible = true;
        }
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1308R.styleable.Badge, i, i2, new int[0]);
        setMaxCharacterCount(obtainStyledAttributes.getInt(C1308R.styleable.Badge_maxCharacterCount, 4));
        if (obtainStyledAttributes.hasValue(C1308R.styleable.Badge_number)) {
            setNumber(obtainStyledAttributes.getInt(C1308R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, obtainStyledAttributes, C1308R.styleable.Badge_backgroundColor));
        if (obtainStyledAttributes.hasValue(C1308R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, obtainStyledAttributes, C1308R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(obtainStyledAttributes.getInt(C1308R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffset(obtainStyledAttributes.getDimensionPixelOffset(C1308R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffset(obtainStyledAttributes.getDimensionPixelOffset(C1308R.styleable.Badge_verticalOffset, 0));
    ...
    private BadgeDrawable(@NonNull Context context) {
        ...
        this.badgeRadius = (float) resources.getDimensionPixelSize(C1308R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = (float) resources.getDimensionPixelSize(C1308R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = (float) resources.getDimensionPixelSize(C1308R.dimen.mtrl_badge_with_text_radius);
        ...
        setTextAppearanceResource(C1308R.C1314style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != C1308R.C1311id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != viewGroup) {
                updateAnchorParentToNotClip(view);
                final FrameLayout frameLayout = new FrameLayout(view.getContext());
                frameLayout.setId(C1308R.C1311id.mtrl_anchor_parent);
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? C1308R.dimen.mtrl_badge_text_horizontal_edge_offset : C1308R.dimen.mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        return context.getString(C1308R.string.mtrl_exceed_max_badge_number_suffix, new Object[]{Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX});
    }
