        ...
        toolbar.post(new Runnable() {
            public void run() {
                ...
                if (actionMenuItemView != null) {
                    ...
                    badgeDrawable.setHorizontalOffset(badgeDrawable.getHorizontalOffset() + toolbar.getResources().getDimensionPixelOffset(C1308R.dimen.mtrl_badge_toolbar_action_menu_item_horizontal_offset));
                    BadgeDrawable badgeDrawable2 = badgeDrawable;
                    badgeDrawable2.setVerticalOffset(badgeDrawable2.getVerticalOffset() + toolbar.getResources().getDimensionPixelOffset(C1308R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset));
