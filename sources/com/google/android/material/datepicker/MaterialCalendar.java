...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i2 = C1308R.C1313layout.mtrl_calendar_vertical;
            i = 1;
        } else {
            i2 = C1308R.C1313layout.mtrl_calendar_horizontal;
            i = 0;
        }
        View inflate = cloneInContext.inflate(i2, viewGroup, false);
        GridView gridView = (GridView) inflate.findViewById(C1308R.C1311id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) inflate.findViewById(C1308R.C1311id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C1308R.integer.mtrl_calendar_year_selector_span);
        this.yearSelector = (RecyclerView) inflate.findViewById(C1308R.C1311id.mtrl_calendar_year_selector_frame);
        ...
        if (inflate.findViewById(C1308R.C1311id.month_navigation_fragment_toggle) != null) {
    ...
    static int getDayHeight(@NonNull Context context) {
        return context.getResources().getDimensionPixelSize(C1308R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C1308R.C1311id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    str = MaterialCalendar.this.getString(C1308R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    str = MaterialCalendar.this.getString(C1308R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(str);
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C1308R.C1311id.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C1308R.C1311id.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C1308R.C1311id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C1308R.C1311id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
