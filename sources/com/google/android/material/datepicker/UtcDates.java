...
class UtcDates {
    ...
    static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll("d", resources.getString(C1308R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(C1308R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(C1308R.string.mtrl_picker_text_input_year_abbr));
    }
