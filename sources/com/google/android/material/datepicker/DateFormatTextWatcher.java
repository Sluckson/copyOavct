...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(final String str, DateFormat dateFormat2, @NonNull TextInputLayout textInputLayout2, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout2.getContext().getString(C1308R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() {
            public void run() {
                ...
                String string = context.getString(C1308R.string.mtrl_picker_invalid_format);
                String format = String.format(context.getString(C1308R.string.mtrl_picker_invalid_format_use), new Object[]{str});
                String format2 = String.format(context.getString(C1308R.string.mtrl_picker_invalid_format_example), new Object[]{access$100.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))});
