...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull OnSelectionChangedListener<Long> onSelectionChangedListener) {
        View inflate = layoutInflater.inflate(C1308R.C1313layout.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C1308R.C1311id.mtrl_picker_text_input_date);
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C1308R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C1308R.string.mtrl_picker_date_header_unselected);
        }
        String yearMonthDay = DateStrings.getYearMonthDay(l.longValue());
        return resources.getString(C1308R.string.mtrl_picker_date_header_selected, new Object[]{yearMonthDay});
    }

    public int getDefaultTitleResId() {
        return C1308R.string.mtrl_picker_date_header_title;
    }
