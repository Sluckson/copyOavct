...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1308R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        this.background = new MaterialShapeDrawable(context, (AttributeSet) null, C1308R.attr.materialCalendarStyle, C1308R.C1314style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C1308R.C1313layout.mtrl_picker_fullscreen : C1308R.C1313layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C1308R.C1311id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C1308R.C1311id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C1308R.C1311id.mtrl_calendar_frame);
        ...
        this.headerSelectionText = (TextView) inflate.findViewById(C1308R.C1311id.mtrl_picker_header_selection_text);
        ViewCompat.setAccessibilityLiveRegion(this.headerSelectionText, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C1308R.C1311id.mtrl_picker_header_toggle);
        TextView textView = (TextView) inflate.findViewById(C1308R.C1311id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C1308R.C1311id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C1308R.C1311id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1308R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C1308R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C1308R.C1311id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(@NonNull CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            str = checkableImageButton.getContext().getString(C1308R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            str = checkableImageButton.getContext().getString(C1308R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C1308R.C1310drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C1308R.C1310drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(@NonNull Context context) {
        return readMaterialCalendarStyleBoolean(context, C1308R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1308R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    private static int getDialogPickerHeight(@NonNull Context context) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C1308R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C1308R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C1308R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C1308R.dimen.mtrl_calendar_days_of_week_height);
        return dimensionPixelSize + dimensionPixelSize2 + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C1308R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C1308R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C1308R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1308R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C1308R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1308R.dimen.mtrl_calendar_month_horizontal_padding));
    }
