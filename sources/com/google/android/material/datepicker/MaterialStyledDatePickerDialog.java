...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    @StyleRes
    private static final int DEF_STYLE_RES = C1308R.C1314style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    @NonNull
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i2, int i3, int i4) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(getContext(), C1308R.attr.colorSurface, getClass().getCanonicalName());
