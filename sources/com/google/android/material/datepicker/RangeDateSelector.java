...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(@NonNull Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(C1308R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis) ? C1308R.attr.materialCalendarTheme : C1308R.attr.materialCalendarFullscreenTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        Resources resources = context.getResources();
        if (this.selectedStartItem == null && this.selectedEndItem == null) {
            return resources.getString(C1308R.string.mtrl_picker_range_header_unselected);
        }
        Long l = this.selectedEndItem;
        if (l == null) {
            return resources.getString(C1308R.string.mtrl_picker_range_header_only_start_selected, new Object[]{DateStrings.getDateString(this.selectedStartItem.longValue())});
        }
        Long l2 = this.selectedStartItem;
        if (l2 == null) {
            return resources.getString(C1308R.string.mtrl_picker_range_header_only_end_selected, new Object[]{DateStrings.getDateString(this.selectedEndItem.longValue())});
        }
        Pair<String, String> dateRangeString = DateStrings.getDateRangeString(l2, l);
        return resources.getString(C1308R.string.mtrl_picker_range_header_selected, new Object[]{dateRangeString.first, dateRangeString.second});
    }

    public int getDefaultTitleResId() {
        return C1308R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        View inflate = layoutInflater.inflate(C1308R.C1313layout.mtrl_picker_text_input_date_range, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C1308R.C1311id.mtrl_picker_text_input_range_start);
        TextInputLayout textInputLayout2 = (TextInputLayout) inflate.findViewById(C1308R.C1311id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = inflate.getResources().getString(C1308R.string.mtrl_picker_invalid_range);
        ...
        C13941 r0 = new DateFormatTextWatcher(textInputHint, simpleDateFormat, textInputLayout, calendarConstraints2) {
