...
class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1308R.animator.design_fab_show_motion_spec);
        }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1308R.animator.design_fab_hide_motion_spec);
        }
