...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C1308R.C1309color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C1308R.C1309color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C1308R.C1309color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C1308R.C1309color.design_fab_stroke_end_outer_color));
