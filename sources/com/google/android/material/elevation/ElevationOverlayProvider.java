...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(@NonNull Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C1308R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C1308R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C1308R.attr.colorSurface, 0);
