...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f203x = f;
        float unused2 = pathLineOperation.f204y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f204y - this.startY), (double) (this.operation.f203x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f204y - this.startY) / (this.operation.f203x - this.startX))));
        }
    }
