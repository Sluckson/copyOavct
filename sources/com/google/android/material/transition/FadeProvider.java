...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(final View view, float f, float f2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f3, @FloatRange(from = 0.0d, mo651to = 1.0d) float f4, final float f5) {
