...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public View onCreateSnapshotView(@NonNull Context context, @Nullable Parcelable parcelable) {
        ...
        if (!(onCreateSnapshotView == null || (weakReference = capturedSharedElement) == null || this.shapeProvider == null || (view = (View) weakReference.get()) == null || (provideShape = this.shapeProvider.provideShape(view)) == null)) {
            onCreateSnapshotView.setTag(C1308R.C1311id.mtrl_motion_snapshot_view, provideShape);
        }
    ...
    public void onSharedElementStart(@NonNull List<String> list, @NonNull List<View> list2, @NonNull List<View> list3) {
        if (!list2.isEmpty() && !list3.isEmpty()) {
            list2.get(0).setTag(C1308R.C1311id.mtrl_motion_snapshot_view, list3.get(0));
        }
    ...
    public void onSharedElementEnd(@NonNull List<String> list, @NonNull List<View> list2, @NonNull List<View> list3) {
        if (!list2.isEmpty() && (list2.get(0).getTag(C1308R.C1311id.mtrl_motion_snapshot_view) instanceof View)) {
            list2.get(0).setTag(C1308R.C1311id.mtrl_motion_snapshot_view, (Object) null);
        }
