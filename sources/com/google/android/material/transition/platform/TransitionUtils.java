...
class TransitionUtils {
    ...
    static float lerp(float f, float f2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f3, @FloatRange(from = 0.0d, mo651to = 1.0d) float f4, @FloatRange(from = 0.0d, mo651to = 1.0d) float f5) {
        return lerp(f, f2, f3, f4, f5, false);
    }

    static float lerp(float f, float f2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f3, @FloatRange(from = 0.0d, mo651to = 1.0d) float f4, @FloatRange(from = 0.0d) float f5, boolean z) {
    ...
    static int lerp(int i, int i2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f, @FloatRange(from = 0.0d, mo651to = 1.0d) float f2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f3) {
        if (f3 < f) {
            return i;
        }
    ...
    static ShapeAppearanceModel lerp(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, RectF rectF, RectF rectF2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f, @FloatRange(from = 0.0d, mo651to = 1.0d) float f2, @FloatRange(from = 0.0d, mo651to = 1.0d) float f3) {
        if (f3 < f) {
