...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    public void setSlideDistance(@C0049Px int i) {
        if (i >= 0) {
    ...
    private int getSlideDistanceOrDefault(Context context) {
        ...
        return context.getResources().getDimensionPixelSize(C1308R.dimen.mtrl_transition_shared_axis_slide_distance);
    }

    private static Animator createTranslationAppearAnimator(View view, View view2, int i, @C0049Px int i2) {
    ...
    private static Animator createTranslationDisappearAnimator(View view, View view2, int i, @C0049Px int i2) {
        float translationX = view2.getTranslationX();
        float translationY = view2.getTranslationY();
        if (i == 3) {
