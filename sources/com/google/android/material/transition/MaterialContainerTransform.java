...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        } else if (transitionValues.view.getTag(C1308R.C1311id.mtrl_motion_snapshot_view) instanceof View) {
            transitionValues.view.setTag(C1308R.C1311id.mtrl_motion_snapshot_view, (Object) null);
            transitionValues.view = (View) transitionValues.view.getTag(C1308R.C1311id.mtrl_motion_snapshot_view);
        }
    ...
    private static ShapeAppearanceModel getShapeAppearance(@NonNull View view, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view.getTag(C1308R.C1311id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C1308R.C1311id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(new int[]{C1308R.attr.transitionShapeAppearance});
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, mo651to = 1.0d) float f, @FloatRange(from = 0.0d, mo651to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
