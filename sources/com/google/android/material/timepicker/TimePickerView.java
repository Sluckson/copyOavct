...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C1308R.C1311id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C1308R.C1313layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C1308R.C1311id.material_clock_face);
        this.toggle = (MaterialButtonToggleGroup) findViewById(C1308R.C1311id.material_clock_period_toggle);
        this.toggle.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
                int i2 = i == C1308R.C1311id.material_clock_period_pm_button ? 1 : 0;
                if (TimePickerView.this.onPeriodChangeListener != null && z) {
                    TimePickerView.this.onPeriodChangeListener.onPeriodChange(i2);
                }
            }
        });
        this.minuteView = (Chip) findViewById(C1308R.C1311id.material_minute_tv);
        this.hourView = (Chip) findViewById(C1308R.C1311id.material_hour_tv);
    ...
    private void setupDoubleTap() {
        ...
        C15534 r1 = new View.OnTouchListener() {
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C1308R.C1311id.selection_type, 12);
        this.hourView.setTag(C1308R.C1311id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C1308R.C1311id.material_clock_period_pm_button : C1308R.C1311id.material_clock_period_am_button);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C1308R.C1311id.material_clock_display, i);
