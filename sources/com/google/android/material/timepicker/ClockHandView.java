...
class ClockHandView extends View {
    ...
    public interface OnActionUpListener {
        void onActionUp(@FloatRange(from = 0.0d, mo651to = 360.0d) float f, boolean z);
    }

    public interface OnRotateListener {
        void onRotate(@FloatRange(from = 0.0d, mo651to = 360.0d) float f, boolean z);
    }
    ...
    public ClockHandView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1308R.styleable.ClockHandView, i, C1308R.C1314style.Widget_MaterialComponents_TimePicker_Clock);
        this.circleRadius = obtainStyledAttributes.getDimensionPixelSize(C1308R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = obtainStyledAttributes.getDimensionPixelSize(C1308R.styleable.ClockHandView_selectorSize, 0);
        Resources resources = getResources();
        this.selectorStrokeWidth = resources.getDimensionPixelSize(C1308R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = (float) resources.getDimensionPixelSize(C1308R.dimen.material_clock_hand_center_dot_radius);
        int color = obtainStyledAttributes.getColor(C1308R.styleable.ClockHandView_clockHandColor, 0);
    ...
    public void setHandRotation(@FloatRange(from = 0.0d, mo651to = 360.0d) float f, boolean z) {
    ...
    public void setHandRotationInternal(@FloatRange(from = 0.0d, mo651to = 360.0d) float f, boolean z) {
        float f2 = f % 360.0f;
        this.originalDeg = f2;
    ...
    @FloatRange(from = 0.0d, mo651to = 360.0d)
