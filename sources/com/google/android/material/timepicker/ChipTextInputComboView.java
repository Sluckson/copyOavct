...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.chip = (Chip) from.inflate(C1308R.C1313layout.material_time_chip, this, false);
        this.textInputLayout = (TextInputLayout) from.inflate(C1308R.C1313layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C1308R.C1311id.material_label);
    }
