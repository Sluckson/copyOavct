...
class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1308R.C1313layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1308R.styleable.RadialViewGroup, i, 0);
        this.radius = obtainStyledAttributes.getDimensionPixelSize(C1308R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    public void updateLayoutParams() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getId() != C1308R.C1311id.circle_center && !shouldSkipView(childAt)) {
                constraintSet.constrainCircle(childAt.getId(), C1308R.C1311id.circle_center, this.radius, f);
