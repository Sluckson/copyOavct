...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    public void setSelection(int i, boolean z) {
        ...
        timePickerView2.setValues(strArr, z2 ? C1308R.string.material_minute_suffix : C1308R.string.material_hour_suffix);
        ...
        timePickerView3.setMinuteHourDelegate(new ClickActionDelegate(timePickerView3.getContext(), C1308R.string.material_hour_selection));
        TimePickerView timePickerView4 = this.timePickerView;
        timePickerView4.setHourClickDelegate(new ClickActionDelegate(timePickerView4.getContext(), C1308R.string.material_minute_selection));
    }
