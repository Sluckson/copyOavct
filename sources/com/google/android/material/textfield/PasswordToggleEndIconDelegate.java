...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C1308R.C1310drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1308R.string.password_toggle_content_description));
