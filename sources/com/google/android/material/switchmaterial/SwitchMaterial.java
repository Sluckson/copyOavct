...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C1308R.C1314style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C1308R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1308R.styleable.SwitchMaterial, i, DEF_STYLE_RES, new int[0]);
        this.useMaterialThemeColors = obtainStyledAttributes.getBoolean(C1308R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C1308R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C1308R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C1308R.dimen.mtrl_switch_thumb_elevation);
