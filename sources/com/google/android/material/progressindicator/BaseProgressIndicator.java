...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C1308R.C1314style.Widget_MaterialComponents_ProgressIndicator;
    ...
    protected BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1308R.styleable.BaseProgressIndicator, i, i2, new int[0]);
        this.showDelay = obtainStyledAttributes.getInt(C1308R.styleable.BaseProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(obtainStyledAttributes.getInt(C1308R.styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
    ...
    public void setTrackThickness(@C0049Px int i) {
    ...
    public void setIndicatorColor(@ColorInt int... iArr) {
        if (iArr.length == 0) {
            iArr = new int[]{MaterialColors.getColor(getContext(), C1308R.attr.colorPrimary, -1)};
        }
    ...
    public void setTrackCornerRadius(@C0049Px int i) {
