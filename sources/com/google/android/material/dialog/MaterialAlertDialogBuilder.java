...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    @AttrRes
    private static final int DEF_STYLE_ATTR = C1308R.attr.alertDialogStyle;
    @StyleRes
    private static final int DEF_STYLE_RES = C1308R.C1314style.MaterialAlertDialog_MaterialComponents;
    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C1308R.attr.materialAlertDialogTheme;
    @Nullable
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C1308R.attr.colorSurface, getClass().getCanonicalName());
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetStart(@C0049Px int i) {
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetTop(@C0049Px int i) {
        this.backgroundInsets.top = i;
        return this;
    }

    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetEnd(@C0049Px int i) {
        if (Build.VERSION.SDK_INT < 17 || getContext().getResources().getConfiguration().getLayoutDirection() != 1) {
            this.backgroundInsets.right = i;
        } else {
            this.backgroundInsets.left = i;
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetBottom(@C0049Px int i) {
