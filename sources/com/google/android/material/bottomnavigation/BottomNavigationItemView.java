...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1308R.C1313layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1308R.C1310drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C1308R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1308R.C1311id.icon);
        this.labelGroup = (ViewGroup) findViewById(C1308R.C1311id.labelGroup);
        this.smallLabel = (TextView) findViewById(C1308R.C1311id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1308R.C1311id.largeLabel);
        this.labelGroup.setTag(C1308R.C1311id.mtrl_view_tag_bottom_padding, Integer.valueOf(this.labelGroup.getPaddingBottom()));
        ...
        if (i != -1) {
            if (i == 0) {
                if (z) {
                    ...
                    updateViewPaddingBottom(viewGroup, ((Integer) viewGroup.getTag(C1308R.C1311id.mtrl_view_tag_bottom_padding)).intValue());
                ...
                updateViewPaddingBottom(viewGroup2, ((Integer) viewGroup2.getTag(C1308R.C1311id.mtrl_view_tag_bottom_padding)).intValue());
                if (z) {
            ...
            if (z) {
                ...
                updateViewPaddingBottom(viewGroup3, ((Integer) viewGroup3.getTag(C1308R.C1311id.mtrl_view_tag_bottom_padding)).intValue());
                this.largeLabel.setVisibility(0);
            } else {
                setViewLayoutParams(this.icon, this.defaultMargin, 17);
                updateViewPaddingBottom(this.labelGroup, 0);
            ...
            updateViewPaddingBottom(viewGroup4, ((Integer) viewGroup4.getTag(C1308R.C1311id.mtrl_view_tag_bottom_padding)).intValue());
            if (z) {
                setViewLayoutParams(this.icon, (int) (((float) this.defaultMargin) + this.shiftAmount), 49);
                setViewScaleValues(this.largeLabel, 1.0f, 1.0f, 0);
