...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C1308R.C1313layout.design_navigation_menu_item, this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C1308R.dimen.design_navigation_icon_size));
        this.textView = (CheckedTextView) findViewById(C1308R.C1311id.design_menu_item_text);
    ...
    private void setActionView(@Nullable View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C1308R.C1311id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(@Nullable Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), C1308R.C1310drawable.navigation_empty_icon, getContext().getTheme());
