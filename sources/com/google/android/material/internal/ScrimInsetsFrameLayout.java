...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsFrameLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1308R.styleable.ScrimInsetsFrameLayout, i, C1308R.C1314style.Widget_Design_ScrimInsetsFrameLayout, new int[0]);
        this.insetForeground = obtainStyledAttributes.getDrawable(C1308R.styleable.ScrimInsetsFrameLayout_insetForeground);
