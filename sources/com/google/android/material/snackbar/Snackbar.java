...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1308R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C1308R.attr.snackbarButtonStyle, C1308R.attr.snackbarTextViewStyle};
    @Nullable
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            ...
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C1308R.C1313layout.mtrl_layout_snackbar_include : C1308R.C1313layout.design_layout_snackbar_include, findSuitableParent, false);
