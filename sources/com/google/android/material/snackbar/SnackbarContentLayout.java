...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1308R.styleable.SnackbarLayout);
        this.maxWidth = obtainStyledAttributes.getDimensionPixelSize(C1308R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C1308R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C1308R.C1311id.snackbar_text);
        this.actionView = (Button) findViewById(C1308R.C1311id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C1308R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    public void onMeasure(int r8, int r9) {
        ...
        L_0x0018:
            ...
            int r1 = com.google.android.material.C1308R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C1308R.dimen.design_snackbar_padding_vertical
