...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            this.container = (FrameLayout) View.inflate(getContext(), C1308R.C1313layout.design_bottom_sheet_dialog, (ViewGroup) null);
            this.behavior = BottomSheetBehavior.from((FrameLayout) this.container.findViewById(C1308R.C1311id.design_bottom_sheet));
    ...
    private View wrapInBottomSheet(int i, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C1308R.C1311id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout = (FrameLayout) this.container.findViewById(C1308R.C1311id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C1308R.C1311id.touch_outside).setOnClickListener(new View.OnClickListener() {
    ...
    private static int getThemeResId(@NonNull Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C1308R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C1308R.C1314style.Theme_Design_Light_BottomSheetDialog;
    }
