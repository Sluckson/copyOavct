...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C1308R.C1314style.Widget_MaterialComponents_Button;
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C1308R.attr.materialButtonStyle);
    }
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1308R.styleable.MaterialButton, i, DEF_STYLE_RES, new int[0]);
        this.iconPadding = obtainStyledAttributes.getDimensionPixelSize(C1308R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C1308R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), obtainStyledAttributes, C1308R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), obtainStyledAttributes, C1308R.styleable.MaterialButton_icon);
        this.iconGravity = obtainStyledAttributes.getInteger(C1308R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = obtainStyledAttributes.getDimensionPixelSize(C1308R.styleable.MaterialButton_iconSize, 0);
    ...
    public void setIconPadding(@C0049Px int i) {
    ...
    public void setIconSize(@C0049Px int i) {
        if (i < 0) {
    ...
    public void setStrokeWidth(@C0049Px int i) {
        if (isUsingOriginalBackground()) {
    ...
    public void setCornerRadius(@C0049Px int i) {
        if (isUsingOriginalBackground()) {
