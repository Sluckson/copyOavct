...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C1308R.C1314style.Widget_MaterialComponents_CardView;
    private static final int[] DRAGGED_STATE_SET = {C1308R.attr.state_dragged};
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1308R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C1308R.styleable.MaterialCardView, i, DEF_STYLE_RES, new int[0]);
