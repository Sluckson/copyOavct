...
public final class PointOfInterest extends AbstractSafeParcelable {
    ...
    public PointOfInterest(@SafeParcelable.Param(mo18233id = 2) LatLng latLng2, @SafeParcelable.Param(mo18233id = 3) String str, @SafeParcelable.Param(mo18233id = 4) String str2) {
        this.latLng = latLng2;
        this.placeId = str;
        this.name = str2;
    }
