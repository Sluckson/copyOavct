...
public class PatternItem extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLength", mo18230id = 3)
    @Nullable
    private final Float zzdv;

    @SafeParcelable.Constructor
    public PatternItem(@SafeParcelable.Param(mo18233id = 2) int i, @SafeParcelable.Param(mo18233id = 3) @Nullable Float f) {
        boolean z = true;
