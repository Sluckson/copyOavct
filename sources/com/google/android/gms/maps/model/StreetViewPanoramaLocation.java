...
public class StreetViewPanoramaLocation extends AbstractSafeParcelable {
    ...
    public StreetViewPanoramaLocation(@SafeParcelable.Param(mo18233id = 2) StreetViewPanoramaLink[] streetViewPanoramaLinkArr, @SafeParcelable.Param(mo18233id = 3) LatLng latLng, @SafeParcelable.Param(mo18233id = 4) String str) {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("panoId", this.panoId).add(Constants_MVVM.EXTRA_ITEM_POSITION, this.position.toString()).toString();
    }
}
