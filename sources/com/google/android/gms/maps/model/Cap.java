...
public class Cap extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWrappedBitmapDescriptorImplBinder", mo18230id = 3, type = "android.os.IBinder")
    @Nullable
    private final BitmapDescriptor bitmapDescriptor;
    @SafeParcelable.Field(getter = "getType", mo18230id = 2)
    private final int type;
    @SafeParcelable.Field(getter = "getBitmapRefWidth", mo18230id = 4)
    @Nullable
    ...
    Cap(@com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo18233id = 2) int r2, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo18233id = 3) @androidx.annotation.Nullable android.os.IBinder r3, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo18233id = 4) @androidx.annotation.Nullable java.lang.Float r4) {
        /*
            r1 = this;
