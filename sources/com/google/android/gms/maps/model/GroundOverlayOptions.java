...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBearing", mo18230id = 7)
    private float bearing;
    @SafeParcelable.Field(getter = "getHeight", mo18230id = 5)
    private float height;
    @SafeParcelable.Field(getter = "getWidth", mo18230id = 4)
    private float width;
    @SafeParcelable.Field(getter = "getZIndex", mo18230id = 8)
    private float zzcs;
    @SafeParcelable.Field(getter = "isVisible", mo18230id = 9)
    private boolean zzct = true;
    @SafeParcelable.Field(getter = "isClickable", mo18230id = 13)
    private boolean zzcu = false;
    @SafeParcelable.Field(getter = "getWrappedImageDescriptorImplBinder", mo18230id = 2, type = "android.os.IBinder")
    @NonNull
    private BitmapDescriptor zzcx;
    @SafeParcelable.Field(getter = "getLocation", mo18230id = 3)
    private LatLng zzcy;
    @SafeParcelable.Field(getter = "getBounds", mo18230id = 6)
    private LatLngBounds zzcz;
    @SafeParcelable.Field(getter = "getTransparency", mo18230id = 10)
    private float zzda = 0.0f;
    @SafeParcelable.Field(getter = "getAnchorU", mo18230id = 11)
    private float zzdb = 0.5f;
    @SafeParcelable.Field(getter = "getAnchorV", mo18230id = 12)
    private float zzdc = 0.5f;

    @SafeParcelable.Constructor
    GroundOverlayOptions(@SafeParcelable.Param(mo18233id = 2) IBinder iBinder, @SafeParcelable.Param(mo18233id = 3) LatLng latLng, @SafeParcelable.Param(mo18233id = 4) float f, @SafeParcelable.Param(mo18233id = 5) float f2, @SafeParcelable.Param(mo18233id = 6) LatLngBounds latLngBounds, @SafeParcelable.Param(mo18233id = 7) float f3, @SafeParcelable.Param(mo18233id = 8) float f4, @SafeParcelable.Param(mo18233id = 9) boolean z, @SafeParcelable.Param(mo18233id = 10) float f5, @SafeParcelable.Param(mo18233id = 11) float f6, @SafeParcelable.Param(mo18233id = 12) float f7, @SafeParcelable.Param(mo18233id = 13) boolean z2) {
