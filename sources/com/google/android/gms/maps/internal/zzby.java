...
public final class zzby {
    public static void zza(@Nullable Bundle bundle, @Nullable Bundle bundle2) {
        if (bundle != null && bundle2 != null) {
            ...
            if (bundle.containsKey(Constants_MVVM.EXTRA_ITEM_POSITION)) {
                bundle2.putString(Constants_MVVM.EXTRA_ITEM_POSITION, bundle.getString(Constants_MVVM.EXTRA_ITEM_POSITION));
            }
