...
public class GcmNetworkManager {
    ...
    public synchronized void schedule(Task task) {
        ...
        zzp zzp = new zzp(valueOf.length() != 0 ? "nts:client:schedule:".concat(valueOf) : new String("nts:client:schedule:"));
        try {
    ...
    public void cancelTask(String str, Class<? extends GcmTaskService> cls) {
        ...
        zzp zzp = new zzp(valueOf.length() != 0 ? "nts:client:cancel:".concat(valueOf) : new String("nts:client:cancel:"));
        try {
            zzd(str);
