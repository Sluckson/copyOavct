...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo18230id = 2)
    private final ConnectionResult zadi;
    @SafeParcelable.VersionField(mo18236id = 1)
    private final int zalf;
    @SafeParcelable.Field(getter = "getResolveAccountResponse", mo18230id = 3)
    private final ResolveAccountResponse zase;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(mo18233id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
