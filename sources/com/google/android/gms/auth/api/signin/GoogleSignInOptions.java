...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo18230id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo18230id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo18230id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo18230id = 9)
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getScopes", mo18230id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo18230id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo18230id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo18230id = 5)
    ...
    GoogleSignInOptions(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(mo18233id = 3) Account account, @SafeParcelable.Param(mo18233id = 4) boolean z, @SafeParcelable.Param(mo18233id = 5) boolean z2, @SafeParcelable.Param(mo18233id = 6) boolean z3, @SafeParcelable.Param(mo18233id = 7) String str, @SafeParcelable.Param(mo18233id = 8) String str2, @SafeParcelable.Param(mo18233id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
