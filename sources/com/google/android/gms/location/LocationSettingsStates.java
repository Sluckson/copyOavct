...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "isGpsUsable", mo18230id = 1)
    private final boolean zzbn;
    @SafeParcelable.Field(getter = "isNetworkLocationUsable", mo18230id = 2)
    private final boolean zzbo;
    @SafeParcelable.Field(getter = "isBleUsable", mo18230id = 3)
    private final boolean zzbp;
    @SafeParcelable.Field(getter = "isGpsPresent", mo18230id = 4)
    private final boolean zzbq;
    @SafeParcelable.Field(getter = "isNetworkLocationPresent", mo18230id = 5)
    private final boolean zzbr;
    @SafeParcelable.Field(getter = "isBlePresent", mo18230id = 6)
    private final boolean zzbs;

    @SafeParcelable.Constructor
    public LocationSettingsStates(@SafeParcelable.Param(mo18233id = 1) boolean z, @SafeParcelable.Param(mo18233id = 2) boolean z2, @SafeParcelable.Param(mo18233id = 3) boolean z3, @SafeParcelable.Param(mo18233id = 4) boolean z4, @SafeParcelable.Param(mo18233id = 5) boolean z5, @SafeParcelable.Param(mo18233id = 6) boolean z6) {
        this.zzbn = z;
        this.zzbo = z2;
        this.zzbp = z3;
        this.zzbq = z4;
