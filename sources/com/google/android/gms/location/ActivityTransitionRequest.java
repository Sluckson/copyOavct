...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo18230id = 2)
    @Nullable
    private final String tag;
    @SafeParcelable.Field(getter = "getActivityTransitions", mo18230id = 1)
    private final List<ActivityTransition> zzl;
    @SafeParcelable.Field(getter = "getClients", mo18230id = 3)
    ...
    public ActivityTransitionRequest(@SafeParcelable.Param(mo18233id = 1) List<ActivityTransition> list, @SafeParcelable.Param(mo18233id = 2) @Nullable String str, @SafeParcelable.Param(mo18233id = 3) @Nullable List<ClientIdentity> list2) {
