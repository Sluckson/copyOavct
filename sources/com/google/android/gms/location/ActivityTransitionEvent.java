...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getActivityType", mo18230id = 1)
    private final int zzi;
    @SafeParcelable.Field(getter = "getTransitionType", mo18230id = 2)
    private final int zzj;
    @SafeParcelable.Field(getter = "getElapsedRealTimeNanos", mo18230id = 3)
    private final long zzk;

    @SafeParcelable.Constructor
    public ActivityTransitionEvent(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) int i2, @SafeParcelable.Param(mo18233id = 3) long j) {
