...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getStatus", mo18230id = 1)
    private final Status zzbl;
    @SafeParcelable.Field(getter = "getLocationSettingsStates", mo18230id = 2)
    ...
    public LocationSettingsResult(@SafeParcelable.Param(mo18233id = 1) Status status, @SafeParcelable.Param(mo18233id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
