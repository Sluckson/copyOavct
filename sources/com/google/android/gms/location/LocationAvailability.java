...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo18230id = 1)
    @Deprecated
    private int zzar;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo18230id = 2)
    @Deprecated
    private int zzas;
    @SafeParcelable.Field(defaultValueUnchecked = "0", mo18230id = 3)
    private long zzat;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo18230id = 4)
    private int zzau;
    @SafeParcelable.Field(mo18230id = 5)
    private zzaj[] zzav;

    @SafeParcelable.Constructor
    LocationAvailability(@SafeParcelable.Param(mo18233id = 4) int i, @SafeParcelable.Param(mo18233id = 1) int i2, @SafeParcelable.Param(mo18233id = 2) int i3, @SafeParcelable.Param(mo18233id = 3) long j, @SafeParcelable.Param(mo18233id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
