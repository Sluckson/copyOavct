...
public final class zzal extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", getter = "getTag", mo18230id = 3)
    private final String tag;
    @SafeParcelable.Field(getter = "getGeofenceIds", mo18230id = 1)
    private final List<String> zzbu;
    @SafeParcelable.Field(getter = "getPendingIntent", mo18230id = 2)
    private final PendingIntent zzbv;

    @SafeParcelable.Constructor
    zzal(@SafeParcelable.Param(mo18233id = 1) @Nullable List<String> list, @SafeParcelable.Param(mo18233id = 2) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(mo18233id = 3) String str) {
