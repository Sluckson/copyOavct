...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getParcelableGeofences", mo18230id = 1)
    private final List<zzbh> zzap;
    @SafeParcelable.Field(getter = "getInitialTrigger", mo18230id = 2)
    ...
    GeofencingRequest(@SafeParcelable.Param(mo18233id = 1) List<zzbh> list, @SafeParcelable.Param(mo18233id = 2) int i, @SafeParcelable.Param(mo18233id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
