...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(mo18233id = 1) List<DetectedActivity> list, @SafeParcelable.Param(mo18233id = 2) long j, @SafeParcelable.Param(mo18233id = 3) long j2, @SafeParcelable.Param(mo18233id = 4) int i, @SafeParcelable.Param(mo18233id = 5) Bundle bundle) {
        boolean z = true;
