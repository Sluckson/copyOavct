...
public final class zzaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "NetworkLocationStatus.STATUS_INVALID_TIMESTAMP", mo18230id = 4)
    private final long zzat;
    @SafeParcelable.Field(defaultValueUnchecked = "NetworkLocationStatus.STATUS_INVALID_TIMESTAMP", mo18230id = 3)
    private final long zzbt;

    @SafeParcelable.Constructor
    zzaj(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) int i2, @SafeParcelable.Param(mo18233id = 3) long j, @SafeParcelable.Param(mo18233id = 4) long j2) {
        this.zzas = i;
        this.zzar = i2;
        this.zzbt = j;
        this.zzat = j2;
