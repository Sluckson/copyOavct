...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationResult.DEFAULT_LOCATIONS", getter = "getLocations", mo18230id = 1)
    private final List<Location> zzbc;

    @SafeParcelable.Constructor
    LocationResult(@SafeParcelable.Param(mo18233id = 1) List<Location> list) {
        this.zzbc = list;
    }
