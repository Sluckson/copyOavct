...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLocationRequests", mo18230id = 1)
    private final List<LocationRequest> zzbg;
    @SafeParcelable.Field(defaultValue = "false", getter = "alwaysShow", mo18230id = 2)
    private final boolean zzbh;
    @SafeParcelable.Field(getter = "needBle", mo18230id = 3)
    private final boolean zzbi;
    @SafeParcelable.Field(getter = "getConfiguration", mo18230id = 5)
    private zzae zzbj;
    ...
    LocationSettingsRequest(@SafeParcelable.Param(mo18233id = 1) List<LocationRequest> list, @SafeParcelable.Param(mo18233id = 2) boolean z, @SafeParcelable.Param(mo18233id = 3) boolean z2, @SafeParcelable.Param(mo18233id = 5) zzae zzae) {
        this.zzbg = list;
        this.zzbh = z;
        this.zzbi = z2;
        this.zzbj = zzae;
