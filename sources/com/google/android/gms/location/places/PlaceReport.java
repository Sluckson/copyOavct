...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo18230id = 3)
    private final String tag;
    @SafeParcelable.VersionField(mo18236id = 1)
    private final int versionCode;
    @SafeParcelable.Field(getter = "getPlaceId", mo18230id = 2)
    private final String zza;
    @SafeParcelable.Field(getter = "getSource", mo18230id = 4)
    private final String zzb;

    @SafeParcelable.Constructor
    PlaceReport(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) String str, @SafeParcelable.Param(mo18233id = 3) String str2, @SafeParcelable.Param(mo18233id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
