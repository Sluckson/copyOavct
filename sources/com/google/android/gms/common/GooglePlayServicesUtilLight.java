...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C1288R.string.common_google_play_services_unknown_issue);
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzaz.get()) {
            ...
            if (zze != 0) {
                ...
                if (zze != i2) {
                    StringBuilder sb = new StringBuilder(TIFFConstants.TIFFTAG_COLORMAP);
