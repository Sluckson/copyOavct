...
public class Logger {
    ...
    @KeepForSdk
    /* renamed from: v */
    public void mo18290v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    @KeepForSdk
    /* renamed from: v */
    public void mo18289v(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    @KeepForSdk
    /* renamed from: d */
    public void mo18282d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    @KeepForSdk
    /* renamed from: d */
    public void mo18281d(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public void mo18287i(String str, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: w */
    public void mo18291w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo18284e(String str, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo18283e(String str, Throwable th, @Nullable Object... objArr) {
