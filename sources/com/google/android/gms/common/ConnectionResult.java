...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo18230id = 2)
    private final int zzr;
    @SafeParcelable.Field(getter = "getResolution", mo18230id = 3)
    private final PendingIntent zzs;
    @SafeParcelable.Field(getter = "getErrorMessage", mo18230id = 4)
    private final String zzt;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) int i2, @SafeParcelable.Param(mo18233id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo18233id = 4) String str) {
        this.zzq = i;
        this.zzr = i2;
