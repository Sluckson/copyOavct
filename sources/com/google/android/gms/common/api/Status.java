...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", mo18230id = 1)
    private final int zzr;
    @SafeParcelable.Field(getter = "getPendingIntent", mo18230id = 3)
    @Nullable
    private final PendingIntent zzs;
    @SafeParcelable.Field(getter = "getStatusMessage", mo18230id = 2)
    @Nullable
    private final String zzt;

    @SafeParcelable.Constructor
    @KeepForSdk
    Status(@SafeParcelable.Param(mo18233id = 1000) int i, @SafeParcelable.Param(mo18233id = 1) int i2, @SafeParcelable.Param(mo18233id = 2) @Nullable String str, @SafeParcelable.Param(mo18233id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzq = i;
        this.zzr = i2;
        this.zzt = str;
