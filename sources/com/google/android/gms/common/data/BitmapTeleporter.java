...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    BitmapTeleporter(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(mo18233id = 3) int i2) {
        this.zalf = i;
        ...
        if (file != null) {
            try {
                ...
                try {
                    ...
                    this.zalg = ParcelFileDescriptor.open(createTempFile, C1119C.ENCODING_PCM_MU_LAW);
