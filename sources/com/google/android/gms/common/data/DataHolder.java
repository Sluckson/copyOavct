...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(mo18236id = 1000)
    private final int zalf;
    @SafeParcelable.Field(getter = "getColumns", mo18230id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @SafeParcelable.Field(getter = "getWindows", mo18230id = 2)
    private final CursorWindow[] zals;
    @SafeParcelable.Field(getter = "getStatusCode", mo18230id = 3)
    private final int zalt;
    @SafeParcelable.Field(getter = "getMetadata", mo18230id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo18233id = 1000) int i, @SafeParcelable.Param(mo18233id = 1) String[] strArr, @SafeParcelable.Param(mo18233id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo18233id = 3) int i2, @SafeParcelable.Param(mo18233id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
