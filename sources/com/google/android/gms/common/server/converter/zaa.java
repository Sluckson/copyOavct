...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", mo18230id = 2)
    private final StringToIntConverter zapl;

    @SafeParcelable.Constructor
    zaa(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) StringToIntConverter stringToIntConverter) {
        this.zalf = i;
