...
public final class StringToIntConverter extends AbstractSafeParcelable implements FastJsonResponse.FieldConverter<String, Integer> {
    ...
    @SafeParcelable.Field(getter = "getSerializedMap", mo18230id = 2)
    private final ArrayList<zaa> zapo;

    @SafeParcelable.Constructor
    StringToIntConverter(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) ArrayList<zaa> arrayList) {
        this.zalf = i;
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Constructor
        zaa(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) String str, @SafeParcelable.Param(mo18233id = 3) int i2) {
            this.versionCode = i;
            this.zapp = str;
            this.zapq = i2;
        }
