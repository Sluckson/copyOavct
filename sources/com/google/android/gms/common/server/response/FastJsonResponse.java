...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.VersionField(getter = "getVersionCode", mo18236id = 1)
        private final int zalf;
        @SafeParcelable.Field(getter = "getTypeIn", mo18230id = 2)
        protected final int zapr;
        @SafeParcelable.Field(getter = "isTypeInArray", mo18230id = 3)
        protected final boolean zaps;
        @SafeParcelable.Field(getter = "getTypeOut", mo18230id = 4)
        protected final int zapt;
        @SafeParcelable.Field(getter = "isTypeOutArray", mo18230id = 5)
        protected final boolean zapu;
        @SafeParcelable.Field(getter = "getOutputFieldName", mo18230id = 6)
        protected final String zapv;
        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo18230id = 7)
        protected final int zapw;
        protected final Class<? extends FastJsonResponse> zapx;
        @SafeParcelable.Field(getter = "getConcreteTypeName", mo18230id = 8)
        private final String zapy;
        private zak zapz;
        /* access modifiers changed from: private */
        @SafeParcelable.Field(getter = "getWrappedConverter", mo18230id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zaqa;

        @SafeParcelable.Constructor
        Field(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) int i2, @SafeParcelable.Param(mo18233id = 3) boolean z, @SafeParcelable.Param(mo18233id = 4) int i3, @SafeParcelable.Param(mo18233id = 5) boolean z2, @SafeParcelable.Param(mo18233id = 6) String str, @SafeParcelable.Param(mo18233id = 7) int i4, @SafeParcelable.Param(mo18233id = 8) String str2, @SafeParcelable.Param(mo18233id = 9) zaa zaa) {
            this.zalf = i;
            this.zapr = i2;
            this.zaps = z;
            this.zapt = i3;
