...
public class FastParser<T extends FastJsonResponse> {
    ...
    private static final char[] zaqh = {'r', 'u', Barcode128.CODE_BC_TO_A};
    private static final char[] zaqi = {'r', 'u', Barcode128.CODE_BC_TO_A, Typography.quote};
    private static final char[] zaqj = {'a', 'l', 's', Barcode128.CODE_BC_TO_A};
    private static final char[] zaqk = {'a', 'l', 's', Barcode128.CODE_BC_TO_A, Typography.quote};
