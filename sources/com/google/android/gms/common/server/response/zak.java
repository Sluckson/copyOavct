...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo18230id = 2)
    private final ArrayList<zal> zaqw;
    @SafeParcelable.Field(getter = "getRootClassName", mo18230id = 3)
    private final String zaqx;

    @SafeParcelable.Constructor
    zak(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) ArrayList<zal> arrayList, @SafeParcelable.Param(mo18233id = 3) String str) {
        this.zalf = i;
        this.zaqw = null;
