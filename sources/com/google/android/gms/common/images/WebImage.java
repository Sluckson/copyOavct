...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getHeight", mo18230id = 4)
    private final int zanf;
    @SafeParcelable.Field(getter = "getUrl", mo18230id = 2)
    private final Uri zang;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) Uri uri, @SafeParcelable.Param(mo18233id = 3) int i2, @SafeParcelable.Param(mo18233id = 4) int i3) {
        this.zalf = i;
        this.zang = uri;
        this.zane = i2;
        this.zanf = i3;
