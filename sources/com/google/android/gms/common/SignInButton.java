...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zaat = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1283R.styleable.SignInButton, 0, 0);
        try {
            this.mSize = obtainStyledAttributes.getInt(C1283R.styleable.SignInButton_buttonSize, 0);
            this.mColor = obtainStyledAttributes.getInt(C1283R.styleable.SignInButton_colorScheme, 2);
