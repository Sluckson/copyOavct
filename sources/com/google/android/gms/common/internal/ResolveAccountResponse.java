...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo18230id = 3)
    private ConnectionResult zadi;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo18230id = 4)
    private boolean zagg;
    @SafeParcelable.VersionField(mo18236id = 1)
    private final int zalf;
    @SafeParcelable.Field(mo18230id = 2)
    private IBinder zanx;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo18230id = 5)
    private boolean zapc;

    @SafeParcelable.Constructor
    ResolveAccountResponse(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) IBinder iBinder, @SafeParcelable.Param(mo18233id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo18233id = 4) boolean z, @SafeParcelable.Param(mo18233id = 5) boolean z2) {
        this.zalf = i;
        this.zanx = iBinder;
