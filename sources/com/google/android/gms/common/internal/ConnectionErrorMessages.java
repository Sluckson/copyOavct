...
import com.google.android.gms.base.C1283R;
import com.google.android.gms.common.C1288R;
...
public final class ConnectionErrorMessages {
    ...
    public static String getErrorTitle(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C1283R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C1283R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C1283R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return str == null ? context.getResources().getString(C1283R.string.common_google_play_services_notification_ticker) : str;
    }
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C1283R.string.common_google_play_services_install_text, new Object[]{appName});
        } else if (i != 2) {
            if (i == 3) {
                return resources.getString(C1283R.string.common_google_play_services_enable_text, new Object[]{appName});
            } else if (i == 5) {
                ...
                if (i == 9) {
                    return resources.getString(C1283R.string.common_google_play_services_unsupported_text, new Object[]{appName});
                } else if (i == 20) {
                    ...
                    switch (i) {
                        ...
                        case 18:
                            return resources.getString(C1283R.string.common_google_play_services_updating_text, new Object[]{appName});
                        default:
                            return resources.getString(C1288R.string.common_google_play_services_unknown_issue, new Object[]{appName});
                    }
                }
            }
        } else if (DeviceProperties.isWearableWithoutPlayStore(context)) {
            return resources.getString(C1283R.string.common_google_play_services_wear_update_text);
        } else {
            return resources.getString(C1283R.string.common_google_play_services_update_text, new Object[]{appName});
        }
    }
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        Resources resources = context.getResources();
        if (i == 1) {
            return resources.getString(C1283R.string.common_google_play_services_install_button);
        }
        if (i == 2) {
            return resources.getString(C1283R.string.common_google_play_services_update_button);
        }
        if (i != 3) {
            return resources.getString(17039370);
        }
        return resources.getString(C1283R.string.common_google_play_services_enable_button);
    }
    ...
    private static String zaa(Context context, String str, String str2) {
        ...
        if (zaa == null) {
            zaa = resources.getString(C1288R.string.common_google_play_services_unknown_issue);
        }
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C1283R.string.common_google_play_services_notification_channel_name);
    }
