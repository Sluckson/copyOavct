...
public final class GmsLogger {
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo18165d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzg(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo18166d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo18174v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzg(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo18175v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo18170i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzg(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo18171i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo18176w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzg(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo18177w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo18167e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzg(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo18168e(String str, String str2, Throwable th) {
        if (canLog(6)) {
