...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(mo18230id = 6, type = "android.accounts.Account")
    private Account zax;

    @SafeParcelable.Constructor
    AuthAccountRequest(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) IBinder iBinder, @SafeParcelable.Param(mo18233id = 3) Scope[] scopeArr, @SafeParcelable.Param(mo18233id = 4) Integer num, @SafeParcelable.Param(mo18233id = 5) Integer num2, @SafeParcelable.Param(mo18233id = 6) Account account) {
        this.zalf = i;
        this.zanx = iBinder;
        this.zany = scopeArr;
        this.zanz = num;
