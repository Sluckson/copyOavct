...
public class SafeBrowsingData extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getMetadata", mo18230id = 2)
    private String zzm;
    @SafeParcelable.Field(getter = "getBlacklistsDataHolder", mo18230id = 3)
    private DataHolder zzn;
    @SafeParcelable.Field(getter = "getFileDescriptor", mo18230id = 4)
    private ParcelFileDescriptor zzo;
    @SafeParcelable.Field(getter = "getLastUpdateTimeMs", mo18230id = 5)
    private long zzp;
    @SafeParcelable.Field(getter = "getState", mo18230id = 6)
    private byte[] zzq;
    private byte[] zzr;
    private File zzs;
    ...
    public SafeBrowsingData(@SafeParcelable.Param(mo18233id = 2) String str, @SafeParcelable.Param(mo18233id = 3) DataHolder dataHolder, @SafeParcelable.Param(mo18233id = 4) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(mo18233id = 5) long j, @SafeParcelable.Param(mo18233id = 6) byte[] bArr) {
        this.zzm = str;
        this.zzn = dataHolder;
