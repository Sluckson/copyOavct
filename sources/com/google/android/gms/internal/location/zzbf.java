...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo18230id = 4)
    private PendingIntent zzbv;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo18230id = 1)
    private int zzcg;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo18230id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo18230id = 2)
    private zzbd zzdl;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo18230id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo18230id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @SafeParcelable.Constructor
    zzbf(@SafeParcelable.Param(mo18233id = 1) int i, @SafeParcelable.Param(mo18233id = 2) zzbd zzbd, @SafeParcelable.Param(mo18233id = 3) IBinder iBinder, @SafeParcelable.Param(mo18233id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(mo18233id = 5) IBinder iBinder2, @SafeParcelable.Param(mo18233id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;
