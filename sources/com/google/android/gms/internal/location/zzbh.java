...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @SafeParcelable.Field(getter = "getRequestId", mo18230id = 1)
    private final String zzad;
    @SafeParcelable.Field(getter = "getTransitionTypes", mo18230id = 7)
    private final int zzae;
    @SafeParcelable.Field(getter = "getType", mo18230id = 3)
    private final short zzag;
    @SafeParcelable.Field(getter = "getLatitude", mo18230id = 4)
    private final double zzah;
    @SafeParcelable.Field(getter = "getLongitude", mo18230id = 5)
    private final double zzai;
    @SafeParcelable.Field(getter = "getRadius", mo18230id = 6)
    private final float zzaj;
    @SafeParcelable.Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo18230id = 8)
    private final int zzak;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getLoiteringDelay", mo18230id = 9)
    private final int zzal;
    @SafeParcelable.Field(getter = "getExpirationTime", mo18230id = 2)
    private final long zzdo;

    @SafeParcelable.Constructor
    public zzbh(@SafeParcelable.Param(mo18233id = 1) String str, @SafeParcelable.Param(mo18233id = 7) int i, @SafeParcelable.Param(mo18233id = 3) short s, @SafeParcelable.Param(mo18233id = 4) double d, @SafeParcelable.Param(mo18233id = 5) double d2, @SafeParcelable.Param(mo18233id = 6) float f, @SafeParcelable.Param(mo18233id = 2) long j, @SafeParcelable.Param(mo18233id = 8) int i2, @SafeParcelable.Param(mo18233id = 9) int i3) {
