...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo18230id = 10)
    @Nullable
    private String moduleId;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo18230id = 6)
    @Nullable
    private String tag;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo18230id = 1)
    private LocationRequest zzdg;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_HIDE_FROM_APP_OPS", mo18230id = 7)
    private boolean zzdh;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_FORCE_COARSE_LOCATION", mo18230id = 8)
    private boolean zzdi;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_EXEMPT_FROM_THROTTLE", mo18230id = 9)
    private boolean zzdj;
    private boolean zzdk = true;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_CLIENTS", mo18230id = 5)
    private List<ClientIdentity> zzm;

    @SafeParcelable.Constructor
    zzbd(@SafeParcelable.Param(mo18233id = 1) LocationRequest locationRequest, @SafeParcelable.Param(mo18233id = 5) List<ClientIdentity> list, @SafeParcelable.Param(mo18233id = 6) @Nullable String str, @SafeParcelable.Param(mo18233id = 7) boolean z, @SafeParcelable.Param(mo18233id = 8) boolean z2, @SafeParcelable.Param(mo18233id = 9) boolean z3, @SafeParcelable.Param(mo18233id = 10) String str2) {
