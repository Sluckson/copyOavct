...
/* renamed from: com.google.android.gms.internal.firebase-perf.zzii */
/* compiled from: com.google.firebase:firebase-perf@@19.0.7 */
final class zzii {
    private static final zzih zzvy;
    ...
    public static boolean zzc(byte[] bArr) {
        return zzvy.zzc(bArr, 0, bArr.length);
    }
    ...
    static int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzvy.zza(charSequence, bArr, i, i2);
    }

    static {
        zzih zzih;
        if (!(zzig.zzji() && zzig.zzjj()) || zzec.zzgh()) {
            zzih = new zzik();
        } else {
            zzih = new zzim();
        }
