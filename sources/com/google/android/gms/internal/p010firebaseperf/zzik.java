...
/* renamed from: com.google.android.gms.internal.firebase-perf.zzik */
/* compiled from: com.google.firebase:firebase-perf@@19.0.7 */
final class zzik extends zzih {
    zzik() {
    }
        ...
        while (r9 < i3) {
            ...
            if (b < 0) {
                if (b < -32) {
                    ...
                    int i6 = i4 + 1;
                    byte b3 = bArr[i4];
                    if (b3 <= -65 && (((b << Ascii.f266FS) + (b3 + 112)) >> 30) == 0) {
                        int i7 = i6 + 1;
                        if (bArr[i6] <= -65) {
                            i4 = i7 + 1;
                            if (bArr[i7] > -65) {
    ...
    public final int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                int i10 = i8 + 1;
                bArr[i8] = (byte) ((charAt2 >>> 12) | WOWZMediaConfig.DEFAULT_VIDEO_FRAME_HEIGHT);
                int i11 = i10 + 1;
