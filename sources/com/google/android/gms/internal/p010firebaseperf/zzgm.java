...
/* renamed from: com.google.android.gms.internal.firebase-perf.zzgm */
...
public final class zzgm<K, V> extends LinkedHashMap<K, V> {
    ...
    public final void zza(zzgm<K, V> zzgm) {
        zzif();
        if (!zzgm.isEmpty()) {
            putAll(zzgm);
        }
    ...
    public final void putAll(Map<? extends K, ? extends V> map) {
        ...
        for (Object next : map.keySet()) {
            zzfj.checkNotNull(next);
            zzfj.checkNotNull(map.get(next));
        }
        super.putAll(map);
    }
    ...
    public final boolean equals(java.lang.Object r7) {
        ...
        L_0x005d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p010firebaseperf.zzgm.equals(java.lang.Object):boolean");
    }
