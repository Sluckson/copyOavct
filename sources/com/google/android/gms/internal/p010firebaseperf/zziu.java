...
/* renamed from: com.google.android.gms.internal.firebase-perf.zziu */
...
interface zziu {
    ...
    void zza(int i, zzee zzee) throws IOException;

    <K, V> void zza(int i, zzgj<K, V> zzgj, Map<K, V> map) throws IOException;
    ...
    void zzb(int i, List<zzee> list) throws IOException;
