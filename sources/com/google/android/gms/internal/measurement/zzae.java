...
public final class zzae extends AbstractSafeParcelable {
    ...
    public zzae(@SafeParcelable.Param(mo18233id = 1) long j, @SafeParcelable.Param(mo18233id = 2) long j2, @SafeParcelable.Param(mo18233id = 3) boolean z, @SafeParcelable.Param(mo18233id = 4) String str, @SafeParcelable.Param(mo18233id = 5) String str2, @SafeParcelable.Param(mo18233id = 6) String str3, @SafeParcelable.Param(mo18233id = 7) Bundle bundle) {
        this.zza = j;
        this.zzb = j2;
        this.zzc = z;
        this.zzd = str;
