...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C5070zza> implements zzdq {
        ...
        public static final class C5070zza extends zzcg.zza<zza, C5070zza> implements zzdq {
            private C5070zza() {
                super(zza.zzsm);
            }

            /* synthetic */ C5070zza(zzgf zzgf) {
                this();
            }
        }
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            CW_PRIMES(242),
            CW_IOS_PRIMES(699),
            FAMILYLINK_ANDROID_PRIMES(C4317c.f4528X),
            ...
            CROSSDEVICENOTIFICATION_DEV(CipherSuite.TLS_DHE_PSK_WITH_RC4_128_SHA),
            ...
            BLUETOOTH(208),
            WIFI(209),
            TELECOM(WMSTransport.SESSIONSTATE_CONNECT_REDIRECT),
            TELEPHONY(211),
            ...
            MADDEN(218),
            INK(219),
            ANDROID_CONTACTS(WMSTransport.SESSIONSTATE_CONNECT_REJECTED),
            ...
            PIGEON_EXPERIMENTAL(WOWZMediaConfig.DEFAULT_VIDEO_FRAME_HEIGHT),
            ...
            GMSCORE_BACKEND_COUNTERS(WOWZMediaConfig.DEFAULT_VIDEO_FRAME_WIDTH),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case 209:
                        return WIFI;
                    case WMSTransport.SESSIONSTATE_CONNECT_REDIRECT /*210*/:
                        return TELECOM;
                    case 211:
                        return TELEPHONY;
                    case 212:
                    ...
                    case 219:
                        return INK;
                    case WMSTransport.SESSIONSTATE_CONNECT_REJECTED /*220*/:
