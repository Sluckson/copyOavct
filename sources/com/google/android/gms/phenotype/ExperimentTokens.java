...
public class ExperimentTokens extends AbstractSafeParcelable {
    ...
    public ExperimentTokens(@SafeParcelable.Param(mo18233id = 2) String str, @SafeParcelable.Param(mo18233id = 3) byte[] bArr, @SafeParcelable.Param(mo18233id = 4) byte[][] bArr2, @SafeParcelable.Param(mo18233id = 5) byte[][] bArr3, @SafeParcelable.Param(mo18233id = 6) byte[][] bArr4, @SafeParcelable.Param(mo18233id = 7) byte[][] bArr5, @SafeParcelable.Param(mo18233id = 8) int[] iArr, @SafeParcelable.Param(mo18233id = 9) byte[][] bArr6) {
        this.zzp = str;
        this.zzq = bArr;
        this.zzr = bArr2;
        this.zzs = bArr3;
