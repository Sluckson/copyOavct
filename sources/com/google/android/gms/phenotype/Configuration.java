...
public class Configuration extends AbstractSafeParcelable implements Comparable<Configuration> {
    ...
    public Configuration(@SafeParcelable.Param(mo18233id = 2) int i, @SafeParcelable.Param(mo18233id = 3) zzi[] zziArr, @SafeParcelable.Param(mo18233id = 4) String[] strArr) {
        this.zzc = i;
        this.zzd = zziArr;
        for (zzi zzi : zziArr) {
