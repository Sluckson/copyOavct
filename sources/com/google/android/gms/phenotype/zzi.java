...
public final class zzi extends AbstractSafeParcelable implements Comparable<zzi> {
    ...
    public zzi(@SafeParcelable.Param(mo18233id = 2) String str, @SafeParcelable.Param(mo18233id = 3) long j, @SafeParcelable.Param(mo18233id = 4) boolean z, @SafeParcelable.Param(mo18233id = 5) double d, @SafeParcelable.Param(mo18233id = 6) String str2, @SafeParcelable.Param(mo18233id = 7) byte[] bArr, @SafeParcelable.Param(mo18233id = 8) int i, @SafeParcelable.Param(mo18233id = 9) int i2) {
        this.name = str;
        this.zzab = j;
        this.zzac = z;
        this.zzad = d;
