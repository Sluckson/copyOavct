...
final class AutoValue_PersistedEvent extends PersistedEvent {
    ...
    public String toString() {
        return "PersistedEvent{id=" + this.f119id + ", transportContext=" + this.transportContext + ", event=" + this.event + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f119id != persistedEvent.getId() || !this.transportContext.equals(persistedEvent.getTransportContext()) || !this.event.equals(persistedEvent.getEvent())) {
            return false;
        }
        return true;
    }
