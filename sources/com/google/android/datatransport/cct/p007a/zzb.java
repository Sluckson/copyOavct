...
public final class zzb implements Configurator {
    ...
    private static final class C5067zzb implements ObjectEncoder<zzo> {
        static final C5067zzb zza = new C5067zzb();
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        encoderConfig.registerEncoder((Class<U>) zzo.class, (ObjectEncoder<? super U>) C5067zzb.zza);
        encoderConfig.registerEncoder((Class<U>) zze.class, (ObjectEncoder<? super U>) C5067zzb.zza);
