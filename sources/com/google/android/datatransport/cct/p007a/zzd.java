...
final class zzd extends zza {
    ...
    static final class zza extends zza.C5066zza {
        private Integer zza;
        private String zzb;
        private String zzc;
        private String zzd;
        ...
        public zza.C5066zza zza(@Nullable Integer num) {
            this.zza = num;
            return this;
        }

        public zza.C5066zza zzb(@Nullable String str) {
            this.zzh = str;
            return this;
        }

        public zza.C5066zza zzc(@Nullable String str) {
            this.zzc = str;
            return this;
        }

        public zza.C5066zza zzd(@Nullable String str) {
            this.zzg = str;
            return this;
        }

        public zza.C5066zza zze(@Nullable String str) {
            this.zzb = str;
            return this;
        }

        public zza.C5066zza zzf(@Nullable String str) {
            this.zzf = str;
            return this;
        }

        public zza.C5066zza zzg(@Nullable String str) {
            this.zze = str;
            return this;
        }

        public zza.C5066zza zza(@Nullable String str) {
            this.zzd = str;
            return this;
        }
