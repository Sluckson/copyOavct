...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public void putDownload(Download download) throws DatabaseIOException {
        ...
        contentValues.put("id", download.request.f137id);
        ...
        if (!this.initialized) {
            try {
                if (VersionTable.getVersion(this.databaseProvider.getReadableDatabase(), 0, this.name) != 2) {
                    ...
                    writableDatabase.execSQL("CREATE TABLE " + this.tableName + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + TABLE_SCHEMA);
