...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static String getCharsetName(int i) {
        return i != 1 ? i != 2 ? i != 3 ? "ISO-8859-1" : "UTF-8" : XmpWriter.UTF16BE : "UTF-16";
    }
    ...
    public Metadata decode(byte[] bArr, int i) {
        ...
        if (!validateFrames(parsableByteArray, decodeHeader.majorVersion, i2, false)) {
            if (decodeHeader.majorVersion != 4 || !validateFrames(parsableByteArray, 4, i2, true)) {
                Log.m54w(TAG, "Failed to validate ID3 tag with majorVersion=" + decodeHeader.majorVersion);
                return null;
            }
            z = true;
        }
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() < 10) {
            Log.m54w(TAG, "Data too short to be an ID3 tag");
            return null;
        }
        int readUnsignedInt24 = parsableByteArray.readUnsignedInt24();
        if (readUnsignedInt24 != ID3_TAG) {
            Log.m54w(TAG, "Unexpected first three bytes of ID3 tag header: " + readUnsignedInt24);
            return null;
        }
        ...
        if (readUnsignedByte == 2) {
            if ((readUnsignedByte2 & 64) != 0) {
                Log.m54w(TAG, "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
            ...
            Log.m54w(TAG, "Skipped ID3 tag with unsupported majorVersion=" + readUnsignedByte);
            return null;
        }
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, @androidx.annotation.Nullable com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x0067:
            ...
            com.google.android.exoplayer2.util.Log.m54w(r4, r0)
            int r0 = r20.limit()
            r7.setPosition(r0)
            return r16
        L_0x0082:
        ...
        L_0x01f9:
            ...
            com.google.android.exoplayer2.util.Log.m54w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x021f }
        L_0x021b:
            r7.setPosition(r14)
            return r1
        L_0x021f:
            java.lang.String r0 = "Unsupported character encoding"
            com.google.android.exoplayer2.util.Log.m54w(r12, r0)     // Catch:{ all -> 0x012f }
            r7.setPosition(r14)
            return r16
        L_0x0228:
            r7.setPosition(r14)
        ...
        L_0x022c:
            ...
            com.google.android.exoplayer2.util.Log.m54w(r12, r0)
            r7.setPosition(r14)
            return r16
        */
