...
public final class MlltFrame extends Id3Frame {
    ...
    public int hashCode() {
        return ((((((((MetaDo.META_OFFSETWINDOWORG + this.mpegFramesBetweenReference) * 31) + this.bytesBetweenReference) * 31) + this.millisecondsBetweenReference) * 31) + Arrays.hashCode(this.bytesDeviations)) * 31) + Arrays.hashCode(this.millisecondsDeviations);
    }
