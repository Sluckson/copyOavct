...
public interface HttpDataSource extends DataSource {
    ...
    public final /* synthetic */ class CC {
        public static /* synthetic */ boolean lambda$static$0(String str) {
            ...
            return !TextUtils.isEmpty(lowerInvariant) && (!lowerInvariant.contains("text") || lowerInvariant.contains(MimeTypes.TEXT_VTT)) && !lowerInvariant.contains(HtmlTags.HTML) && !lowerInvariant.contains("xml");
        }
    }
