...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final LoadErrorAction DONT_RETRY = new LoadErrorAction(2, C1119C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY_FATAL = new LoadErrorAction(3, C1119C.TIME_UNSET);
    public static final LoadErrorAction RETRY = createRetryAction(false, C1119C.TIME_UNSET);
    public static final LoadErrorAction RETRY_RESET_ERROR_COUNT = createRetryAction(true, C1119C.TIME_UNSET);
    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.m51e(TAG, "Unexpected exception loading stream", e2);
                if (!this.released) {
                    obtainMessage(3, new UnexpectedLoaderException(e2)).sendToTarget();
                }
            } catch (OutOfMemoryError e3) {
                Log.m51e(TAG, "OutOfMemory error loading stream", e3);
                if (!this.released) {
                    obtainMessage(3, new UnexpectedLoaderException(e3)).sendToTarget();
                }
            } catch (Error e4) {
                Log.m51e(TAG, "Unexpected error loading stream", e4);
                if (!this.released) {
                ...
                if (message.what == 0) {
                    ...
                    if (i == 1) {
                        ...
                        try {
                            ...
                            Log.m51e(TAG, "Unexpected exception handling load completed", e);
                        ...
                        if (onLoadError.type == 3) {
                            ...
                            if (onLoadError.retryDelayMillis != C1119C.TIME_UNSET) {
