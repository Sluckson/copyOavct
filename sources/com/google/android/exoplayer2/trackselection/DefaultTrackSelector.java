...
public class DefaultTrackSelector extends MappingTrackSelector {
            ...
            if (rendererType != 1) {
                if (rendererType != 2) {
                    if (rendererType != 3) {
                        ...
                        str = str5;
                        Pair<TrackSelection.Definition, Integer> selectTextTrack = selectTextTrack(mappedTrackInfo2.getTrackGroups(i4), iArr[i4], parameters2, str);
    ...
    private static int[] getAdaptiveAudioTracks(TrackGroup trackGroup, int[] iArr, int i, boolean z, boolean z2) {
        ...
        for (int i3 = 0; i3 < trackGroup2.length; i3++) {
            ...
            if (hashSet.add(audioConfigurationTuple2) && (adaptiveAudioTrackCount = getAdaptiveAudioTrackCount(trackGroup, iArr, audioConfigurationTuple2, i, z, z2)) > i2) {
    ...
    protected static boolean stringDefinesNoLanguage(@Nullable String str) {
        return TextUtils.isEmpty(str) || TextUtils.equals(str, C1119C.LANGUAGE_UNDETERMINED);
    }
    ...
    protected static int getFormatLanguageScore(Format format, @Nullable String str) {
        ...
        if (Util.splitAtFirst(format.language, "-")[0].equals(Util.splitAtFirst(str, "-")[0])) {
            return 1;
        }
        return 0;
    }
