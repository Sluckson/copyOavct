...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter) {
        this(trackGroup, iArr, bandwidthMeter, 10000, 25000, 25000, 0.75f, 0.75f, (long) DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS, Clock.DEFAULT);
    }
    ...
    private AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthProvider bandwidthProvider2, long j, long j2, long j3, float f, long j4, Clock clock2) {
        ...
        this.reason = 0;
        this.lastBufferEvaluationMs = C1119C.TIME_UNSET;
        this.trackBitrateEstimator = TrackBitrateEstimator.DEFAULT;
    ...
    public boolean shouldEvaluateQueueSize(long j) {
        ...
        return j2 == C1119C.TIME_UNSET || j - j2 >= this.minTimeBetweenBufferReevaluationMs;
    }
    ...
    private long minDurationForQualityIncreaseUs(long j) {
        return (j > C1119C.TIME_UNSET ? 1 : (j == C1119C.TIME_UNSET ? 0 : -1)) != 0 && (j > this.minDurationForQualityIncreaseUs ? 1 : (j == this.minDurationForQualityIncreaseUs ? 0 : -1)) <= 0 ? (long) (((float) j) * this.bufferedFractionToLiveEdgeForQualityIncrease) : this.minDurationForQualityIncreaseUs;
    }
