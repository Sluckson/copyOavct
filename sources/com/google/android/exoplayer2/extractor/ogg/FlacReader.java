...
final class FlacReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) throws IOException, InterruptedException {
        ...
        if (this.streamMetadata == null) {
            ...
            setupData.format = Format.createAudioSampleFormat((String) null, MimeTypes.AUDIO_FLAC, (String) null, -1, this.streamMetadata.bitRate(), this.streamMetadata.channels, this.streamMetadata.sampleRate, Collections.singletonList(copyOfRange), (DrmInitData) null, 0, (String) null);
            return true;
