...
public final class Mp3Extractor implements Extractor {
    ...
    public Mp3Extractor(int i, long j) {
        ...
        this.basisTimeUs = C1119C.TIME_UNSET;
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        if (this.sampleBytesRemaining == 0) {
            ...
            if (this.basisTimeUs == C1119C.TIME_UNSET) {
                this.basisTimeUs = this.seeker.getTimeUs(extractorInput.getPosition());
                if (this.forcedFirstSampleTimestampUs != C1119C.TIME_UNSET) {
    ...
    private boolean synchronize(ExtractorInput extractorInput, boolean z) throws IOException, InterruptedException {
        ...
        while (true) {
            if (!peekEndOfStreamOrHeader(extractorInput)) {
                this.scratch.setPosition(0);
                int readInt = this.scratch.readInt();
                if ((i4 == 0 || headersMatch(readInt, (long) i4)) && (frameSize = MpegAudioHeader.getFrameSize(readInt)) != -1) {
                    i5 = i3 + 1;
                    if (i5 != 1) {
                        if (i5 == 4) {
                            break;
