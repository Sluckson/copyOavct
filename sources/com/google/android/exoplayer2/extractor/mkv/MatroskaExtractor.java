...
public class MatroskaExtractor implements Extractor {
    ...
    private static final byte[] SSA_PREFIX = {68, 105, 97, 108, 111, 103, 117, 101, 58, 32, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 44, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 44};
    private static final int SSA_PREFIX_END_TIMECODE_OFFSET = 21;
    private static final byte[] SSA_TIMECODE_EMPTY = {32, 32, 32, 32, 32, 32, 32, 32, 32, 32};
    private static final String SSA_TIMECODE_FORMAT = "%01d:%02d:%02d:%02d";
    private static final long SSA_TIMECODE_LAST_VALUE_SCALING_FACTOR = 10000;
    private static final byte[] SUBRIP_PREFIX = {49, 10, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 44, ByteBuffer.ZERO, ByteBuffer.ZERO, ByteBuffer.ZERO, 32, 45, 45, DocWriter.f569GT, 32, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 44, ByteBuffer.ZERO, ByteBuffer.ZERO, ByteBuffer.ZERO, 10};
    ...
    MatroskaExtractor(EbmlReader ebmlReader, int i) {
        ...
        this.timecodeScale = C1119C.TIME_UNSET;
        this.durationTimecode = C1119C.TIME_UNSET;
        this.durationUs = C1119C.TIME_UNSET;
        this.cuesContentPosition = -1;
        this.seekPositionAfterBuildingCues = -1;
        this.clusterTimecodeUs = C1119C.TIME_UNSET;
        ...
        if (i != ID_BLOCK_GROUP) {
            if (i == ID_TRACK_ENTRY) {
                ...
                if (i != ID_CONTENT_ENCODINGS) {
                    if (i == 357149030) {
                        if (this.timecodeScale == C1119C.TIME_UNSET) {
                ...
                if (this.currentTrack.cryptoData != null) {
                    this.currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C1119C.UUID_NIL, MimeTypes.VIDEO_WEBM, this.currentTrack.cryptoData.encryptionKey));
                    return;
                }
                    ...
                    if ((this.sampleSignalByte & 1) == 1) {
                        ...
                        if (z2) {
                            ...
                            if (byteBuffer == null || byteBuffer.capacity() < i5) {
                                this.encryptionSubsampleDataBuffer = java.nio.ByteBuffer.allocate(i5);
                            }
    ...
    private static void setSampleDuration(byte[] bArr, long j, String str, int i, long j2, byte[] bArr2) {
        ...
        if (j == C1119C.TIME_UNSET) {
            ...
            String str2 = str;
            bArr3 = Util.getUtf8Bytes(String.format(locale, str, objArr));
            bArr4 = bArr2;
        }
        byte[] bArr5 = bArr;
        int i6 = i;
    ...
    private SeekMap buildSeekMap() {
        ...
        if (this.segmentContentPosition == -1 || this.durationUs == C1119C.TIME_UNSET || (longArray = this.cueTimesUs) == null || longArray.size() == 0 || (longArray2 = this.cueClusterPositions) == null || longArray2.size() != this.cueTimesUs.size()) {
    ...
    private static final class Track {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:148:0x0334, code lost:
            r1 = com.google.android.exoplayer2.Format.createAudioSampleFormat(java.lang.Integer.toString(r34), r1, (java.lang.String) null, -1, r20, r0.channelCount, r0.sampleRate, r23, r3, r0.drmInitData, r11 ? 1 : 0, r0.language);
            r7 = 1;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:180:0x03d2, code lost:
            r2 = com.lowagie.text.pdf.codec.TIFFConstants.TIFFTAG_IMAGEDESCRIPTION;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:200:0x0424, code lost:
            r25 = com.lowagie.text.pdf.codec.TIFFConstants.TIFFTAG_IMAGEDESCRIPTION;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:203:0x0430, code lost:
            r1 = com.google.android.exoplayer2.Format.createVideoSampleFormat(java.lang.Integer.toString(r34), r1, (java.lang.String) null, -1, r20, r0.width, r0.height, -1.0f, r3, r25, r26, r0.projectionData, r0.stereoMode, r29, r0.drmInitData);
            r7 = 2;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:205:0x045d, code lost:
            if (com.google.android.exoplayer2.util.MimeTypes.APPLICATION_SUBRIP.equals(r1) == false) goto L_0x046d;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:208:0x0471, code lost:
            if (com.google.android.exoplayer2.util.MimeTypes.TEXT_SSA.equals(r1) == false) goto L_0x04a6;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:209:0x0473, code lost:
            ...
            r1 = com.google.android.exoplayer2.Format.createTextSampleFormat(java.lang.Integer.toString(r34), r1, (java.lang.String) null, -1, r11 ? 1 : 0, r0.language, -1, r0.drmInitData, Long.MAX_VALUE, r2);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:211:0x04aa, code lost:
            if (com.google.android.exoplayer2.util.MimeTypes.APPLICATION_VOBSUB.equals(r1) != false) goto L_0x04c5;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:218:0x04c5, code lost:
            r1 = com.google.android.exoplayer2.Format.createImageSampleFormat(java.lang.Integer.toString(r34), r1, (java.lang.String) null, -1, r11 ? 1 : 0, r3, r0.language, r0.drmInitData);
         */
        ...
        public void initializeOutput(com.google.android.exoplayer2.extractor.ExtractorOutput r33, int r34) throws com.google.android.exoplayer2.ParserException {
            ...
            L_0x01b7:
                ...
                com.google.android.exoplayer2.util.Log.m54w(r13, r1)
                goto L_0x022e
            L_0x01de:
                r23 = r1
                r1 = r11
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m54w(MatroskaExtractor.TAG, "Unknown FourCC. Setting mimeType to video/x-unknown");
