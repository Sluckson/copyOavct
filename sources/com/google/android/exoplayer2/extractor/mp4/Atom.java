...
abstract class Atom {
    ...
    public static final int TYPE_avc1 = Util.getIntegerCodeForString(C4317c.f4533b);
    public static final int TYPE_avc3 = Util.getIntegerCodeForString("avc3");
    public static final int TYPE_avcC = Util.getIntegerCodeForString(C4317c.f4534c);
    ...
    public static final int TYPE_hev1 = Util.getIntegerCodeForString(C4318a.f4571g);
    public static final int TYPE_hvc1 = Util.getIntegerCodeForString(C4318a.f4570f);
    public static final int TYPE_hvcC = Util.getIntegerCodeForString(C4318a.f4572h);
    ...
    public static final int TYPE_meta = Util.getIntegerCodeForString(HtmlTags.META);
