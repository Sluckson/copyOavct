...
public final class TrackEncryptionBox {
    ...
    private static int schemeToCryptoMode(@Nullable String str) {
        ...
        switch (str.hashCode()) {
            case 3046605:
                if (str.equals(C1119C.CENC_TYPE_cbc1)) {
                    c = 2;
                    break;
                }
                break;
            case 3046671:
                if (str.equals(C1119C.CENC_TYPE_cbcs)) {
                    c = 3;
                    break;
                }
                break;
            case 3049879:
                if (str.equals(C1119C.CENC_TYPE_cenc)) {
                    c = 0;
                    break;
                }
                break;
            case 3049895:
                if (str.equals(C1119C.CENC_TYPE_cens)) {
                    c = 1;
                    break;
                }
                break;
        ...
        Log.m54w(TAG, "Unsupported protection scheme type '" + str + "'. Assuming AES-CTR crypto mode.");
        return 1;
    }
}
