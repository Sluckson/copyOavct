...
public final class AdtsExtractor implements Extractor {
    ...
    public boolean sniff(com.google.android.exoplayer2.extractor.ExtractorInput r9) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x0008:
            ...
            boolean r5 = com.google.android.exoplayer2.extractor.p008ts.AdtsReader.isAdtsSyncWord(r5)
        ...
        L_0x0055:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p008ts.AdtsExtractor.sniff(com.google.android.exoplayer2.extractor.ExtractorInput):boolean");
    }
    ...
    private void maybeOutputSeekMap(long j, boolean z, boolean z2) {
        if (!this.hasOutputSeekMap) {
            ...
            if (!z3 || this.reader.getSampleDurationUs() != C1119C.TIME_UNSET || z2) {
                ExtractorOutput extractorOutput2 = (ExtractorOutput) Assertions.checkNotNull(this.extractorOutput);
                if (!z3 || this.reader.getSampleDurationUs() == C1119C.TIME_UNSET) {
                    extractorOutput2.seekMap(new SeekMap.Unseekable(C1119C.TIME_UNSET));
                } else {
