...
public final class PsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        if ((this.timestampAdjuster.getTimestampOffsetUs() == C1119C.TIME_UNSET) || !(this.timestampAdjuster.getFirstSampleTimestampUs() == 0 || this.timestampAdjuster.getFirstSampleTimestampUs() == j2)) {
    ...
    private void maybeOutputSeekMap(long j) {
        if (!this.hasOutputSeekMap) {
            ...
            if (this.durationReader.getDurationUs() != C1119C.TIME_UNSET) {
