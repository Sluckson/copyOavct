...
public final class Ac4Reader implements ElementaryStreamReader {
    ...
    private boolean skipToNextSync(com.google.android.exoplayer2.util.ParsableByteArray r6) {
        ...
        L_0x0031:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p008ts.Ac4Reader.skipToNextSync(com.google.android.exoplayer2.util.ParsableByteArray):boolean");
    }
    ...
    private void parseHeader() {
        ...
        if (this.format == null || parseAc4SyncframeInfo.channelCount != this.format.channelCount || parseAc4SyncframeInfo.sampleRate != this.format.sampleRate || !MimeTypes.AUDIO_AC4.equals(this.format.sampleMimeType)) {
            this.format = Format.createAudioSampleFormat(this.trackFormatId, MimeTypes.AUDIO_AC4, (String) null, -1, -1, parseAc4SyncframeInfo.channelCount, parseAc4SyncframeInfo.sampleRate, (List<byte[]>) null, (DrmInitData) null, 0, this.language);
