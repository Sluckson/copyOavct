...
public abstract class Timeline {
    ...
    public static final class Window {
        ...
        public long getDefaultPositionMs() {
            return C1119C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getDurationMs() {
            return C1119C.usToMs(this.durationUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C1119C.usToMs(this.positionInFirstPeriodUs);
        }
    ...
    public static final class Period {
        ...
        public long getPositionInWindowMs() {
            return C1119C.usToMs(this.positionInWindowUs);
        }
        ...
        public long getAdDurationUs(int i, int i2) {
            AdPlaybackState.AdGroup adGroup = this.adPlaybackState.adGroups[i];
            return adGroup.count != -1 ? adGroup.durationsUs[i2] : C1119C.TIME_UNSET;
        }
    ...
    public final Pair<Object, Long> getPeriodPosition(Window window, Period period, int i, long j, long j2) {
        ...
        while (durationUs != C1119C.TIME_UNSET && positionInFirstPeriodUs >= durationUs && i2 < window.lastPeriodIndex) {
