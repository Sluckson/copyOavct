...
public final class NalUnitUtil {
    ...
    public static void discardToSps(ByteBuffer byteBuffer) {
        ...
        while (true) {
            ...
            if (i3 < position) {
                ...
                if (i2 == 3) {
                    if (b == 1 && (byteBuffer.get(i3) & Ascii.f275US) == 7) {
    ...
    public static boolean isNalUnitSei(String str, byte b) {
        if ("video/avc".equals(str) && (b & Ascii.f275US) == 6) {
            return true;
        }
    ...
    public static com.google.android.exoplayer2.util.NalUnitUtil.SpsData parseSpsNalUnit(byte[] r20, int r21, int r22) {
        ...
        L_0x014e:
            ...
            com.google.android.exoplayer2.util.Log.m54w(r2, r0)
        L_0x0164:
