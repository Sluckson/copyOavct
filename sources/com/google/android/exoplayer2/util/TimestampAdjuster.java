...
public final class TimestampAdjuster {
    ...
    private volatile long lastSampleTimestampUs = C1119C.TIME_UNSET;
    ...
    public synchronized void setFirstSampleTimestampUs(long j) {
        Assertions.checkState(this.lastSampleTimestampUs == C1119C.TIME_UNSET);
    ...
    public long getLastAdjustedTimestampUs() {
        if (this.lastSampleTimestampUs != C1119C.TIME_UNSET) {
            return this.timestampOffsetUs + this.lastSampleTimestampUs;
        }
        long j = this.firstSampleTimestampUs;
        return j != Long.MAX_VALUE ? j : C1119C.TIME_UNSET;
    }
    ...
    public long getTimestampOffsetUs() {
        ...
        return this.lastSampleTimestampUs == C1119C.TIME_UNSET ? C1119C.TIME_UNSET : this.timestampOffsetUs;
    }

    public void reset() {
        this.lastSampleTimestampUs = C1119C.TIME_UNSET;
    }
    ...
    public synchronized void waitUntilInitialized() throws InterruptedException {
        while (this.lastSampleTimestampUs == C1119C.TIME_UNSET) {
            wait();
        }
    }
