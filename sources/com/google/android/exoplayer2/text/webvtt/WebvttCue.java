    ...
    public static class Builder {
        ...
        private Builder derivePositionAnchorFromAlignment() {
            if (this.textAlignment == null) {
                ...
                int i = C12271.$SwitchMap$android$text$Layout$Alignment[this.textAlignment.ordinal()];
                if (i == 1) {
                    this.positionAnchor = 0;
                } else if (i == 2) {
                    this.positionAnchor = 1;
                } else if (i != 3) {
                    Log.m54w(TAG, "Unrecognized alignment: " + this.textAlignment);
                    this.positionAnchor = 0;
                } else {
    ...
    static /* synthetic */ class C12271 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.text.webvtt.WebvttCue.C12271.<clinit>():void");
        }
    }
}
