...
public class SsManifest implements FilterableManifest<SsManifest> {
    ...
    public SsManifest(int i, int i2, long j, long j2, long j3, int i3, boolean z, ProtectionElement protectionElement2, StreamElement[] streamElementArr) {
        this(i, i2, j2 == 0 ? -9223372036854775807L : Util.scaleLargeTimestamp(j2, 1000000, j), j3 != 0 ? Util.scaleLargeTimestamp(j3, 1000000, j) : C1119C.TIME_UNSET, i3, z, protectionElement2, streamElementArr);
    }
