...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    private static class StreamIndexParser extends ElementParser {
        ...
        private void parseStreamFragmentStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            long parseLong = parseLong(xmlPullParser, KEY_FRAGMENT_START_TIME, C1119C.TIME_UNSET);
            int i = 1;
            if (parseLong == C1119C.TIME_UNSET) {
                if (size == 0) {
                    parseLong = 0;
            ...
            this.lastChunkDuration = parseLong(xmlPullParser, KEY_FRAGMENT_DURATION, C1119C.TIME_UNSET);
            long parseLong2 = parseLong(xmlPullParser, KEY_FRAGMENT_REPEAT_COUNT, 1);
            if (parseLong2 <= 1 || this.lastChunkDuration != C1119C.TIME_UNSET) {
                while (true) {
                    long j = (long) i;
                    if (j < parseLong2) {
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (intValue == 2) {
                this.format = Format.createVideoContainerFormat(attributeValue, str, MimeTypes.VIDEO_MP4, fourCCToMimeType, (String) null, parseRequiredInt, parseRequiredInt(xmlPullParser2, KEY_MAX_WIDTH), parseRequiredInt(xmlPullParser2, KEY_MAX_HEIGHT), -1.0f, buildCodecSpecificData(xmlPullParser2.getAttributeValue((String) null, KEY_CODEC_PRIVATE_DATA)), 0, 0);
            } else if (intValue == 1) {
                ...
                this.format = Format.createAudioContainerFormat(attributeValue, str, MimeTypes.AUDIO_MP4, fourCCToMimeType, (String) null, parseRequiredInt, parseRequiredInt2, parseRequiredInt3, buildCodecSpecificData, 0, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
            } else if (intValue == 3) {
                ...
                this.format = Format.createTextContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, fourCCToMimeType, (String) null, parseRequiredInt, 0, c != 0 ? c != 1 ? 0 : 1024 : 64, (String) getNormalizedAttribute(KEY_LANGUAGE));
            } else {
                this.format = Format.createContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, fourCCToMimeType, (String) null, parseRequiredInt, 0, 0, (String) null);
            }
        }
