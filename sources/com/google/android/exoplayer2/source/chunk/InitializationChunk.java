...
public final class InitializationChunk extends Chunk {
    ...
    public InitializationChunk(DataSource dataSource, DataSpec dataSpec, Format format, int i, @Nullable Object obj, ChunkExtractorWrapper chunkExtractorWrapper) {
        super(dataSource, dataSpec, 2, format, i, obj, C1119C.TIME_UNSET, C1119C.TIME_UNSET);
    ...
    public void load() throws IOException, InterruptedException {
        ...
        try {
            ...
            if (this.nextLoadPosition == 0) {
                this.extractorWrapper.init((ChunkExtractorWrapper.TrackOutputProvider) null, C1119C.TIME_UNSET, C1119C.TIME_UNSET);
            }
