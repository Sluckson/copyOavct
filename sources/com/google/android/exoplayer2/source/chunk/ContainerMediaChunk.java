    ...
    public final void load() throws IOException, InterruptedException {
        ...
        try {
            ...
            if (this.nextLoadPosition == 0) {
                ...
                this.extractorWrapper.init(getTrackOutputProvider(output), this.clippedStartTimeUs == C1119C.TIME_UNSET ? -9223372036854775807L : this.clippedStartTimeUs - this.sampleOffsetUs, this.clippedEndTimeUs == C1119C.TIME_UNSET ? -9223372036854775807L : this.clippedEndTimeUs - this.sampleOffsetUs);
            }
