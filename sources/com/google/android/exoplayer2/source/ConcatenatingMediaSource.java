...
public class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    private void updateMediaSourceInternal(com.google.android.exoplayer2.source.ConcatenatingMediaSource.MediaSourceHolder r14, com.google.android.exoplayer2.Timeline r15) {
        ...
        L_0x0080:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r15 = r0.f139id
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r1 = r0.f139id
    ...
    private static final class DummyTimeline extends Timeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, boolean z, long j) {
            return window.set(this.tag, C1119C.TIME_UNSET, C1119C.TIME_UNSET, false, true, 0, C1119C.TIME_UNSET, 0, 0, 0);
        }

        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            return period.set(0, DeferredTimeline.DUMMY_ID, 0, C1119C.TIME_UNSET, 0);
        }
