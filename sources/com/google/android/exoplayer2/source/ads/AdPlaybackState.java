...
public final class AdPlaybackState {
    ...
    public static final class AdGroup {
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(copyOf, length, max, C1119C.TIME_UNSET);
            return copyOf;
        }
    }
    ...
    public AdPlaybackState(long... jArr) {
        ...
        this.contentDurationUs = C1119C.TIME_UNSET;
    }
    ...
    public int getAdGroupIndexAfterPositionUs(long j, long j2) {
        if (j == Long.MIN_VALUE || (j2 != C1119C.TIME_UNSET && j >= j2)) {
            return -1;
        }
        int i = 0;
        while (true) {
