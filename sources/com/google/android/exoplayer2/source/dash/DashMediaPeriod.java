...
final class DashMediaPeriod implements MediaPeriod, SequenceableLoader.Callback<ChunkSampleStream<DashChunkSource>>, ChunkSampleStream.ReleaseCallback<DashChunkSource> {
    ...
    public void updateManifest(DashManifest dashManifest, int i) {
        ...
        for (EventSampleStream eventSampleStream : this.eventSampleStreams) {
            ...
            while (true) {
                ...
                if (next.mo16026id().equals(eventSampleStream.eventStreamId())) {
                    boolean z = true;
    ...
    private static int[][] getGroupedAdaptationSetIndices(List<AdaptationSet> list) {
        ...
        for (int i = 0; i < size; i++) {
            sparseIntArray.put(list.get(i).f143id, i);
        }
    ...
    private static int buildPrimaryAndEmbeddedTrackGroupInfos(List<AdaptationSet> list, int[][] iArr, int i, boolean[] zArr, Format[][] formatArr, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr) {
        ...
        while (i5 < i4) {
            ...
            if (i9 != -1) {
                trackGroupArr[i9] = new TrackGroup(Format.createSampleFormat(adaptationSet.f143id + ":emsg", MimeTypes.APPLICATION_EMSG, (String) null, -1, (DrmInitData) null));
    ...
    private static void buildManifestEventTrackGroupInfos(List<EventStream> list, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr, int i) {
        ...
        int i3 = 0;
        while (i3 < list.size()) {
            trackGroupArr[i2] = new TrackGroup(Format.createSampleFormat(list.get(i3).mo16026id(), MimeTypes.APPLICATION_EMSG, (String) null, -1, (DrmInitData) null));
        ...
        for (int i : iArr) {
            ...
            for (int i2 = 0; i2 < list2.size(); i2++) {
                ...
                if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri)) {
                    ...
                    if (str == null) {
                        return new Format[]{buildCea608TrackFormat(adaptationSet.f143id)};
                    }
                    ...
                    for (int i3 = 0; i3 < split.length; i3++) {
                        ...
                        formatArr[i3] = buildCea608TrackFormat(adaptationSet.f143id, matcher.group(2), Integer.parseInt(matcher.group(1)));
                    }
                    return formatArr;
                }
            }
    ...
    private static Format buildCea608TrackFormat(int i, String str, int i2) {
        ...
        sb.append(str2);
        return Format.createTextSampleFormat(sb.toString(), MimeTypes.APPLICATION_CEA608, (String) null, -1, 0, str, i2, (DrmInitData) null, Long.MAX_VALUE, (List<byte[]>) null);
    }
