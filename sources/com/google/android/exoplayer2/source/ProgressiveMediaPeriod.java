...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public ProgressiveMediaPeriod(Uri uri2, DataSource dataSource2, Extractor[] extractorArr, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, MediaSourceEventListener.EventDispatcher eventDispatcher2, Listener listener2, Allocator allocator2, @Nullable String str, int i) {
        this.uri = uri2;
        ...
        this.pendingResetPositionUs = C1119C.TIME_UNSET;
        this.length = -1;
    ...
    public void onLoadCompleted(ExtractingLoadable extractingLoadable, long j, long j2) {
        SeekMap seekMap2;
        if (this.durationUs == C1119C.TIME_UNSET && (seekMap2 = this.seekMap) != null) {
    ...
    public void seekMap(SeekMap seekMap2) {
        if (this.icyHeaders != null) {
            seekMap2 = new SeekMap.Unseekable(C1119C.TIME_UNSET);
        }
    ...
    public void maybeFinishPrepare() {
        ...
        if (!this.released && !this.prepared && this.sampleQueuesBuilt && seekMap2 != null) {
            ...
            this.dataType = (this.length == -1 && seekMap2.getDurationUs() == C1119C.TIME_UNSET) ? 7 : 1;
    ...
    private void startLoading() {
        ...
        if (this.prepared) {
            ...
            if (j == C1119C.TIME_UNSET || this.pendingResetPositionUs <= j) {
    ...
    private boolean configureRetry(ExtractingLoadable extractingLoadable, int i) {
        SeekMap seekMap2;
        if (this.length == -1 && ((seekMap2 = this.seekMap) == null || seekMap2.getDurationUs() == C1119C.TIME_UNSET)) {
    ...
    private boolean isPendingReset() {
        return this.pendingResetPositionUs != C1119C.TIME_UNSET;
    }
    ...
    private static final class TrackId {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f140id == trackId.f140id && this.isIcyTrack == trackId.isIcyTrack) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f140id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
}
