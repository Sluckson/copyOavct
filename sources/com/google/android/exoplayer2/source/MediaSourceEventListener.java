...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaPeriodId2) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo15675xa9fff584(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo15675xa9fff584(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2) {
        ...
        public void mediaPeriodReleased() {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaPeriodId2) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo15676xb596e71e(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo15676xb596e71e(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2) {
        ...
        public void loadStarted(DataSpec dataSpec, int i, long j) {
            loadStarted(dataSpec, i, -1, (Format) null, 0, (Object) null, C1119C.TIME_UNSET, C1119C.TIME_UNSET, j);
        }
        ...
        public void loadCompleted(DataSpec dataSpec, Uri uri, Map<String, List<String>> map, int i, long j, long j2, long j3) {
            loadCompleted(dataSpec, uri, map, i, -1, (Format) null, 0, (Object) null, C1119C.TIME_UNSET, C1119C.TIME_UNSET, j, j2, j3);
        }
        ...
        public void loadCanceled(DataSpec dataSpec, Uri uri, Map<String, List<String>> map, int i, long j, long j2, long j3) {
            loadCanceled(dataSpec, uri, map, i, -1, (Format) null, 0, (Object) null, C1119C.TIME_UNSET, C1119C.TIME_UNSET, j, j2, j3);
        }
        ...
        public void loadError(DataSpec dataSpec, Uri uri, Map<String, List<String>> map, int i, long j, long j2, long j3, IOException iOException, boolean z) {
            loadError(dataSpec, uri, map, i, -1, (Format) null, 0, (Object) null, C1119C.TIME_UNSET, C1119C.TIME_UNSET, j, j2, j3, iOException, z);
        }
        ...
        public void upstreamDiscarded(MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaPeriodId2, mediaLoadData) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo15678xcce9218(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo15678xcce9218(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2, MediaLoadData mediaLoadData) {
        ...
        public void downstreamFormatChanged(int i, @Nullable Format format, int i2, @Nullable Object obj, long j) {
            downstreamFormatChanged(new MediaLoadData(1, i, format, i2, obj, adjustMediaTime(j), C1119C.TIME_UNSET));
        }
        ...
        public void downstreamFormatChanged(MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaLoadData) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo15670x9a021abe(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo15670x9a021abe(MediaSourceEventListener mediaSourceEventListener, MediaLoadData mediaLoadData) {
            mediaSourceEventListener.onDownstreamFormatChanged(this.windowIndex, this.mediaPeriodId, mediaLoadData);
        }

        private long adjustMediaTime(long j) {
            long usToMs = C1119C.usToMs(j);
            if (usToMs == C1119C.TIME_UNSET) {
