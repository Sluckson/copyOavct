...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        this.disableView.setText(C1247R.string.exo_track_selection_none);
        ...
        addView(this.inflater.inflate(C1247R.C1251layout.exo_list_divider, this, false));
        ...
        this.defaultView.setText(C1247R.string.exo_track_selection_auto);
    ...
    public void init(MappingTrackSelector.MappedTrackInfo mappedTrackInfo2, int i, boolean z, List<DefaultTrackSelector.SelectionOverride> list, @Nullable TrackSelectionListener trackSelectionListener) {
