...
final class SubtitlePainter {
    ...
    private void setupTextLayout() {
        ...
        if (i9 <= 0) {
            Log.m54w(TAG, "Skipped drawing subtitle cue (insufficient space)");
            return;
        }
        ...
        int i15 = i - i2;
        if (i15 <= 0) {
            Log.m54w(TAG, "Skipped drawing subtitle cue (invalid horizontal positioning)");
            return;
        }
    ...
    private void setupBitmapLayout() {
        ...
        L_0x0064:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p009ui.SubtitlePainter.setupBitmapLayout():void");
    }
