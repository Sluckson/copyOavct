...
import com.google.android.exoplayer2.p009ui.spherical.SingleTapListener;
import com.google.android.exoplayer2.p009ui.spherical.SphericalSurfaceView;
...
public class PlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i8 = C1247R.C1251layout.exo_player_view;
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C1247R.styleable.PlayerView, 0, 0);
            try {
                z4 = obtainStyledAttributes.hasValue(C1247R.styleable.PlayerView_shutter_background_color);
                i5 = obtainStyledAttributes.getColor(C1247R.styleable.PlayerView_shutter_background_color, 0);
                int resourceId = obtainStyledAttributes.getResourceId(C1247R.styleable.PlayerView_player_layout_id, i8);
                z3 = obtainStyledAttributes.getBoolean(C1247R.styleable.PlayerView_use_artwork, true);
                i4 = obtainStyledAttributes.getResourceId(C1247R.styleable.PlayerView_default_artwork, 0);
                boolean z8 = obtainStyledAttributes.getBoolean(C1247R.styleable.PlayerView_use_controller, true);
                i3 = obtainStyledAttributes.getInt(C1247R.styleable.PlayerView_surface_type, 1);
                i2 = obtainStyledAttributes.getInt(C1247R.styleable.PlayerView_resize_mode, 0);
                int i9 = obtainStyledAttributes.getInt(C1247R.styleable.PlayerView_show_timeout, 5000);
                boolean z9 = obtainStyledAttributes.getBoolean(C1247R.styleable.PlayerView_hide_on_touch, true);
                boolean z10 = obtainStyledAttributes.getBoolean(C1247R.styleable.PlayerView_auto_show, true);
                int i10 = resourceId;
                i7 = obtainStyledAttributes.getInteger(C1247R.styleable.PlayerView_show_buffering, 0);
                boolean z11 = z9;
                this.keepContentOnPlayerReset = obtainStyledAttributes.getBoolean(C1247R.styleable.PlayerView_keep_content_on_player_reset, this.keepContentOnPlayerReset);
                boolean z12 = obtainStyledAttributes.getBoolean(C1247R.styleable.PlayerView_hide_during_ads, true);
        ...
        this.contentFrame = (AspectRatioFrameLayout) findViewById(C1247R.C1250id.exo_content_frame);
        AspectRatioFrameLayout aspectRatioFrameLayout = this.contentFrame;
        if (aspectRatioFrameLayout != null) {
            setResizeModeRaw(aspectRatioFrameLayout, i2);
        }
        this.shutterView = findViewById(C1247R.C1250id.exo_shutter);
        ...
        this.adOverlayFrameLayout = (FrameLayout) findViewById(C1247R.C1250id.exo_ad_overlay);
        this.overlayFrameLayout = (FrameLayout) findViewById(C1247R.C1250id.exo_overlay);
        this.artworkView = (ImageView) findViewById(C1247R.C1250id.exo_artwork);
        this.useArtwork = z3 && this.artworkView != null;
        if (i4 != 0) {
            this.defaultArtwork = ContextCompat.getDrawable(getContext(), i4);
        }
        this.subtitleView = (SubtitleView) findViewById(C1247R.C1250id.exo_subtitles);
        SubtitleView subtitleView2 = this.subtitleView;
        if (subtitleView2 != null) {
            subtitleView2.setUserDefaultStyle();
            this.subtitleView.setUserDefaultTextSize();
        }
        this.bufferingView = findViewById(C1247R.C1250id.exo_buffering);
        View view2 = this.bufferingView;
        if (view2 != null) {
            view2.setVisibility(8);
        }
        this.showBuffering = i7;
        this.errorMessageView = (TextView) findViewById(C1247R.C1250id.exo_error_message);
        TextView textView = this.errorMessageView;
        if (textView != null) {
            textView.setVisibility(8);
        }
        PlayerControlView playerControlView = (PlayerControlView) findViewById(C1247R.C1250id.exo_controller);
        View findViewById = findViewById(C1247R.C1250id.exo_controller_placeholder);
        if (playerControlView != null) {
            ...
            this.controller.setId(C1247R.C1250id.exo_controller);
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if (z && !this.controller.isVisible()) {
    ...
    private static void configureEditModeLogoV23(Resources resources, ImageView imageView) {
        imageView.setImageDrawable(resources.getDrawable(C1247R.C1249drawable.exo_edit_mode_logo, (Resources.Theme) null));
        imageView.setBackgroundColor(resources.getColor(C1247R.C1248color.exo_edit_mode_background_color, (Resources.Theme) null));
    }

    private static void configureEditModeLogo(Resources resources, ImageView imageView) {
        imageView.setImageDrawable(resources.getDrawable(C1247R.C1249drawable.exo_edit_mode_logo));
        imageView.setBackgroundColor(resources.getColor(C1247R.C1248color.exo_edit_mode_background_color));
    }
