...
public final class DefaultAudioSink implements AudioSink {
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (this.inputBuffer == null) {
            ...
            if (this.startMediaTimeState == 0) {
                ...
                if (this.startMediaTimeState == 1 && Math.abs(inputFramesToDurationUs - j2) > 200000) {
                    Log.m50e(TAG, "Discontinuity detected [expected " + inputFramesToDurationUs + ", got " + j2 + "]");
                    this.startMediaTimeState = 2;
                }
        ...
        if (!this.inputBuffer.hasRemaining()) {
            ...
            Log.m54w(TAG, "Resetting stalled audio track");
            flush();
            return true;
        }
    }
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            if (!DefaultAudioSink.failOnSpuriousAudioTimestamp) {
                Log.m54w(DefaultAudioSink.TAG, str);
                return;
            }
        ...
        public void onInvalidLatency(long j) {
            Log.m54w(DefaultAudioSink.TAG, "Ignoring impossibly large audio latency: " + j);
        }
