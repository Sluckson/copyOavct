...
final class AudioTrackPositionTracker {
    ...
    public void setAudioTrack(AudioTrack audioTrack2, int i, int i2, int i3) {
        ...
        this.hasData = false;
        this.stopTimestampUs = C1119C.TIME_UNSET;
        this.forceResetWorkaroundTimeMs = C1119C.TIME_UNSET;
        this.latencyUs = 0;
    }
    ...
    public boolean mayHandleBuffer(long j) {
        ...
        if (z && !this.hasData && playState != 1 && (listener2 = this.listener) != null) {
            listener2.onUnderrun(this.bufferSize, C1119C.usToMs(this.bufferSizeUs));
        }
        return true;
    }
    ...
    public boolean isStalled(long j) {
        return this.forceResetWorkaroundTimeMs != C1119C.TIME_UNSET && j > 0 && SystemClock.elapsedRealtime() - this.forceResetWorkaroundTimeMs >= FORCE_RESET_WORKAROUND_TIMEOUT_MS;
    }
    ...
    public boolean pause() {
        resetSyncParams();
        if (this.stopTimestampUs != C1119C.TIME_UNSET) {
            return false;
        }
        ((AudioTimestampPoller) Assertions.checkNotNull(this.audioTimestampPoller)).reset();
        return true;
    ...
    private long getPlaybackHeadPosition() {
        ...
        if (Util.SDK_INT <= 29) {
            if (playbackHeadPosition == 0 && this.lastRawPlaybackHeadPosition > 0 && playState == 3) {
                if (this.forceResetWorkaroundTimeMs == C1119C.TIME_UNSET) {
