...
public final class Ac4Util {
    ...
    private static final int[] SAMPLE_COUNT = {2002, 2000, 1920, 1601, 1600, 1001, 1000, 960, LogSeverity.EMERGENCY_VALUE, LogSeverity.EMERGENCY_VALUE, WOWZMediaConfig.DEFAULT_VIDEO_FRAME_HEIGHT, 400, 400, 2048};
    ...
    public static Format parseAc4AnnexEFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, MimeTypes.AUDIO_AC4, (String) null, -1, -1, 2, ((parsableByteArray.readUnsignedByte() & 32) >> 5) == 1 ? 48000 : WOWZMediaConfig.DEFAULT_AUDIO_SAMPLE_RATE, (List<byte[]>) null, drmInitData, 0, str2);
    }
