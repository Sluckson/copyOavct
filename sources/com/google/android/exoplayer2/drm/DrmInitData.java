...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    private DrmInitData(@androidx.annotation.Nullable java.lang.String r1, boolean r2, com.google.android.exoplayer2.drm.DrmInitData.SchemeData... r3) {
        ...
        L_0x000e:
            ...
            com.google.android.exoplayer2.drm.DrmInitData$SchemeData[] r1 = r0.schemeDatas
    ...
    public int compare(SchemeData schemeData, SchemeData schemeData2) {
        if (C1119C.UUID_NIL.equals(schemeData.uuid)) {
            return C1119C.UUID_NIL.equals(schemeData2.uuid) ? 0 : 1;
        }
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public boolean matches(UUID uuid2) {
            return C1119C.UUID_NIL.equals(this.uuid) || uuid2.equals(this.uuid);
        }
