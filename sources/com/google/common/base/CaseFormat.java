...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m109is('-'), "-") {
    ...
    LOWER_UNDERSCORE(CharMatcher.m109is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String str) {
            return Ascii.toLowerCase(str);
        }
    ...
    UPPER_UNDERSCORE(CharMatcher.m109is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String str) {
            return Ascii.toUpperCase(str);
        }
    ...
    /* renamed from: to */
    public final String mo28444to(CaseFormat caseFormat, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.mo28444to(this.targetFormat, str);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String str) {
            return this.targetFormat.mo28444to(this.sourceFormat, str);
        }
