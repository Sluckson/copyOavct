...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m109is(char c) {
        return new C1663Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m109is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo28465or(CharMatcher charMatcher) {
        return new C1664Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m109is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C1664Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1664Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C1663Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo28465or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo28465or(charMatcher);
        }
