...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m123or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m124or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m122or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m121in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f279f;

        /* renamed from: p */
        final Predicate<B> f280p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f280p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f279f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f280p.apply(this.f279f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f279f.equals(compositionPredicate.f279f) || !this.f280p.equals(compositionPredicate.f280p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f279f.hashCode() ^ this.f280p.hashCode();
        }

        public String toString() {
            return this.f280p + "(" + this.f279f + ")";
        }
    }
