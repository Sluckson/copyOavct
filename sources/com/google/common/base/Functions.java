...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f277f;

        /* renamed from: g */
        private final Function<B, C> f278g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f278g = (Function) Preconditions.checkNotNull(function);
            this.f277f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f278g.apply(this.f277f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f277f.equals(functionComposition.f277f) || !this.f278g.equals(functionComposition.f278g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f277f.hashCode() ^ this.f278g.hashCode();
        }

        public String toString() {
            return this.f278g + "(" + this.f277f + ")";
        }
    }
