...
import com.google.common.p013io.ByteSource;
import com.google.common.p013io.CharSource;
import com.google.common.p013io.Resources;
import java.io.File;
...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m131on(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m283of(String str, ClassLoader classLoader) {
    ...
    static abstract class Scanner {
        ...
        static com.google.common.collect.ImmutableList<java.net.URL> parseJavaClassPath() {
            /*
                ...
                com.google.common.base.Splitter r1 = com.google.common.base.Splitter.m131on((java.lang.String) r1)
    ...
    static final class DefaultScanner extends Scanner {
        ...
        public ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry next : this.resources.entries()) {
                builder.add((Object) ResourceInfo.m283of((String) next.getValue(), (ClassLoader) next.getKey()));
            }
            return builder.build();
        }
