...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m146of(), ImmutableList.m146of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m184of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m185of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m147of(range), ImmutableList.m147of(v));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return new ImmutableRangeMap<K, V>(new ImmutableList<Range<K>>() {
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range) {
                ...
                return ImmutableRangeMap.m184of();
            }
        };
    }
