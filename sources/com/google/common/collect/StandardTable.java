    ...
    private class Column extends Maps.ViewCachingAbstractMap<R, V> {
        ...
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m121in(collection)));
            }
        }
        ...
        private class KeySet extends Maps.KeySet<R, V> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m121in(collection))));
            }
        }
        ...
        private class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m121in(collection)));
            }

            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m121in(collection))));
            }
        }
    }
