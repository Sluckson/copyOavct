...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    private static final class BelowValue<C extends Comparable> extends Cut<C> {
        ...
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> discreteDomain) {
            int i = C17521.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
            if (i == 1) {
                return this;
            }
            if (i == 2) {
    ...
    static /* synthetic */ class C17521 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.Cut.C17521.<clinit>():void");
        }
    }
