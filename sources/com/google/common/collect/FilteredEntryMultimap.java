    ...
    class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        public Set<K> createKeySet() {
            return new Maps.KeySet<K, Collection<V>>() {
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.m121in(collection)));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m121in(collection))));
                }
        ...
        public Set<Map.Entry<K, Collection<V>>> createEntrySet() {
            return new Maps.EntrySet<K, Collection<V>>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.m121in(collection));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.not(Predicates.m121in(collection)));
                }
        ...
        public Collection<Collection<V>> createValues() {
            return new Maps.Values<K, Collection<V>>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.m121in(collection)));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m121in(collection))));
                }
            };
        }
    }
    ...
    class Keys extends Multimaps.Keys<K, V> {
        ...
        public Set<Multiset.Entry<K>> entrySet() {
            return new Multisets.EntrySet<K>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return removeEntriesIf(Predicates.m121in(collection));
                }

                public boolean retainAll(Collection<?> collection) {
                    return removeEntriesIf(Predicates.not(Predicates.m121in(collection)));
                }
            };
        }
    }
