...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m147of(Range.all()));
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m146of());
    @LazyInit
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m186of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m187of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m147of(range));
    }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m226of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m186of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m147of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
