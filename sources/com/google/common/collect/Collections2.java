...
public final class Collections2 {
    ...
    static StringBuilder newStringBuilderForCollection(int i) {
        CollectPreconditions.checkNonnegative(i, ElementTags.SIZE);
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            int size = list2.size();
            this.f297c = new int[size];
            this.f299o = new int[size];
            Arrays.fill(this.f297c, 0);
            Arrays.fill(this.f299o, 1);
        }
        ...
        /* access modifiers changed from: package-private */
        public void calculateNextPermutation() {
            this.f298j = this.list.size() - 1;
            if (this.f298j != -1) {
                int i = 0;
                while (true) {
                    int[] iArr = this.f297c;
                    int i2 = this.f298j;
                    int i3 = iArr[i2] + this.f299o[i2];
                    if (i3 < 0) {
                        switchDirection();
                    } else if (i3 != i2 + 1) {
                        Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                        this.f297c[this.f298j] = i3;
                        return;
                    } else if (i2 != 0) {
                        i++;
                        switchDirection();
