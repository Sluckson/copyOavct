...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: at */
    public V mo29356at(int i, int i2) {
    ...
    public V get(@NullableDecl Object obj, @NullableDecl Object obj2) {
        ...
        return mo29356at(num.intValue(), num2.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(final int i) {
        return new Tables.AbstractCell<R, C, V>() {
            ...
            public V getValue() {
                return ArrayTable.this.mo29356at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int i) {
        return mo29356at(i / this.columnList.size(), i % this.columnList.size());
    }

    public Map<R, V> column(C c) {
        Preconditions.checkNotNull(c);
        Integer num = this.columnKeyToIndex.get(c);
        return num == null ? ImmutableMap.m165of() : new Column(num.intValue());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int i) {
            return ArrayTable.this.mo29356at(i, this.columnIndex);
        }
    ...
    public Map<C, V> row(R r) {
        Preconditions.checkNotNull(r);
        Integer num = this.rowKeyToIndex.get(r);
        return num == null ? ImmutableMap.m165of() : new Row(num.intValue());
    }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int i) {
            return ArrayTable.this.mo29356at(this.rowIndex, i);
        }
