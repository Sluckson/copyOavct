...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m239of() {
        return SparseImmutableTable.EMPTY;
    }

    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m240of(R r, C c, V v) {
    ...
    public static final class Builder<R, C, V> {
        ...
        public Builder<R, C, V> put(Table.Cell<? extends R, ? extends C, ? extends V> cell) {
            if (cell instanceof Tables.ImmutableCell) {
                Preconditions.checkNotNull(cell.getRowKey(), ElementTags.ROW);
    ...
    public ImmutableMap<R, V> column(C c) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(c), ImmutableMap.m165of());
    }
    ...
    public ImmutableMap<C, V> row(R r) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(r), ImmutableMap.m165of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            ...
            int i = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m240of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
