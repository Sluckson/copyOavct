...
public final class IntMath {
    ...
    @VisibleForTesting
    static final int[] halfPowersOf10 = {3, 31, TIFFConstants.TIFFTAG_HOSTCOMPUTER, 3162, 31622, 316227, 3162277, 31622776, 316227766, Integer.MAX_VALUE};
    @VisibleForTesting
    ...
    static /* synthetic */ class C20391 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.IntMath.C20391.<clinit>():void");
        }
    }

    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", i);
        switch (C20391.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(int r3, java.math.RoundingMode r4) {
        /*
            ...
            int[] r1 = powersOf10
            r1 = r1[r0]
            int[] r2 = com.google.common.math.IntMath.C20391.$SwitchMap$java$math$RoundingMode
            int r4 = r4.ordinal()
            r4 = r2[r4]
            switch(r4) {
    ...
    public static int sqrt(int r2, java.math.RoundingMode r3) {
        /*
            ...
            int r0 = sqrtFloor(r2)
            int[] r1 = com.google.common.math.IntMath.C20391.$SwitchMap$java$math$RoundingMode
            int r3 = r3.ordinal()
            r3 = r1[r3]
            switch(r3) {
    ...
    public static int divide(int r5, int r6, java.math.RoundingMode r7) {
        ...
        L_0x000e:
            ...
            r2 = 1
            r5 = r5 | r2
            int[] r3 = com.google.common.math.IntMath.C20391.$SwitchMap$java$math$RoundingMode
            int r4 = r7.ordinal()
            r3 = r3[r4]
            r4 = 0
            switch(r3) {
    ...
    public static int gcd(int i, int i2) {
        MathPreconditions.checkNonNegative(HtmlTags.ANCHOR, i);
        MathPreconditions.checkNonNegative(HtmlTags.f603B, i2);
        if (i == 0) {
            return i2;
        }
        if (i2 == 0) {
