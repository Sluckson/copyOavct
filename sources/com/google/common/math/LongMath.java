...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, TIFFConstants.TIFFTAG_CELLLENGTH, HttpStatus.SC_PARTIAL_CONTENT, 169, CipherSuite.TLS_DHE_PSK_WITH_3DES_EDE_CBC_SHA, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    @VisibleForTesting
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, MetaDo.META_TEXTOUT, 684, HttpStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE, TIFFConstants.TIFFTAG_YPOSITION, 214, 169, CipherSuite.TLS_PSK_WITH_3DES_EDE_CBC_SHA, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    static /* synthetic */ class C20411 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.LongMath.C20411.<clinit>():void");
        }
    }

    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C20411.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(long r4, java.math.RoundingMode r6) {
        /*
            ...
            long[] r1 = powersOf10
            r2 = r1[r0]
            int[] r1 = com.google.common.math.LongMath.C20411.$SwitchMap$java$math$RoundingMode
            int r6 = r6.ordinal()
            r6 = r1[r6]
            switch(r6) {
    ...
    public static long divide(long r9, long r11, java.math.RoundingMode r13) {
        ...
        L_0x0010:
            ...
            r9 = 1
            r10 = r10 | r9
            int[] r7 = com.google.common.math.LongMath.C20411.$SwitchMap$java$math$RoundingMode
            int r8 = r13.ordinal()
            r7 = r7[r8]
            r8 = 0
            switch(r7) {
    ...
    public static long gcd(long j, long j2) {
        MathPreconditions.checkNonNegative(HtmlTags.ANCHOR, j);
        MathPreconditions.checkNonNegative(HtmlTags.f603B, j2);
        if (j == 0) {
            return j2;
        }
        if (j2 == 0) {
