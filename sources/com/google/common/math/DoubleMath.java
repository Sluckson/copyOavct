...
public final class DoubleMath {
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C20381.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C20381 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C20381.<clinit>():void");
        }
    }
