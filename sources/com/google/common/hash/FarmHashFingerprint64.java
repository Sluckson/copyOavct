...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    /* renamed from: K0 */
    private static final long f305K0 = -4348849565147123417L;

    /* renamed from: K1 */
    private static final long f306K1 = -5435081209227447693L;

    /* renamed from: K2 */
    private static final long f307K2 = -7286425919675154353L;
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        if (i2 >= 8) {
            long j = ((long) (i2 * 2)) + f307K2;
            long load64 = LittleEndianByteArray.load64(bArr, i) + f307K2;
            ...
            return hashLength16(((long) i2) + ((((long) LittleEndianByteArray.load32(bArr, i)) & 4294967295L) << 3), ((long) LittleEndianByteArray.load32(bArr, (i + i2) - 4)) & 4294967295L, ((long) (i2 * 2)) + f307K2);
        } else if (i2 <= 0) {
            return f307K2;
        } else {
            return shiftMix((((long) ((bArr[i] & 255) + ((bArr[(i2 >> 1) + i] & 255) << 8))) * f307K2) ^ (((long) (i2 + ((bArr[i + (i2 - 1)] & 255) << 2))) * f305K0)) * f307K2;
        }
    }
    ...
    private static long hashLength17to32(byte[] bArr, int i, int i2) {
        byte[] bArr2 = bArr;
        long j = ((long) (i2 * 2)) + f307K2;
        long load64 = LittleEndianByteArray.load64(bArr, i) * f306K1;
        long load642 = LittleEndianByteArray.load64(bArr2, i + 8);
        int i3 = i + i2;
        long load643 = LittleEndianByteArray.load64(bArr2, i3 - 8) * j;
        return hashLength16((LittleEndianByteArray.load64(bArr2, i3 - 16) * f307K2) + Long.rotateRight(load64 + load642, 43) + Long.rotateRight(load643, 30), load64 + Long.rotateRight(load642 + f307K2, 18) + load643, j);
    }
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        int i3 = i + i2;
        long load643 = LittleEndianByteArray.load64(bArr2, i3 - 8) * j;
        long rotateRight = Long.rotateRight(load64 + load642, 43) + Long.rotateRight(load643, 30) + (LittleEndianByteArray.load64(bArr2, i3 - 16) * f307K2);
        long hashLength16 = hashLength16(rotateRight, load643 + Long.rotateRight(load642 + f307K2, 18) + load64, j);
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        byte[] bArr2 = bArr;
        long shiftMix = shiftMix(-7956866745689871395L) * f307K2;
        ...
        int i7 = i;
        while (true) {
            long rotateRight = Long.rotateRight(load64 + j + jArr[0] + LittleEndianByteArray.load64(bArr2, i7 + 8), 37) * f306K1;
            long rotateRight2 = Long.rotateRight(j + jArr[1] + LittleEndianByteArray.load64(bArr2, i7 + 48), 42) * f306K1;
            long j2 = rotateRight ^ jArr2[1];
            long load642 = rotateRight2 + jArr[0] + LittleEndianByteArray.load64(bArr2, i7 + 40);
            long rotateRight3 = Long.rotateRight(shiftMix + jArr2[0], 33) * f306K1;
            weakHashLength32WithSeeds(bArr, i7, jArr[1] * f306K1, j2 + jArr2[0], jArr);
            weakHashLength32WithSeeds(bArr, i7 + 32, rotateRight3 + jArr2[1], load642 + LittleEndianByteArray.load64(bArr2, i7 + 16), jArr2);
            i7 += 64;
            if (i7 == i4) {
                long j3 = ((j2 & 255) << 1) + f306K1;
                ...
                long j4 = j3;
                return hashLength16(hashLength16(jArr[0], jArr2[0], j4) + (shiftMix(rotateRight5) * f305K0) + rotateRight4, hashLength16(jArr[1], jArr2[1], j4) + rotateRight6, j4);
            }
            shiftMix = j2;
            j = load642;
            load64 = rotateRight3;
