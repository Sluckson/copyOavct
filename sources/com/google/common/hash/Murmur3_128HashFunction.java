...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f308C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f309C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            this.f310h1 = mixK1(j) ^ this.f310h1;
            this.f310h1 = Long.rotateLeft(this.f310h1, 27);
            long j3 = this.f310h1;
            long j4 = this.f311h2;
            this.f310h1 = j3 + j4;
            this.f310h1 = (this.f310h1 * 5) + 1390208809;
            this.f311h2 = mixK2(j2) ^ j4;
            this.f311h2 = Long.rotateLeft(this.f311h2, 31);
            this.f311h2 += this.f310h1;
            this.f311h2 = (this.f311h2 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f310h1 = mixK1(r2) ^ r11.f310h1;
            r11.f311h2 = mixK2(r0) ^ r11.f311h2;
         */
        ...
        public HashCode makeHash() {
            ...
            long j4 = this.f310h1;
            this.f311h2 = j3 + j4;
            this.f310h1 = fmix64(j4);
            this.f311h2 = fmix64(this.f311h2);
            long j5 = this.f310h1;
            long j6 = this.f311h2;
            this.f310h1 = j5 + j6;
            this.f311h2 = j6 + this.f310h1;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f310h1).putLong(this.f311h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f308C1, 31) * f309C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f309C2, 33) * f308C1;
        }
    }
}
