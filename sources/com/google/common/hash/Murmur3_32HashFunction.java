...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f312C1 = -862048943;

    /* renamed from: C2 */
    private static final int f313C2 = 461845907;
    ...
    public static long charToThreeUtf8Bytes(char c) {
        return (long) ((((c & '?') | 128) << 16) | (((c >>> 12) | WOWZMediaConfig.DEFAULT_VIDEO_FRAME_HEIGHT) & 255) | ((((c >>> 6) & 63) | 128) << 8));
    }
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f312C1, 15) * f313C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            ...
            this.length += i;
            if (this.shift >= 32) {
                this.f314h1 = Murmur3_32HashFunction.mixH1(this.f314h1, Murmur3_32HashFunction.mixK1((int) this.buffer));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            this.f314h1 ^= Murmur3_32HashFunction.mixK1((int) this.buffer);
            return Murmur3_32HashFunction.fmix(this.f314h1, this.length);
        }
    }
}
