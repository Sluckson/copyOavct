...
public final class ImmutableDoubleArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m259of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m260of(double d) {
        return new ImmutableDoubleArray(new double[]{d});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m261of(double d, double d2) {
        return new ImmutableDoubleArray(new double[]{d, d2});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m262of(double d, double d2, double d3) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m263of(double d, double d2, double d3, double d4) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m264of(double d, double d2, double d3, double d4, double d5) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m265of(double d, double d2, double d3, double d4, double d5, double d6) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5, d6});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m266of(double d, double... dArr) {
