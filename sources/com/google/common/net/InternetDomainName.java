...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m115on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m128on('.');
    private static final int MAX_DOMAIN_PART_LENGTH = 63;
    private static final int MAX_LENGTH = 253;
    private static final int MAX_PARTS = 127;
    private static final int NO_SUFFIX_FOUND = -1;
    private static final CharMatcher PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo28465or(DASH_MATCHER);
    ...
    InternetDomainName(String str) {
        ...
        Preconditions.checkArgument(this.parts.size() > 127 ? false : z, "Domain has too many parts: '%s'", (Object) lowerCase);
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m117of(PublicSuffixType.REGISTRY));
    }
