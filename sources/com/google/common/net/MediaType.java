...
public final class MediaType {
    ...
    public static final MediaType HTML_UTF_8 = createConstantUtf8("text", HtmlTags.HTML);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m116on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m160of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m159of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        addKnownType.parsedCharset = Optional.m117of(Charsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    optional = Optional.m117of(Charset.forName(str2));
                    str = str2;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m189of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withParameter.parsedCharset = Optional.m117of(charset);
    ...
    /* renamed from: is */
    public boolean mo32055is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m159of());
