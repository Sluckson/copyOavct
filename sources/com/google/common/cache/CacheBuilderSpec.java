...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m128on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m128on('=').trimResults();
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C16961.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int i = C16961.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C16961 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.cache.CacheBuilderSpec.C16961.<clinit>():void");
        }
    }
