...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
            ...
            public Set<EndpointPair<N>> edges() {
                ...
                return new AbstractSet<EndpointPair<N>>() {
                    ...
                    public boolean contains(@NullableDecl Object obj) {
                        ...
                        if (C19701.this.isDirected() != endpointPair.isOrdered() || !C19701.this.nodes().contains(endpointPair.nodeU()) || !C19701.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV())) {
                            return false;
                        }
                        return true;
                    }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m189of(e));
    }
