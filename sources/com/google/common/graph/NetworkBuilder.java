...
public final class NetworkBuilder<N, E> extends AbstractGraphBuilder<N> {
    ...
    public NetworkBuilder<N, E> expectedNodeCount(int i) {
        this.expectedNodeCount = Optional.m117of(Integer.valueOf(Graphs.checkNonNegative(i)));
        return this;
    }

    public NetworkBuilder<N, E> expectedEdgeCount(int i) {
        this.expectedEdgeCount = Optional.m117of(Integer.valueOf(Graphs.checkNonNegative(i)));
        return this;
    }
