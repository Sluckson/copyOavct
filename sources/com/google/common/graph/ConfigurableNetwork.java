...
class ConfigurableNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    ConfigurableNetwork(NetworkBuilder<? super N, ? super E> networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(((Integer) networkBuilder.expectedNodeCount.mo28432or(10)).intValue()), networkBuilder.edgeOrder.createMap(networkBuilder.expectedEdgeCount.mo28432or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E e) {
        ...
        return EndpointPair.m246of((Network<?, ?>) this, checkedReferenceNode, this.nodeConnections.get(checkedReferenceNode).adjacentNode(e));
    }
