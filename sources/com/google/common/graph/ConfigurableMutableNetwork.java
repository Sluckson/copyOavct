...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m246of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m243of();
            }
            return DirectedNetworkConnections.m244of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m249of();
        } else {
            return UndirectedNetworkConnections.m250of();
        }
    }
}
