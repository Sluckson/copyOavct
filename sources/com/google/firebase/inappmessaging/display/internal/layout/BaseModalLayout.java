...
public abstract class BaseModalLayout extends FrameLayout {
    ...
    public BaseModalLayout(Context context, @Nullable AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2314R.styleable.ModalLayout, 0, 0);
        try {
            this.mMaxWidthPct = obtainStyledAttributes.getFloat(C2314R.styleable.ModalLayout_maxWidthPct, -1.0f);
            this.mMaxHeightPct = obtainStyledAttributes.getFloat(C2314R.styleable.ModalLayout_maxHeightPct, -1.0f);
    ...
    /* access modifiers changed from: protected */
    @NonNull
    public View findChildById(@IdRes int i) {
