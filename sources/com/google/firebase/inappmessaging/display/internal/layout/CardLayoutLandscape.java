...
public class CardLayoutLandscape extends BaseModalLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.imageChild = findChildById(C2314R.C2317id.image_view);
        this.titleChild = findChildById(C2314R.C2317id.message_title);
        this.scrollChild = findChildById(C2314R.C2317id.body_scroll);
        this.actionBarChild = findChildById(C2314R.C2317id.action_bar);
        int i3 = 0;
        List<View> asList = Arrays.asList(new View[]{this.titleChild, this.scrollChild, this.actionBarChild});
