...
public final class DaggerUniversalComponent implements UniversalComponent {
    ...
    private void initialize(ApplicationModule applicationModule, InflaterConfigModule inflaterConfigModule2) {
        ...
        this.providesDisplayMetricsProvider = InflaterConfigModule_ProvidesDisplayMetricsFactory.create(inflaterConfigModule2, this.providesApplicationProvider);
        this.providesPortraitImageLayoutConfigProvider = InflaterConfigModule_ProvidesPortraitImageLayoutConfigFactory.create(inflaterConfigModule2, this.providesDisplayMetricsProvider);
