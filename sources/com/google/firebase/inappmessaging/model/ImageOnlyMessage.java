...
public class ImageOnlyMessage extends InAppMessage {
    ...
    private ImageOnlyMessage(@NonNull CampaignMetadata campaignMetadata, @NonNull ImageData imageData2, @Nullable Action action2, @Nullable Map<String, String> map) {
