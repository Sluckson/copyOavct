...
public class BannerMessage extends InAppMessage {
    ...
    private BannerMessage(@NonNull CampaignMetadata campaignMetadata, @NonNull Text text, @Nullable Text text2, @Nullable ImageData imageData2, @Nullable Action action2, @NonNull String str, @Nullable Map<String, String> map) {
