...
class QueueFileLogStore implements FileLogStore {
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Logger.getLogger().mo33260e("A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                logger.mo33260e("Could not open log file: " + this.workingFile, e);
            }
        }
    }
    ...
    private void doWriteToLog(long j, String str) {
        if (this.logFile != null) {
            ...
            try {
                ...
                this.logFile.add(String.format(Locale.US, "%d %s%n", new Object[]{Long.valueOf(j), str.replaceAll("\r", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).replaceAll("\n", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR)}).getBytes(UTF_8));
                while (!this.logFile.isEmpty() && this.logFile.usedBytes() > this.maxLogSize) {
                    this.logFile.remove();
                }
            } catch (IOException e) {
                Logger.getLogger().mo33260e("There was a problem writing to the Crashlytics log.", e);
            }
        }
    }
}
