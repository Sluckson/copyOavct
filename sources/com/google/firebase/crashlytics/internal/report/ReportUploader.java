...
public class ReportUploader {
    ...
    public synchronized void uploadReportsAsync(List<Report> list, boolean z, float f) {
        if (this.uploadThread != null) {
            Logger.getLogger().mo33257d("Report upload has already been started.");
            return;
        }
    ...
    public boolean uploadReport(com.google.firebase.crashlytics.internal.report.model.Report r6, boolean r7) {
        /*
            ...
            r7.mo33257d(r1)     // Catch:{ Exception -> 0x0069 }
            goto L_0x0032
        L_0x001b:
            com.google.firebase.crashlytics.internal.common.DataTransportState r2 = r5.dataTransportState     // Catch:{ Exception -> 0x0069 }
        ...
        L_0x004f:
            ...
            r1.mo33261i(r2)     // Catch:{ Exception -> 0x0069 }
        L_0x0060:
    ...
    private class Worker extends BackgroundPriorityRunnable {
        ...
        public void onRun() {
            try {
                ...
                Logger.getLogger().mo33260e("An unexpected error occurred while attempting to upload crash reports.", e);
            }
        ...
        private void attemptUploadWithRetry(List<Report> list, boolean z) {
            ...
            logger.mo33257d("Starting report processing in " + this.delay + " second(s)...");
            float f = this.delay;
            if (f > 0.0f) {
                try {
            ...
            if (!ReportUploader.this.handlingExceptionCheck.isHandlingException()) {
                ...
                while (list.size() > 0 && !ReportUploader.this.handlingExceptionCheck.isHandlingException()) {
                    ...
                    logger2.mo33257d("Attempting to send " + list.size() + " report(s)");
                    ...
                    if (arrayList.size() > 0) {
                        ...
                        logger3.mo33257d("Report submission: scheduling delayed retry in " + j + " seconds");
                        try {
                            Thread.sleep(j * 1000);
                            i = i2;
