...
class BinaryImagesConverter {
    ...
    private JSONArray parseProcMapsJsonFromString(String str) {
        ...
        try {
            ...
            Logger.getLogger().mo33268w("Unable to parse proc maps string", e);
            return jSONArray;
        }
    }
        ...
        if (parse != null && isRelevant(parse)) {
            try {
                try {
                    ...
                    Logger.getLogger().mo33258d("Could not create a binary image json string", e);
                    return null;
                }
            } catch (IOException e2) {
                Logger logger = Logger.getLogger();
                logger.mo33258d("Could not generate ID for file " + parse.path, e2);
            }
        }
        return null;
    }
    ...
    private File correctDataPath(File file) {
        ...
        try {
            ...
            Logger.getLogger().mo33260e("Error getting ApplicationInfo", e);
            return file;
        }
    }
    ...
    private static byte[] generateBinaryImagesJsonString(JSONArray jSONArray) {
        ...
        try {
            ...
            Logger.getLogger().mo33268w("Binary images string is null", e);
            return new byte[0];
        }
    }
    ...
    private static JSONObject createBinaryImageJson(String str, ProcMapEntry procMapEntry) throws JSONException {
        ...
        jSONObject.put(ElementTags.SIZE, procMapEntry.size);
