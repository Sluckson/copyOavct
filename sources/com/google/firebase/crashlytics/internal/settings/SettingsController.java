...
public class SettingsController implements SettingsDataProvider {
                ...
                if (parseSettingsJson != null) {
                    ...
                    if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior)) {
                        if (parseSettingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().mo33257d("Cached settings have expired.");
                            return null;
                        }
                    }
                    try {
                        Logger.getLogger().mo33257d("Returning cached settings.");
                        return parseSettingsJson;
                    } catch (Exception e) {
                        e = e;
                        settingsData = parseSettingsJson;
                        Logger.getLogger().mo33260e("Failed to get cached settings", e);
                        return settingsData;
                    }
                } else {
                    Logger.getLogger().mo33260e("Failed to parse cached settings data.", (Throwable) null);
                    return null;
                }
            } else {
                Logger.getLogger().mo33257d("No cached settings data found.");
                return null;
            }
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        ...
        logger.mo33257d(str + jSONObject.toString());
    }
