...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Logger.getLogger().mo33257d("Reading cached settings...");
        ...
        try {
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    ...
                    e = e;
                    try {
                        Logger.getLogger().mo33260e("Failed to fetch cached settings", e);
                ...
                Logger.getLogger().mo33257d("No cached settings found.");
                jSONObject = null;
            }
            CommonUtils.closeOrLog(fileInputStream2, "Error while closing settings cache file.");
            return jSONObject;
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        Logger.getLogger().mo33257d("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Logger.getLogger().mo33260e("Failed to cache settings", e);
