...
final class C2252xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    private C2252xc2f5febc(String str, @Nullable String str2, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList, @Nullable CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.type = str;
        this.reason = str2;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            if (str.isEmpty()) {
                return new C2252xc2f5febc(this.type, this.reason, this.frames, this.causedBy, this.overflowCount.intValue());
            }
