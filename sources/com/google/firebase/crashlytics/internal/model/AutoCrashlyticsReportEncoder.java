...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder((Class<U>) C2256x7e3e3ebd.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, (ObjectEncoder<? super U>) C2238xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C2258xce3d994b.class, (ObjectEncoder<? super U>) C2238xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Exception.class, (ObjectEncoder<? super U>) C2237x55689506.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C2252xc2f5febc.class, (ObjectEncoder<? super U>) C2237x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) C2254x7c929f5b.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, (ObjectEncoder<? super U>) C2236x99c932db.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C2250xfe724d07.class, (ObjectEncoder<? super U>) C2236x99c932db.INSTANCE);
    ...
    private static final class C2238xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C2238xc3999712 INSTANCE = new C2238xc3999712();

        private C2238xc3999712() {
        }
        ...
        public void encode(CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame frame, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ElementTags.OFFSET, frame.getOffset());
    ...
    private static final class C2237x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C2237x55689506 INSTANCE = new C2237x55689506();

        private C2237x55689506() {
        }
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        ...
        public void encode(CrashlyticsReport.Session.Event.Application.Execution.Signal signal, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(HtmlTags.CODE, (Object) signal.getCode());
    ...
    private static final class C2236x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C2236x99c932db INSTANCE = new C2236x99c932db();

        private C2236x99c932db() {
        }
        ...
        public void encode(CrashlyticsReport.Session.Event.Application.Execution.BinaryImage binaryImage, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ElementTags.SIZE, binaryImage.getSize());
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        ...
        public void encode(CrashlyticsReport.Session.Event.Device device, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ElementTags.ORIENTATION, device.getOrientation());
