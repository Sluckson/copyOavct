...
final class C2254x7c929f5b extends CrashlyticsReport.Session.Event.Application.Execution.Signal {
    private final long address;
    private final String code;
    private final String name;

    private C2254x7c929f5b(String str, String str2, long j) {
        this.name = str;
        this.code = str2;
        this.address = j;
    }
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal build() {
            ...
            if (str.isEmpty()) {
                return new C2254x7c929f5b(this.name, this.code, this.address.longValue());
            }
