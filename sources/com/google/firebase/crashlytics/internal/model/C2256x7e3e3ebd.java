...
final class C2256x7e3e3ebd extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    private final ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> frames;
    private final int importance;
    private final String name;

    private C2256x7e3e3ebd(String str, int i, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList) {
        this.name = str;
        this.importance = i;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            ...
            if (str.isEmpty()) {
                return new C2256x7e3e3ebd(this.name, this.importance.intValue(), this.frames);
            }
