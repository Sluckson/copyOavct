...
final class C2250xfe724d07 extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage {
    private final long baseAddress;
    private final String name;
    private final long size;
    private final String uuid;

    private C2250xfe724d07(long j, long j2, String str, @Nullable String str2) {
        this.baseAddress = j;
        this.size = j2;
        this.name = str;
        this.uuid = str2;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.BinaryImage build() {
            ...
            if (str.isEmpty()) {
                return new C2250xfe724d07(this.baseAddress.longValue(), this.size.longValue(), this.name, this.uuid);
            }
