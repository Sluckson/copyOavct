...
public class DataTransportCrashlyticsReportSender {
    ...
    public static DataTransportCrashlyticsReportSender create(Context context) {
        ...
        return new DataTransportCrashlyticsReportSender(TransportRuntime.getInstance().newFactory((Destination) new CCTDestination(CRASHLYTICS_ENDPOINT, CRASHLYTICS_API_KEY)).getTransport(CRASHLYTICS_TRANSPORT_NAME, CrashlyticsReport.class, Encoding.m28of("json"), DEFAULT_TRANSFORM), DEFAULT_TRANSFORM);
    }
