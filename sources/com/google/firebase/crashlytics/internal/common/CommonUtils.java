...
public class CommonUtils {
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        e = e;
                        try {
                            Logger.getLogger().mo33260e("Error parsing " + file, e);
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().mo33257d("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.mo33257d("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.mo33260e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Logger.getLogger().mo33260e("Could not calculate hash for app icon.", e);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.mo33260e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static boolean isEmulator(Context context) {
        return SDK.equals(Build.PRODUCT) || GOOGLE_SDK.equals(Build.PRODUCT) || Settings.Secure.getString(context.getContentResolver(), C4820b.f5526f) == null;
    }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().mo33260e(str, e);
            }
        }
    }
    ...
    public static String getAppIconHashOrNull(Context context) {
        ...
        try {
            ...
            try {
                ...
                e = e;
                try {
                    Logger.getLogger().mo33267w("Could not calculate hash for app icon:" + e.getMessage());
                    closeOrLog(inputStream, "Failed to close icon input stream.");
                    return null;
                } catch (Throwable th) {
                    th = th;
    ...
    public static String resolveUnityEditorVersion(Context context) {
        ...
        Logger logger = Logger.getLogger();
        logger.mo33257d("Unity Editor version is: " + string);
        return string;
    }
