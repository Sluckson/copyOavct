...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().mo33257d(String.format("Crashlytics automatic data collection %s by %s.", new Object[]{str2, str}));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().mo33258d("Unable to get PackageManager. Falling through", e);
            return null;
        }
    }
