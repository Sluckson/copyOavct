...
public class FirebaseCrashlytics {
    ...
    static com.google.firebase.crashlytics.FirebaseCrashlytics init(@androidx.annotation.NonNull com.google.firebase.FirebaseApp r16, @androidx.annotation.NonNull com.google.firebase.installations.FirebaseInstallationsApi r17, @androidx.annotation.Nullable com.google.firebase.crashlytics.internal.CrashlyticsNativeComponent r18, @androidx.annotation.Nullable com.google.firebase.analytics.connector.AnalyticsConnector r19) {
        /*
            r8 = r16
            r0 = r19
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(@NonNull AnalyticsConnector analyticsConnector, @NonNull CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        if (registerAnalyticsConnectorListener == null) {
            Logger.getLogger().mo33257d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
            ...
            if (registerAnalyticsConnectorListener != null) {
                Logger.getLogger().mo33267w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
            }
        }
    ...
    public void recordException(@NonNull Throwable th) {
        if (th == null) {
            Logger.getLogger().mo33267w("Crashlytics is ignoring a request to log a null exception.");
        } else {
