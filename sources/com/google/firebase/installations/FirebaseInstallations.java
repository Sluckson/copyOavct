...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C23802.f372xc38d2559[createFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(@NonNull PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C23802.f373xe5baa01a[generateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C23802 {

        /* renamed from: $SwitchMap$com$google$firebase$installations$remote$InstallationResponse$ResponseCode */
        static final /* synthetic */ int[] f372xc38d2559 = new int[InstallationResponse.ResponseCode.values().length];

        /* renamed from: $SwitchMap$com$google$firebase$installations$remote$TokenResult$ResponseCode */
        static final /* synthetic */ int[] f373xe5baa01a = new int[TokenResult.ResponseCode.values().length];
        ...
        static {
            /*
                ...
                f373xe5baa01a = r0
                r0 = 1
                int[] r1 = f373xe5baa01a     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f373xe5baa01a     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r2 = f373xe5baa01a     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                ...
                int[] r2 = new int[r2]
                f372xc38d2559 = r2
                int[] r2 = f372xc38d2559     // Catch:{ NoSuchFieldError -> 0x003d }
            ...
            L_0x003d:
                int[] r0 = f372xc38d2559     // Catch:{ NoSuchFieldError -> 0x0047 }
            ...
            L_0x0047:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.C23802.<clinit>():void");
        }
    }
