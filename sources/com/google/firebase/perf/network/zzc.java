...
public final class zzc extends HttpsURLConnection {
    ...
    private final HttpsURLConnection zzgv;

    zzc(HttpsURLConnection httpsURLConnection, zzbw zzbw, zzbg zzbg) {
        super(httpsURLConnection.getURL());
        this.zzgv = httpsURLConnection;
        this.zzgu = new zzf(httpsURLConnection, zzbw, zzbg);
    }
    ...
    public final String getCipherSuite() {
        return this.zzgv.getCipherSuite();
    }

    public final HostnameVerifier getHostnameVerifier() {
        return this.zzgv.getHostnameVerifier();
    }

    public final Certificate[] getLocalCertificates() {
        return this.zzgv.getLocalCertificates();
    }

    public final Principal getLocalPrincipal() {
        return this.zzgv.getLocalPrincipal();
    }

    public final Principal getPeerPrincipal() throws SSLPeerUnverifiedException {
        return this.zzgv.getPeerPrincipal();
    }

    public final Certificate[] getServerCertificates() throws SSLPeerUnverifiedException {
        return this.zzgv.getServerCertificates();
    }

    public final SSLSocketFactory getSSLSocketFactory() {
        return this.zzgv.getSSLSocketFactory();
    }

    public final void setHostnameVerifier(HostnameVerifier hostnameVerifier) {
        this.zzgv.setHostnameVerifier(hostnameVerifier);
    }

    public final void setSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        this.zzgv.setSSLSocketFactory(sSLSocketFactory);
    }
}
