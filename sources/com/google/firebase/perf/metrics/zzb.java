...
public class zzb implements Parcelable {
    ...
    private AtomicLong zzfx;

    public zzb(@NonNull String str) {
        this.mName = str;
        this.zzfx = new AtomicLong(0);
    }
    ...
    private zzb(Parcel parcel) {
        ...
        this.zzfx = new AtomicLong(parcel.readLong());
    }

    public final void zzr(long j) {
        this.zzfx.addAndGet(j);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.zzfx.get());
    }
