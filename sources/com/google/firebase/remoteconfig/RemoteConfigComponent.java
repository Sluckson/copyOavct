...
public class RemoteConfigComponent {
    ...
    RemoteConfigComponent(Context context2, FirebaseApp firebaseApp2, FirebaseInstanceId firebaseInstanceId2, FirebaseABTesting firebaseABTesting, @Nullable AnalyticsConnector analyticsConnector2) {
    ...
    @VisibleForTesting
    protected RemoteConfigComponent(Context context2, ExecutorService executorService2, FirebaseApp firebaseApp2, FirebaseInstanceId firebaseInstanceId2, FirebaseABTesting firebaseABTesting, @Nullable AnalyticsConnector analyticsConnector2, LegacyConfigsHandler legacyConfigsHandler, boolean z) {
    ...
    public synchronized FirebaseRemoteConfig get(String str) {
        ...
        return get(this.firebaseApp, str, this.firebaseInstanceId, this.firebaseAbt, this.executorService, cacheClient, cacheClient2, cacheClient3, getFetchHandler(str, cacheClient, metadataClient), getGetHandler(cacheClient2, cacheClient3), metadataClient);
    }

    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public synchronized FirebaseRemoteConfig get(FirebaseApp firebaseApp2, String str, FirebaseInstanceId firebaseInstanceId2, FirebaseABTesting firebaseABTesting, Executor executor, ConfigCacheClient configCacheClient, ConfigCacheClient configCacheClient2, ConfigCacheClient configCacheClient3, ConfigFetchHandler configFetchHandler, ConfigGetParameterHandler configGetParameterHandler, ConfigMetadataClient configMetadataClient) {
        FirebaseRemoteConfig firebaseRemoteConfig;
        String str2 = str;
        synchronized (this) {
            if (!this.frcNamespaceInstances.containsKey(str2)) {
                FirebaseRemoteConfig firebaseRemoteConfig2 = new FirebaseRemoteConfig(this.context, firebaseApp2, firebaseInstanceId2, isAbtSupported(firebaseApp2, str) ? firebaseABTesting : null, executor, configCacheClient, configCacheClient2, configCacheClient3, configFetchHandler, configGetParameterHandler, configMetadataClient);
