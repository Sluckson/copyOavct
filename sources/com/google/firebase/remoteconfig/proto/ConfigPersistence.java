...
public final class ConfigPersistence {
    ...
    public static final class PersistedConfig extends GeneratedMessageLite<PersistedConfig, Builder> implements PersistedConfigOrBuilder {
        ...
        public static final PersistedConfig DEFAULT_INSTANCE = new PersistedConfig();
                        ...
                        try {
                            ...
                            if (readTag != 0) {
                                if (readTag == 10) {
                                    ...
                                    this.fetchedConfigHolder_ = (ConfigHolder) codedInputStream.readMessage(ConfigHolder.parser(), extensionRegistryLite);
                                    if (builder != null) {
                                        builder.mergeFrom(this.fetchedConfigHolder_);
                                    ...
                                    this.activeConfigHolder_ = (ConfigHolder) codedInputStream.readMessage(ConfigHolder.parser(), extensionRegistryLite);
                                    if (builder2 != null) {
                                        builder2.mergeFrom(this.activeConfigHolder_);
                                    ...
                                    this.defaultsConfigHolder_ = (ConfigHolder) codedInputStream.readMessage(ConfigHolder.parser(), extensionRegistryLite);
                                    if (builder3 != null) {
                                        builder3.mergeFrom(this.defaultsConfigHolder_);
    ...
    public static final class NamespaceKeyValue extends GeneratedMessageLite<NamespaceKeyValue, Builder> implements NamespaceKeyValueOrBuilder {
        /* access modifiers changed from: private */
        public static final NamespaceKeyValue DEFAULT_INSTANCE = new NamespaceKeyValue();
    ...
    public static final class ConfigHolder extends GeneratedMessageLite<ConfigHolder, Builder> implements ConfigHolderOrBuilder {
        /* access modifiers changed from: private */
        public static final ConfigHolder DEFAULT_INSTANCE = new ConfigHolder();
