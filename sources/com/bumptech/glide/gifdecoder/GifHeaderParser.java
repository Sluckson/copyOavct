...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f103ix = readShort();
        this.header.currentFrame.f104iy = readShort();
        this.header.currentFrame.f102iw = readShort();
        this.header.currentFrame.f101ih = readShort();
        int read = read();
        boolean z = false;
