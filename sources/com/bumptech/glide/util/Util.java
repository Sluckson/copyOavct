...
public final class Util {
    ...
    private static int getBytesPerPixel(Bitmap.Config config) {
        ...
        int i = C10721.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i != 1) {
            return (i == 2 || i == 3) ? 2 : 4;
        }
        return 1;
    ...
    static /* synthetic */ class C10721 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C10721.<clinit>():void");
        }
    }
