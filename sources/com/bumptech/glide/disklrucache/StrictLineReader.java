...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f98CR = 13;

    /* renamed from: LF */
    private static final byte f99LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f100in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f100in) {
            if (this.buf != null) {
                ...
                C10301 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f100in;
        byte[] bArr = this.buf;
