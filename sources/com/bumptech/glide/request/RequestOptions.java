...
public class RequestOptions implements Cloneable {
    ...
    @CheckResult
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, mo651to = 1.0d) float f) {
    ...
    @CheckResult
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, mo669to = 100) int i) {
    ...
    @CheckResult
    public RequestOptions sizeMultiplier(@FloatRange(from = 0.0d, mo651to = 1.0d) float f) {
    ...
    @CheckResult
    public RequestOptions encodeQuality(@IntRange(from = 0, mo669to = 100) int i) {
