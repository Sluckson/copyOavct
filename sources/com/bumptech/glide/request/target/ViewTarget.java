...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
        ...
        this.attachStateListener = new View.OnAttachStateChangeListener() {
            ...
            public void onViewDetachedFromWindow(View view) {
                ...
                if (request != null && !request.isCancelled() && !request.isPaused()) {
                    boolean unused = ViewTarget.this.isClearedByUs = true;
                    request.pause();
                    boolean unused2 = ViewTarget.this.isClearedByUs = false;
                }
            }
        };
    ...
    public final ViewTarget<T, Z> waitForLayout() {
        boolean unused = this.sizeDeterminer.waitForLayout = true;
        return this;
    }
