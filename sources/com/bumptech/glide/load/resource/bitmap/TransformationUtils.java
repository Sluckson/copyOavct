...
public final class TransformationUtils {
    private static final Lock BITMAP_DRAWABLE_LOCK = ((!MODELS_REQUIRING_BITMAP_LOCK.contains(Build.MODEL) || Build.VERSION.SDK_INT != 22) ? new NoLock() : new ReentrantLock());
    ...
    private static final List<String> MODELS_REQUIRING_BITMAP_LOCK = Arrays.asList(new String[]{"XT1085", "XT1092", "XT1093", "XT1094", "XT1095", "XT1096", "XT1097", "XT1098"});
