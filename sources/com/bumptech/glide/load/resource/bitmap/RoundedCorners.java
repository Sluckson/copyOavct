...
public final class RoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f115ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    ...
    public int hashCode() {
        return Util.hashCode(f115ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
