...
public final class MemorySizeCalculator {
    ...
    MemorySizeCalculator(Builder builder) {
        ...
        if (i3 <= i2) {
            ...
            float access$600 = ((float) i2) / (builder.bitmapPoolScreens + builder.memoryCacheScreens);
            this.memoryCacheSize = Math.round(builder.memoryCacheScreens * access$600);
            this.bitmapPoolSize = Math.round(access$600 * builder.bitmapPoolScreens);
        }
    ...
    public static final class Builder {
        ...
        /* access modifiers changed from: private */
        public float lowMemoryMaxSizeMultiplier = LOW_MEMORY_MAX_SIZE_MULTIPLIER;
        /* access modifiers changed from: private */
        public float maxSizeMultiplier = MAX_SIZE_MULTIPLIER;
        /* access modifiers changed from: private */
