    ...
    static /* synthetic */ class C10441 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C10441.<clinit>():void");
        }
    }

    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        int i = C10441.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
