...
public class RequestBuilder<TranscodeType> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    public ViewTarget<ImageView, TranscodeType> into(ImageView imageView) {
        ...
        if (!requestOptions2.isTransformationSet() && requestOptions2.isTransformationAllowed() && imageView.getScaleType() != null) {
            switch (C10262.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
            ...
            this.glideContext.getMainHandler().post(new Runnable() {
                public void run() {
                    if (!requestFutureTarget.isCancelled()) {
                        ...
                        Target unused = requestBuilder.into(requestFutureTarget, requestFutureTarget);
                    }
                }
            });
        } else {
    ...
    static /* synthetic */ class C10262 {
        ...
        static {
            ...
            L_0x0093:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.RequestBuilder.C10262.<clinit>():void");
        }
    }

    private Priority getThumbnailPriority(Priority priority) {
        int i = C10262.$SwitchMap$com$bumptech$glide$Priority[priority.ordinal()];
        if (i == 1) {
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, @Nullable RequestListener<TranscodeType> requestListener2, @Nullable RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions2, Priority priority, int i, int i2, RequestOptions requestOptions2) {
        ...
        errorRequestCoordinator3.setRequests(buildThumbnailRequestRecursive, requestBuilder.buildRequestRecursive(target, requestListener2, errorRequestCoordinator, requestBuilder.transitionOptions, requestBuilder.requestOptions.getPriority(), overrideWidth, overrideHeight, this.errorBuilder.requestOptions));
    ...
    private Request buildThumbnailRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener2, @Nullable RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions2, Priority priority, int i, int i2, RequestOptions requestOptions2) {
        ...
        if (requestBuilder != null) {
            if (!this.isThumbnailBuilt) {
                ...
                Request buildRequestRecursive = requestBuilder2.buildRequestRecursive(target, requestListener2, thumbnailRequestCoordinator, transitionOptions3, priority3, overrideWidth, overrideHeight, requestBuilder2.requestOptions);
