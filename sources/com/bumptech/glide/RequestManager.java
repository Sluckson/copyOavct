...
public class RequestManager implements LifecycleListener, ModelTypes<RequestBuilder<Drawable>> {
    ...
    public RequestBuilder<Bitmap> asBitmap() {
        return mo12279as(Bitmap.class).apply(DECODE_TYPE_BITMAP);
    }

    @CheckResult
    public RequestBuilder<GifDrawable> asGif() {
        return mo12279as(GifDrawable.class).apply(DECODE_TYPE_GIF);
    }

    @CheckResult
    public RequestBuilder<Drawable> asDrawable() {
        return mo12279as(Drawable.class);
    }
    ...
    public RequestBuilder<File> downloadOnly() {
        return mo12279as(File.class).apply(DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public RequestBuilder<File> asFile() {
        return mo12279as(File.class).apply(RequestOptions.skipMemoryCacheOf(true));
    }

    @CheckResult
    /* renamed from: as */
    public <ResourceType> RequestBuilder<ResourceType> mo12279as(Class<ResourceType> cls) {
