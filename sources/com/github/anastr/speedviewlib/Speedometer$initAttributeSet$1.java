...
final class Speedometer$initAttributeSet$1 extends Lambda implements Function2<Integer, Float, String> {
    final /* synthetic */ Speedometer this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    Speedometer$initAttributeSet$1(Speedometer speedometer) {
        super(2);
