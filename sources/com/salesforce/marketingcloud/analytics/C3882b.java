...
abstract class C3882b extends C$$AutoValue_PiCartItem {
    C3882b(String str, int i, double d, String str2) {
        super(str, i, d, str2);
    }
    ...
    public org.json.JSONObject mo56248a() {
        /*
            r4 = this;
        ...
        L_0x002f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.salesforce.marketingcloud.analytics.C3882b.mo56248a():org.json.JSONObject");
    }
}
