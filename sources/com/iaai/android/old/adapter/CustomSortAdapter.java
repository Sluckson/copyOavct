...
public class CustomSortAdapter extends BaseAdapter {
    ...
    public CustomSortAdapter(Context context, List<FilterSelect> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.sortOrder = (ImageView) view.findViewById(C2723R.C2726id.img_sort_order);
        ...
        viewHolder.sortOrder.setBackgroundResource(this.items.get(i).getResID());
