...
public class MDAbstractListActivity$$ViewBinder<T extends MDAbstractListActivity> implements ViewBinder<T> {
    public Unbinder bind(Finder finder, T t, Object obj) {
        return new InnerUnbinder(t, finder, obj);
    }

    /* compiled from: MDAbstractListActivity$$ViewBinder */
    protected static class InnerUnbinder<T extends MDAbstractListActivity> implements Unbinder {
        protected T target;
