...
public class MDBuyNowOfferListActivity$$ViewBinder<T extends MDBuyNowOfferListActivity> implements ViewBinder<T> {
    public Unbinder bind(Finder finder, T t, Object obj) {
        return new InnerUnbinder(t, finder, obj);
    }

    /* compiled from: MDBuyNowOfferListActivity$$ViewBinder */
    protected static class InnerUnbinder<T extends MDBuyNowOfferListActivity> implements Unbinder {
        protected T target;
