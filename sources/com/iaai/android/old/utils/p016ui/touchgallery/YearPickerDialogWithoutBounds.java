...
/* renamed from: com.iaai.android.old.utils.ui.touchgallery.YearPickerDialogWithoutBounds */
public class YearPickerDialogWithoutBounds extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setView(inflate).setPositiveButton((CharSequence) getString(C2723R.string.btn_apply), (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                YearPickerDialogWithoutBounds.this.listener.onDateSet((DatePicker) null, numberPicker.getValue(), 0, 0);
            }
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                YearPickerDialogWithoutBounds.this.getDialog().cancel();
            }
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                YearPickerDialogWithoutBounds.this.listener.onDateSet((DatePicker) null, 0, 0, 0);
            }
        });
