...
/* renamed from: com.iaai.android.old.utils.ui.touchgallery.NewYearPickerDialogWithoutBounds */
public class NewYearPickerDialogWithoutBounds extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setView(inflate).setPositiveButton((CharSequence) getString(C2723R.string.btn_apply), (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                NewYearPickerDialogWithoutBounds.this.listener.onDateSet((DatePicker) null, numberPicker.getValue(), 0, 0);
            }
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                NewYearPickerDialogWithoutBounds.this.getDialog().cancel();
            }
        }).setNeutralButton((CharSequence) getString(C2723R.string.lbl_reset_year), (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                NewYearPickerDialogWithoutBounds.this.listener.onDateSet((DatePicker) null, 0, 0, 0);
            }
        });
