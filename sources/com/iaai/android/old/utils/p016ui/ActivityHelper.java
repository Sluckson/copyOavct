...
/* renamed from: com.iaai.android.old.utils.ui.ActivityHelper */
public class ActivityHelper {
    ...
    public static Dialog showProgressDialog(Activity activity, String str, DialogInterface.OnCancelListener onCancelListener) {
        ...
        try {
            progressDialog = ProgressDialog.show(dialogContainer.getContext(), "", str, true);
    ...
    public static boolean onPopUpItemSeleted(Activity activity, int i) {
        if (i != C2723R.C2726id.menu_id_contact_us) {
            return false;
        }
        activity.startActivity(new Intent(activity, ContactUsActivity.class));
        return true;
    ...
    public static <T> void promptSelection(Activity activity, String str, T[] tArr, final ICommand<T> iCommand) {
        ...
        if (dialogContainer != null) {
            ...
            new AlertDialog.Builder(dialogContainer.getContext()).setTitle(str).setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
