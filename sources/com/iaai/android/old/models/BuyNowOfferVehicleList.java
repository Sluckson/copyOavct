...
public class BuyNowOfferVehicleList implements Parcelable {
    public static final Parcelable.Creator<BuyNowOfferVehicleList> CREATOR = new Parcelable.Creator<BuyNowOfferVehicleList>() {
        public BuyNowOfferVehicleList createFromParcel(Parcel parcel) {
            return new BuyNowOfferVehicleList(parcel);
        }

        public BuyNowOfferVehicleList[] newArray(int i) {
            return new BuyNowOfferVehicleList[i];
        }
    };
    ...
    protected BuyNowOfferVehicleList(Parcel parcel) {
