...
final class Activity_ExtensionKt$showAlertWithButton$2 implements DialogInterface.OnClickListener {
    final /* synthetic */ OnAlertButtonClick $onAlertButtonClick;

    Activity_ExtensionKt$showAlertWithButton$2(OnAlertButtonClick onAlertButtonClick) {
        this.$onAlertButtonClick = onAlertButtonClick;
    }

    public final void onClick(DialogInterface dialogInterface, int i) {
        dialogInterface.cancel();
        this.$onAlertButtonClick.onCancelClick();
    }
}
