...
final class AuctionSalesListFragment$subscribeToViewModel$6<T> implements Observer<UpdateWatchListResponse> {
    final /* synthetic */ AuctionSalesListFragment this$0;

    AuctionSalesListFragment$subscribeToViewModel$6(AuctionSalesListFragment auctionSalesListFragment) {
    ...
    public final void onChanged(UpdateWatchListResponse updateWatchListResponse) {
        if (updateWatchListResponse != null && this.this$0.isAdded()) {
            if (Intrinsics.areEqual((Object) this.this$0.action, (Object) "add")) {
                AuctionSalesListFragment.access$getAuctionSalesListAdapter$p(this.this$0).setWatchingData(true, this.this$0.itemIdWatch);
                AuctionSalesListFragment.access$getAuctionSalesListAdapter$p(this.this$0).notifyItemChanged(this.this$0.indexToUpdate);
            } else if (Intrinsics.areEqual((Object) this.this$0.action, (Object) "delete")) {
                AuctionSalesListFragment.access$getAuctionSalesListAdapter$p(this.this$0).setWatchingData(false, this.this$0.itemIdWatch);
                AuctionSalesListFragment.access$getAuctionSalesListAdapter$p(this.this$0).notifyItemChanged(this.this$0.indexToUpdate);
            }
        }
    }
