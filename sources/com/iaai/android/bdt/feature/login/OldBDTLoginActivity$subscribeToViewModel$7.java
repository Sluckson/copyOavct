...
final class OldBDTLoginActivity$subscribeToViewModel$7<T> implements Observer<String> {
    final /* synthetic */ OldBDTLoginActivity this$0;

    OldBDTLoginActivity$subscribeToViewModel$7(OldBDTLoginActivity oldBDTLoginActivity) {
        this.this$0 = oldBDTLoginActivity;
    }

    public final void onChanged(String str) {
        String tag = this.this$0.getTAG();
        Log.e(tag, "valid email error: " + str);
