...
final class EmailConfirmationActivity$initializeUI$1 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ EmailConfirmationActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EmailConfirmationActivity$initializeUI$1(EmailConfirmationActivity emailConfirmationActivity) {
        super(1);
    ...
    public final void invoke(@NotNull String str) {
        ...
        if (charSequence.length() > 0) {
            this.this$0.newID = StringsKt.trim(charSequence).toString();
        }
