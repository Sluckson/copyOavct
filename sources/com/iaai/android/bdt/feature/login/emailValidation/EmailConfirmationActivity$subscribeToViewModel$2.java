...
final class EmailConfirmationActivity$subscribeToViewModel$2<T> implements Observer<String> {
    final /* synthetic */ EmailConfirmationActivity this$0;

    EmailConfirmationActivity$subscribeToViewModel$2(EmailConfirmationActivity emailConfirmationActivity) {
        this.this$0 = emailConfirmationActivity;
    }

    public final void onChanged(String str) {
        String tag = this.this$0.getTAG();
        Log.e(tag, "Email Confirmation: " + str);
        EmailConfirmationActivity emailConfirmationActivity = this.this$0;
        Intrinsics.checkExpressionValueIsNotNull(str, "it");
        Context_ExtensionKt.showToast(emailConfirmationActivity, str);
    }
}
