...
public final class OldBDTLoginActivity extends BaseActivity {
    ...
    public static final /* synthetic */ BDTLoginResponse access$getLoginResponse$p(OldBDTLoginActivity oldBDTLoginActivity) {
        BDTLoginResponse bDTLoginResponse = oldBDTLoginActivity.loginResponse;
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView((int) C2723R.C2728layout.old_activity_bdt_login);
    ...
    private final void initializeUI() {
        ...
        if (supportActionBar != null) {
            supportActionBar.setTitle((CharSequence) getResources().getString(C2723R.string.lbl_login));
        }
        ...
        EditText_ExtensionKt.onChange(editText, new OldBDTLoginActivity$initializeUI$1(this));
        ...
        EditText_ExtensionKt.onChange(editText2, new OldBDTLoginActivity$initializeUI$2(this));
        ((ImageView) _$_findCachedViewById(C2723R.C2726id.ivClear)).setOnClickListener(new OldBDTLoginActivity$initializeUI$3(this));
        ((TextView) _$_findCachedViewById(C2723R.C2726id.tvRegisterNow)).setOnClickListener(new OldBDTLoginActivity$initializeUI$4(this));
        ((TextView) _$_findCachedViewById(C2723R.C2726id.tvContactUs)).setOnClickListener(new OldBDTLoginActivity$initializeUI$5(this));
        ((TextView) _$_findCachedViewById(C2723R.C2726id.tvTerms)).setOnClickListener(new OldBDTLoginActivity$initializeUI$6(this));
        ((TextView) _$_findCachedViewById(C2723R.C2726id.tvForgotPassword)).setOnClickListener(new OldBDTLoginActivity$initializeUI$7(this));
        ((EditText) _$_findCachedViewById(C2723R.C2726id.etPassword)).setOnEditorActionListener(new OldBDTLoginActivity$initializeUI$8(this));
        ((TextView) _$_findCachedViewById(C2723R.C2726id.tvLogin)).setOnClickListener(new OldBDTLoginActivity$initializeUI$9(this));
    }
    ...
    private final void subscribeToViewModel() {
        ...
        loginViewModel.getLoginResponse().observe(lifecycleOwner, new OldBDTLoginActivity$subscribeToViewModel$1(this));
        LoginViewModel loginViewModel2 = this.viewModel;
        if (loginViewModel2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        loginViewModel2.getLoginError().observe(lifecycleOwner, new OldBDTLoginActivity$subscribeToViewModel$2(this));
        LoginViewModel loginViewModel3 = this.viewModel;
        if (loginViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        loginViewModel3.getShowLoading().observe(lifecycleOwner, new OldBDTLoginActivity$subscribeToViewModel$3(this));
        LoginViewModel loginViewModel4 = this.viewModel;
        if (loginViewModel4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        loginViewModel4.getAuctionRuleResponse().observe(lifecycleOwner, new OldBDTLoginActivity$subscribeToViewModel$4(this));
        LoginViewModel loginViewModel5 = this.viewModel;
        if (loginViewModel5 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        loginViewModel5.getAuctionRuleError().observe(lifecycleOwner, new OldBDTLoginActivity$subscribeToViewModel$5(this));
        LoginViewModel loginViewModel6 = this.viewModel;
        if (loginViewModel6 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        loginViewModel6.isValidEmail().observe(lifecycleOwner, new OldBDTLoginActivity$subscribeToViewModel$6(this));
        LoginViewModel loginViewModel7 = this.viewModel;
        if (loginViewModel7 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        }
        loginViewModel7.isValidEmailError().observe(lifecycleOwner, new OldBDTLoginActivity$subscribeToViewModel$7(this));
    }
