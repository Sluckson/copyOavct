...
final class OldBDTLoginActivity$subscribeToViewModel$6<T> implements Observer<Boolean> {
    final /* synthetic */ OldBDTLoginActivity this$0;

    OldBDTLoginActivity$subscribeToViewModel$6(OldBDTLoginActivity oldBDTLoginActivity) {
    ...
    public final void onChanged(Boolean bool) {
        ...
        if (bool.booleanValue()) {
            ...
            sessionManager.setLoginResponseOnSuccess(oldBDTLoginActivity, OldBDTLoginActivity.access$getLoginResponse$p(oldBDTLoginActivity), this.this$0.getUsername(), this.this$0.getPassword());
