...
final class OldBDTLoginActivity$initializeUI$2 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ OldBDTLoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OldBDTLoginActivity$initializeUI$2(OldBDTLoginActivity oldBDTLoginActivity) {
        super(1);
