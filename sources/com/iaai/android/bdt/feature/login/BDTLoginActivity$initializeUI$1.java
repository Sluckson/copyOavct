...
final class BDTLoginActivity$initializeUI$1 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ BDTLoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BDTLoginActivity$initializeUI$1(BDTLoginActivity bDTLoginActivity) {
        super(1);
