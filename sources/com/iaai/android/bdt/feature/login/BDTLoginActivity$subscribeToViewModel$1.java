...
final class BDTLoginActivity$subscribeToViewModel$1<T> implements Observer<BDTLoginResponse> {
    final /* synthetic */ BDTLoginActivity this$0;

    BDTLoginActivity$subscribeToViewModel$1(BDTLoginActivity bDTLoginActivity) {
    ...
    public final void onChanged(BDTLoginResponse bDTLoginResponse) {
        ...
        bDTLoginActivity.loginResponse = bDTLoginResponse;
