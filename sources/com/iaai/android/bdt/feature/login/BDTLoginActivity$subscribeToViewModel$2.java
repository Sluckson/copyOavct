...
final class BDTLoginActivity$subscribeToViewModel$2<T> implements Observer<String> {
    final /* synthetic */ BDTLoginActivity this$0;

    BDTLoginActivity$subscribeToViewModel$2(BDTLoginActivity bDTLoginActivity) {
    ...
    public final void onChanged(String str) {
        ...
        Context_ExtensionKt.showToast(bDTLoginActivity, str);
    }
}
