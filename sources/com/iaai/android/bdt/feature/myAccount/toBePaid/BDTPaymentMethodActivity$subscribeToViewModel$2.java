...
final class BDTPaymentMethodActivity$subscribeToViewModel$2<T> implements Observer<String> {
    final /* synthetic */ BDTPaymentMethodActivity this$0;

    BDTPaymentMethodActivity$subscribeToViewModel$2(BDTPaymentMethodActivity bDTPaymentMethodActivity) {
    ...
    public final void onChanged(String str) {
        ...
        try {
            ...
            bDTPaymentMethodActivity.logIAAError(currentSessionUserId, "acserviceswebapi/api/generatepaypaltoken/", json, str, "network failure");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
