...
public final class DeliveryInstructionViewModel extends ViewModel {
    ...
    public static final /* synthetic */ DisposableObserver access$getDisposableObserverGetSaleDocList$p(DeliveryInstructionViewModel deliveryInstructionViewModel) {
        DisposableObserver<GetSaleDocListResponse> disposableObserver = deliveryInstructionViewModel.disposableObserverGetSaleDocList;
    ...
    public static final /* synthetic */ DisposableObserver access$getDisposableObserverGetSaleDocListGroup$p(DeliveryInstructionViewModel deliveryInstructionViewModel) {
        DisposableObserver<GetSaleDocListGroupResponse> disposableObserver = deliveryInstructionViewModel.disposableObserverGetSaleDocListGroup;
        if (disposableObserver == null) {
    ...
    @Inject
    public DeliveryInstructionViewModel(@NotNull MyAccountRepository myAccountRepository2) {
    ...
    public final void getSaleDocList(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, @NotNull GetSaleDocListRequest getSaleDocListRequest) {
        ...
        this.disposableObserverGetSaleDocList = new DeliveryInstructionViewModel$getSaleDocList$1(this);
    ...
    public final void disposeElements() {
        DeliveryInstructionViewModel deliveryInstructionViewModel = this;
        if (deliveryInstructionViewModel.disposableObserverGetSaleDocListGroup != null) {
        ...
        if (deliveryInstructionViewModel.disposableObserverGetSaleDocList != null) {
