...
final class DeliveryMethodActivity$checkNetworkConnection$1<T> implements Observer<Boolean> {
    final /* synthetic */ DeliveryMethodActivity this$0;

    DeliveryMethodActivity$checkNetworkConnection$1(DeliveryMethodActivity deliveryMethodActivity) {
        this.this$0 = deliveryMethodActivity;
    }

    public final void onChanged(Boolean bool) {
        if (bool != null && bool.booleanValue()) {
            this.this$0.getDeliveryMethods();
        }
    }
}
