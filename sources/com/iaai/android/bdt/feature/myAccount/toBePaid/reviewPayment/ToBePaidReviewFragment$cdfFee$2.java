...
final class ToBePaidReviewFragment$cdfFee$2 extends Lambda implements Function0<Double> {
    final /* synthetic */ ToBePaidReviewFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ToBePaidReviewFragment$cdfFee$2(ToBePaidReviewFragment toBePaidReviewFragment) {
        super(0);
