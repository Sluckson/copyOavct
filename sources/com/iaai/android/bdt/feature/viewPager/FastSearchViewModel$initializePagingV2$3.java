...
public final class FastSearchViewModel$initializePagingV2$3 implements Function<SearchDataSourceV2, LiveData<Integer>> {
    ...
    public LiveData<Integer> apply(@NotNull SearchDataSourceV2 searchDataSourceV2) {
        ...
        MutableLiveData scrollSearchListToTopCount = searchDataSourceV2.getScrollSearchListToTopCount();
