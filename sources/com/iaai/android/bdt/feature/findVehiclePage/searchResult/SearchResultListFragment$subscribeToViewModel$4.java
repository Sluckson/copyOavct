...
final class SearchResultListFragment$subscribeToViewModel$4<T> implements Observer<UpdateWatchListResponse> {
    final /* synthetic */ SearchResultListFragment this$0;

    SearchResultListFragment$subscribeToViewModel$4(SearchResultListFragment searchResultListFragment) {
    ...
    public final void onChanged(UpdateWatchListResponse updateWatchListResponse) {
        if (updateWatchListResponse != null && this.this$0.isAdded()) {
            if (Intrinsics.areEqual((Object) this.this$0.action, (Object) "add")) {
                SearchResultListFragment.access$getSearchReultListAdapter$p(this.this$0).setWatchingData(true, this.this$0.itemIdWatch);
                SearchResultListFragment.access$getSearchReultListAdapter$p(this.this$0).notifyItemChanged(this.this$0.indexToUpdate);
            } else if (Intrinsics.areEqual((Object) this.this$0.action, (Object) "delete")) {
                SearchResultListFragment.access$getSearchReultListAdapter$p(this.this$0).setWatchingData(false, this.this$0.itemIdWatch);
                SearchResultListFragment.access$getSearchReultListAdapter$p(this.this$0).notifyItemChanged(this.this$0.indexToUpdate);
            }
        }
    }
