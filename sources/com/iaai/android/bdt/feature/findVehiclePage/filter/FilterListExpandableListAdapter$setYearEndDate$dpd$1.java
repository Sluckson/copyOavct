...
final class FilterListExpandableListAdapter$setYearEndDate$dpd$1 implements DatePickerDialog.OnDateSetListener {
    final /* synthetic */ int $childPos;
    final /* synthetic */ TextView $etFilterEndYear;
    final /* synthetic */ int $groupPos;
    final /* synthetic */ String $startYear;
    final /* synthetic */ Ref.IntRef $year;
    final /* synthetic */ FilterListExpandableListAdapter this$0;

    FilterListExpandableListAdapter$setYearEndDate$dpd$1(FilterListExpandableListAdapter filterListExpandableListAdapter, Ref.IntRef intRef, TextView textView, String str, int i, int i2) {
    ...
    public final void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
        ...
        intRef.element = i;
        this.$etFilterEndYear.setText(String.valueOf(intRef.element));
        CharSequence text = this.$etFilterEndYear.getText();
        Intrinsics.checkExpressionValueIsNotNull(text, "etFilterEndYear.text");
        boolean z = true;
        if (!(text.length() == 0)) {
            ...
            if (!z) {
                String str = this.$startYear + '-' + this.$etFilterEndYear.getText();
