...
@Metadata(mo66931bv = {1, 0, 3}, mo66932d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, mo66933d2 = {"<anonymous>", "", "groupPosition", "", "onGroupExpand"}, mo66934k = 3, mo66935mv = {1, 1, 13})
/* compiled from: FilterFragment.kt */
final class FilterFragment$initFilterList$1 implements ExpandableListView.OnGroupExpandListener {
    final /* synthetic */ FilterFragment this$0;

    FilterFragment$initFilterList$1(FilterFragment filterFragment) {
    ...
    public final void onGroupExpand(int i) {
        ...
        if (filterValues.size() > 10) {
            if (StringsKt.equals(this.this$0.getFilterDataList().get(i).getFilterId(), "make", true) || StringsKt.equals(this.this$0.getFilterDataList().get(i).getFilterId(), "Make & Model", true)) {
                ...
                intent.putExtra(Constants_MVVM.EXTRA_DISPLAY_FILTER_TITLE, filterFragment.getDisplayName(displayText));
            ...
            intent2.putExtra(Constants_MVVM.EXTRA_DISPLAY_FILTER_TITLE, filterFragment2.getDisplayName(displayText2));
            intent2.putParcelableArrayListExtra(Constants_MVVM.EXTRA_LAST_SELECTED_MAKE_MODEL, this.this$0.lastSelectedMakeModel);
            ...
            String displayText4 = filterFragment3.getFilterDataList().get(i).getDisplayText();
            if (displayText4 == null) {
                displayText4 = "";
            }
            intent3.putExtra(Constants_MVVM.EXTRA_DISPLAY_FILTER_TITLE, filterFragment3.getDisplayName(displayText4));
