...
final class FilterFragment$setOnClick$4 implements View.OnClickListener {
    final /* synthetic */ FilterFragment this$0;

    FilterFragment$setOnClick$4(FilterFragment filterFragment) {
        this.this$0 = filterFragment;
    }

    public final void onClick(View view) {
        TextView textView = (TextView) this.this$0._$_findCachedViewById(C2723R.C2726id.tvClearFilterFindVehicle);
        ...
        TextView textView2 = (TextView) this.this$0._$_findCachedViewById(C2723R.C2726id.filterFragmentSearch);
        Intrinsics.checkExpressionValueIsNotNull(textView2, "filterFragmentSearch");
        textView2.setHint(this.this$0.getString(C2723R.string.hint_search_vehicle));
