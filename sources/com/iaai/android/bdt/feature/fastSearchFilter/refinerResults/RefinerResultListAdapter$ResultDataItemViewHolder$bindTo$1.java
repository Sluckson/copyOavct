...
final class RefinerResultListAdapter$ResultDataItemViewHolder$bindTo$1 implements ViewTreeObserver.OnPreDrawListener {
    final /* synthetic */ RefinerResultListAdapter.ResultDataItemViewHolder this$0;

    RefinerResultListAdapter$ResultDataItemViewHolder$bindTo$1(RefinerResultListAdapter.ResultDataItemViewHolder resultDataItemViewHolder) {
        this.this$0 = resultDataItemViewHolder;
    }

    public final boolean onPreDraw() {
        int lineCount;
        Layout layout = this.this$0.binding.tvIsPublic.getLayout();
        if (layout != null && (lineCount = layout.getLineCount()) > 0 && layout.getEllipsisCount(lineCount - 1) > 0) {
            this.this$0.this$0.isPublicTruncate = true;
