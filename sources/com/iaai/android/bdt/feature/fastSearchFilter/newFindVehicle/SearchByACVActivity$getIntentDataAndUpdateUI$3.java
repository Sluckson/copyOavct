...
final class SearchByACVActivity$getIntentDataAndUpdateUI$3 implements TextView.OnEditorActionListener {
    final /* synthetic */ SearchByACVActivity this$0;

    SearchByACVActivity$getIntentDataAndUpdateUI$3(SearchByACVActivity searchByACVActivity) {
    ...
    public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
        ...
        if (z) {
            ...
            if (editText2.getText().length() > 1) {
                ...
                EditText editText3 = (EditText) searchByACVActivity._$_findCachedViewById(C2723R.C2726id.etStart);
                Intrinsics.checkExpressionValueIsNotNull(editText3, "etStart");
                searchByACVActivity.setMinInputValue(String_ExtensionKt.resetFormattedString(editText3.getText().toString()));
