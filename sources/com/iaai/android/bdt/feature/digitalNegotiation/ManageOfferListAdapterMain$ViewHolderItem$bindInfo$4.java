...
final class ManageOfferListAdapterMain$ViewHolderItem$bindInfo$4 implements View.OnClickListener {
    ...
    ManageOfferListAdapterMain$ViewHolderItem$bindInfo$4(ManageOfferListAdapterMain.ViewHolderItem viewHolderItem, MobileNegotiationsList mobileNegotiationsList, int i) {
    ...
    public final void onClick(View view) {
        ...
        listener.onManageActionButtonClick(view, this.$mobileNegotiationsList, this.$position, NegotiationActionEnum.BUY_IT);
    }
}
