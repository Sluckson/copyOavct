...
final class ManageOfferListFragment$checkNetworkConnection$1<T> implements Observer<Boolean> {
    final /* synthetic */ ManageOfferListFragment this$0;

    ManageOfferListFragment$checkNetworkConnection$1(ManageOfferListFragment manageOfferListFragment) {
        this.this$0 = manageOfferListFragment;
    }

    public final void onChanged(Boolean bool) {
        if (bool != null && bool.booleanValue()) {
            this.this$0.fetchManageOfferList();
        }
    }
}
