...
final class ManageOfferListAdapterMain$ViewHolderItem$bindInfo$5 implements View.OnClickListener {
    ...
    ManageOfferListAdapterMain$ViewHolderItem$bindInfo$5(ManageOfferListAdapterMain.ViewHolderItem viewHolderItem, MobileNegotiationsList mobileNegotiationsList, int i) {
    ...
    public final void onClick(View view) {
        ...
        listener.onManageActionButtonClick(view, this.$mobileNegotiationsList, this.$position, NegotiationActionEnum.KEEP_MY_BID);
    }
}
