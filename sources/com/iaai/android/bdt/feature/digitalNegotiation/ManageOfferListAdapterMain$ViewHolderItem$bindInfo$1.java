...
final class ManageOfferListAdapterMain$ViewHolderItem$bindInfo$1 implements View.OnClickListener {
    ...
    ManageOfferListAdapterMain$ViewHolderItem$bindInfo$1(ManageOfferListAdapterMain.ViewHolderItem viewHolderItem, MobileNegotiationsList mobileNegotiationsList, int i) {
    ...
    public final void onClick(View view) {
        ...
        listener.onManageOfferListClick(view, this.$mobileNegotiationsList, this.$position - 1);
    }
}
