...
final class ManageOfferListAdapterMain$ViewHolderItem$bindInfo$7 implements View.OnClickListener {
    ...
    ManageOfferListAdapterMain$ViewHolderItem$bindInfo$7(ManageOfferListAdapterMain.ViewHolderItem viewHolderItem, MobileNegotiationsList mobileNegotiationsList, int i) {
    ...
    public final void onClick(View view) {
        MobileNegotiationsList mobileNegotiationsList = this.$mobileNegotiationsList;
        mobileNegotiationsList.setBidHistoryVisible(Boolean.valueOf(!Intrinsics.areEqual((Object) mobileNegotiationsList.isBidHistoryVisible(), (Object) true)));
