...
final class ManageOfferListAdapterMain$ViewHolderItem$bindInfo$2 implements View.OnClickListener {
    ...
    ManageOfferListAdapterMain$ViewHolderItem$bindInfo$2(ManageOfferListAdapterMain.ViewHolderItem viewHolderItem, MobileNegotiationsList mobileNegotiationsList, int i) {
    ...
    public final void onClick(View view) {
        ...
        listener.onManageActionButtonClick(view, this.$mobileNegotiationsList, this.$position, NegotiationActionEnum.RAISE_MY_BID_DISABLED_MSG);
    }
}
