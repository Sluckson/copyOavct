...
final class AuctionMainListFragment$checkNetworkConnection$1<T> implements Observer<Boolean> {
    final /* synthetic */ AuctionMainListFragment this$0;

    AuctionMainListFragment$checkNetworkConnection$1(AuctionMainListFragment auctionMainListFragment) {
        this.this$0 = auctionMainListFragment;
    }

    public final void onChanged(Boolean bool) {
        AuctionMainListFragment auctionMainListFragment = this.this$0;
        auctionMainListFragment.fetchAuctionMainListFirstTime(auctionMainListFragment.searchDate);
    }
}
