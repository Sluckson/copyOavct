...
final class BDTAuctionMainListAdapter$onCreateViewHolder$4 implements View.OnClickListener {
    final /* synthetic */ BDTAuctionMainListAdapter.ViewHolder $holder;
    final /* synthetic */ BDTAuctionMainListAdapter this$0;

    BDTAuctionMainListAdapter$onCreateViewHolder$4(BDTAuctionMainListAdapter bDTAuctionMainListAdapter, BDTAuctionMainListAdapter.ViewHolder viewHolder) {
    ...
    public final void onClick(View view) {
        ...
        listener.onAuctionClick(view, this.this$0.getItem(this.$holder.getAdapterPosition()));
    }
}
