...
final class ProductHDImageActivity$initializeBtnActions$3 implements View.OnClickListener {
    final /* synthetic */ ProductHDImageActivity this$0;

    ProductHDImageActivity$initializeBtnActions$3(ProductHDImageActivity productHDImageActivity) {
        this.this$0 = productHDImageActivity;
    }

    public final void onClick(View view) {
        if (this.this$0.index < this.this$0.vehicleImages.size() - 1) {
