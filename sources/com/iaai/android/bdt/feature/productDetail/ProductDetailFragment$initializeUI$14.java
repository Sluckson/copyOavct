...
final class ProductDetailFragment$initializeUI$14 implements View.OnClickListener {
    final /* synthetic */ ProductDetailFragment this$0;

    ProductDetailFragment$initializeUI$14(ProductDetailFragment productDetailFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (!IAASharedPreference.getSalesInfoViewLessPreferencesMVVM(application.getApplicationContext()).booleanValue()) {
            ...
            IAASharedPreference.setSalesInfoViewLessPreferencesMVVM(application2.getApplicationContext(), true);
            TextView textView = (TextView) this.this$0._$_findCachedViewById(C2723R.C2726id.txtSalesInfoViewMore);
        ...
        IAASharedPreference.setSalesInfoViewLessPreferencesMVVM(application3.getApplicationContext(), false);
        TextView textView2 = (TextView) this.this$0._$_findCachedViewById(C2723R.C2726id.txtSalesInfoViewMore);
