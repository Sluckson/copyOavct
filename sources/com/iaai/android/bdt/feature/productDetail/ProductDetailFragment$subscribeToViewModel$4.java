...
final class ProductDetailFragment$subscribeToViewModel$4<T> implements Observer<ProductDetailErrorModel> {
    final /* synthetic */ ProductDetailFragment this$0;

    ProductDetailFragment$subscribeToViewModel$4(ProductDetailFragment productDetailFragment) {
    ...
    public final void onChanged(ProductDetailErrorModel productDetailErrorModel) {
        ...
        if (this.this$0.isAdded() && this.this$0.isViewAvalibale) {
            this.this$0.isBuyNowButtonClick = false;
            this.this$0.isPreBidButtonClick = false;
