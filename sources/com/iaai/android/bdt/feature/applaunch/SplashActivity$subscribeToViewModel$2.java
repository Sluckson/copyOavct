...
final class SplashActivity$subscribeToViewModel$2<T> implements Observer<String> {
    final /* synthetic */ SplashActivity this$0;

    SplashActivity$subscribeToViewModel$2(SplashActivity splashActivity) {
        this.this$0 = splashActivity;
    }

    public final void onChanged(String str) {
        Log.d("Make Model Data", str);
