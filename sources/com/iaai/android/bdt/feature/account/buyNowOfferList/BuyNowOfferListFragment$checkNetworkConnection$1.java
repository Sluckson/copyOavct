...
final class BuyNowOfferListFragment$checkNetworkConnection$1<T> implements Observer<Boolean> {
    final /* synthetic */ BuyNowOfferListFragment this$0;

    BuyNowOfferListFragment$checkNetworkConnection$1(BuyNowOfferListFragment buyNowOfferListFragment) {
        this.this$0 = buyNowOfferListFragment;
    }

    public final void onChanged(Boolean bool) {
        if (bool != null && bool.booleanValue()) {
            this.this$0.fetchBuyNowOfferList();
        }
    }
}
