...
final class BuyNowOfferListFragment$subscribeToViewModel$5<T> implements Observer<Integer> {
    final /* synthetic */ BuyNowOfferListFragment this$0;

    BuyNowOfferListFragment$subscribeToViewModel$5(BuyNowOfferListFragment buyNowOfferListFragment) {
        this.this$0 = buyNowOfferListFragment;
    }

    public final void onChanged(Integer num) {
        ((RecyclerView) this.this$0._$_findCachedViewById(C2723R.C2726id.rvBuyNowOfferList)).scrollToPosition(0);
