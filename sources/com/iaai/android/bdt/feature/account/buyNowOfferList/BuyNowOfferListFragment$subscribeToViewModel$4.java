...
final class BuyNowOfferListFragment$subscribeToViewModel$4<T> implements Observer<NetworkState> {
    public static final BuyNowOfferListFragment$subscribeToViewModel$4 INSTANCE = new BuyNowOfferListFragment$subscribeToViewModel$4();

    BuyNowOfferListFragment$subscribeToViewModel$4() {
    }
