...
final class ManageBranchPrefActivity$checkNetworkConnection$1<T> implements Observer<Boolean> {
    final /* synthetic */ ManageBranchPrefActivity this$0;

    ManageBranchPrefActivity$checkNetworkConnection$1(ManageBranchPrefActivity manageBranchPrefActivity) {
        this.this$0 = manageBranchPrefActivity;
    }

    public final void onChanged(Boolean bool) {
        if (bool != null && bool.booleanValue()) {
            this.this$0.fetchSaleDocManagePrefBranchList();
        }
    }
}
