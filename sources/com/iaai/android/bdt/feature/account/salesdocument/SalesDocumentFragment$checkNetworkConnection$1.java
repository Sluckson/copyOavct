...
final class SalesDocumentFragment$checkNetworkConnection$1<T> implements Observer<Boolean> {
    final /* synthetic */ SalesDocumentFragment this$0;

    SalesDocumentFragment$checkNetworkConnection$1(SalesDocumentFragment salesDocumentFragment) {
        this.this$0 = salesDocumentFragment;
    }

    public final void onChanged(Boolean bool) {
        if (bool != null && bool.booleanValue()) {
            this.this$0.fetchSalesDocument(false);
            this.this$0.fetchSaleDocBranchList();
        }
    }
}
