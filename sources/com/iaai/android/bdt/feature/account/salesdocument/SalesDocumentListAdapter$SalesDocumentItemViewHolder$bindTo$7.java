...
final class SalesDocumentListAdapter$SalesDocumentItemViewHolder$bindTo$7 implements View.OnClickListener {
    final /* synthetic */ int $position;
    final /* synthetic */ SalesDocumentListAdapter.SalesDocumentItemViewHolder this$0;

    SalesDocumentListAdapter$SalesDocumentItemViewHolder$bindTo$7(SalesDocumentListAdapter.SalesDocumentItemViewHolder salesDocumentItemViewHolder, int i) {
    ...
    public final void onClick(View view) {
        ...
        if (access$getItem != null) {
            ...
            Boolean valueOf = access$getItem2 != null ? Boolean.valueOf(access$getItem2.isSelected()) : null;
            if (valueOf == null) {
                Intrinsics.throwNpe();
            }
            access$getItem.setSelected(!valueOf.booleanValue());
        }
        ...
        this.this$0.this$0.salesDocumentClickListener.onDocumentSelect(this.this$0.this$0.getCurrentList());
    }
}
