...
final class MyListFragment$onActivityCreated$1 implements View.OnClickListener {
    final /* synthetic */ MyListFragment this$0;

    MyListFragment$onActivityCreated$1(MyListFragment myListFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (medalliaFBRemoteConfigModel == null) {
            ...
            BaseActivity access$getBaseActivity$p = MyListFragment.access$getBaseActivity$p(this.this$0);
            ...
            MedalliaDigital.showForm(medalliaFBRemoteConfigModel.getFeedback_form_id(), new MyListFragment$onActivityCreated$1$mdResultCallback$1());
        } else {
            Intrinsics.checkExpressionValueIsNotNull(view, "v");
            Context context2 = view.getContext();
            BaseActivity access$getBaseActivity$p2 = MyListFragment.access$getBaseActivity$p(this.this$0);
