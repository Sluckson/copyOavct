...
final class PreSaleListFragment$subscribeToViewModel$3<T> implements Observer<NetworkState> {
    public static final PreSaleListFragment$subscribeToViewModel$3 INSTANCE = new PreSaleListFragment$subscribeToViewModel$3();

    PreSaleListFragment$subscribeToViewModel$3() {
    }
