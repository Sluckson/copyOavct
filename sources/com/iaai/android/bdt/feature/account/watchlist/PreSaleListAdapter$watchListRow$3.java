...
final class PreSaleListAdapter$watchListRow$3 implements ViewTreeObserver.OnPreDrawListener {
    final /* synthetic */ ItemAuctionSalesListBinding $binding;
    final /* synthetic */ PreSaleListAdapter this$0;

    PreSaleListAdapter$watchListRow$3(PreSaleListAdapter preSaleListAdapter, ItemAuctionSalesListBinding itemAuctionSalesListBinding) {
    ...
    public final boolean onPreDraw() {
        int lineCount;
        Layout layout = this.$binding.tvOffsite.getLayout();
        if (layout != null && (lineCount = layout.getLineCount()) > 0 && layout.getEllipsisCount(lineCount - 1) > 0) {
            this.this$0.isOffsiteTruncate = true;
