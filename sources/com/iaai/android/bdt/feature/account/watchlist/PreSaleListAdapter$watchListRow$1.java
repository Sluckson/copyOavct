...
final class PreSaleListAdapter$watchListRow$1 implements ViewTreeObserver.OnPreDrawListener {
    final /* synthetic */ ItemAuctionSalesListBinding $binding;
    final /* synthetic */ PreSaleListAdapter this$0;

    PreSaleListAdapter$watchListRow$1(PreSaleListAdapter preSaleListAdapter, ItemAuctionSalesListBinding itemAuctionSalesListBinding) {
    ...
    public final boolean onPreDraw() {
        int lineCount;
        Layout layout = this.$binding.tvIsPublic.getLayout();
        if (layout != null && (lineCount = layout.getLineCount()) > 0 && layout.getEllipsisCount(lineCount - 1) > 0) {
            this.this$0.isPublicTruncate = true;
