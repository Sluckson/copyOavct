...
public final class VINInfo implements Serializable {
    ...
    @NotNull
    public static /* synthetic */ VINInfo copy$default(VINInfo vINInfo, int i, String str, List<DisplayValue> list, String str2, Object obj, int i2, Object obj2) {
        if ((i2 & 1) != 0) {
            i = vINInfo.DisplayPattern;
        }
        if ((i2 & 2) != 0) {
            str = vINInfo.DisplayText;
        }
        String str3 = str;
        if ((i2 & 4) != 0) {
            list = vINInfo.DisplayValues;
        }
        ...
        return vINInfo.copy(i, str3, list2, str4, obj);
    }
    ...
    @NotNull
    public final VINInfo copy(int i, @NotNull String str, @NotNull List<DisplayValue> list, @NotNull String str2, @NotNull Object obj) {
        ...
        return new VINInfo(i, str, list, str2, obj);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        if (this != obj) {
            if (obj instanceof VINInfo) {
                ...
                if (!(this.DisplayPattern == vINInfo.DisplayPattern) || !Intrinsics.areEqual((Object) this.DisplayText, (Object) vINInfo.DisplayText) || !Intrinsics.areEqual((Object) this.DisplayValues, (Object) vINInfo.DisplayValues) || !Intrinsics.areEqual((Object) this.Name, (Object) vINInfo.Name) || !Intrinsics.areEqual(this.Rank, vINInfo.Rank)) {
                    return false;
                }
            }
            return false;
    ...
    public String toString() {
        return "VINInfo(DisplayPattern=" + this.DisplayPattern + ", DisplayText=" + this.DisplayText + ", DisplayValues=" + this.DisplayValues + ", Name=" + this.Name + ", Rank=" + this.Rank + ")";
    }

    public VINInfo(int i, @NotNull String str, @NotNull List<DisplayValue> list, @NotNull String str2, @NotNull Object obj) {
        Intrinsics.checkParameterIsNotNull(str, "DisplayText");
        Intrinsics.checkParameterIsNotNull(list, "DisplayValues");
        Intrinsics.checkParameterIsNotNull(str2, "Name");
        Intrinsics.checkParameterIsNotNull(obj, "Rank");
