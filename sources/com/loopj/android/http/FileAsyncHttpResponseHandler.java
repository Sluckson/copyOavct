...
public abstract class FileAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public FileAsyncHttpResponseHandler(File file2, boolean z, boolean z2, boolean z3) {
        ...
        if (file2.isDirectory() && !file2.mkdirs()) {
            AsyncHttpClient.log.mo51334d(LOG_TAG, "Cannot create directories for requested Directory location, might not be a problem");
        }
        this.file = file2;
        this.append = z;
    ...
    public File getTemporaryFile(Context context) {
        ...
        try {
            ...
            AsyncHttpClient.log.mo51337e(LOG_TAG, "Cannot create temporary file", e);
            return null;
        }
    }
