...
public class JsonStreamerEntity implements HttpEntity {
    ...
    private static final byte[] JSON_FALSE = PdfBoolean.FALSE.getBytes();
    ...
    public void writeTo(OutputStream outputStream) throws IOException {
        if (outputStream != null) {
            ...
            if (size > 0) {
                ...
                logInterface.mo51339i(LOG_TAG, "Uploaded JSON in " + Math.floor((double) (currentTimeMillis2 / 1000)) + " seconds");
            }
            outputStream.write(125);
            outputStream.flush();
