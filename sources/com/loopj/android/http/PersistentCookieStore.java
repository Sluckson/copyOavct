...
public class PersistentCookieStore implements CookieStore {
    ...
    public String encodeCookie(SerializableCookie serializableCookie) {
        ...
        try {
            ...
            AsyncHttpClient.log.mo51335d(LOG_TAG, "IOException in encodeCookie", e);
            return null;
        }
    }
    ...
    public Cookie decodeCookie(String str) {
        try {
            ...
            AsyncHttpClient.log.mo51335d(LOG_TAG, "IOException in decodeCookie", e);
            return null;
        } catch (ClassNotFoundException e2) {
            AsyncHttpClient.log.mo51335d(LOG_TAG, "ClassNotFoundException in decodeCookie", e2);
            return null;
        }
    }
