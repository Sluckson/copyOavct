...
public abstract class DataAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public void onProgressData(byte[] bArr) {
        AsyncHttpClient.log.mo51334d(LOG_TAG, "onProgressData(byte[]) was not overriden, but callback was received");
    }
    ...
    public void handleMessage(Message message) {
        ...
        if (message.what == 7) {
            ...
            if (objArr == null || objArr.length < 1) {
                AsyncHttpClient.log.mo51336e(LOG_TAG, "PROGRESS_DATA_MESSAGE didn't got enough params");
                return;
            }
            try {
                onProgressData((byte[]) objArr[0]);
            } catch (Throwable th) {
                AsyncHttpClient.log.mo51337e(LOG_TAG, "custom onProgressData contains an error", th);
            }
        }
    }
    ...
    public byte[] getResponseData(p052cz.msebera.android.httpclient.HttpEntity r7) throws java.io.IOException {
        /*
            r6 = this;
