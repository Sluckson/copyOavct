...
import p052cz.msebera.android.httpclient.impl.client.AbstractHttpClient;
                ...
                if (!isCancelled()) {
                    try {
                        ...
                        if (!isCancelled()) {
                            ...
                            AsyncHttpClient.log.mo51337e("AsyncHttpRequest", "makeRequestWithRetries returned error", e);
                        }
                    }
                    if (!isCancelled()) {
        ...
        while (z) {
            try {
                ...
                try {
                    ...
                    AsyncHttpClient.log.mo51337e("AsyncHttpRequest", "Unhandled exception origin cause", e4);
