...
public abstract class BinaryHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public BinaryHttpResponseHandler(String[] strArr) {
        if (strArr != null) {
            ...
            AsyncHttpClient.log.mo51336e(LOG_TAG, "Constructor passed allowedContentTypes was null !");
        }
    }
    ...
    public final void sendResponseMessage(HttpResponse httpResponse) throws IOException {
        ...
        for (String str : getAllowedContentTypes()) {
            try {
                ...
                AsyncHttpClient.log.mo51337e(LOG_TAG, "Given pattern is not valid: " + str, e);
            }
        }
        if (!z) {
