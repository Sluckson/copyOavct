...
public class CameraInstance {
    ...
    private Runnable closer = new Runnable() {
        public void run() {
            ...
            CameraInstance.this.readyHandler.sendEmptyMessage(C2695R.C2697id.zxing_camera_closed);
        ...
        public void run() {
            try {
                ...
                if (CameraInstance.this.readyHandler != null) {
                    CameraInstance.this.readyHandler.obtainMessage(C2695R.C2697id.zxing_prewiew_size_ready, CameraInstance.this.getPreviewSize()).sendToTarget();
                }
            } catch (Exception e) {
    ...
    public void notifyError(Exception exc) {
        ...
        if (handler != null) {
            handler.obtainMessage(C2695R.C2697id.zxing_camera_error, exc).sendToTarget();
        }
    }
