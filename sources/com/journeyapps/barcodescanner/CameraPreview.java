...
public class CameraPreview extends ViewGroup {
    ...
    private final Handler.Callback stateCallback = new Handler.Callback() {
        public boolean handleMessage(Message message) {
            if (message.what == C2695R.C2697id.zxing_prewiew_size_ready) {
                CameraPreview.this.previewSized((Size) message.obj);
                return true;
            } else if (message.what == C2695R.C2697id.zxing_camera_error) {
                ...
                return false;
            } else if (message.what != C2695R.C2697id.zxing_camera_closed) {
                return false;
            } else {
    ...
    public void initializeAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C2695R.styleable.zxing_camera_preview);
        int dimension = (int) obtainStyledAttributes.getDimension(C2695R.styleable.zxing_camera_preview_zxing_framing_rect_width, -1.0f);
        int dimension2 = (int) obtainStyledAttributes.getDimension(C2695R.styleable.zxing_camera_preview_zxing_framing_rect_height, -1.0f);
        if (dimension > 0 && dimension2 > 0) {
            this.framingRectSize = new Size(dimension, dimension2);
        }
        this.useTextureView = obtainStyledAttributes.getBoolean(C2695R.styleable.zxing_camera_preview_zxing_use_texture_view, true);
        int integer = obtainStyledAttributes.getInteger(C2695R.styleable.zxing_camera_preview_zxing_preview_scaling_strategy, -1);
        if (integer == 1) {
    ...
    public void pause() {
        ...
        if (cameraInstance2 != null) {
            ...
            this.stateHandler.sendEmptyMessage(C2695R.C2697id.zxing_camera_closed);
        }
