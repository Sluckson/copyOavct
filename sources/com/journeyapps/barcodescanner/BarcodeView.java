...
public class BarcodeView extends CameraPreview {
    ...
    private final Handler.Callback resultCallback = new Handler.Callback() {
        public boolean handleMessage(Message message) {
            if (message.what == C2695R.C2697id.zxing_decode_succeeded) {
                ...
                return true;
            } else if (message.what == C2695R.C2697id.zxing_decode_failed) {
                return true;
            } else {
                if (message.what != C2695R.C2697id.zxing_possible_result_points) {
                    return false;
                }
