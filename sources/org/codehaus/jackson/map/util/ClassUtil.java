...
public final class ClassUtil {
    ...
    public static boolean isConcrete(Class<?> cls) {
        return (cls.getModifiers() & WMSTransport.PUSHPUBLISHSESSIONWOWZ_HANDSHAKESIZE_CLIENT1) == 0;
    }

    public static boolean isConcrete(Member member) {
        return (member.getModifiers() & WMSTransport.PUSHPUBLISHSESSIONWOWZ_HANDSHAKESIZE_CLIENT1) == 0;
    }
