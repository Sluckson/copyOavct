...
public class ViewListener implements StaticTypeListener {
    ...
    public ViewListener(Provider<Context> provider, Application application2, ContextScope contextScope) {
    ...
    public <I> void hear(com.google.inject.TypeLiteral<I> r9, com.google.inject.spi.TypeEncounter<I> r10) {
        ...
        L_0x000c:
            ...
            java.lang.Class<roboguice.inject.InjectView> r4 = roboguice.inject.InjectView.class
            boolean r4 = r3.isAnnotationPresent(r4)
            if (r4 == 0) goto L_0x0036
            roboguice.inject.ViewMembersInjector r4 = new roboguice.inject.ViewMembersInjector
            ...
            roboguice.inject.InjectView r6 = (roboguice.inject.InjectView) r6
