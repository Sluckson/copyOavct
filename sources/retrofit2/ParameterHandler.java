            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        Object value = next.getValue();
                        if (value != null) {
                            requestBuilder.addPart(Headers.m4753of("Content-Disposition", "form-data; name=\"" + str + "\"", MIME.CONTENT_TRANSFER_ENC, this.transferEncoding), this.valueConverter.convert(value));
                        } else {
