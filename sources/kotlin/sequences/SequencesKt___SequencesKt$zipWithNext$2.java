...
@DebugMetadata(mo67566c = "kotlin.sequences.SequencesKt___SequencesKt$zipWithNext$2", mo67567f = "_Sequences.kt", mo67568i = {0, 0, 0, 0}, mo67569l = {1863}, mo67570m = "invokeSuspend", mo67571n = {"$this$result", "iterator", "current", "next"}, mo67572s = {"L$0", "L$1", "L$2", "L$3"})
...
final class SequencesKt___SequencesKt$zipWithNext$2 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        sequencesKt___SequencesKt$zipWithNext$2.f5413p$ = (SequenceScope) obj;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            SequenceScope sequenceScope2 = this.f5413p$;
