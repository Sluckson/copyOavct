...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 == 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m5747getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
        } else {
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m4975toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m4975toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    @Metadata(mo66931bv = {1, 0, 3}, mo66932d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000b\u0002\u0004\n\u0002\b\u0019¨\u0006\f"}, mo66933d2 = {"Lkotlin/ranges/UIntProgression$Companion;", "", "()V", "fromClosedRange", "Lkotlin/ranges/UIntProgression;", "rangeStart", "Lkotlin/UInt;", "rangeEnd", "step", "", "fromClosedRange-Nkh28Cs", "(III)Lkotlin/ranges/UIntProgression;", "kotlin-stdlib"}, mo66934k = 1, mo66935mv = {1, 1, 16})
    /* compiled from: UIntRange.kt */
    public static final class Companion {
        ...
        public final UIntProgression m5761fromClosedRangeNkh28Cs(int i, int i2, int i3) {
