...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final double m4637ln(double d) {
        return Math.log(d);
    }
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final float m4638ln(float f) {
