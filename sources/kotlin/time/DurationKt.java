...
public final class DurationKt {
    ...
    private static final double m5853timesmvk6XK0(int i, double d) {
        return Duration.m5835timesimpl(d, i);
    }
    ...
    private static final double m5852timeskIfJnKk(double d, double d2) {
        return Duration.m5834timesimpl(d2, d);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m5808constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
