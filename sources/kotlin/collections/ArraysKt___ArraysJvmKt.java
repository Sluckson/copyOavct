...
class ArraysKt___ArraysJvmKt extends ArraysKt__ArraysKt {
    ...
    public static final <T> T[] plus(@NotNull T[] tArr, T t) {
        ...
        copyOf[length] = t;
        Intrinsics.checkExpressionValueIsNotNull(copyOf, Constants.EXTRA_RESULT);
        return copyOf;
    }
